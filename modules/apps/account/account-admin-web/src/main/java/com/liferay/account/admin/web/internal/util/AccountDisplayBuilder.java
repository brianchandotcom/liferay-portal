 ...
 * @author Pei-Jung Lan
 */
public class AccountDisplayBuilder {

	public static AccountDisplay getAccountDisplay(AccountEntry accountEntry) {
		AccountDisplay accountDisplay = new AccountDisplay();

		accountDisplay.setAccountId(accountEntry.getAccountEntryId());

		accountDisplay.setDescription(accountEntry.getDescription());
		accountDisplay.setName(accountEntry.getName());
		accountDisplay.setParentAccountName(
			_getParentAccountName(accountEntry));
		accountDisplay.setStatusLabel(_getStatusLabel(accountEntry));
		accountDisplay.setWebsite(_getWebsite(accountEntry));
