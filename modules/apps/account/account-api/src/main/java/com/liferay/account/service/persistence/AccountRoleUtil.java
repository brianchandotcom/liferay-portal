...
public class AccountRoleUtil {
	 ...
	 */
	public static List<AccountRole> findByAccountEntryIds(long accountEntryId) {
		return getPersistence().findByAccountEntryIds(accountEntryId);
	}
	 ...
	 */
	public static List<AccountRole> findByAccountEntryIds(
		long accountEntryId, int start, int end) {

		return getPersistence().findByAccountEntryIds(
	 ...
	 */
	public static AccountRole findByAccountEntryIds_First(
			long accountEntryId,
			OrderByComparator<AccountRole> orderByComparator)
		throws com.liferay.account.exception.NoSuchRoleException {

		return getPersistence().findByAccountEntryIds_First(
	 ...
	 */
	public static AccountRole fetchByAccountEntryIds_First(
		long accountEntryId, OrderByComparator<AccountRole> orderByComparator) {

		return getPersistence().fetchByAccountEntryIds_First(
			accountEntryId, orderByComparator);
	}
	 ...
	 * @throws NoSuchRoleException if a matching account role could not be found
	 */
	public static AccountRole findByAccountEntryIds_Last(
			long accountEntryId,
			OrderByComparator<AccountRole> orderByComparator)
		throws com.liferay.account.exception.NoSuchRoleException {

		return getPersistence().findByAccountEntryIds_Last(
			accountEntryId, orderByComparator);
	}
	 ...
	 */
	public static AccountRole fetchByAccountEntryIds_Last(
		long accountEntryId, OrderByComparator<AccountRole> orderByComparator) {

		return getPersistence().fetchByAccountEntryIds_Last(
			accountEntryId, orderByComparator);
	}
	 ...
	 */
	public static AccountRole[] findByAccountEntryIds_PrevAndNext(
			long accountRoleId, long accountEntryId,
			OrderByComparator<AccountRole> orderByComparator)
		throws com.liferay.account.exception.NoSuchRoleException {

		return getPersistence().findByAccountEntryIds_PrevAndNext(
	...
	public static List<AccountRole> findByAccountEntryIds(
		...
		return getPersistence().findByAccountEntryIds(accountEntryIds);
	}
	 ...
	 * @param accountEntryId the account entry ID
	 */
	public static void removeByAccountEntryIds(long accountEntryId) {
		getPersistence().removeByAccountEntryIds(accountEntryId);
	}
	 ...
	 */
	public static int countByAccountEntryIds(long accountEntryId) {
		return getPersistence().countByAccountEntryIds(accountEntryId);
	}
	 ...
	 * @return the number of matching account roles
	 */
	public static int countByAccountEntryIds(long[] accountEntryIds) {
		return getPersistence().countByAccountEntryIds(accountEntryIds);
	}
