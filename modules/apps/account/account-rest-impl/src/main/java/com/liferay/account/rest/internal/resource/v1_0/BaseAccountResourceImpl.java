...
public abstract class BaseAccountResourceImpl
	implements AccountResource, BatchEngineTaskItemDelegate<Account>,
			   EntityModelResource {
	...
	@Override
	public com.liferay.batch.engine.pagination.Page<Account> read(
			Filter filter,
			com.liferay.batch.engine.pagination.Pagination pagination,
			Sort[] sorts, Map<String, Serializable> parameters, String search)
		throws Exception {

		Page<Account> page = getAccountsPage(
			(String)parameters.get("keywords"), filter,
