...
public class AccountGroupServiceHttp {
	...
	public static int getAccountGroupsByAccountEntryIdCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				AccountGroupServiceUtil.class,
				"getAccountGroupsByAccountEntryIdCount",
				_getAccountGroupsByAccountEntryIdCountParameterTypes6);
	...
	private static final Class<?>[]
		_getAccountGroupsByAccountEntryIdCountParameterTypes6 = new Class[] {
			long.class
		};
