...
public class AccountUserRetrieverWhenSearchingAssignableUsersTest {
	...
	public void testShouldReturnUsersWithMatchingEmailDomain()
		...
		String[] emailDomains = {"test1.com", "test2.com"};
		...
		_accountEntry = AccountEntryTestUtil.addAccountEntry(
			_accountEntryLocalService, emailDomains);
	...
	private User _addAccountUser(String emailDomain) throws Exception {
		User user = _addUser(emailDomain);
