...
public class AccountRolePersistenceTest {
	...
	@Test
	public void testCountByAccountEntryIds() throws Exception {
		_persistence.countByAccountEntryIds(RandomTestUtil.nextLong());

		_persistence.countByAccountEntryIds(0L);
	}

	@Test
	public void testCountByAccountEntryIdsArrayable() throws Exception {
		_persistence.countByAccountEntryIds(
