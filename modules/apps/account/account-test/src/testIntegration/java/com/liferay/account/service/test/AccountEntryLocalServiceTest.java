...
public class AccountEntryLocalServiceTest {
	...
	public void testSearchByType() throws Exception {
		...
		_assertSearchWithParams(
			...
			_getLinkedHashMap(
				Field.TYPE, AccountConstants.ACCOUNT_ENTRY_TYPE_BUSINESS));
		_assertSearchWithParams(
			Collections.singletonList(personalAccountEntry),
			_getLinkedHashMap(
				Field.TYPE, AccountConstants.ACCOUNT_ENTRY_TYPE_PERSONAL));
		_assertSearchWithParams(
			Collections.emptyList(),
			_getLinkedHashMap(Field.TYPE, "invalidType"));
	}
