...
public class AccountEntryServiceWhenSearchingAccountEntriesTest {
	...
	public void setUp() throws Exception {
		...
		_companyAdmin = UserTestUtil.addCompanyAdminUser(company);

		Organization rootOrganization =
			_organizationLocalService.addOrganization(
				_companyAdmin.getUserId(),
				OrganizationConstants.DEFAULT_PARENT_ORGANIZATION_ID,
				RandomTestUtil.randomString(), false);

		Organization organization = _organizationLocalService.addOrganization(
			_companyAdmin.getUserId(), rootOrganization.getOrganizationId(),
			RandomTestUtil.randomString(), false);

		Organization suborganization =
			_organizationLocalService.addOrganization(
				_companyAdmin.getUserId(), organization.getOrganizationId(),
				RandomTestUtil.randomString(), false);
	...
	public void testShouldReturnOrganizationAccountEntriesWithManageAccountsPermission()
		...
		Role role = _roleLocalService.addRole(
			_companyAdmin.getUserId(), null, 0, RandomTestUtil.randomString(),
