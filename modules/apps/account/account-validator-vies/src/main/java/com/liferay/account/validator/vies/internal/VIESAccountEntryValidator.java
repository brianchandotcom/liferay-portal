...
public class VIESAccountEntryValidator extends BaseAccountEntryValidator {
	...
	public AccountEntryValidatorResult doValidate(
		...
		if (accountEntry == null) {
			return AccountEntryValidatorResult.builder(
				...
				_RESULT_MESSAGE_MISSING_ACCOUNT
			).resultStatus(
		...
		if (!_isAccountEntryAddress(accountEntry, address, jsonObject)) {
			return AccountEntryValidatorResult.builder(
				...
				_RESULT_MESSAGE_INVALID_BILLING_ADDRESS
			).resultStatus(
				AccountEntryValidatorConstants.RESULT_FAILURE
			).build();
		}
	...
	public Set<String> getResultMessages() {
		...
		resultMessages.add(_RESULT_MESSAGE_INVALID_BILLING_ADDRESS);
		resultMessages.add(_RESULT_MESSAGE_MISSING_ACCOUNT);
	...
	private boolean _isAccountEntryAddress(
		...
		if (Objects.equals(_CLASS_NAME_COMMERCE_ORDER, className)) {
	...
	private static final String _CLASS_NAME_COMMERCE_ORDER =
		"com.liferay.commerce.model.CommerceOrder";

	private static final String _RESULT_MESSAGE_INVALID_BILLING_ADDRESS =
		"vies-invalid-billing-address-error";

	private static final String _RESULT_MESSAGE_MISSING_ACCOUNT =
