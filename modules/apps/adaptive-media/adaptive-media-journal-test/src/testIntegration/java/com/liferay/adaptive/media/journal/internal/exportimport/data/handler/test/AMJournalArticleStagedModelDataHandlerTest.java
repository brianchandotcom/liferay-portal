...
public class AMJournalArticleStagedModelDataHandlerTest
	...
	public void testExportSucceedsWithInvalidReferences() throws Exception {
		...
		JournalArticle journalArticle = _withJournalValidationDisabled(
			() -> _addJournalArticle(
	...
	private JournalArticle _withJournalValidationDisabled(
		...
		try {
			...
			ExportImportThreadLocal.setPortletValidationInProcess(
				portletValidationInProcess);
		}
	}
