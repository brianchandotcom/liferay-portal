 ...
 */
@Generated("")
@GraphQLName("ObjectEntryHistogramMetric")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ObjectEntryHistogramMetric")
public class ObjectEntryHistogramMetric implements Serializable {

	public static ObjectEntryHistogramMetric toDTO(String json) {
		return ObjectMapperUtil.readValue(
			ObjectEntryHistogramMetric.class, json);
	}

	public static ObjectEntryHistogramMetric unsafeToDTO(String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.analytics.cms.rest.dto.v1_0.ObjectEntryHistogramMetric",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-1283850125