...
public interface PerformanceMetricResource {
	...
	public HttpInvoker.HttpResponse
			getPerformanceMetricViewsByCategorizationHttpResponse(
				Long[] depotEntryIds, Integer rangeKey)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getPerformanceMetricViewsByLocationHttpResponse(
				Long[] depotEntryIds, Integer rangeKey)
		throws Exception;
	...
	public static class PerformanceMetricResourceImpl
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/analytics-cms-rest/v1.0/performance-metric-views-by-categorization");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/analytics-cms-rest/v1.0/performance-metric-views-by-location");
...
// LIFERAY-REST-BUILDER-HASH:1876235542