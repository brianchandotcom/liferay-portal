...
public class PerformanceMetricResourceTest
	...
	@Override
	@Test
	public void testGetPerformanceMetricViewsByCategorization()
		throws Exception {
		...
		PerformanceMetric performanceMetric = _getPerformanceMetric(
			...
			"/api/1.0/asset-metric/objectEntry/categories", rangeKey,
			depotEntryIds ->
				_performanceMetricResource.
					getPerformanceMetricViewsByCategorization(
						depotEntryIds, rangeKey));

		Assert.assertEquals("viewsMetric", performanceMetric.getMetricType());
	...
	@Override
	@Test
	public void testGetPerformanceMetricViewsByLocation() throws Exception {
		long dataSourceId = RandomTestUtil.nextLong();
		int rangeKey = RandomTestUtil.nextInt();
		int value1 = RandomTestUtil.nextInt();
		int value2 = RandomTestUtil.nextInt();
		...
		PerformanceMetric performanceMetric = _getPerformanceMetric(
			...
			"/api/1.0/asset-metric/objectEntry/geolocation", rangeKey,
			depotEntryIds ->
				_performanceMetricResource.getPerformanceMetricViewsByLocation(
					depotEntryIds, rangeKey));
	...
	private PerformanceMetric _getPerformanceMetric(
			long dataSourceId, String metricsJSON, String path, int rangeKey,
