...
public enum RecommendationNotificationType {
	...
	CONTENT_RECOMMENDER_MOST_POPULAR_ITEMS_FAILED(
		"an-unexpected-error-occurred,-preventing-the-most-popular-content-" +
	...
	CONTENT_RECOMMENDER_USER_PERSONALIZATION_FAILED(
		"an-unexpected-error-occurred,-preventing-the-user's-personalized-" +
			"content-recommendations-model-from-being-enabled.-go-to-" +
