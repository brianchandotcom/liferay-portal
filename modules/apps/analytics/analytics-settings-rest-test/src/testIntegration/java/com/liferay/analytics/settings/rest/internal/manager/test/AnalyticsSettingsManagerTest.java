...
public class AnalyticsSettingsManagerTest {
	...
	public void setUp() throws Exception {
		_channelIdA = RandomTestUtil.randomString(8);

		_channelIdB = RandomTestUtil.randomString(8);
	...
	public void testGetCommerceChannelIds() throws Exception {
		_analyticsSettingsManager.updateCompanyConfiguration(
			...
			HashMapBuilder.<String, Object>put(
				...
				_analyticsSettingsManager.updateCommerceChannelIds(
					_channelIdA, TestPropsValues.getCompanyId(),
		...
		_analyticsSettingsManager.updateCompanyConfiguration(
			...
			HashMapBuilder.<String, Object>put(
				"syncedCommerceChannelIds",
				_analyticsSettingsManager.updateCommerceChannelIds(
					_channelIdB, TestPropsValues.getCompanyId(),
	...
	private String _channelIdA;
	private String _channelIdB;
