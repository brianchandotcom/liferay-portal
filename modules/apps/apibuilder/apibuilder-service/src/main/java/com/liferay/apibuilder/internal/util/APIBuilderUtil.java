...
public class APIBuilderUtil {
	...
	public static APIBuilderEntry toAPIBuilderEntry(
		Collection<InfoFieldValue<Object>> infoFieldValues, long primaryKey,
		String schemaName) {

		APIBuilderEntry apiBuilderEntry = new APIBuilderEntry();
		...
		apiBuilderEntry.setContent(content);
		apiBuilderEntry.setName(schemaName);
		apiBuilderEntry.setPrimaryKey(primaryKey);

		return apiBuilderEntry;
	}
