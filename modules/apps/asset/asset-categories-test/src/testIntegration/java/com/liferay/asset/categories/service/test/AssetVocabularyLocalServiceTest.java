...
public class AssetVocabularyLocalServiceTest {
	...
	public void testDeleteVocabulary() throws Exception {
		_testDeleteSystemVocabulary();
		_testDeleteSystemVocabularyWhenDeletingGroup();
	}
	...
	public void testUpdateVocabulary() throws Exception {
		_testUpdateSystemVocabularyAssetTypes();
		_testUpdateSystemVocabularyDescription();
		_testUpdateSystemVocabularyMultiValued();
		_testUpdateSystemVocabularyRename();
		_testUpdateSystemVocabularyVisibilityType();
	...
	private void _testDeleteSystemVocabulary() throws Exception {
		AssetVocabulary vocabulary = _addSystemVocabulary();

		AssertUtils.assertFailure(
			SystemVocabularyException.MustNotDeleteSystemVocabulary.class,
			StringBundler.concat(
				"The system vocabulary ", vocabulary.getVocabularyId(),
				" cannot be deleted"),
			() -> _assetVocabularyLocalService.deleteVocabulary(
				vocabulary.getVocabularyId()));
	}

	private void _testDeleteSystemVocabularyWhenDeletingGroup()
		throws Exception {
	...
	private void _testUpdateSystemVocabularyAssetTypes() throws Exception {
		AssetVocabulary vocabulary = _addSystemVocabulary();
		...
		assetVocabularySettingsHelper.setClassNameIdsAndClassTypePKs(
			new long[] {RandomTestUtil.randomLong()}, new long[] {0},
			new boolean[] {false});
	...
	private void _testUpdateSystemVocabularyDescription() throws Exception {
		AssetVocabulary vocabulary = _addSystemVocabulary();
	...
	private void _testUpdateSystemVocabularyMultiValued() throws Exception {
		AssetVocabulary vocabulary = _addSystemVocabulary();
	...
	private void _testUpdateSystemVocabularyRename() throws Exception {
		AssetVocabulary vocabulary = _addSystemVocabulary();

		AssertUtils.assertFailure(
			SystemVocabularyException.MustNotRenameSystemVocabulary.class,
			StringBundler.concat(
				"The system vocabulary ", vocabulary.getVocabularyId(),
				" cannot be renamed"),
			() -> _assetVocabularyLocalService.updateVocabulary(
	...
	private void _testUpdateSystemVocabularyVisibilityType() throws Exception {
		AssetVocabulary vocabulary = _addSystemVocabulary();
