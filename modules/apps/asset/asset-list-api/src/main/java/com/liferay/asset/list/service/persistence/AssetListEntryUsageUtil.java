...
public class AssetListEntryUsageUtil {
	...
	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathWithoutPaginationFindByC_C_K() {

		return getPersistence().getFinderPathWithoutPaginationFindByC_C_K();
	}

	public static com.liferay.portal.kernel.dao.orm.FinderPath
		getFinderPathCountByC_C_K() {

		return getPersistence().getFinderPathCountByC_C_K();
	}
