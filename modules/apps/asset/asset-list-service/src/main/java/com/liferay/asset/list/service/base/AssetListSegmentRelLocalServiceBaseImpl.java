...
import com.liferay.asset.list.service.AssetListSegmentRelLocalService;
...
/**
 * Provides the base implementation for the asset list segment rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.asset.list.service.impl.AssetListSegmentRelLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.asset.list.service.impl.AssetListSegmentRelLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class AssetListSegmentRelLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AssetListSegmentRelLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AssetListSegmentRelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.asset.list.service.AssetListSegmentRelLocalServiceUtil</code>.
	 */
	...
	public AssetListSegmentRel addAssetListSegmentRel(
		...
		return assetListSegmentRelPersistence.update(assetListSegmentRel);
	}
	...
	public AssetListSegmentRel createAssetListSegmentRel(
		...
		return assetListSegmentRelPersistence.create(assetListSegmentRelId);
	}
	...
	public AssetListSegmentRel deleteAssetListSegmentRel(
		...
		return assetListSegmentRelPersistence.remove(assetListSegmentRelId);
	}
	...
	public AssetListSegmentRel deleteAssetListSegmentRel(
		...
		return assetListSegmentRelPersistence.remove(assetListSegmentRel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AssetListSegmentRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return assetListSegmentRelPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return assetListSegmentRelPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public AssetListSegmentRel fetchAssetListSegmentRel(
		...
		return assetListSegmentRelPersistence.fetchByPrimaryKey(
	...
	public AssetListSegmentRel fetchAssetListSegmentRelByUuidAndGroupId(
		...
		return assetListSegmentRelPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public AssetListSegmentRel getAssetListSegmentRel(
		...
		return assetListSegmentRelPersistence.findByPrimaryKey(
			assetListSegmentRelId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AssetListSegmentRel.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, assetListSegmentRel);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					AssetListSegmentRel.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return assetListSegmentRelLocalService.deleteAssetListSegmentRel(
			(AssetListSegmentRel)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return assetListSegmentRelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AssetListSegmentRel> getAssetListSegmentRelsByUuidAndCompanyId(
		...
		return assetListSegmentRelPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<AssetListSegmentRel> getAssetListSegmentRelsByUuidAndCompanyId(
		...
		return assetListSegmentRelPersistence.findByUuid_C(
	...
	public AssetListSegmentRel getAssetListSegmentRelByUuidAndGroupId(
		...
		return assetListSegmentRelPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<AssetListSegmentRel> getAssetListSegmentRels(
		...
		return assetListSegmentRelPersistence.findAll(start, end);
	}
	...
	public int getAssetListSegmentRelsCount() {
		return assetListSegmentRelPersistence.countAll();
	}
	...
	/**
	 * Returns the asset list segment rel local service.
	 *
	 * @return the asset list segment rel local service
	 */
	public AssetListSegmentRelLocalService
		getAssetListSegmentRelLocalService() {

		return assetListSegmentRelLocalService;
	}

	/**
	 * Sets the asset list segment rel local service.
	 *
	 * @param assetListSegmentRelLocalService the asset list segment rel local service
	 */
	public void setAssetListSegmentRelLocalService(
		AssetListSegmentRelLocalService assetListSegmentRelLocalService) {

		this.assetListSegmentRelLocalService = assetListSegmentRelLocalService;
	}

	/**
	 * Returns the asset list segment rel persistence.
	 *
	 * @return the asset list segment rel persistence
	 */
	public AssetListSegmentRelPersistence getAssetListSegmentRelPersistence() {
		return assetListSegmentRelPersistence;
	}

	/**
	 * Sets the asset list segment rel persistence.
	 *
	 * @param assetListSegmentRelPersistence the asset list segment rel persistence
	 */
	public void setAssetListSegmentRelPersistence(
		AssetListSegmentRelPersistence assetListSegmentRelPersistence) {

		this.assetListSegmentRelPersistence = assetListSegmentRelPersistence;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AssetListSegmentRelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				assetListSegmentRelPersistence.getDataSource();
	...
	@BeanReference(type = AssetListSegmentRelLocalService.class)
	protected AssetListSegmentRelLocalService assetListSegmentRelLocalService;

	@BeanReference(type = AssetListSegmentRelPersistence.class)
	protected AssetListSegmentRelPersistence assetListSegmentRelPersistence;
