...
public class AssetListEntryServiceHttp {
	...
	public static void addAssetEntrySelection(
			HttpPrincipal httpPrincipal, long assetEntryId,
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, assetEntryId, assetListEntryId, segmentsEntryId,
				serviceContext);
	...
	public static void addAssetEntrySelections(
			HttpPrincipal httpPrincipal, long[] assetEntryIds,
			long assetListEntryId, long segmentsEntryId,
			com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws com.liferay.portal.kernel.exception.PortalException {
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, assetEntryIds, assetListEntryId, segmentsEntryId,
				serviceContext);
