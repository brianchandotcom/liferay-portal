...
public class AssetListFiltersUtilTest {
	...
	public void testFilterQueriesWithRelativeDateOperators() {
		...
		String lastYearLowerTerm = _resolveRelativeDateLowerTerm("last-year");
		String nextMonthLowerTerm = _resolveRelativeDateLowerTerm("next-month");
		String nowLowerTerm = _resolveRelativeDateLowerTerm("now");
		String past24HoursLowerTerm = _resolveRelativeDateLowerTerm(
			"past-24-hours");
		String pastDayLowerTerm = _resolveRelativeDateLowerTerm("past-day");
		String pastMonthLowerTerm = _resolveRelativeDateLowerTerm("past-month");
		String pastWeekLowerTerm = _resolveRelativeDateLowerTerm("past-week");
		String pastYearLowerTerm = _resolveRelativeDateLowerTerm("past-year");
	...
	private String _resolveRelativeDateLowerTerm(String value) {
	...
	private void _setUpPicklistObjectField() {
		ObjectField objectField = _setUpObjectField(
			ObjectFieldConstants.BUSINESS_TYPE_PICKLIST,
			ObjectFieldConstants.DB_TYPE_STRING, "status");
