...
public class AssetListAssetEntryProviderFiltersTest {
	...
	public void testGetAssetEntriesInfoPageWithAssetTagFilters()
		...
		_assertFilteredJournalArticles(
			_getFiltersJSONArray(
				_getAssetFilterJSONObject(
					"contains", "assetTags", "any", tagName1, tagName2)),
			journalArticle1, journalArticle2, journalArticle3);
		_assertFilteredJournalArticles(
			_getFiltersJSONArray(
				_getAssetFilterJSONObject(
		...
		_assertFilteredJournalArticles(
			_getFiltersJSONArray(
				_getAssetFilterJSONObject(
					"not-contains", "assetTags", "all", tagName1, tagName2)),
			journalArticle1, journalArticle2);
	}
		...
		_assertFilteredObjectEntries(
			_getFiltersJSONArray(
				_getKeywordsFilterJSONObject(
					"contains", keyword1 + StringPool.SPACE + keyword2)),
			objectEntry1);
		_assertFilteredObjectEntries(
			_getFiltersJSONArray(
				_getKeywordsFilterJSONObject(
					"not-contains", keyword1 + StringPool.SPACE + keyword2)),
			objectEntry2);
	}
