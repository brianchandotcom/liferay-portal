...
public class AssetListAssetEntryProviderFiltersTest {
	...
	public void testGetAssetEntriesInfoPageWithEqualityFilters()
		...
		_assertFilteredClassPKs(
			_buildFiltersJSONArray(
				_buildFilterJSONObject(
					"eq", "priority", String.valueOf(priority))),
			objectEntry1);
		...
		_assertFilteredClassPKs(
			_buildFiltersJSONArray(
				_buildFilterJSONObject("not-eq", "title", title)),
			objectEntry1);
		...
		_assertFilteredClassPKs(
			_buildFiltersJSONArray(
				_buildFilterJSONObject("eq", "title", title)),
			objectEntry2);
		_assertFilteredClassPKs(
			_buildFiltersJSONArray(
				_buildFilterJSONObject(
					"not-eq", "priority", String.valueOf(priority))),
			objectEntry2);
	}
	...
	public void testGetAssetEntriesInfoPageWithKeywordTextContainsFilters()
		...
		_assertFilteredClassPKs(
			_buildFiltersJSONArray(
				_buildFilterJSONObject(
					"contains", "learnDocumentation", keyword)),
			objectEntry1);
		...
		_assertFilteredClassPKs(
			_buildFiltersJSONArray(
				_buildFilterJSONObject(
					"not-contains", "learnDocumentation", keyword)),
			objectEntry2);
	}
	...
	public void testGetAssetEntriesInfoPageWithMultipleFiltersJoinedWithMust()
		...
		_assertFilteredClassPKs(
			_buildFiltersJSONArray(
				_buildFilterJSONObject("contains", "title", title),
				_buildFilterJSONObject(
					"eq", "priority", String.valueOf(priority))),
			objectEntry1);
	}
	...
	public void testGetAssetEntriesInfoPageWithTextContainsFilters()
		...
		_assertFilteredClassPKs(
			_buildFiltersJSONArray(
				_buildFilterJSONObject("not-contains", "title", title)),
			objectEntry2);
	}
