...
public class AssetListContentActionDropdownItems {
	...
	private UnsafeConsumer<DropdownItem, Exception>
		...
		return dropdownItem -> {
			...
			dropdownItem.setDisabled(editDisplayPageTemplateURL == null);
			dropdownItem.setLabel(
				LanguageUtil.get(
	...
	private String _getEditDisplayPageTemplateURL(AssetEntry assetEntry)
		...
		editLayoutURL = HttpUtil.setParameter(
			editLayoutURL, "p_l_back_url", _themeDisplay.getURLCurrent());
	...
	private UnsafeConsumer<DropdownItem, Exception>
		...
		return dropdownItem -> {
			...
			dropdownItem.setDisabled(viewDisplayPageURL == null);
			dropdownItem.setLabel(
