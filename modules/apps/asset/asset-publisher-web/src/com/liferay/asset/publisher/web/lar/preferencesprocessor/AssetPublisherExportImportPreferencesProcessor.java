...
public class AssetPublisherExportImportPreferencesProcessor
	extends DefaultExportImportPreferencesProcessor {
		...
		return new ArrayList<>(
			ListUtil.toList(
				new ExportImportPreferencesProcessorCapability[] {
					_assetPublisherPortletDisplayTemplateExportPreferencesProcessorCapability
				})
			);
	}
	...
	public List<ExportImportPreferencesProcessorCapability>
		...
		return new ArrayList<>(
			ListUtil.toList(
				new ExportImportPreferencesProcessorCapability[] {
					_assetPublisherPortletDisplayTemplateImportPreferencesProcessorCapability
				})
			);
	}
	...
	@Reference(unbind = "-")
	protected void setAssetPublisherPortletDisplayTemplateExportPreferencesProcessorCapability(
		AssetPublisherPortletDisplayTemplateExportPreferencesProcessorCapability
			assetPublisherPortletDisplayTemplateExportPreferencesProcessorCapability) {
	...
	@Reference(unbind = "-")
	protected void setAssetPublisherPortletDisplayTemplateImportPreferencesProcessorCapability(
		AssetPublisherPortletDisplayTemplateImportPreferencesProcessorCapability
			assetPublisherPortletDisplayTemplateImportPreferencesProcessorCapability) {
	...
	protected PortletPreferences updateImportPortletPreferences(
		...
		restorePortletPreference(
				portletDataContext, "notifiedAssetEntryIds",
				portletPreferences);
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AssetPublisherExportImportPreferencesProcessor.class);
