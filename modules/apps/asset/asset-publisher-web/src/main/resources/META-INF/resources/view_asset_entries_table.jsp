		...
		<tbody>
			...
			%>
				...
				<tr class="<%= ((previewClassNameId == assetEntry.getClassNameId()) && (previewClassPK == assetEntry.getClassPK())) ? "table-active" : StringPool.BLANK %>" <%= AUIUtil.buildData(fragmentsEditorData) %>>
					<td class="table-cell-expand table-title" <%= inViewMode ? assetAnalyticsAttributesProvider.buildAttributes(AssetAnalyticsAttributesProvider.ACTION_IMPRESSION, AssetAnalyticsAttributesProvider.FIELD_TITLE) : StringPool.BLANK %>>
					...
					%>
						...
						<c:choose>
							<c:when test='<%= Objects.equals(metadataField, "author") %>'>
								<td class="table-cell-expand" <%= inViewMode ? assetAnalyticsAttributesProvider.buildAttributes(AssetAnalyticsAttributesProvider.ACTION_IMPRESSION, AssetAnalyticsAttributesProvider.FIELD_AUTHOR) : StringPool.BLANK %>>
							...
							<c:otherwise>
								...
								<td class="table-cell-expand-smallest" <%= (inViewMode && dateField) ? assetAnalyticsAttributesProvider.buildAttributes(AssetAnalyticsAttributesProvider.ACTION_IMPRESSION, metadataField) : StringPool.BLANK %>>
