...
<liferay-util:dynamic-include key="<%= DynamicIncludeKeys.ASSET_PUBLISHER_VIEW_CONTENT_PRE %>" />
...
<liferay-util:dynamic-include key="<%= DynamicIncludeKeys.ASSET_PUBLISHER_VIEW_CONTENT_POST %>" />