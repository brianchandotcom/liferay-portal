	...
	public void defineTableReferences(
		...
		tableReferenceDefinitionHelper.defineReferenceInnerJoin(
			fromStep -> fromStep.from(
				...
				AssetTagTable.INSTANCE.groupId.eq(GroupTable.INSTANCE.groupId)
			));
		...
		tableReferenceDefinitionHelper.defineReferenceInnerJoin(
			fromStep -> fromStep.from(
				...
				AssetTagTable.INSTANCE,
				AssetTagTable.INSTANCE.companyId.eq(
		...
		tableReferenceDefinitionHelper.defineReferenceInnerJoin(
			fromStep -> fromStep.from(
				...
				AssetTagTable.INSTANCE,
				AssetTagTable.INSTANCE.userId.eq(UserTable.INSTANCE.userId)
			));

		tableReferenceDefinitionHelper.defineNonreferenceColumn(
			AssetTagTable.INSTANCE.userName);

		tableReferenceDefinitionHelper.defineNonreferenceColumn(
			AssetTagTable.INSTANCE.createDate);

		tableReferenceDefinitionHelper.defineNonreferenceColumn(
			AssetTagTable.INSTANCE.modifiedDate);
