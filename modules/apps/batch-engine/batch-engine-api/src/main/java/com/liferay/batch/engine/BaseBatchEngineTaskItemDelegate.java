...
public abstract class BaseBatchEngineTaskItemDelegate<T>
	...
	@Override
	public boolean hasCreateStrategy(String strategy) {
		if (_availableCreateStrategies.contains(strategy)) {
			return true;
		}
	...
	@Override
	public boolean hasUpdateStrategy(String strategy) {
		if (_availableUpdateStrategies.contains(strategy)) {
			return true;
		}
