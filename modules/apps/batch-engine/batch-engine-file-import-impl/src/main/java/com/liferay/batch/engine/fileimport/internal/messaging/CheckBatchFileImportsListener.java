 ...
 */
@Component(
	immediate = true, property = "interval=15",
...
public class CheckBatchFileImportsListener extends BaseMessageListener {
	...
	protected void activate(Map<String, Object> properties) throws Exception {
		...
		_checkTerminatedBatchFileImports();

		_activateSchedulerEngine(properties);
	}
	...
	protected void doReceive(Message message) throws Exception {
		...
		BatchFileImport batchFileImport =
			_batchFileImportLocalService.fetchFirstBatchFileImport(
				BatchStatus.UNKNOWN);
	...
	private void _activateSchedulerEngine(Map<String, Object> properties) {
		Class<?> clazz = getClass();

		String className = clazz.getName();

		int interval = GetterUtil.getInteger(properties.get("interval"), 15);
	...
	private void _checkTerminatedBatchFileImports() throws Exception {
