...
public class BatchPlannerLogSoap implements Serializable {
	...
	public static BatchPlannerLogSoap toSoapModel(BatchPlannerLog model) {
		...
		soapModel.setBatchExternalReferenceCode(
			model.getBatchExternalReferenceCode());
		soapModel.setDispatchExternalReferenceCode(
			model.getDispatchExternalReferenceCode());
	...
	private String _dispatchExternalReferenceCode;
