...
public class BatchPlannerLogTable extends BaseTable<BatchPlannerLogTable> {
	...
	public final Column<BatchPlannerLogTable, Long> batchPlannerPlanId =
		createColumn(
			...
			Column.FLAG_DEFAULT);
	public final Column<BatchPlannerLogTable, String>
		batchExternalReferenceCode = createColumn(
			"batchExternalReferenceCode", String.class, Types.VARCHAR,
			Column.FLAG_DEFAULT);
	public final Column<BatchPlannerLogTable, String>
		dispatchExternalReferenceCode = createColumn(
			"dispatchExternalReferenceCode", String.class, Types.VARCHAR,
			Column.FLAG_DEFAULT);
	...
	public final Column<BatchPlannerLogTable, String> status = createColumn(
