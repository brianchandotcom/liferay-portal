...
public class BatchPlannerMappingTable
	...
	public final Column<BatchPlannerMappingTable, Long> batchPlannerPlanId =
		createColumn(
			...
			Column.FLAG_DEFAULT);
	public final Column<BatchPlannerMappingTable, String> externalName =
		createColumn(
			"externalName", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	public final Column<BatchPlannerMappingTable, String> externalType =
		createColumn(
			"externalType", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	public final Column<BatchPlannerMappingTable, String> internalName =
		createColumn(
			"internalName", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	public final Column<BatchPlannerMappingTable, String> internalType =
		createColumn(
			"internalType", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	public final Column<BatchPlannerMappingTable, String>
		transformationExpression = createColumn(
			"transformationExpression", String.class, Types.VARCHAR,
			Column.FLAG_DEFAULT);
