...
public class BatchPlannerPlanSoap implements Serializable {
	...
	public static BatchPlannerPlanSoap toSoapModel(BatchPlannerPlan model) {
		...
		soapModel.setExternalContentType(model.getExternalContentType());
	...
	public String getExternalContentType() {
		return _externalContentType;
	}

	public void setExternalContentType(String externalContentType) {
		_externalContentType = externalContentType;
	}
	...
	private String _externalContentType;
