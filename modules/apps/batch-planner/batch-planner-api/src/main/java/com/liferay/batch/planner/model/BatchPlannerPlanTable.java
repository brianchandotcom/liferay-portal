...
public class BatchPlannerPlanTable extends BaseTable<BatchPlannerPlanTable> {
	...
	public final Column<BatchPlannerPlanTable, String> externalContentType =
		createColumn(
			"externalContentType", String.class, Types.VARCHAR,
			Column.FLAG_DEFAULT);
	...
	public final Column<BatchPlannerPlanTable, String> channel = createColumn(
