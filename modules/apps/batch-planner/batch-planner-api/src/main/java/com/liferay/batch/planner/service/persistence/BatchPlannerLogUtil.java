...
public class BatchPlannerLogUtil {
	 ...
	 * @throws NoSuchLogException if a matching batch planner log could not be found
	 */
	public static BatchPlannerLog findByBPPI_BEERC(
			long batchPlannerPlanId, String batchExternalReferenceCode)
		throws com.liferay.batch.planner.exception.NoSuchLogException {

		return getPersistence().findByBPPI_BEERC(
	 ...
	 */
	public static BatchPlannerLog fetchByBPPI_BEERC(
		long batchPlannerPlanId, String batchExternalReferenceCode) {

		return getPersistence().fetchByBPPI_BEERC(
			batchPlannerPlanId, batchExternalReferenceCode);
	}
	...
	public static BatchPlannerLog fetchByBPPI_BEERC(
		...
		return getPersistence().fetchByBPPI_BEERC(
			batchPlannerPlanId, batchExternalReferenceCode, useFinderCache);
	}
	 ...
	 */
	public static BatchPlannerLog removeByBPPI_BEERC(
			long batchPlannerPlanId, String batchExternalReferenceCode)
		throws com.liferay.batch.planner.exception.NoSuchLogException {

		return getPersistence().removeByBPPI_BEERC(
			batchPlannerPlanId, batchExternalReferenceCode);
	}
	 ...
	 * @return the number of matching batch planner logs
	 */
	public static int countByBPPI_BEERC(
		long batchPlannerPlanId, String batchExternalReferenceCode) {

		return getPersistence().countByBPPI_BEERC(
			batchPlannerPlanId, batchExternalReferenceCode);
	}
	 ...
	 * @throws NoSuchLogException if a matching batch planner log could not be found
	 */
	public static BatchPlannerLog findByBPPI_DERC(
			long batchPlannerPlanId, String dispatchExternalReferenceCode)
		throws com.liferay.batch.planner.exception.NoSuchLogException {

		return getPersistence().findByBPPI_DERC(
	 ...
	 * @return the matching batch planner log, or <code>null</code> if a matching batch planner log could not be found
	 */
	public static BatchPlannerLog fetchByBPPI_DERC(
		long batchPlannerPlanId, String dispatchExternalReferenceCode) {

		return getPersistence().fetchByBPPI_DERC(
			batchPlannerPlanId, dispatchExternalReferenceCode);
	}
	...
	public static BatchPlannerLog fetchByBPPI_DERC(
		...
		return getPersistence().fetchByBPPI_DERC(
			batchPlannerPlanId, dispatchExternalReferenceCode, useFinderCache);
	}
	 ...
	 * @return the batch planner log that was removed
	 */
	public static BatchPlannerLog removeByBPPI_DERC(
			long batchPlannerPlanId, String dispatchExternalReferenceCode)
		throws com.liferay.batch.planner.exception.NoSuchLogException {

		return getPersistence().removeByBPPI_DERC(
			batchPlannerPlanId, dispatchExternalReferenceCode);
	}
	 ...
	 * @return the number of matching batch planner logs
	 */
	public static int countByBPPI_DERC(
		long batchPlannerPlanId, String dispatchExternalReferenceCode) {

		return getPersistence().countByBPPI_DERC(
			batchPlannerPlanId, dispatchExternalReferenceCode);
	}
