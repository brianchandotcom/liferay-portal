...
public class BatchPlannerMappingUtil {
	 ...
	 * @throws NoSuchMappingException if a matching batch planner mapping could not be found
	 */
	public static BatchPlannerMapping findByBPPI_EN(
			long batchPlannerPlanId, String externalName)
		throws com.liferay.batch.planner.exception.NoSuchMappingException {

		return getPersistence().findByBPPI_EN(batchPlannerPlanId, externalName);
	}
	 ...
	 */
	public static BatchPlannerMapping fetchByBPPI_EN(
		long batchPlannerPlanId, String externalName) {

		return getPersistence().fetchByBPPI_EN(
	...
	public static BatchPlannerMapping fetchByBPPI_EN(
		...
		return getPersistence().fetchByBPPI_EN(
			batchPlannerPlanId, externalName, useFinderCache);
	}
	 ...
	 */
	public static BatchPlannerMapping removeByBPPI_EN(
			long batchPlannerPlanId, String externalName)
		throws com.liferay.batch.planner.exception.NoSuchMappingException {

		return getPersistence().removeByBPPI_EN(
			batchPlannerPlanId, externalName);
	}
	 ...
	 * @return the number of matching batch planner mappings
	 */
	public static int countByBPPI_EN(
		long batchPlannerPlanId, String externalName) {

		return getPersistence().countByBPPI_EN(
			batchPlannerPlanId, externalName);
	}
