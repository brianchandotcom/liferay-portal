...
public class BatchPlannerPlanUtil {
	 ...
	 * @return the matching batch planner plans
	 */
	public static List<BatchPlannerPlan> findByC_ECT(
		long companyId, String externalContentType) {

		return getPersistence().findByC_ECT(companyId, externalContentType);
	}
	...
	public static List<BatchPlannerPlan> findByC_ECT(
		...
		return getPersistence().findByC_ECT(
			companyId, externalContentType, start, end);
	}
	 ...
	 * @throws NoSuchPlanException if a matching batch planner plan could not be found
	 */
	public static BatchPlannerPlan findByC_ECT_First(
			long companyId, String externalContentType,
			OrderByComparator<BatchPlannerPlan> orderByComparator)
		throws com.liferay.batch.planner.exception.NoSuchPlanException {

		return getPersistence().findByC_ECT_First(
	 ...
	 * @return the first matching batch planner plan, or <code>null</code> if a matching batch planner plan could not be found
	 */
	public static BatchPlannerPlan fetchByC_ECT_First(
		long companyId, String externalContentType,
		OrderByComparator<BatchPlannerPlan> orderByComparator) {

		return getPersistence().fetchByC_ECT_First(
			companyId, externalContentType, orderByComparator);
	}
	 ...
	 * @throws NoSuchPlanException if a matching batch planner plan could not be found
	 */
	public static BatchPlannerPlan findByC_ECT_Last(
			long companyId, String externalContentType,
			OrderByComparator<BatchPlannerPlan> orderByComparator)
		throws com.liferay.batch.planner.exception.NoSuchPlanException {

		return getPersistence().findByC_ECT_Last(
			companyId, externalContentType, orderByComparator);
	}
	 ...
	 * @return the last matching batch planner plan, or <code>null</code> if a matching batch planner plan could not be found
	 */
	public static BatchPlannerPlan fetchByC_ECT_Last(
		long companyId, String externalContentType,
		OrderByComparator<BatchPlannerPlan> orderByComparator) {

		return getPersistence().fetchByC_ECT_Last(
			companyId, externalContentType, orderByComparator);
	}
	 ...
	 * @throws NoSuchPlanException if a batch planner plan with the primary key could not be found
	 */
	public static BatchPlannerPlan[] findByC_ECT_PrevAndNext(
			long batchPlannerPlanId, long companyId, String externalContentType,
			OrderByComparator<BatchPlannerPlan> orderByComparator)
		throws com.liferay.batch.planner.exception.NoSuchPlanException {

		return getPersistence().findByC_ECT_PrevAndNext(
			batchPlannerPlanId, companyId, externalContentType,
			orderByComparator);
	}
	 ...
	 * @param externalContentType the external content type
	 */
	public static void removeByC_ECT(
		long companyId, String externalContentType) {

		getPersistence().removeByC_ECT(companyId, externalContentType);
	}
	 ...
	 * @return the number of matching batch planner plans
	 */
	public static int countByC_ECT(long companyId, String externalContentType) {
		return getPersistence().countByC_ECT(companyId, externalContentType);
	}
