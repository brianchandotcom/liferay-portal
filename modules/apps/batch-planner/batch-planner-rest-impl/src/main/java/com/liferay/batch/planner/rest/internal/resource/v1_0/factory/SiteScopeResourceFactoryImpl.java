...
public class SiteScopeResourceFactoryImpl implements SiteScopeResource.Factory {
	...
	@Override
	public SiteScopeResource.Builder create() {
		return new SiteScopeResource.Builder() {
			...
			public SiteScopeResource build() {
				...
				return _siteScopeResourceProxyProviderFunction.apply(
			...
			@Override
			public SiteScopeResource.Builder checkPermissions(
			...
			@Override
			public SiteScopeResource.Builder httpServletRequest(
			...
			@Override
			public SiteScopeResource.Builder httpServletResponse(
			...
			@Override
			public SiteScopeResource.Builder preferredLocale(
			...
			@Override
			public SiteScopeResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, SiteScopeResource>
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			SiteScopeResource.class.getClassLoader(), SiteScopeResource.class);

		try {
			Constructor<SiteScopeResource> constructor =
				(Constructor<SiteScopeResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(siteScopeResource);
	...
	private static final Function<InvocationHandler, SiteScopeResource>
		_siteScopeResourceProxyProviderFunction = _getProxyProviderFunction();

	@Reference
	private CompanyLocalService _companyLocalService;

	@Reference(scope = ReferenceScope.PROTOTYPE_REQUIRED)
	private ComponentServiceObjects<SiteScopeResource> _componentServiceObjects;
