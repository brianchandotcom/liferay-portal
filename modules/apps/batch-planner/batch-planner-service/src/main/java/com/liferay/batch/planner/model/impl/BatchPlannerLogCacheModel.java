...
public class BatchPlannerLogCacheModel
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		batchExternalReferenceCode = objectInput.readUTF();
		dispatchExternalReferenceCode = objectInput.readUTF();
	...
	public void writeExternal(ObjectOutput objectOutput) throws IOException {
		...
		if (batchExternalReferenceCode == null) {
			...
			objectOutput.writeUTF(batchExternalReferenceCode);
		}
		...
		if (dispatchExternalReferenceCode == null) {
			...
			objectOutput.writeUTF(dispatchExternalReferenceCode);
		}
	...
	public String batchExternalReferenceCode;
	public String dispatchExternalReferenceCode;
	public int size;
	public int total;
