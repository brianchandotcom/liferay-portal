...
public class BatchPlannerLogModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"batchExternalReferenceCode", Types.VARCHAR},
		{"dispatchExternalReferenceCode", Types.VARCHAR},
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("batchExternalReferenceCode", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("dispatchExternalReferenceCode", Types.VARCHAR);
	...
	public static final String TABLE_SQL_CREATE =
		"create table BatchPlannerLog (mvccVersion LONG default 0 not null,batchPlannerLogId LONG not null primary key,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,batchPlannerPlanId LONG,batchExternalReferenceCode VARCHAR(75) null,dispatchExternalReferenceCode VARCHAR(75) null,size_ INTEGER,total INTEGER,status VARCHAR(75) null)";
	 ...
	 */
	@Deprecated
	public static final long BATCHEXTERNALREFERENCECODE_COLUMN_BITMASK = 1L;
	 ...
	 */
	@Deprecated
	public static final long DISPATCHEXTERNALREFERENCECODE_COLUMN_BITMASK = 4L;
	...
	public static BatchPlannerLog toModel(BatchPlannerLogSoap soapModel) {
		...
		model.setBatchExternalReferenceCode(
			soapModel.getBatchExternalReferenceCode());
		model.setDispatchExternalReferenceCode(
			soapModel.getDispatchExternalReferenceCode());
	...
	static {
		...
		attributeGetterFunctions.put(
			...
			BatchPlannerLog::getBatchExternalReferenceCode);
		attributeSetterBiConsumers.put(
			"batchExternalReferenceCode",
			(BiConsumer<BatchPlannerLog, String>)
				BatchPlannerLog::setBatchExternalReferenceCode);
		attributeGetterFunctions.put(
			"dispatchExternalReferenceCode",
			BatchPlannerLog::getDispatchExternalReferenceCode);
		attributeSetterBiConsumers.put(
			"dispatchExternalReferenceCode",
			(BiConsumer<BatchPlannerLog, String>)
				BatchPlannerLog::setDispatchExternalReferenceCode);
		...
		attributeSetterBiConsumers.put(
			"status",
			(BiConsumer<BatchPlannerLog, String>)BatchPlannerLog::setStatus);
	 ...
	 */
	@Deprecated
	public String getOriginalBatchExternalReferenceCode() {
		return getColumnOriginalValue("batchExternalReferenceCode");
	}
	 ...
	 */
	@Deprecated
	public String getOriginalDispatchExternalReferenceCode() {
		return getColumnOriginalValue("dispatchExternalReferenceCode");
	}
	...
	public Object clone() {
		...
		batchPlannerLogImpl.setBatchExternalReferenceCode(
			getBatchExternalReferenceCode());
		batchPlannerLogImpl.setDispatchExternalReferenceCode(
	...
	public CacheModel<BatchPlannerLog> toCacheModel() {
		...
		batchPlannerLogCacheModel.batchExternalReferenceCode =
			getBatchExternalReferenceCode();
		...
		if ((batchExternalReferenceCode != null) &&
			(batchExternalReferenceCode.length() == 0)) {

			batchPlannerLogCacheModel.batchExternalReferenceCode = null;
		}

		batchPlannerLogCacheModel.dispatchExternalReferenceCode =
			getDispatchExternalReferenceCode();
		...
		if ((dispatchExternalReferenceCode != null) &&
			(dispatchExternalReferenceCode.length() == 0)) {

			batchPlannerLogCacheModel.dispatchExternalReferenceCode = null;
		}

		Integer size = getSize();

		if (size != null) {
			batchPlannerLogCacheModel.size = size;
		}

		Integer total = getTotal();

		if (total != null) {
			batchPlannerLogCacheModel.total = total;
		}

		batchPlannerLogCacheModel.status = getStatus();

		String status = batchPlannerLogCacheModel.status;

		if ((status != null) && (status.length() == 0)) {
			batchPlannerLogCacheModel.status = null;
		}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put(
			"batchExternalReferenceCode", _batchExternalReferenceCode);
		_columnOriginalValues.put(
			"dispatchExternalReferenceCode", _dispatchExternalReferenceCode);
	...
	static {
		...
		columnBitmasks.put("batchExternalReferenceCode", 256L);

		columnBitmasks.put("dispatchExternalReferenceCode", 512L);
