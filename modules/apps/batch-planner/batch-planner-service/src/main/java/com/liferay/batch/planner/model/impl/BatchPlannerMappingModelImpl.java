...
public class BatchPlannerMappingModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"externalName", Types.VARCHAR}, {"externalType", Types.VARCHAR},
		{"internalName", Types.VARCHAR}, {"internalType", Types.VARCHAR},
		{"transformationExpression", Types.VARCHAR}
	};
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("externalName", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("externalType", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("internalName", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("internalType", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("transformationExpression", Types.VARCHAR);
	}

	public static final String TABLE_SQL_CREATE =
		"create table BatchPlannerMapping (mvccVersion LONG default 0 not null,batchPlannerMappingId LONG not null primary key,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,batchPlannerPlanId LONG,externalName VARCHAR(75) null,externalType VARCHAR(75) null,internalName VARCHAR(75) null,internalType VARCHAR(75) null,transformationExpression VARCHAR(75) null)";
	 ...
	 */
	@Deprecated
	public static final long EXTERNALNAME_COLUMN_BITMASK = 2L;
	...
	public static BatchPlannerMapping toModel(
		...
		model.setExternalName(soapModel.getExternalName());
		model.setExternalType(soapModel.getExternalType());
		model.setInternalName(soapModel.getInternalName());
		model.setInternalType(soapModel.getInternalType());
		model.setTransformationExpression(
			soapModel.getTransformationExpression());
	...
	static {
		...
		attributeGetterFunctions.put(
			"externalName", BatchPlannerMapping::getExternalName);
		attributeSetterBiConsumers.put(
			"externalName",
			(BiConsumer<BatchPlannerMapping, String>)
				BatchPlannerMapping::setExternalName);
		attributeGetterFunctions.put(
			"externalType", BatchPlannerMapping::getExternalType);
		attributeSetterBiConsumers.put(
			"externalType",
			(BiConsumer<BatchPlannerMapping, String>)
				BatchPlannerMapping::setExternalType);
		attributeGetterFunctions.put(
			"internalName", BatchPlannerMapping::getInternalName);
		attributeSetterBiConsumers.put(
			"internalName",
			(BiConsumer<BatchPlannerMapping, String>)
				BatchPlannerMapping::setInternalName);
		attributeGetterFunctions.put(
			"internalType", BatchPlannerMapping::getInternalType);
		attributeSetterBiConsumers.put(
			"internalType",
			(BiConsumer<BatchPlannerMapping, String>)
				BatchPlannerMapping::setInternalType);
		attributeGetterFunctions.put(
			"transformationExpression",
			BatchPlannerMapping::getTransformationExpression);
		attributeSetterBiConsumers.put(
			"transformationExpression",
			(BiConsumer<BatchPlannerMapping, String>)
				BatchPlannerMapping::setTransformationExpression);
	...
	public String getOriginalExternalName() {
		return getColumnOriginalValue("externalName");
	}
	...
	public String getTransformationExpression() {
		return _transformationExpression;
	}
	...
	public Object clone() {
		...
		batchPlannerMappingImpl.setExternalName(getExternalName());
		batchPlannerMappingImpl.setExternalType(getExternalType());
		batchPlannerMappingImpl.setInternalName(getInternalName());
		batchPlannerMappingImpl.setInternalType(getInternalType());
		batchPlannerMappingImpl.setTransformationExpression(
			getTransformationExpression());
	...
	public CacheModel<BatchPlannerMapping> toCacheModel() {
		...
		batchPlannerMappingCacheModel.externalName = getExternalName();

		String externalName = batchPlannerMappingCacheModel.externalName;

		if ((externalName != null) && (externalName.length() == 0)) {
			batchPlannerMappingCacheModel.externalName = null;
		}

		batchPlannerMappingCacheModel.externalType = getExternalType();

		String externalType = batchPlannerMappingCacheModel.externalType;

		if ((externalType != null) && (externalType.length() == 0)) {
			batchPlannerMappingCacheModel.externalType = null;
		}

		batchPlannerMappingCacheModel.internalName = getInternalName();

		String internalName = batchPlannerMappingCacheModel.internalName;

		if ((internalName != null) && (internalName.length() == 0)) {
			batchPlannerMappingCacheModel.internalName = null;
		}

		batchPlannerMappingCacheModel.internalType = getInternalType();

		String internalType = batchPlannerMappingCacheModel.internalType;

		if ((internalType != null) && (internalType.length() == 0)) {
			batchPlannerMappingCacheModel.internalType = null;
		}

		batchPlannerMappingCacheModel.transformationExpression =
			getTransformationExpression();
		...
		if ((transformationExpression != null) &&
			(transformationExpression.length() == 0)) {

			batchPlannerMappingCacheModel.transformationExpression = null;
		}
	...
	private String _transformationExpression;
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("externalName", _externalName);
		_columnOriginalValues.put("externalType", _externalType);
		_columnOriginalValues.put("internalName", _internalName);
		_columnOriginalValues.put("internalType", _internalType);
		_columnOriginalValues.put(
			"transformationExpression", _transformationExpression);
	}
	...
	static {
		...
		columnBitmasks.put("externalName", 256L);

		columnBitmasks.put("externalType", 512L);

		columnBitmasks.put("internalName", 1024L);

		columnBitmasks.put("internalType", 2048L);

		columnBitmasks.put("transformationExpression", 4096L);
