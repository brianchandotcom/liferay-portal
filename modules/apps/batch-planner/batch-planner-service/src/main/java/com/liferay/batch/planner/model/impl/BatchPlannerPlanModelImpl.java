...
public class BatchPlannerPlanModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"externalContentType", Types.VARCHAR},
		{"internalClassName", Types.VARCHAR}, {"name", Types.VARCHAR},
		{"channel", Types.VARCHAR}, {"export", Types.BOOLEAN}
	};
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("externalContentType", Types.VARCHAR);
	 ...
	 */
	@Deprecated
	public static final long EXTERNALCONTENTTYPE_COLUMN_BITMASK = 2L;
	...
	public static BatchPlannerPlan toModel(BatchPlannerPlanSoap soapModel) {
		...
		model.setExternalContentType(soapModel.getExternalContentType());
	...
	static {
		...
		attributeGetterFunctions.put(
			"externalContentType", BatchPlannerPlan::getExternalContentType);
		attributeSetterBiConsumers.put(
			"externalContentType",
			(BiConsumer<BatchPlannerPlan, String>)
				BatchPlannerPlan::setExternalContentType);
		attributeGetterFunctions.put(
		...
		attributeGetterFunctions.put("channel", BatchPlannerPlan::getChannel);
		attributeSetterBiConsumers.put(
			"channel",
			(BiConsumer<BatchPlannerPlan, String>)BatchPlannerPlan::setChannel);
	 ...
	 */
	@Deprecated
	public String getOriginalExternalContentType() {
		return getColumnOriginalValue("externalContentType");
	}
	...
	public Object clone() {
		...
		batchPlannerPlanImpl.setExternalContentType(getExternalContentType());
		batchPlannerPlanImpl.setInternalClassName(getInternalClassName());
		batchPlannerPlanImpl.setName(getName());
		batchPlannerPlanImpl.setChannel(getChannel());
	...
	public CacheModel<BatchPlannerPlan> toCacheModel() {
		...
		batchPlannerPlanCacheModel.externalContentType =
		...
		if ((externalContentType != null) &&
			(externalContentType.length() == 0)) {

			batchPlannerPlanCacheModel.externalContentType = null;
		}
		...
		batchPlannerPlanCacheModel.channel = getChannel();

		String channel = batchPlannerPlanCacheModel.channel;

		if ((channel != null) && (channel.length() == 0)) {
			batchPlannerPlanCacheModel.channel = null;
		}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("externalContentType", _externalContentType);
	...
	static {
		...
		columnBitmasks.put("externalContentType", 256L);

		columnBitmasks.put("internalClassName", 512L);

		columnBitmasks.put("name", 1024L);

		columnBitmasks.put("channel", 2048L);
