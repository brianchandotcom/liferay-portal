...
public class BatchPlannerLogPersistenceImpl
	...
	private FinderPath _finderPathFetchByBPPI_BEERC;
	private FinderPath _finderPathCountByBPPI_BEERC;
	...
	public BatchPlannerLog findByBPPI_BEERC(
		...
		BatchPlannerLog batchPlannerLog = fetchByBPPI_BEERC(
			batchPlannerPlanId, batchExternalReferenceCode);
		...
		if (batchPlannerLog == null) {
			...
			sb.append(", batchExternalReferenceCode=");
			sb.append(batchExternalReferenceCode);
	...
	public BatchPlannerLog fetchByBPPI_BEERC(
		...
		return fetchByBPPI_BEERC(
			batchPlannerPlanId, batchExternalReferenceCode, true);
	}
	...
	public BatchPlannerLog fetchByBPPI_BEERC(
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchByBPPI_BEERC, finderArgs);
		}
		...
		if (result == null) {
			...
			sb.append(_FINDER_COLUMN_BPPI_BEERC_BATCHPLANNERPLANID_2);

			boolean bindBatchExternalReferenceCode = false;

			if (batchExternalReferenceCode == null) {
				sb.append(
					_FINDER_COLUMN_BPPI_BEERC_BATCHEXTERNALREFERENCECODE_1);
			}
			else if (batchExternalReferenceCode.isEmpty()) {
				sb.append(
					_FINDER_COLUMN_BPPI_BEERC_BATCHEXTERNALREFERENCECODE_3);
			}
			else {
				bindBatchExternalReferenceCode = true;

				sb.append(
					_FINDER_COLUMN_BPPI_BEERC_BATCHEXTERNALREFERENCECODE_2);
			}
			...
			try {
				...
				if (bindBatchExternalReferenceCode) {
					queryPos.add(batchExternalReferenceCode);
				}
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchByBPPI_BEERC, finderArgs, list);
					}
				}
				else {
	...
	public BatchPlannerLog removeByBPPI_BEERC(
		...
		BatchPlannerLog batchPlannerLog = findByBPPI_BEERC(
			batchPlannerPlanId, batchExternalReferenceCode);
	...
	public int countByBPPI_BEERC(
		...
		FinderPath finderPath = _finderPathCountByBPPI_BEERC;
	...
	private static final String _FINDER_COLUMN_BPPI_BEERC_BATCHPLANNERPLANID_2 =
		"batchPlannerLog.batchPlannerPlanId = ? AND ";

	private static final String
		_FINDER_COLUMN_BPPI_BEERC_BATCHEXTERNALREFERENCECODE_1 =
			"batchPlannerLog.batchExternalReferenceCode IS NULL";

	private static final String
		_FINDER_COLUMN_BPPI_BEERC_BATCHEXTERNALREFERENCECODE_2 =
			"batchPlannerLog.batchExternalReferenceCode = ?";

	private static final String
		_FINDER_COLUMN_BPPI_BEERC_BATCHEXTERNALREFERENCECODE_3 =
			"(batchPlannerLog.batchExternalReferenceCode IS NULL OR batchPlannerLog.batchExternalReferenceCode = '')";

	private FinderPath _finderPathFetchByBPPI_DERC;
	private FinderPath _finderPathCountByBPPI_DERC;
	...
	public BatchPlannerLog findByBPPI_DERC(
		...
		BatchPlannerLog batchPlannerLog = fetchByBPPI_DERC(
			batchPlannerPlanId, dispatchExternalReferenceCode);
		...
		if (batchPlannerLog == null) {
			...
			sb.append(", dispatchExternalReferenceCode=");
			sb.append(dispatchExternalReferenceCode);
	...
	public BatchPlannerLog fetchByBPPI_DERC(
		...
		return fetchByBPPI_DERC(
			batchPlannerPlanId, dispatchExternalReferenceCode, true);
	}
	...
	public BatchPlannerLog fetchByBPPI_DERC(
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchByBPPI_DERC, finderArgs);
		}
		...
		if (result == null) {
			...
			sb.append(_FINDER_COLUMN_BPPI_DERC_BATCHPLANNERPLANID_2);

			boolean bindDispatchExternalReferenceCode = false;

			if (dispatchExternalReferenceCode == null) {
				sb.append(
					_FINDER_COLUMN_BPPI_DERC_DISPATCHEXTERNALREFERENCECODE_1);
			}
			else if (dispatchExternalReferenceCode.isEmpty()) {
				sb.append(
					_FINDER_COLUMN_BPPI_DERC_DISPATCHEXTERNALREFERENCECODE_3);
			}
			else {
				bindDispatchExternalReferenceCode = true;

				sb.append(
					_FINDER_COLUMN_BPPI_DERC_DISPATCHEXTERNALREFERENCECODE_2);
			}
			...
			try {
				...
				if (bindDispatchExternalReferenceCode) {
					queryPos.add(dispatchExternalReferenceCode);
				}
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchByBPPI_DERC, finderArgs, list);
					}
				}
				else {
					BatchPlannerLog batchPlannerLog = list.get(0);
	...
	public BatchPlannerLog removeByBPPI_DERC(
		...
		BatchPlannerLog batchPlannerLog = findByBPPI_DERC(
			batchPlannerPlanId, dispatchExternalReferenceCode);
	...
	public int countByBPPI_DERC(
		...
		FinderPath finderPath = _finderPathCountByBPPI_DERC;
	...
	private static final String _FINDER_COLUMN_BPPI_DERC_BATCHPLANNERPLANID_2 =
		"batchPlannerLog.batchPlannerPlanId = ? AND ";

	private static final String
		_FINDER_COLUMN_BPPI_DERC_DISPATCHEXTERNALREFERENCECODE_1 =
			"batchPlannerLog.dispatchExternalReferenceCode IS NULL";

	private static final String
		_FINDER_COLUMN_BPPI_DERC_DISPATCHEXTERNALREFERENCECODE_2 =
			"batchPlannerLog.dispatchExternalReferenceCode = ?";

	private static final String
		_FINDER_COLUMN_BPPI_DERC_DISPATCHEXTERNALREFERENCECODE_3 =
			"(batchPlannerLog.dispatchExternalReferenceCode IS NULL OR batchPlannerLog.dispatchExternalReferenceCode = '')";
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
			...
			batchPlannerLogModelImpl.getBatchExternalReferenceCode()
		};

		finderCache.putResult(
			_finderPathCountByBPPI_BEERC, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByBPPI_BEERC, args, batchPlannerLogModelImpl);

		args = new Object[] {
			batchPlannerLogModelImpl.getBatchPlannerPlanId(),
			batchPlannerLogModelImpl.getDispatchExternalReferenceCode()
		};

		finderCache.putResult(
			_finderPathCountByBPPI_DERC, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByBPPI_DERC, args, batchPlannerLogModelImpl);
	}
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByBPPI_BEERC = new FinderPath(
			FINDER_CLASS_NAME_ENTITY, "fetchByBPPI_BEERC",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"batchPlannerPlanId", "batchExternalReferenceCode"},
			true);

		_finderPathCountByBPPI_BEERC = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByBPPI_BEERC",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"batchPlannerPlanId", "batchExternalReferenceCode"},
			false);

		_finderPathFetchByBPPI_DERC = new FinderPath(
			FINDER_CLASS_NAME_ENTITY, "fetchByBPPI_DERC",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {
				"batchPlannerPlanId", "dispatchExternalReferenceCode"
			},
		...
		_finderPathCountByBPPI_DERC = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByBPPI_DERC",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {
				"batchPlannerPlanId", "dispatchExternalReferenceCode"
			},
