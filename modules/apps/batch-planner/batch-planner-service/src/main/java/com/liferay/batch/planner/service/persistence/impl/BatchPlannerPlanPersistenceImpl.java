...
public class BatchPlannerPlanPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByC_ECT;
	private FinderPath _finderPathWithoutPaginationFindByC_ECT;
	private FinderPath _finderPathCountByC_ECT;

	/**
	 * Returns all the batch planner plans where companyId = &#63; and externalContentType = &#63;.
	 *
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public List<BatchPlannerPlan> findByC_ECT(
		long companyId, String externalContentType) {

		return findByC_ECT(
			companyId, externalContentType, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the batch planner plans where companyId = &#63; and externalContentType = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>BatchPlannerPlanModelImpl</code>.
	 * </p>
	...
	@Override
	public List<BatchPlannerPlan> findByC_ECT(
		long companyId, String externalContentType, int start, int end) {

		return findByC_ECT(companyId, externalContentType, start, end, null);
	}

	/**
	 * Returns an ordered range of all the batch planner plans where companyId = &#63; and externalContentType = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>BatchPlannerPlanModelImpl</code>.
	 * </p>
	...
	public List<BatchPlannerPlan> findByC_ECT(
		...
		return findByC_ECT(
			companyId, externalContentType, start, end, orderByComparator,
			true);
	}
	...
	public List<BatchPlannerPlan> findByC_ECT(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByC_ECT;
				finderArgs = new Object[] {companyId, externalContentType};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByC_ECT;
			finderArgs = new Object[] {
				companyId, externalContentType, start, end, orderByComparator
			};
		}
			...
			if ((list != null) && !list.isEmpty()) {
				for (BatchPlannerPlan batchPlannerPlan : list) {
					if ((companyId != batchPlannerPlan.getCompanyId()) ||
						!Objects.equals(
							externalContentType,
							batchPlannerPlan.getExternalContentType())) {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_C_ECT_COMPANYID_2);

			boolean bindExternalContentType = false;

			if (externalContentType == null) {
				sb.append(_FINDER_COLUMN_C_ECT_EXTERNALCONTENTTYPE_1);
			}
			else if (externalContentType.isEmpty()) {
				sb.append(_FINDER_COLUMN_C_ECT_EXTERNALCONTENTTYPE_3);
			}
			else {
				bindExternalContentType = true;

				sb.append(_FINDER_COLUMN_C_ECT_EXTERNALCONTENTTYPE_2);
			}
			...
			try {
				...
				if (bindExternalContentType) {
					queryPos.add(externalContentType);
				}
	...
	/**
	 * Returns the first batch planner plan in the ordered set where companyId = &#63; and externalContentType = &#63;.
	 *
	 * @param companyId the company ID
	 * @param externalContentType the external content type
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public BatchPlannerPlan findByC_ECT_First(
			long companyId, String externalContentType,
			OrderByComparator<BatchPlannerPlan> orderByComparator)
		throws NoSuchPlanException {

		BatchPlannerPlan batchPlannerPlan = fetchByC_ECT_First(
			companyId, externalContentType, orderByComparator);
	 ...
	 */
	@Override
	public BatchPlannerPlan fetchByC_ECT_First(
		long companyId, String externalContentType,
		OrderByComparator<BatchPlannerPlan> orderByComparator) {

		List<BatchPlannerPlan> list = findByC_ECT(
			companyId, externalContentType, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last batch planner plan in the ordered set where companyId = &#63; and externalContentType = &#63;.
	 *
	 * @param companyId the company ID
	 * @param externalContentType the external content type
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public BatchPlannerPlan findByC_ECT_Last(
			long companyId, String externalContentType,
			OrderByComparator<BatchPlannerPlan> orderByComparator)
		throws NoSuchPlanException {

		BatchPlannerPlan batchPlannerPlan = fetchByC_ECT_Last(
			companyId, externalContentType, orderByComparator);
	 ...
	 */
	@Override
	public BatchPlannerPlan fetchByC_ECT_Last(
		long companyId, String externalContentType,
		OrderByComparator<BatchPlannerPlan> orderByComparator) {

		int count = countByC_ECT(companyId, externalContentType);
		...
		List<BatchPlannerPlan> list = findByC_ECT(
			companyId, externalContentType, count - 1, count,
			orderByComparator);
	...
	/**
	 * Returns the batch planner plans before and after the current batch planner plan in the ordered set where companyId = &#63; and externalContentType = &#63;.
	 *
	 * @param batchPlannerPlanId the primary key of the current batch planner plan
	 * @param companyId the company ID
	 * @param externalContentType the external content type
	 ...
	 */
	@Override
	public BatchPlannerPlan[] findByC_ECT_PrevAndNext(
			long batchPlannerPlanId, long companyId, String externalContentType,
			OrderByComparator<BatchPlannerPlan> orderByComparator)
		throws NoSuchPlanException {
		...
		try {
			...
			array[0] = getByC_ECT_PrevAndNext(
				session, batchPlannerPlan, companyId, externalContentType,
				orderByComparator, true);

			array[1] = batchPlannerPlan;

			array[2] = getByC_ECT_PrevAndNext(
				session, batchPlannerPlan, companyId, externalContentType,
	...
	protected BatchPlannerPlan getByC_ECT_PrevAndNext(
		Session session, BatchPlannerPlan batchPlannerPlan, long companyId,
	...
	/**
	 * Removes all the batch planner plans where companyId = &#63; and externalContentType = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @param externalContentType the external content type
	 */
	@Override
	public void removeByC_ECT(long companyId, String externalContentType) {
		for (BatchPlannerPlan batchPlannerPlan :
				findByC_ECT(
					companyId, externalContentType, QueryUtil.ALL_POS,
					QueryUtil.ALL_POS, null)) {
	...
	/**
	 * Returns the number of batch planner plans where companyId = &#63; and externalContentType = &#63;.
	 *
	 * @param companyId the company ID
	 * @param externalContentType the external content type
	 * @return the number of matching batch planner plans
	 */
	@Override
	public int countByC_ECT(long companyId, String externalContentType) {
		FinderPath finderPath = _finderPathCountByC_ECT;

		Object[] finderArgs = new Object[] {companyId, externalContentType};
	...
	private static final String _FINDER_COLUMN_C_ECT_COMPANYID_2 =
		"batchPlannerPlan.companyId = ? AND ";

	private static final String _FINDER_COLUMN_C_ECT_EXTERNALCONTENTTYPE_1 =
		"batchPlannerPlan.externalContentType IS NULL";

	private static final String _FINDER_COLUMN_C_ECT_EXTERNALCONTENTTYPE_2 =
		"batchPlannerPlan.externalContentType = ?";

	private static final String _FINDER_COLUMN_C_ECT_EXTERNALCONTENTTYPE_3 =
		"(batchPlannerPlan.externalContentType IS NULL OR batchPlannerPlan.externalContentType = '')";
	...
	public BatchPlannerPlan fetchByC_N(
		...
		if (result == null) {
			...
			if (name == null) {
				sb.append(_FINDER_COLUMN_C_N_NAME_1);
			}
	...
	private static final String _FINDER_COLUMN_C_N_NAME_1 =
		"batchPlannerPlan.name IS NULL";
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByC_ECT = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_ECT",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
			},
			new String[] {"companyId", "externalContentType"}, true);

		_finderPathWithoutPaginationFindByC_ECT = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_ECT",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"companyId", "externalContentType"}, true);

		_finderPathCountByC_ECT = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_ECT",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"companyId", "externalContentType"}, false);
