...
create unique index IX_98CE17B1 on BatchPlannerMapping (companyId, externalReferenceCode[$COLUMN_LENGTH:75$]);
...
create unique index IX_EB970B43 on BatchPlannerPolicy (groupId, externalReferenceCode[$COLUMN_LENGTH:75$]);