...
public class BatchEngineBrokerTest {
	...
	public void testExportCompanyScopeObjectEntry() throws Exception {
		...
		_assertEquals(
			expectedJsonNode, jsonNode.get(0), _objectEntryFieldNames);
	}
	...
	public void testExportObjectDefinition() throws Exception {
		...
		_assertEquals(
			expectedJsonNode, actualJsonNode, _objectDefinitionFieldNames);
	}
	...
	private void _assertEquals(
		JsonNode expectedJsonNode, JsonNode jsonNode, List<String> fieldNames) {
