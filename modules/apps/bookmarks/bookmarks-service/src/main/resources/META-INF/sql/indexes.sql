...
create unique index IX_8F9A44F7 on BookmarksEntry (uuid_[$COLUMN_LENGTH:75$], groupId, companyId);
...
create unique index IX_1B7B0CA1 on BookmarksFolder (uuid_[$COLUMN_LENGTH:75$], groupId, companyId);