...
<liferay-util:dynamic-include key="<%= DynamicIncludeKeys.BOOKMARKS_VIEW_ENTRY_PRE %>" />
...
<liferay-util:dynamic-include key="<%= DynamicIncludeKeys.BOOKMARKS_VIEW_ENTRY_POST %>" />