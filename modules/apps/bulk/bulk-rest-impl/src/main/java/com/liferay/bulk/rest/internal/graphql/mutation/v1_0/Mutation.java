...
public class Mutation {
	...
	public boolean patchAssetClassNameCategoryBatch(
		...
		return categoryResource.patchAssetClassNameCategoryBatch(
			classNameId, documentSelection);
	}

	@GraphQLInvokeDetached
	public boolean putAssetClassNameCategoryBatch(
			@GraphQLName("class-name-id") Long classNameId,
			@GraphQLName("DocumentSelection") DocumentSelection
				documentSelection)
		throws Exception {
		...
		return categoryResource.putAssetClassNameCategoryBatch(
			classNameId, documentSelection);
	}

	@GraphQLInvokeDetached
	public boolean patchAssetClassNameKeywordBatch(
			@GraphQLName("class-name-id") Long classNameId,
			@GraphQLName("DocumentSelection") DocumentSelection
				documentSelection)
		throws Exception {
		...
		return keywordResource.patchAssetClassNameKeywordBatch(
			classNameId, documentSelection);
	}

	@GraphQLInvokeDetached
	public boolean putAssetClassNameKeywordBatch(
			@GraphQLName("class-name-id") Long classNameId,
			@GraphQLName("DocumentSelection") DocumentSelection
				documentSelection)
		throws Exception {
		...
		return keywordResource.putAssetClassNameKeywordBatch(
			classNameId, documentSelection);
	}

	@GraphQLField
	@GraphQLInvokeDetached
	public Collection<Keyword> postAssetClassNameKeywordCommonPage(
			@GraphQLName("class-name-id") Long classNameId,
			@GraphQLName("DocumentSelection") DocumentSelection
				documentSelection)
		throws Exception {
		...
		return keywordResource.postAssetClassNameKeywordCommonPage(
			classNameId, documentSelection);
	}

	@GraphQLField
	@GraphQLInvokeDetached
	public MessageSelection postAssetClassNameKeywordMessageSelection(
			@GraphQLName("class-name-id") Long classNameId,
			@GraphQLName("DocumentSelection") DocumentSelection
				documentSelection)
		throws Exception {
		...
		return messageSelectionResource.
			postAssetClassNameKeywordMessageSelection(
				classNameId, documentSelection);
	}

	@GraphQLField
	@GraphQLInvokeDetached
	public MessageSelection postAssetClassNameVocabularyMessageSelection(
			@GraphQLName("class-name-id") Long classNameId,
			@GraphQLName("DocumentSelection") DocumentSelection
				documentSelection)
		throws Exception {
		...
		return messageSelectionResource.
			postAssetClassNameVocabularyMessageSelection(
				classNameId, documentSelection);
	}

	@GraphQLField
	@GraphQLInvokeDetached
	public Collection<Vocabulary>
			postContentSpaceAssetClassNameVocabularyCommonPage(
		...
		return vocabularyResource.
			postContentSpaceAssetClassNameVocabularyCommonPage(
				contentSpaceId, classNameId, documentSelection);
	}
