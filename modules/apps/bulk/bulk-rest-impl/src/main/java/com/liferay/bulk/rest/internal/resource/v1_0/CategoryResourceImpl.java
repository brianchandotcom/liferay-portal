...
public class CategoryResourceImpl extends BaseCategoryResourceImpl {
	...
	public boolean patchAssetClassNameCategoryBatch(
		...
		_updateAssetCategories(classNameId, documentSelection, true);
	...
	public boolean putAssetClassNameCategoryBatch(
		...
		_updateAssetCategories(classNameId, documentSelection, false);

		return true;
	}

	private void _updateAssetCategories(
			Long classNameId, DocumentSelection documentSelection,
			boolean append)
