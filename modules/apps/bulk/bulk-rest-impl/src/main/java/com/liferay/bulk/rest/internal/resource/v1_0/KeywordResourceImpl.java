...
public class KeywordResourceImpl extends BaseKeywordResourceImpl {
	...
	public boolean patchAssetClassNameKeywordBatch(
		...
		_updateAssetKeywords(classNameId, documentSelection, false);

		return true;
	}

	@Override
	public Page<Keyword> postAssetClassNameKeywordCommonPage(
			Long classNameId, DocumentSelection documentSelection)
		throws Exception {
	...
	public boolean putAssetClassNameKeywordBatch(
		...
		_updateAssetKeywords(classNameId, documentSelection, true);
	...
	private void _updateAssetKeywords(
			Long classNameId, DocumentSelection documentSelection,
			boolean append)
