...
public abstract class BaseKeywordResourceTestCase {
	...
	@Test
	public void testPatchAssetClassNameKeywordBatch() throws Exception {
		Keyword postKeyword = testPatchAssetClassNameKeywordBatch_addKeyword(
			randomKeyword());

		Keyword randomPatchKeyword = randomKeyword();

		Keyword patchKeyword = testPatchAssetClassNameKeywordBatch_addKeyword(
			randomPatchKeyword);
	...
	protected Keyword testPatchAssetClassNameKeywordBatch_addKeyword(
			Keyword keyword)
		throws Exception {
	...
	protected boolean invokePatchAssetClassNameKeywordBatch(
		...
		String location =
			_resourceURL +
				_toPath("/asset/{class-name-id}/keywords/batch", classNameId);
	...
	protected Http.Response invokePatchAssetClassNameKeywordBatchResponse(
			Long classNameId, DocumentSelection documentSelection)
		throws Exception {
	...
	@Test
	public void testPutAssetClassNameKeywordBatch() throws Exception {
		Keyword postKeyword = testPutAssetClassNameKeywordBatch_addKeyword();
	...
	protected Keyword testPutAssetClassNameKeywordBatch_addKeyword()
		throws Exception {
	...
	protected boolean invokePutAssetClassNameKeywordBatch(
			Long classNameId, DocumentSelection documentSelection)
		throws Exception {
	...
	protected Http.Response invokePutAssetClassNameKeywordBatchResponse(
			Long classNameId, DocumentSelection documentSelection)
		throws Exception {
	...
	@Test
	public void testPostAssetClassNameKeywordCommonPage() throws Exception {
		Keyword randomKeyword = randomKeyword();

		Keyword postKeyword =
			testPostAssetClassNameKeywordCommonPage_addKeyword(randomKeyword);

		assertEquals(randomKeyword, postKeyword);
		assertValid(postKeyword);
	}

	protected Keyword testPostAssetClassNameKeywordCommonPage_addKeyword(
			Keyword keyword)
		throws Exception {
	...
	protected Page<Keyword> invokePostAssetClassNameKeywordCommonPage(
			Long classNameId, DocumentSelection documentSelection)
		throws Exception {
		...
		String location =
			_resourceURL +
				_toPath("/asset/{class-name-id}/keywords/common", classNameId);
	...
	protected Http.Response invokePostAssetClassNameKeywordCommonPageResponse(
			Long classNameId, DocumentSelection documentSelection)
		throws Exception {
