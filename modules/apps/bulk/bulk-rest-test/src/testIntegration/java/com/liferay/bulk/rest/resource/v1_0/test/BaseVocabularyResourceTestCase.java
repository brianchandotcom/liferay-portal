...
public abstract class BaseVocabularyResourceTestCase {
	...
	@Test
	public void testPostContentSpaceAssetClassNameVocabularyCommonPage()
		throws Exception {

		Vocabulary randomVocabulary = randomVocabulary();

		Vocabulary postVocabulary =
			testPostContentSpaceAssetClassNameVocabularyCommonPage_addVocabulary(
				randomVocabulary);
	...
	protected Page<Vocabulary>
			invokePostContentSpaceAssetClassNameVocabularyCommonPage(
	...
	protected Http.Response
			invokePostContentSpaceAssetClassNameVocabularyCommonPageResponse(
				Long contentSpaceId, Long classNameId,
				DocumentSelection documentSelection)
		throws Exception {
