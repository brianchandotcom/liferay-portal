...
<liferay-util:dynamic-include key="<%= DynamicIncludeKeys.CALENDAR_VIEW_CALENDAR_BOOKING_PRE %>" />
...
<liferay-util:dynamic-include key="<%= DynamicIncludeKeys.CALENDAR_VIEW_CALENDAR_BOOKING_POST %>" />