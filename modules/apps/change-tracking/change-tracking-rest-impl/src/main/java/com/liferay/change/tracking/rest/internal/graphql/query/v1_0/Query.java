...
public class Query {
	...
	public java.util.Collection<AffectedEntry> getCollectionEntryAffectedsPage(
	...
	public Entry getCollectionEntry(
		...
		return _applyComponentServiceObjects(
			_entryResourceComponentServiceObjects,
			this::_populateResourceContext,
			entryResource -> entryResource.getCollectionEntry(
	...
	public java.util.Collection<ProcessUser> getProcessUsersPage(
		...
		return _applyComponentServiceObjects(
			...
			this::_populateResourceContext,
			processResource -> {
				Page paginationPage = processResource.getProcessUsersPage(
