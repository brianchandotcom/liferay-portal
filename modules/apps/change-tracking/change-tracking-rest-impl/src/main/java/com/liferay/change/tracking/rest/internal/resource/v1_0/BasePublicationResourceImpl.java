...
public abstract class BasePublicationResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/change-tracking-rest/v1.0/publications/export-batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.Path("/publications/export-batch")
	@javax.ws.rs.POST
	...
	public Response postPublicationsPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				Publication.class.getName(), callbackURL, contentType,
				fieldNames)
		).build();
	}
		...
		if (StringUtil.equalsIgnoreCase(updateStrategy, "PARTIAL_UPDATE")) {
			publicationUnsafeConsumer = publication -> patchPublication(
				publication.getId() != null ? publication.getId() :
					_parseLong((String)parameters.get("publicationId")),
				publication);
		}
