...
public class CTEntryDTOConverterTest {
	...
	public void testToDTOFallsBackToIndexerDocument() throws Exception {
		...
		indexerDocument.addKeyword(_CT_COLLECTION_NAME, ctCollectionName);
	...
	public void testToDTOUsesContextDocument() throws Exception {
		...
		contextDocument.addKeyword(_CT_COLLECTION_NAME, ctCollectionName);
	...
	private final CTEntry _ctEntry = Mockito.mock(CTEntry.class);
	private final CTEntryDTOConverter _ctEntryDTOConverter =
		new CTEntryDTOConverter();
	private final Indexer<CTEntry> _indexer = Mockito.mock(Indexer.class);
