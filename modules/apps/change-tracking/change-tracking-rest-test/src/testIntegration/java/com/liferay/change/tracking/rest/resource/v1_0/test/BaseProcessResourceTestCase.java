...
public abstract class BaseProcessResourceTestCase {
	...
	public void testGetProcessUsersPage() throws Exception {
		Page<Process> page = processResource.getProcessUsersPage(
			null, RandomTestUtil.randomString(), RandomTestUtil.randomString(),
			Pagination.of(1, 2));

		Assert.assertEquals(0, page.getTotalCount());

		Process process1 = testGetProcessUsersPage_addProcess(randomProcess());

		Process process2 = testGetProcessUsersPage_addProcess(randomProcess());

		page = processResource.getProcessUsersPage(
	...
	public void testGetProcessUsersPageWithPagination() throws Exception {
		...
		Process process3 = testGetProcessUsersPage_addProcess(randomProcess());

		Page<Process> page1 = processResource.getProcessUsersPage(
			null, null, null, Pagination.of(1, 2));
		...
		Page<Process> page2 = processResource.getProcessUsersPage(
		...
		Page<Process> page3 = processResource.getProcessUsersPage(
	...
	protected Process testGetProcessUsersPage_addProcess(Process process)
		throws Exception {
