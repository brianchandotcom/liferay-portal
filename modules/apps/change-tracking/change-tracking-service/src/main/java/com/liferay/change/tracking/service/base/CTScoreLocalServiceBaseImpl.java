...
/**
 * Provides the base implementation for the ct score local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.change.tracking.service.impl.CTScoreLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.change.tracking.service.impl.CTScoreLocalServiceImpl
 * @generated
 */
public abstract class CTScoreLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CTScoreLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CTScoreLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.change.tracking.service.CTScoreLocalServiceUtil</code>.
	 */
	...
	public CTScore deleteCTScore(CTScore ctScore) {
		return ctScorePersistence.remove(ctScore);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return ctScorePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CTScore.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ctScorePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return ctScorePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ctScorePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return ctScorePersistence.countWithDynamicQuery(
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ctScoreLocalService);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return ctScorePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CTScoreLocalServiceImpl#deleteCTScore(CTScore) to avoid orphaned data");
		}

		return ctScoreLocalService.deleteCTScore((CTScore)persistedModel);
	}

	@Override
	public BasePersistence<CTScore> getBasePersistence() {
		return ctScorePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return ctScorePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CTScore> getCTScores(int start, int end) {
		return ctScorePersistence.findAll(start, end);
	}
	...
	public int getCTScoresCount() {
		return ctScorePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CTScoreLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		ctScoreLocalService = (CTScoreLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CTScoreLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ctScorePersistence.getDataSource();
	...
	protected CTScoreLocalService ctScoreLocalService;
