...
<div class="form-group row">
	<div class="col-md-12">
		<aui:select label="site-settings-strategy" name="ClickToChat--siteSettingsStrategy--" onchange='<%= liferayPortletResponse.getNamespace() + "onChangeClickToChatSiteSettingsStrategy(event);" %>' value="<%= clickToChatConfiguration.siteSettingsStrategy() %>">
...
<div class="row" id="<%= liferayPortletResponse.getNamespace() + "divProviderFields" %>">
	<div class="col-md-6">
...
<script>
	...
	var clickToChatChatProviderAccountId = document.getElementById(
		'<portlet:namespace />chatProviderAccountId'
	);
	...
	var clickToChatGuestUsersAllowed = document.getElementById(
		'<portlet:namespace />guestUsersAllowed'
	);
	...
	var divProviderFields = document.getElementById(
		'<portlet:namespace />divProviderFields'
	);
