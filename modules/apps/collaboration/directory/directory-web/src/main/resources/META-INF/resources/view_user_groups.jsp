...
>
	...
	if (portletName.equals(PortletKeys.MY_SITES_DIRECTORY)) {
		...
		userGroupParams.put(UserGroupConstants.PARAM_USER_GROUPS_GROUPS, SitesUtil.filterGroups(groups, PropsValues.MY_SITES_DIRECTORY_SITE_EXCLUDES));
	}
	else if (portletName.equals(PortletKeys.SITE_MEMBERS_DIRECTORY)) {
		userGroupParams.put(UserGroupConstants.PARAM_USER_GROUPS_GROUPS, Long.valueOf(themeDisplay.getScopeGroupId()));
	}
	%>
