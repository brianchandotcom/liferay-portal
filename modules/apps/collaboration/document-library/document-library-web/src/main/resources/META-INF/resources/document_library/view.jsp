...
<div id="<portlet:namespace />documentLibraryContainer">
	...
	<div class="<%= infoPanelState %> <%= portletTitleBasedNavigation ? "container-fluid-1280" : StringPool.BLANK %> sidenav-container sidenav-right" id="<portlet:namespace />infoPanelId">
