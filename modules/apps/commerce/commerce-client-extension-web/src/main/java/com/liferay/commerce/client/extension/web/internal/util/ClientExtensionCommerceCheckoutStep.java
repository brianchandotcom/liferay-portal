...
public class ClientExtensionCommerceCheckoutStep
	...
	public ClientExtensionCommerceCheckoutStep(
		...
		_actionURL = commerceCheckoutStepCET.getActionURL();
		...
		_readyURL = commerceCheckoutStepCET.getReadyURL();
		_renderURL = commerceCheckoutStepCET.getRenderURL();
	...
	public void render(
		...
		httpServletRequest.setAttribute(WebKeys.RENDER_URL, _renderURL);
