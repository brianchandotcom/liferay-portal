...
<c:choose>
	...
	<c:when test="<%= commerceOrderContentDisplayContext.isCommerceSiteTypeB2C() %>">
		<liferay-util:include page="/commerce_placed_orders/b2c/view.jsp" servletContext="<%= application %>" />
	</c:when>
	<c:otherwise>
		<liferay-util:include page="/commerce_placed_orders/b2b/view.jsp" servletContext="<%= application %>" />
	</c:otherwise>
</c:choose>