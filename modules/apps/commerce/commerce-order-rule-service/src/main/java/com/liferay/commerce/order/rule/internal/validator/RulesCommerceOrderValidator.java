...
import com.liferay.commerce.order.rule.type.COREntryType;
import com.liferay.commerce.order.rule.type.COREntryTypeRegistry;
...
@Component(
	...
	property = {
		"commerce.order.validator.key=" + RulesCommerceOrderValidator.KEY,
		"commerce.order.validator.priority:Integer=50"
	},
	service = CommerceOrderValidator.class
)
public class RulesCommerceOrderValidator implements CommerceOrderValidator {

	public static final String KEY = "order-rules";

	@Override
	public String getKey() {
		return RulesCommerceOrderValidator.KEY;
	}
