			...
			>
				...
				<aui:fieldset collapsible="<%= false %>" cssClass='<%= "price-entry-price-settings " + (priceOnApplication ? "disabled" : StringPool.BLANK) %>' id='<%= liferayPortletResponse.getNamespace() + "price-entry-price-settings" %>'>
					...
					<div class="row">
						...
						<div class="col-12">
							<div class="<%= discountDiscovery ? "hide" : StringPool.BLANK %>" id="<portlet:namespace />discountLevels">
								...
								<div class="row">
									<div class="col-3">
										<aui:input disabled="<%= discountDiscovery || priceOnApplication %>" ignoreRequestValue="<%= true %>" inlineField="<%= true %>" label="l1" name="discountLevel1" type="currency" value="<%= cpInstanceCommercePriceEntryDisplayContext.getDiscountFormatted(commercePriceEntry.getDiscountLevel1()) %>" wrapperCssClass="discount-label-wrapper">
									...
									<div class="col-3">
										<aui:input disabled="<%= discountDiscovery || priceOnApplication %>" ignoreRequestValue="<%= true %>" inlineField="<%= true %>" label="l2" name="discountLevel2" type="currency" value="<%= cpInstanceCommercePriceEntryDisplayContext.getDiscountFormatted(commercePriceEntry.getDiscountLevel2()) %>" wrapperCssClass="discount-label-wrapper">
											<aui:validator name="min"><%= CommercePriceConstants.PRICE_VALUE_MIN %></aui:validator>
											<aui:validator name="max"><%= CommercePriceConstants.PRICE_VALUE_MAX %></aui:validator>
											<aui:validator name="number" />
										</aui:input>
									...
									<div class="col-3">
										<aui:input disabled="<%= discountDiscovery || priceOnApplication %>" ignoreRequestValue="<%= true %>" inlineField="<%= true %>" label="l3" name="discountLevel3" type="currency" value="<%= cpInstanceCommercePriceEntryDisplayContext.getDiscountFormatted(commercePriceEntry.getDiscountLevel3()) %>" wrapperCssClass="discount-label-wrapper">
											<aui:validator name="min"><%= CommercePriceConstants.PRICE_VALUE_MIN %></aui:validator>
											<aui:validator name="max"><%= CommercePriceConstants.PRICE_VALUE_MAX %></aui:validator>
											<aui:validator name="number" />
										</aui:input>
									...
									<div class="col-3">
										<aui:input disabled="<%= discountDiscovery || priceOnApplication %>" ignoreRequestValue="<%= true %>" inlineField="<%= true %>" label="l4" name="discountLevel4" type="currency" value="<%= cpInstanceCommercePriceEntryDisplayContext.getDiscountFormatted(commercePriceEntry.getDiscountLevel4()) %>" wrapperCssClass="discount-label-wrapper">
											<aui:validator name="min"><%= CommercePriceConstants.PRICE_VALUE_MIN %></aui:validator>
											<aui:validator name="max"><%= CommercePriceConstants.PRICE_VALUE_MAX %></aui:validator>
											<aui:validator name="number" />
										</aui:input>
					...
					<div class="row">
						...
						<div class="col-6">
							<aui:input disabled="<%= priceOnApplication %>" label="<%= priceInputLabel %>" name="price" suffix="<%= HtmlUtil.escape(commerceCurrency.getCode()) %>" type="currency" value="<%= cpInstanceCommercePriceEntryDisplayContext.getPriceFormatted() %>">
								<aui:validator name="min"><%= CommercePriceConstants.PRICE_VALUE_MIN %></aui:validator>
								<aui:validator name="max"><%= CommercePriceConstants.PRICE_VALUE_MAX %></aui:validator>
								<aui:validator name="number" />
							</aui:input>
