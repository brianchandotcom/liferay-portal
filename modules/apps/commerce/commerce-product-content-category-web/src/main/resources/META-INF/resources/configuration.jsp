...
String useAssetCategoryContentClass = "lfr-use-asset-category-content ";

if (!cpCategoryContentDisplayContext.useAssetCategory()) {
	useAssetCategoryContentClass += "hide";
}
				...
				<div class="panel-group panel-group-flush">
					<aui:fieldset>
						...
						<div id="<portlet:namespace />assetCategoryContainer">
							...
							<div class="<%= useAssetCategoryContentClass %>" id="<portlet:namespace />assetCategoryContent">
