...
export function updateProductFields(data) {
	...
	const availabilityEstimateContainer = document.querySelector(
		'[data-text-cp-instance-availability-estimate]'
	);
	const gtinContainer = document.querySelector(
		'[data-text-cp-instance-gtin]'
	);
	const mpnContainer = document.querySelector(
		'[data-text-cp-instance-manufacturer-part-number]'
	);
	const skuContainer = document.querySelector('[data-text-cp-instance-sku]');
	const stockQuantityContainer = document.querySelector(
