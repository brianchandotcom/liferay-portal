...
String layoutPageTemplateEntryName = StringPool.BLANK;

if ((cpDisplayLayout != null) && (cpDisplayLayout.getType() == CPDisplayLayoutConstants.TYPE_LAYOUT_PAGE_TEMPLATE_ENTRY)) {
	LayoutPageTemplateEntry selLayoutPageTemplateEntry = LayoutPageTemplateEntryLocalServiceUtil.fetchLayoutPageTemplateEntryByUuidAndGroupId(cpDisplayLayout.getEntryUuid(), commerceChannel.getSiteGroupId());

	if (selLayoutPageTemplateEntry != null) {
		layoutPageTemplateEntryName = selLayoutPageTemplateEntry.getName();
	}
}
%>

<aui:input name="type" type="hidden" value="<%= CPDisplayLayoutConstants.TYPE_LAYOUT_PAGE_TEMPLATE_ENTRY %>" />
