...
public class CPDisplayLayoutPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByG_LPTE;
	private FinderPath _finderPathWithoutPaginationFindByG_LPTE;
	private FinderPath _finderPathCountByG_LPTE;
	 ...
	 */
	@Override
	public List<CPDisplayLayout> findByG_LPTE(
	...
	public List<CPDisplayLayout> findByG_LPTE(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache && productionMode) {
				finderPath = _finderPathWithoutPaginationFindByG_LPTE;
				finderArgs = new Object[] {
			...
			finderPath = _finderPathWithPaginationFindByG_LPTE;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_G_LPTE_GROUPID_2);

			boolean bindLayoutPageTemplateEntryUuid = false;

			if (layoutPageTemplateEntryUuid.isEmpty()) {
				sb.append(_FINDER_COLUMN_G_LPTE_LAYOUTPAGETEMPLATEENTRYUUID_3);
			}
			else {
				bindLayoutPageTemplateEntryUuid = true;

				sb.append(_FINDER_COLUMN_G_LPTE_LAYOUTPAGETEMPLATEENTRYUUID_2);
			}
	...
	public CPDisplayLayout findByG_LPTE_First(
		...
		CPDisplayLayout cpDisplayLayout = fetchByG_LPTE_First(
	...
	public CPDisplayLayout fetchByG_LPTE_First(
		...
		List<CPDisplayLayout> list = findByG_LPTE(
	...
	public CPDisplayLayout findByG_LPTE_Last(
		...
		CPDisplayLayout cpDisplayLayout = fetchByG_LPTE_Last(
			groupId, layoutPageTemplateEntryUuid, orderByComparator);
	...
	public CPDisplayLayout fetchByG_LPTE_Last(
		...
		int count = countByG_LPTE(groupId, layoutPageTemplateEntryUuid);
	...
	public CPDisplayLayout[] findByG_LPTE_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_LPTE_PrevAndNext(
				session, cpDisplayLayout, groupId, layoutPageTemplateEntryUuid,
				orderByComparator, true);

			array[1] = cpDisplayLayout;

			array[2] = getByG_LPTE_PrevAndNext(
				session, cpDisplayLayout, groupId, layoutPageTemplateEntryUuid,
				orderByComparator, false);
	...
	protected CPDisplayLayout getByG_LPTE_PrevAndNext(
		Session session, CPDisplayLayout cpDisplayLayout, long groupId,
		String layoutPageTemplateEntryUuid,
		OrderByComparator<CPDisplayLayout> orderByComparator,
		boolean previous) {
	...
	public int countByG_LPTE(long groupId, String layoutPageTemplateEntryUuid) {
		...
		if (productionMode) {
			finderPath = _finderPathCountByG_LPTE;
	...
	private static final String _FINDER_COLUMN_G_LPTE_GROUPID_2 =
		"cpDisplayLayout.groupId = ? AND ";

	private static final String
		_FINDER_COLUMN_G_LPTE_LAYOUTPAGETEMPLATEENTRYUUID_2 =
			"cpDisplayLayout.layoutPageTemplateEntryUuid = ?";

	private static final String
		_FINDER_COLUMN_G_LPTE_LAYOUTPAGETEMPLATEENTRYUUID_3 =
	...
	private FinderPath _finderPathWithPaginationFindByC_C_LPTE;
	private FinderPath _finderPathWithoutPaginationFindByC_C_LPTE;
	private FinderPath _finderPathCountByC_C_LPTE;
	 ...
	 */
	@Override
	public List<CPDisplayLayout> findByC_C_LPTE(
		long classNameId, long classPK) {

		return findByC_C_LPTE(
			classNameId, classPK, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<CPDisplayLayout> findByC_C_LPTE(
		...
		return findByC_C_LPTE(classNameId, classPK, start, end, null);
	}
	...
	public List<CPDisplayLayout> findByC_C_LPTE(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache && productionMode) {
				finderPath = _finderPathWithoutPaginationFindByC_C_LPTE;
				finderArgs = new Object[] {classNameId, classPK};
			}
		}
		else if (useFinderCache && productionMode) {
			finderPath = _finderPathWithPaginationFindByC_C_LPTE;
			finderArgs = new Object[] {
				classNameId, classPK, start, end, orderByComparator
			};
		}
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_C_C_LPTE_CLASSNAMEID_2);

			sb.append(_FINDER_COLUMN_C_C_LPTE_CLASSPK_2);
	...
	public CPDisplayLayout findByC_C_LPTE_First(
		...
		CPDisplayLayout cpDisplayLayout = fetchByC_C_LPTE_First(
			classNameId, classPK, orderByComparator);
	...
	public CPDisplayLayout fetchByC_C_LPTE_First(
		...
		List<CPDisplayLayout> list = findByC_C_LPTE(
			classNameId, classPK, 0, 1, orderByComparator);
	...
	public CPDisplayLayout findByC_C_LPTE_Last(
		...
		CPDisplayLayout cpDisplayLayout = fetchByC_C_LPTE_Last(
			classNameId, classPK, orderByComparator);
	...
	public CPDisplayLayout fetchByC_C_LPTE_Last(
		...
		int count = countByC_C_LPTE(classNameId, classPK);
	...
	public CPDisplayLayout[] findByC_C_LPTE_PrevAndNext(
		...
		try {
			...
			array[0] = getByC_C_LPTE_PrevAndNext(
				session, cpDisplayLayout, classNameId, classPK,
				orderByComparator, true);

			array[1] = cpDisplayLayout;

			array[2] = getByC_C_LPTE_PrevAndNext(
				session, cpDisplayLayout, classNameId, classPK,
				orderByComparator, false);
	...
	protected CPDisplayLayout getByC_C_LPTE_PrevAndNext(
		Session session, CPDisplayLayout cpDisplayLayout, long classNameId,
		long classPK, OrderByComparator<CPDisplayLayout> orderByComparator,
		boolean previous) {
	...
	public int countByC_C_LPTE(long classNameId, long classPK) {
		...
		if (productionMode) {
			finderPath = _finderPathCountByC_C_LPTE;
	...
	private static final String _FINDER_COLUMN_C_C_LPTE_CLASSNAMEID_2 =
		"cpDisplayLayout.classNameId = ? AND ";

	private static final String _FINDER_COLUMN_C_C_LPTE_CLASSPK_2 =
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByG_LPTE = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_LPTE",
			new String[] {
		...
		_finderPathWithoutPaginationFindByG_LPTE = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_LPTE",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"groupId", "layoutPageTemplateEntryUuid"}, true);

		_finderPathCountByG_LPTE = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_LPTE",
			new String[] {Long.class.getName(), String.class.getName()},
		...
		_finderPathWithPaginationFindByC_C_LPTE = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_C_LPTE",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByC_C_LPTE = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC_C_LPTE",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"classNameId", "classPK"}, true);

		_finderPathCountByC_C_LPTE = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByC_C_LPTE",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"classNameId", "classPK"}, false);
