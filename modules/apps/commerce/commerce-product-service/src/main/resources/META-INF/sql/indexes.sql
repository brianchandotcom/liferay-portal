...
create index IX_8092ED39 on CPDisplayLayout (classNameId, classPK, type_, ctCollectionId);
create unique index IX_8167D39 on CPDisplayLayout (groupId, classNameId, classPK, type_, ctCollectionId);
...
create index IX_4C7C4DD6 on CPDisplayLayout (groupId, entryUuid[$COLUMN_LENGTH:75$], ctCollectionId);
