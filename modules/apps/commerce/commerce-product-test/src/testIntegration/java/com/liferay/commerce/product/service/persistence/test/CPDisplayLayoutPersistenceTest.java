...
public class CPDisplayLayoutPersistenceTest {
	...
	@Test
	public void testCountByG_LPTE() throws Exception {
		_persistence.countByG_LPTE(RandomTestUtil.nextLong(), "");

		_persistence.countByG_LPTE(0L, "null");

		_persistence.countByG_LPTE(0L, (String)null);
	}
	...
	@Test
	public void testCountByC_C_LPTE() throws Exception {
		_persistence.countByC_C_LPTE(
			RandomTestUtil.nextLong(), RandomTestUtil.nextLong());

		_persistence.countByC_C_LPTE(0L, 0L);
	}
