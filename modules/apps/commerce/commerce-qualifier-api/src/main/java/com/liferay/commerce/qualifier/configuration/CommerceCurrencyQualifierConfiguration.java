...
@Meta.OCD(
	id = "com.liferay.commerce.qualifier.configuration.CommerceCurrencyQualifierConfiguration",
	localization = "content/Language",
	name = "commerce-currency-qualifier-configuration-name"
)
public interface CommerceCurrencyQualifierConfiguration
