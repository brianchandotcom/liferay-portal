...
@Meta.OCD(
	id = "com.liferay.commerce.qualifier.configuration.CommerceDiscountQualifierConfiguration",
	localization = "content/Language",
	name = "commerce-discount-qualifier-configuration-name"
)
public interface CommerceDiscountQualifierConfiguration
