...
@Meta.OCD(
	id = "com.liferay.commerce.qualifier.configuration.CommerceShippingFixedOptionQualifierConfiguration",
	localization = "content/Language",
	name = "commerce-shipping-fixed-option-qualifier-configuration-name"
)
public interface CommerceShippingFixedOptionQualifierConfiguration
