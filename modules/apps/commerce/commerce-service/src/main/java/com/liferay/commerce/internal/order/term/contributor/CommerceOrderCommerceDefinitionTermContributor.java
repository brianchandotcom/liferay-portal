...
public class CommerceOrderCommerceDefinitionTermContributor
	...
	public String getFilledTerm(String term, Object object, Locale locale)
		...
		if (term.equals(_ORDER_CREATOR_USER_TITLE)) {
			return _getOrderCreatorUserTitleTerm(locale, commerceOrder);
		}
		...
		if (term.equals(_ORDER_DATE)) {
			return _getOrderDateTerm(locale, commerceOrder);
		}
		...
		if (term.equals(_ORDER_PAYMENT_METHOD)) {
			return _getOrderPaymentMethodTerm(locale, commerceOrder);
		}
		...
		if (term.equals(_ORDER_SHIPPING_OPTION)) {
			return _getOrderShippinhOptionTerm(locale, commerceOrder);
		}
	...
	private String _getOrderDateTerm(Locale locale, CommerceOrder commerceOrder)
		throws PortalException {
