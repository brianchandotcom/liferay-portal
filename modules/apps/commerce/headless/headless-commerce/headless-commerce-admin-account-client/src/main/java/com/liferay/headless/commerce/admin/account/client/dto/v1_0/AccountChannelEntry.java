...
public class AccountChannelEntry implements Cloneable, Serializable {
	...
	public String getEntryExternalReferenceCode() {
		return entryExternalReferenceCode;
	}

	public void setEntryExternalReferenceCode(
		String entryExternalReferenceCode) {

		this.entryExternalReferenceCode = entryExternalReferenceCode;
	}

	public void setEntryExternalReferenceCode(
		UnsafeSupplier<String, Exception>
			entryExternalReferenceCodeUnsafeSupplier) {

		try {
			entryExternalReferenceCode =
				entryExternalReferenceCodeUnsafeSupplier.get();
		}
		catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	protected String entryExternalReferenceCode;
