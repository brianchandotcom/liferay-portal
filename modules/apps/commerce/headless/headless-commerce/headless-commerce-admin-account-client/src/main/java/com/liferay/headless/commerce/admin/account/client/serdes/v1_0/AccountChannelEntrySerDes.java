...
public class AccountChannelEntrySerDes {
	...
	public static String toJSON(AccountChannelEntry accountChannelEntry) {
		...
		if (accountChannelEntry.getEntryExternalReferenceCode() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}

			sb.append("\"entryExternalReferenceCode\": ");

			sb.append("\"");

			sb.append(
				_escape(accountChannelEntry.getEntryExternalReferenceCode()));
		...
		if (accountChannelEntry.getEntryId() != null) {
			...
			sb.append(accountChannelEntry.getEntryId());
		}
	...
	public static Map<String, String> toMap(
		...
		if (accountChannelEntry.getEntryExternalReferenceCode() == null) {
			map.put("entryExternalReferenceCode", null);
		}
		else {
			map.put(
		...
		if (accountChannelEntry.getEntryId() == null) {
			...
			map.put(
				"entryId", String.valueOf(accountChannelEntry.getEntryId()));
		}
			...
			if (Objects.equals(
				...
				if (jsonParserFieldValue != null) {
					accountChannelEntry.setChannelId(
						...
						jsonParserFieldName, "entryExternalReferenceCode")) {

				if (jsonParserFieldValue != null) {
					accountChannelEntry.setEntryExternalReferenceCode(
						(String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "entryId")) {
				if (jsonParserFieldValue != null) {
					accountChannelEntry.setEntryId(
						Long.valueOf((String)jsonParserFieldValue));
				}
			}
