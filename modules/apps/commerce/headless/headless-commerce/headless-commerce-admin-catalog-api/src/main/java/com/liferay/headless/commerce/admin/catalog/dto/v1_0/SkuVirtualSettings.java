...
public class SkuVirtualSettings implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "External reference code of the site that owns the web content article named by `termsOfUseJournalArticleExternalReferenceCode`; supply it when the article lives outside the site that owns the SKU, since a web content external reference code is unique only within its own site. It defaults to the site that owns the SKU. An unresolved code fails the request.",
		example = "AB-34098-789-N"
	)
...
// LIFERAY-REST-BUILDER-HASH:-512431433