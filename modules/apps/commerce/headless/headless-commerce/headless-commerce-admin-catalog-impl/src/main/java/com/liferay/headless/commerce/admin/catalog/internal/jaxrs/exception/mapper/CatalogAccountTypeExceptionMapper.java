...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.CatalogAccountTypeExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class CatalogAccountTypeExceptionMapper
	...
	protected Problem getProblem(
		...
		return new Problem(
			Response.Status.BAD_REQUEST, "Catalog account type is invalid");
	}
