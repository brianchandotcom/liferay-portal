...
public interface MappedProductResource {
	...
	public HttpInvoker.HttpResponse deleteMappedProductHttpResponse(Long id)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getMappedProductHttpResponse(Long id)
		throws Exception;
	...
	public static class MappedProductResourceImpl
		...
		public void deleteMappedProduct(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				deleteMappedProductHttpResponse(id);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/mapped-products/{id}");
		...
		public MappedProduct getMappedProduct(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				getMappedProductHttpResponse(id);
		...
		public MappedProduct patchMappedProduct(
			...
			HttpInvoker.HttpResponse httpResponse =
				patchMappedProductHttpResponse(id, mappedProduct);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/products/{id}/mapped-products");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/products/mapped-products/batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-commerce-admin-catalog/v2.0/products/{id}/mapped-products/by-sequence/{sequence}");
