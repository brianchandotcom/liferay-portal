...
package com.liferay.headless.commerce.admin.catalog.v2.internal.graphql.mutation.v2_0;
...
public class Mutation {
	...
	public Diagram patchDiagram(
		...
		return _applyComponentServiceObjects(
			_diagramResourceComponentServiceObjects,
			this::_populateResourceContext,
			diagramResource -> diagramResource.patchDiagram(id, diagram));
	}
	...
	@GraphQLField
	public boolean deleteGroupedProduct(@GraphQLName("id") Long id)
		throws Exception {
		...
		_applyVoidComponentServiceObjects(
			...
			groupedProductResource ->
				groupedProductResource.deleteGroupedProduct(id));
	...
	public GroupedProduct patchGroupedProduct(
		...
		return _applyComponentServiceObjects(
			...
			this::_populateResourceContext,
			groupedProductResource ->
				groupedProductResource.patchGroupedProduct(id, groupedProduct));
	}
	...
	@GraphQLField
	public boolean deleteMappedProduct(@GraphQLName("id") Long id)
		throws Exception {
	...
	@GraphQLField
	public boolean deletePin(@GraphQLName("id") Long id) throws Exception {
		_applyVoidComponentServiceObjects(
	...
	@GraphQLField
	public Pin patchPin(@GraphQLName("id") Long id, @GraphQLName("pin") Pin pin)
		throws Exception {
