...
package com.liferay.headless.commerce.admin.catalog.v2.internal.jaxrs.exception.mapper;
...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Catalog.DuplicateGroupedProductExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class DuplicateGroupedProductExceptionMapper
