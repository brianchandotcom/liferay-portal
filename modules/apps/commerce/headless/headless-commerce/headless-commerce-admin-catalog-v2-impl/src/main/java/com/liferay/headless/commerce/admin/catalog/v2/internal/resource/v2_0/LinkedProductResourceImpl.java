...
import com.liferay.headless.commerce.admin.catalog.v2.internal.dto.v2_0.converter.LinkedProductDTOConverter;
import com.liferay.headless.commerce.admin.catalog.v2.internal.dto.v2_0.converter.LinkedProductDTOConverterContext;
...
public class LinkedProductResourceImpl
	...
	public Page<LinkedProduct> getProductIdLinkedProductsPage(
		...
		int cProductCSDiagramEntriesCount =
			_csDiagramEntryService.getCProductCSDiagramEntriesCount(id);
		int entryCProductCPDefinitionGroupedEntriesCount =
			_cpDefinitionGroupedEntryService.
				getEntryCProductCPDefinitionGroupedEntriesCount(id);
