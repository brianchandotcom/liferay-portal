...
import com.liferay.headless.commerce.admin.catalog.v2.internal.dto.v2_0.converter.MappedProductDTOConverter;
...
public class MappedProductResourceImpl
	...
	@Override
	public void deleteMappedProduct(Long id) throws Exception {
	...
	@Override
	public MappedProduct getMappedProduct(Long id) throws Exception {
		return _toMappedProduct(id);
	}
