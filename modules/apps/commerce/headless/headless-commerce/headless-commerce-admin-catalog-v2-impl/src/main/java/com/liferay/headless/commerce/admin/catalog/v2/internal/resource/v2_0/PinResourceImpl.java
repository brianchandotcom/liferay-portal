...
import com.liferay.headless.commerce.admin.catalog.v2.internal.dto.v2_0.converter.PinDTOConverter;
import com.liferay.headless.commerce.admin.catalog.v2.internal.util.v2_0.MappedProductUtil;
import com.liferay.headless.commerce.admin.catalog.v2.internal.util.v2_0.PinUtil;
...
public class PinResourceImpl
	...
	public void deletePin(Long id) throws Exception {
		CSDiagramPin csDiagramPin = _csDiagramPinService.getCSDiagramPin(id);
