...
import com.liferay.headless.commerce.admin.catalog.v2.client.resource.v2_0.PinResource;
...
public abstract class BasePinResourceTestCase {
	...
	protected Map<String, Map> testGetProductPinsPage_getExpectedActions(
			Long productId)
		throws Exception {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.headless.commerce.admin.catalog.v2.dto.v2_0.Pin.
						class)) {
	...
	@Inject
	private
		com.liferay.headless.commerce.admin.catalog.v2.resource.v2_0.PinResource
			_pinResource;
