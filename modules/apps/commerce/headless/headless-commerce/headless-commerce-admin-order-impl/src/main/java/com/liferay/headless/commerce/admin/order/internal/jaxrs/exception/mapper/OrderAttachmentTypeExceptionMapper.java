...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Order.OrderAttachmentTypeExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class OrderAttachmentTypeExceptionMapper
	extends BaseExceptionMapper<CommerceOrderAttachmentTypeException> {

	@Override
	public String getErrorDescription() {
		return "Invalid order attachment type";
	}
