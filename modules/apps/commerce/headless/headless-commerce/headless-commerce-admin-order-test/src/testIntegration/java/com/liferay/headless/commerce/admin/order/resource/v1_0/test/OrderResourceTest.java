...
public class OrderResourceTest extends BaseOrderResourceTestCase {
	...
	public void testGetOrder() throws Exception {
		...
		testGetOrderWithNestedEntities();
	}
	...
	protected OrderResource getOrderResourceWithParameters(
		String... parameters) {
	...
	protected OrderItem randomOrderItem(ShippingAddress shippingAddress)
		throws Exception {
	...
	protected Order randomOrderWithNestedFields() throws Exception {
		Order order = randomOrder();

		ShippingAddress shippingAddress = randomShippingAddress();

		OrderItem orderItem = randomOrderItem(shippingAddress);
