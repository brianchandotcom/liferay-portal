...
public class Payment implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Creation timestamp of the payment in ISO 8601. Read-only; set when the record is first persisted. Sortable via the OData query parameter.",
		example = "2017-07-21"
	)
...
// LIFERAY-REST-BUILDER-HASH:637195860