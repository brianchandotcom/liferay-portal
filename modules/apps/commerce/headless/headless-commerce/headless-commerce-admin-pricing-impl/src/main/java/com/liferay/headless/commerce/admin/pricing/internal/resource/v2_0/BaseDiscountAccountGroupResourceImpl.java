...
public abstract class BaseDiscountAccountGroupResourceImpl
	...
	public List<String> getCreateEntityScopes() {
		return Arrays.asList("discountExternalReferenceCode", "discount");
	}

	@Override
	public String getEntityClassName() {
		return DiscountAccountGroup.class.getName();
	}
	...
	public List<com.liferay.portal.vulcan.batch.engine.Field>
		...
		return Arrays.asList(
			...
			com.liferay.portal.vulcan.batch.engine.Field.of(
				"", "discountAccountGroupId", true, false, Long.class, false),
			com.liferay.portal.vulcan.batch.engine.Field.of(
				"", "discountExternalReferenceCode", false, false, String.class,
				false),
			com.liferay.portal.vulcan.batch.engine.Field.of(
				"", "discountId", false, true, Long.class, false));
	}
