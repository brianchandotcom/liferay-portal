...
public abstract class BasePriceListOrderTypeResourceImpl
	...
	@Path("/price-list-order-types/{priceListOrderTypeId}")
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "PriceListOrderType")})
	...
	@Path("/price-list-order-types/batch")
	...
	@Path("/price-lists/{id}/price-list-order-types")
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "PriceListOrderType")})
	...
	@Path("/price-lists/price-list-order-types/batch")
	@POST
	@Produces("application/json")
	@Tags(value = {})
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BasePriceListOrderTypeResourceImpl.class);
