...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Delivery.Cart.OrderAttachmentTitleExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class OrderAttachmentTitleExceptionMapper
	extends BaseExceptionMapper<CommerceOrderAttachmentTitleException> {

	@Override
	public String getErrorDescription() {
		return "Invalid order attachment title";
	}
