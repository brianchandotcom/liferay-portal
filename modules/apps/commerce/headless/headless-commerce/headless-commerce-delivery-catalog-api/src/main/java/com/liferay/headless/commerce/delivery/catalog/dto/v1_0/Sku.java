...
public class Sku implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Date the SKU was marked discontinued, in ISO 8601.",
		example = "2017-07-21"
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Date from which the SKU becomes visible to buyers, in ISO 8601.",
		example = "2017-07-21"
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Date after which the SKU is no longer visible to buyers, in ISO 8601. Ignored when neverExpire is true.",
		example = "2017-08-21"
	)
...
// LIFERAY-REST-BUILDER-HASH:-376755798