...
import com.liferay.osgi.config.admin.util.ConfigurationDDMHelper;
...
public class BindConfigurationAction implements ActionCommand {
	...
	public boolean processCommand(
		...
		try {
			...
			Dictionary<String, Object> properties = PropertiesFromDDM.bind(
	...
	private final ConfigurationDDMHelper _modelToDDM = new ConfigurationDDMHelper();
