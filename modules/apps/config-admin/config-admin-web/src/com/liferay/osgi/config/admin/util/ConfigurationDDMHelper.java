 ...
 * @author Raymond Augé
 */
public class ConfigurationDDMHelper {

	public DDMForm convert(
	...
	private void _addFieldToForm(
		...
		for (AttributeDefinition attributeDefinition : attributeDefinitions) {
			...
			String type = _attributeToDDMType(attributeDefinition, locale);
			...
			ddmFormField.setLabel(
				_attributeToLabel(attributeDefinition, locale));
			ddmFormField.setTip(_attributeToTip(attributeDefinition, locale));
			...
			// We don't need to set this for checkbox
	...
	private LocalizedValue _attributeDefaultValue(
	...
	private String _attributeToDDMDataType(
	...
	private String _attributeToDDMType(
	...
	private LocalizedValue _attributeToLabel(
		AttributeDefinition attributeDefinition, Locale locale) {
	...
	private LocalizedValue _attributeToTip(
		AttributeDefinition attributeDefinition, Locale locale) {
	...
	private boolean _hasDDMFormFieldOptionsAvailable(
	...
	private void _setOptionFieldLabelsAndValues(
