...
public class ConsentManagementPlatformConfigurationModelListenerTest {
	...
	public void testGetInvalidElementName() {
		...
		Assert.assertEquals("meta", _getInvalidElementName(_META_TAG_REFRESH));
		Assert.assertEquals(
			"style",
	...
	private static final String _META_TAG_REFRESH =
		"<meta content=\"0;url=https://liferay.com\" http-equiv=\"refresh\">";
