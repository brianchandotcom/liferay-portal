								...
								<aui:col cssClass="contacts-center-home" width="<%= 100 %>">
									...
									<c:if test="<%= !showOnlySiteMembers %>">
										...
										<aui:row>
											<aui:col cssClass="contacts contacts-count" width="<%= 100 %>">
												<a href="javascript:;"><liferay-ui:message arguments="<%= String.valueOf(myContactsCount) %>" key='<%= (myContactsCount == 1) ? "view-x-contact" : "view-my-x-contacts" %>' translateArguments="<%= false %>" /></a>
											</aui:col>
										</aui:row>
									</c:if>
									...
									<aui:row>
										<aui:col cssClass="all contacts-count" width="<%= 100 %>">
											<a href="javascript:;"><liferay-ui:message arguments="<%= String.valueOf(allUsersCount) %>" key='<%= (allUsersCount == 1) ? "view-x-user" : "view-all-x-users" %>' translateArguments="<%= false %>" /></a>
										</aui:col>
									</aui:row>
