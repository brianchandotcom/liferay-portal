...
/**
 * Provides the local service interface for ContentRepositoryEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ContentRepositoryEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ContentRepositoryEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/**
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ContentRepositoryEntryLocalServiceUtil} to access the content repository entry local service. Add custom service methods to <code>com.liferay.content.repository.service.impl.ContentRepositoryEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
