 ...
 */
public class ContentRepositoryAdminManagementToolbarDisplayContext
	extends SearchContainerManagementToolbarDisplayContext {

	public ContentRepositoryAdminManagementToolbarDisplayContext(
		LiferayPortletRequest liferayPortletRequest,
		LiferayPortletResponse liferayPortletResponse,
		HttpServletRequest httpServletRequest,
		ContentRepositoryAdminDisplayContext
			contentRepositoryAdminDisplayContext) {

		super(
			liferayPortletRequest, liferayPortletResponse, httpServletRequest,
			contentRepositoryAdminDisplayContext.getSearchContainer());
	}
	...
	public String getComponentId() {
		return "contentRepositoryAdminManagementToolbar";
	}
	...
	public CreationMenu getCreationMenu() {
		...
		try {
			PortletURL addContentRepositoryEntryURL =
				ContentRepositoryEntryURLUtil.
					getAddContentRepositoryEntryActionURL(
					...
					addPrimaryDropdownItem(
						dropdownItem -> {
							dropdownItem.putData(
								"action", "addContentRepositoryEntry");
							dropdownItem.putData(
								"addContentRepositoryEntryURL",
								addContentRepositoryEntryURL.toString());
	...
	public String getDefaultEventHandler() {
		return "contentRepositoryAdminManagementToolbarDefaultEventHandler";
	}
