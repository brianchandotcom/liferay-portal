...
public class PortletHeaderControlMenuEntry
	...
	public boolean include(
		...
		PortletDisplay portletDisplay = getPortletDisplay(request);
	...
	protected PortletDisplay getPortletDisplay(HttpServletRequest request) {
		return (PortletDisplay)request.getAttribute("original_portlet_display");
	}
