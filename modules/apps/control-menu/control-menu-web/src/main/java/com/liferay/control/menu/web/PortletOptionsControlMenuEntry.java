...
public class PortletOptionsControlMenuEntry
	...
	public boolean include(
		...
		request.setAttribute("portletRequest", getPortletRequest(request));
	...
	protected String getPortletId(HttpServletRequest request) {
		return (String)request.getAttribute("original_portlet_id");
	}

	protected PortletRequest getPortletRequest(HttpServletRequest request) {
		return (PortletRequest)request.getAttribute("original_portlet_request");
	}
