			...
			%>
				...
				>
					<clay:content-col
						expand="<%= true %>"
					>
						<h2><%= cookiesBannerConfigurationDisplayContext.getCookiesTitle(requiredCookie, request) %></h2>
					</clay:content-col>
				...
				<clay:content-row
					cssClass="mb-3"
				>
					<p><%= cookiesBannerConfigurationDisplayContext.getCookiesDescription(requiredCookie, request) %></p>
				</clay:content-row>
			...
			%>
				...
				>
					<clay:content-col
						expand="<%= true %>"
					>
						<h2><%= cookiesBannerConfigurationDisplayContext.getCookiesTitle(optionalCookie, request) %></h2>
					</clay:content-col>
				...
				<clay:content-row
					cssClass="mb-3"
				>
					<p><%= cookiesBannerConfigurationDisplayContext.getCookiesDescription(optionalCookie, request) %></p>
				</clay:content-row>
