...
public class CustomElementsSourceLocalServiceUtil {
	...
	public static List<CustomElementsSource> searchCustomElementsSources(
		String keywords, int start, int end,
		com.liferay.portal.kernel.search.Sort sort) {

		return getService().searchCustomElementsSources(
			keywords, start, end, sort);
	}

	public static int searchCustomElementsSourcesCount(String keywords) {
		return getService().searchCustomElementsSourcesCount(keywords);
	}
