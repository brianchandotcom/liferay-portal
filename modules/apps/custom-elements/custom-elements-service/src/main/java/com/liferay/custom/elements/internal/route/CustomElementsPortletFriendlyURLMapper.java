 ...
 */
public class CustomElementsPortletFriendlyURLMapper
	extends DefaultFriendlyURLMapper implements FriendlyURLMapper {

	public CustomElementsPortletFriendlyURLMapper(
		CustomElementsPortletDescriptor customElementsPortletDescriptor) {

		_mapping = customElementsPortletDescriptor.getFriendlyURLMapping();

		Router router = new RouterImpl();

		String prefix =
			customElementsPortletDescriptor.getInstanceable() ?
