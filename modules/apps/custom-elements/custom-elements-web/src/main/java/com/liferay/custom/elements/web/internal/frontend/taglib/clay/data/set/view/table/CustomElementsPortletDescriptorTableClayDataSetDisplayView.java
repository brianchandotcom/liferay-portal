...
@Component(
	immediate = true,
	property = "clay.data.set.display.name=" + CustomElementsClayDataSetDisplayNames.CUSTOM_ELEMENT_PORTLET_DESCRIPTORS,
	service = ClayDataSetDisplayView.class
)
public class CustomElementsPortletDescriptorTableClayDataSetDisplayView
