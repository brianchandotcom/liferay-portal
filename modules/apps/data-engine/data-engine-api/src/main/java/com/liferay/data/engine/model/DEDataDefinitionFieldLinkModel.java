...
public interface DEDataDefinitionFieldLinkModel
	...
	/**
	 * Returns the data definition field link ID of this de data definition field link.
	 *
	 * @return the data definition field link ID of this de data definition field link
	 */
	public long getDataDefinitionFieldLinkId();

	/**
	 * Sets the data definition field link ID of this de data definition field link.
	 *
	 * @param dataDefinitionFieldLinkId the data definition field link ID of this de data definition field link
	 */
