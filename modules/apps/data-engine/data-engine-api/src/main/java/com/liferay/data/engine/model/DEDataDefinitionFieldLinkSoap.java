...
public class DEDataDefinitionFieldLinkSoap implements Serializable {
	...
	public static DEDataDefinitionFieldLinkSoap toSoapModel(
		...
		soapModel.setDataDefinitionFieldLinkId(
			model.getDataDefinitionFieldLinkId());
	...
	public long getPrimaryKey() {
		return _dataDefinitionFieldLinkId;
	}

	public void setPrimaryKey(long pk) {
		setDataDefinitionFieldLinkId(pk);
	}
	...
	public long getDataDefinitionFieldLinkId() {
		return _dataDefinitionFieldLinkId;
	}

	public void setDataDefinitionFieldLinkId(long dataDefinitionFieldLinkId) {
		_dataDefinitionFieldLinkId = dataDefinitionFieldLinkId;
	}
	...
	private long _dataDefinitionFieldLinkId;
