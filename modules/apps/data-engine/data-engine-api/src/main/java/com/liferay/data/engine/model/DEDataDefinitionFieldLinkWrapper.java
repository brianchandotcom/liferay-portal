...
public class DEDataDefinitionFieldLinkWrapper
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put(
			"dataDefinitionFieldLinkId", getDataDefinitionFieldLinkId());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		Long dataDefinitionFieldLinkId = (Long)attributes.get(
			"dataDefinitionFieldLinkId");

		if (dataDefinitionFieldLinkId != null) {
			setDataDefinitionFieldLinkId(dataDefinitionFieldLinkId);
		}
	...
	public long getDataDefinitionFieldLinkId() {
		return model.getDataDefinitionFieldLinkId();
	}
	...
	public void setDataDefinitionFieldLinkId(long dataDefinitionFieldLinkId) {
		model.setDataDefinitionFieldLinkId(dataDefinitionFieldLinkId);
	}
