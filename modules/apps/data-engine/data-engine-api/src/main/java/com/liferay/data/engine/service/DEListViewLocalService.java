...
public interface DEListViewLocalService
	...
	public DEListView createDEListView(long deListViewId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public DEListView deleteDEListView(long deListViewId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DEListView fetchDEListView(long deListViewId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DEListView getDEListView(long deListViewId) throws PortalException;
