...
/**
 * Provides the local service interface for DEListView. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DEListViewLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DEListViewLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DEListViewLocalServiceUtil} to access the de list view local service. Add custom service methods to <code>com.liferay.data.engine.service.impl.DEListViewLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
