...
/**
 * Provides the local service utility for DEListView. This utility wraps
 * <code>com.liferay.data.engine.service.impl.DEListViewLocalServiceImpl</code> and
 ...
 */
@ProviderType
public class DEListViewLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.data.engine.service.impl.DEListViewLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.liferay.data.engine.model.DEListView addDEListView(
		com.liferay.data.engine.model.DEListView deListView) {

		return getService().addDEListView(deListView);
	}
	 ...
	 */
	public static com.liferay.data.engine.model.DEListView createDEListView(
		long deListViewId) {

		return getService().createDEListView(deListViewId);
	}
	 ...
	 */
	public static com.liferay.data.engine.model.DEListView deleteDEListView(
		com.liferay.data.engine.model.DEListView deListView) {

		return getService().deleteDEListView(deListView);
	}
	...
	public static com.liferay.data.engine.model.DEListView deleteDEListView(
		...
		return getService().deleteDEListView(deListViewId);
	}
	...
	public static com.liferay.data.engine.model.DEListView fetchDEListView(
		long deListViewId) {

		return getService().fetchDEListView(deListViewId);
	}
	 ...
	 */
	public static com.liferay.data.engine.model.DEListView
		fetchDEListViewByUuidAndGroupId(String uuid, long groupId) {

		return getService().fetchDEListViewByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 * @throws PortalException if a de list view with the primary key could not be found
	 */
	public static com.liferay.data.engine.model.DEListView getDEListView(
			long deListViewId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getDEListView(deListViewId);
	}
	...
	public static com.liferay.data.engine.model.DEListView
		...
		return getService().getDEListViewByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static java.util.List<com.liferay.data.engine.model.DEListView>
		getDEListViews(int start, int end) {

		return getService().getDEListViews(start, end);
	}
	...
	public static java.util.List<com.liferay.data.engine.model.DEListView>
		...
		return getService().getDEListViewsByUuidAndCompanyId(uuid, companyId);
	}
	...
	public static java.util.List<com.liferay.data.engine.model.DEListView>
		...
		return getService().getDEListViewsByUuidAndCompanyId(
	 ...
	 */
	public static int getDEListViewsCount() {
		return getService().getDEListViewsCount();
	}
	 ...
	 */
	public static com.liferay.data.engine.model.DEListView updateDEListView(
		com.liferay.data.engine.model.DEListView deListView) {

		return getService().updateDEListView(deListView);
	}

	public static DEListViewLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<DEListViewLocalService, DEListViewLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(DEListViewLocalService.class);

		ServiceTracker<DEListViewLocalService, DEListViewLocalService>
			serviceTracker =
				new ServiceTracker
					<DEListViewLocalService, DEListViewLocalService>(
						bundle.getBundleContext(), DEListViewLocalService.class,
						null);
