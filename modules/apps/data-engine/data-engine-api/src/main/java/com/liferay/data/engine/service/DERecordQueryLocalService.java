...
/**
 * Provides the local service interface for DERecordQuery. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DERecordQueryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DERecordQueryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DERecordQueryLocalServiceUtil} to access the de record query local service. Add custom service methods to <code>com.liferay.data.engine.service.impl.DERecordQueryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public DERecordQuery createDERecordQuery(long deRecordQueryId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public DERecordQuery deleteDERecordQuery(long deRecordQueryId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DERecordQuery fetchDERecordQuery(long deRecordQueryId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DERecordQuery getDERecordQuery(long deRecordQueryId)
		throws PortalException;
