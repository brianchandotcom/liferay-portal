...
public class DEListViewUtil {
	...
	public static DEListView[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			listViewId, uuid, orderByComparator);
	}
	...
	public static DEListView[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			listViewId, uuid, companyId, orderByComparator);
	}
	...
	public static DEListView[] findByG_C_D_PrevAndNext(
		...
		return getPersistence().findByG_C_D_PrevAndNext(
			listViewId, groupId, companyId, DDMStructureId, orderByComparator);
	}
	 ...
	 */
	public static DEListView create(long listViewId) {
		return getPersistence().create(listViewId);
	}
	 ...
	 * @throws NoSuchListViewException if a de list view with the primary key could not be found
	 */
	public static DEListView remove(long listViewId)
		throws com.liferay.data.engine.exception.NoSuchListViewException {

		return getPersistence().remove(listViewId);
	}
	 ...
	 * @throws NoSuchListViewException if a de list view with the primary key could not be found
	 */
	public static DEListView findByPrimaryKey(long listViewId)
		throws com.liferay.data.engine.exception.NoSuchListViewException {

		return getPersistence().findByPrimaryKey(listViewId);
	}
	 ...
	 */
	public static DEListView fetchByPrimaryKey(long listViewId) {
		return getPersistence().fetchByPrimaryKey(listViewId);
	}
