...
public class DERecordQueryUtil {
	...
	public static DERecordQuery[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			deRecordQueryId, uuid, orderByComparator);
	}
	 ...
	 */
	public static DERecordQuery create(long deRecordQueryId) {
		return getPersistence().create(deRecordQueryId);
	}
	 ...
	 * @throws NoSuchRecordQueryException if a de record query with the primary key could not be found
	 */
	public static DERecordQuery remove(long deRecordQueryId)
		throws com.liferay.data.engine.exception.NoSuchRecordQueryException {

		return getPersistence().remove(deRecordQueryId);
	}
	 ...
	 * @throws NoSuchRecordQueryException if a de record query with the primary key could not be found
	 */
	public static DERecordQuery findByPrimaryKey(long deRecordQueryId)
		throws com.liferay.data.engine.exception.NoSuchRecordQueryException {

		return getPersistence().findByPrimaryKey(deRecordQueryId);
	}
	 ...
	 */
	public static DERecordQuery fetchByPrimaryKey(long deRecordQueryId) {
		return getPersistence().fetchByPrimaryKey(deRecordQueryId);
	}
