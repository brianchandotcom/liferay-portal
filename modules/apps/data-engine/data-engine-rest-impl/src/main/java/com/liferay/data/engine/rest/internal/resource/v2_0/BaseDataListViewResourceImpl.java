...
public abstract class BaseDataListViewResourceImpl
	implements DataListViewResource, BatchEngineTaskItemDelegate<DataListView>,
			   EntityModelResource {
	...
	@Override
	public com.liferay.batch.engine.pagination.Page<DataListView> read(
			Filter filter,
			com.liferay.batch.engine.pagination.Pagination pagination,
			Sort[] sorts, Map<String, Serializable> parameters, String search)
		throws Exception {

		Page<DataListView> page = getDataDefinitionDataListViewsPage(
