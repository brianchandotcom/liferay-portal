...
public abstract class BaseDataRecordResourceImpl
	implements DataRecordResource, BatchEngineTaskItemDelegate<DataRecord>,
			   EntityModelResource {
	...
	@Override
	public com.liferay.batch.engine.pagination.Page<DataRecord> read(
			Filter filter,
			com.liferay.batch.engine.pagination.Pagination pagination,
			Sort[] sorts, Map<String, Serializable> parameters, String search)
		throws Exception {

		Page<DataRecord> page = getDataDefinitionDataRecordsPage(
