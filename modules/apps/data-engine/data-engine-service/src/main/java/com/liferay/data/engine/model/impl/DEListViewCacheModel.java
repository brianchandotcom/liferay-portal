...
public class DEListViewCacheModel
	...
	public boolean equals(Object obj) {
		...
		if (listViewId == deListViewCacheModel.listViewId) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, listViewId);
	}
	...
	public DEListView toEntityModel() {
		...
		deListViewImpl.setListViewId(listViewId);
		...
		deListViewImpl.setRecordQueryId(recordQueryId);
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		listViewId = objectInput.readLong();
		...
		recordQueryId = objectInput.readLong();
	}
	...
	public void writeExternal(ObjectOutput objectOutput) throws IOException {
		...
		objectOutput.writeLong(listViewId);
		...
		objectOutput.writeLong(recordQueryId);
	}

	public String uuid;
	public long listViewId;
	public long groupId;
