...
public class DEDataDefinitionFieldLinkPersistenceImpl
	 ...
	 *
	 * @param dataDefinitionFieldLinkId the primary key of the current de data definition field link
	 * @param uuid the uuid
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public DEDataDefinitionFieldLink[] findByUuid_PrevAndNext(
			long dataDefinitionFieldLinkId, String uuid,
			OrderByComparator<DEDataDefinitionFieldLink> orderByComparator)
		throws NoSuchDataDefinitionFieldLinkException {
	 ...
	 */
	@Override
	public DEDataDefinitionFieldLink create(long dataDefinitionFieldLinkId) {
		DEDataDefinitionFieldLink deDataDefinitionFieldLink =
			new DEDataDefinitionFieldLinkImpl();

		deDataDefinitionFieldLink.setNew(true);
		deDataDefinitionFieldLink.setPrimaryKey(dataDefinitionFieldLinkId);
	 ...
	 */
	@Override
	public DEDataDefinitionFieldLink remove(long dataDefinitionFieldLinkId)
		throws NoSuchDataDefinitionFieldLinkException {

		return remove((Serializable)dataDefinitionFieldLinkId);
	}
	...
	public DEDataDefinitionFieldLink findByPrimaryKey(
			long dataDefinitionFieldLinkId)
		throws NoSuchDataDefinitionFieldLinkException {

		return findByPrimaryKey((Serializable)dataDefinitionFieldLinkId);
	}
	...
	public DEDataDefinitionFieldLink fetchByPrimaryKey(
		...
		return fetchByPrimaryKey((Serializable)dataDefinitionFieldLinkId);
	}
	...
	protected String getPKDBName() {
		return "dataDefinitionFieldLinkId";
	}
