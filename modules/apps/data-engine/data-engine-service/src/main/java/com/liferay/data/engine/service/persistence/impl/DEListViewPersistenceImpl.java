...
public class DEListViewPersistenceImpl
	...
	public DEListView[] findByUuid_PrevAndNext(
		...
		DEListView deListView = findByPrimaryKey(deListViewId);
	...
	public DEListView create(long deListViewId) {
		...
		deListView.setPrimaryKey(deListViewId);
	...
	public DEListView remove(long deListViewId) throws NoSuchListViewException {
		return remove((Serializable)deListViewId);
	}
	...
	public DEListView findByPrimaryKey(long deListViewId)
		...
		return findByPrimaryKey((Serializable)deListViewId);
	}
	...
	public DEListView fetchByPrimaryKey(long deListViewId) {
		return fetchByPrimaryKey((Serializable)deListViewId);
	}
