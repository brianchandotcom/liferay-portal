...
public class DERecordQueryPersistenceImpl
	...
	public DERecordQuery[] findByUuid_PrevAndNext(
		...
		DERecordQuery deRecordQuery = findByPrimaryKey(deRecordQueryId);
	...
	public DERecordQuery create(long deRecordQueryId) {
		...
		deRecordQuery.setPrimaryKey(deRecordQueryId);
	...
	public DERecordQuery remove(long deRecordQueryId)
		...
		return remove((Serializable)deRecordQueryId);
	}
	...
	public DERecordQuery findByPrimaryKey(long deRecordQueryId)
		...
		return findByPrimaryKey((Serializable)deRecordQueryId);
	}
	...
	public DERecordQuery fetchByPrimaryKey(long deRecordQueryId) {
		return fetchByPrimaryKey((Serializable)deRecordQueryId);
	}
