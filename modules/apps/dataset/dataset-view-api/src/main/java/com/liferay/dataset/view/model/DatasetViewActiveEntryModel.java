...
/**
 * The base model interface for the DatasetViewActiveEntry service. Represents a row in the &quot;DatasetViewActiveEntry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.liferay.dataset.view.model.impl.DatasetViewActiveEntryModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.liferay.dataset.view.model.impl.DatasetViewActiveEntryImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface DatasetViewActiveEntryModel
	extends BaseModel<DatasetViewActiveEntry>, ContainerModel, MVCCModel,
			ShardedModel, StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a dataset view active entry model instance should use the {@link DatasetViewActiveEntry} interface instead.
	 */
