...
/**
 * Provides the local service utility for DatasetViewActiveEntry. This utility wraps
 * <code>com.liferay.dataset.view.service.impl.DatasetViewActiveEntryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DatasetViewActiveEntryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.dataset.view.service.impl.DatasetViewActiveEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DatasetViewActiveEntry addDatasetViewActiveEntry(
		DatasetViewActiveEntry datasetViewActiveEntry) {

		return getService().addDatasetViewActiveEntry(datasetViewActiveEntry);
	}
	 ...
	 */
	public static DatasetViewActiveEntry deleteDatasetViewActiveEntry(
		DatasetViewActiveEntry datasetViewActiveEntry) {

		return getService().deleteDatasetViewActiveEntry(
	 ...
	 */
	public static DatasetViewActiveEntry
		fetchDatasetViewActiveEntryByUuidAndCompanyId(
			String uuid, long companyId) {

		return getService().fetchDatasetViewActiveEntryByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static List<DatasetViewActiveEntry> getDatasetViewActiveEntries(
		int start, int end) {

		return getService().getDatasetViewActiveEntries(start, end);
	}
	 ...
	 */
	public static int getDatasetViewActiveEntriesCount() {
		return getService().getDatasetViewActiveEntriesCount();
	}
	 ...
	 * @throws PortalException if a dataset view active entry with the primary key could not be found
	 */
	public static DatasetViewActiveEntry getDatasetViewActiveEntry(
			long datasetViewActiveEntryId)
		throws PortalException {

		return getService().getDatasetViewActiveEntry(datasetViewActiveEntryId);
	}
	...
	public static DatasetViewActiveEntry
		...
		return getService().getDatasetViewActiveEntryByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static DatasetViewActiveEntry updateDatasetViewActiveEntry(
		DatasetViewActiveEntry datasetViewActiveEntry) {

		return getService().updateDatasetViewActiveEntry(
			datasetViewActiveEntry);
	}

	public static DatasetViewActiveEntryLocalService getService() {
		return _service;
	}

	private static volatile DatasetViewActiveEntryLocalService _service;
