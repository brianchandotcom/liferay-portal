...
/**
 * The persistence interface for the dataset view active entry service.
 *
 * <p>
 ...
 * @see DatasetViewActiveEntryUtil
 * @generated
 */
@ProviderType
public interface DatasetViewActiveEntryPersistence
	extends BasePersistence<DatasetViewActiveEntry> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DatasetViewActiveEntryUtil} to access the dataset view active entry persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<DatasetViewActiveEntry> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<DatasetViewActiveEntry> findByUuid(
	...
	public java.util.List<DatasetViewActiveEntry> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<DatasetViewActiveEntry>
			orderByComparator);
	...
	public DatasetViewActiveEntry findByUuid_First(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<DatasetViewActiveEntry> orderByComparator)
	 ...
	 * @return the matching dataset view active entries
	 */
	public java.util.List<DatasetViewActiveEntry> findByUuid_C(
	...
	public void cacheResult(
		java.util.List<DatasetViewActiveEntry> datasetViewActiveEntries);
	 ...
	 */
	public java.util.List<DatasetViewActiveEntry> findAll();
	 ...
	 */
	public java.util.List<DatasetViewActiveEntry> findAll(int start, int end);
