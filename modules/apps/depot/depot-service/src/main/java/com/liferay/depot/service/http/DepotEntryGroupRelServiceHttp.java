...
public class DepotEntryGroupRelServiceHttp {
	...
	public static com.liferay.depot.model.DepotEntryGroupRel
		...
		try {
			MethodKey methodKey = new MethodKey(
				DepotEntryGroupRelServiceUtil.class, "getDepotEntryGroupRel",
				_getDepotEntryGroupRelParameterTypes2);
	...
	private static final Class<?>[] _getDepotEntryGroupRelParameterTypes2 =
		new Class[] {long.class, long.class};
