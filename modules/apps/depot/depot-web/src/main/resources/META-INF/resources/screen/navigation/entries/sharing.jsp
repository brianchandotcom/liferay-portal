...
<c:if test="<%= groupSharingConfiguration.isAvailable() %>">
	...
	>
		<aui:input helpMessage="asset-library-sharing-help" inlineLabel="right" label="enable-sharing" labelCssClass="simple-toggle-switch" name="TypeSettingsProperties--sharingEnabled--" type="toggle-switch" value="<%= groupSharingConfiguration.isEnabled() %>" />
	</liferay-frontend:fieldset>
</c:if>