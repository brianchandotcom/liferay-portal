...
public interface DSEnvelopeResource {
	...
	public HttpInvoker.HttpResponse
			postSiteDSEnvelopeDsRecipientViewDefinitionHttpResponse(
				Long siteId, String dsEnvelopeId,
				DSRecipientViewDefinition dsRecipientViewDefinition)
		throws Exception;
	...
	public static class DSEnvelopeResourceImpl implements DSEnvelopeResource {
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/digital-signature-rest/v1.0/sites/{siteId}/ds-envelopes/{dsEnvelopeId}/ds-recipient-view-definition");
