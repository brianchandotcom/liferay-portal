...
public class DispatchTriggerPersistenceImpl
	...
	public List<DispatchTrigger> findByCompanyId(
		...
		if (list == null) {
			...
			query.append(_SQL_SELECT_DISPATCHTRIGGER_WHERE);
			...
			if (orderByComparator != null) {
				...
				query.append(DispatchTriggerModelImpl.ORDER_BY_JPQL);
			}
	...
	public DispatchTrigger findByCompanyId_First(
		...
		throw new NoSuchTriggerException(msg.toString());
	}
	...
	protected DispatchTrigger getByCompanyId_PrevAndNext(
		...
		List<DispatchTrigger> list = q.list();
	...
	public List<DispatchTrigger> filterFindByCompanyId(
		...
		if (getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_DISPATCHTRIGGER_WHERE);
		}
		else {
			query.append(
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(DispatchTriggerModelImpl.ORDER_BY_SQL);
			}
		}

		String sql = InlineSQLHelperUtil.replacePermissionCheck(
			query.toString(), DispatchTrigger.class.getName(),
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				q.addEntity(_FILTER_ENTITY_ALIAS, DispatchTriggerImpl.class);
			}
			else {
				q.addEntity(_FILTER_ENTITY_TABLE, DispatchTriggerImpl.class);
			}
	...
	public int countByCompanyId(long companyId) {
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_DISPATCHTRIGGER_WHERE);
	...
	public int filterCountByCompanyId(long companyId) {
		...
		query.append(_FILTER_SQL_COUNT_DISPATCHTRIGGER_WHERE);
	...
	public DispatchTrigger remove(Serializable primaryKey)
		...
		catch (NoSuchTriggerException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	public List<DispatchTrigger> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(_SQL_SELECT_DISPATCHTRIGGER);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_DISPATCHTRIGGER);
