 ...
 * @author Igor Beslic
 */
public class TalendArchiveParserTest extends BaseTalend {
	...
	private static final String _JOB_JAR_PATH =
		"./talend_executor_test/talend_executor_test_0_1.jar";

	private static final String _JOB_NAME = "talend_executor_test";
