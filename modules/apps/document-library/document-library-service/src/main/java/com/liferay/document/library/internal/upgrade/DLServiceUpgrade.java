...
import com.liferay.document.library.internal.upgrade.v3_2_2.DLAppDLFileEntryCleanUpgradeProcess;
import com.liferay.document.library.internal.upgrade.v3_2_2.DLAppDLFolderCleanUpgradeProcess;
...
public class DLServiceUpgrade implements UpgradeStepRegistrator {
	...
	public void register(Registry registry) {
		...
		registry.register(
			"3.2.2", "3.2.3",
			new DLAppDLFileEntryCleanUpgradeProcess(_classNameLocalService),
			new DLAppDLFolderCleanUpgradeProcess(_classNameLocalService));
	}
