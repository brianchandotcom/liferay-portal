...
<div class="lfr-form-content">
	<clay:sheet>
		<div class="panel-group panel-group-flush">
			...
			<liferay-portlet:resourceURL id="/document_library_video/get_dl_external_video_fields" portletName="<%= DLVideoPortletKeys.DL_VIDEO %>" var="getDLExternalVideoFieldsURL" />

			<react:component
				module="js/DLExternalVideoURLItemSelectorView"
				props='<%=
