...
@Component(
	property = {
		...
		"mvc.command.name=/document_library/folder_copy_dl_object"
	},
	service = MVCRenderCommand.class
)
public class FolderCopyDLObjectMVCRenderCommand
	...
	protected String getPath() {
		return "/document_library/folder_copy_dl_object.jsp";
	}
