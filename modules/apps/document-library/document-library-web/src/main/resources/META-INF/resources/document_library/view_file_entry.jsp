...
<liferay-util:dynamic-include key="<%= DynamicIncludeKeys.DOCUMENT_LIBRARY_VIEW_FILE_ENTRY_PRE %>" />
...
<liferay-util:dynamic-include key="<%= DynamicIncludeKeys.DOCUMENT_LIBRARY_VIEW_FILE_ENTRY_POST %>" />