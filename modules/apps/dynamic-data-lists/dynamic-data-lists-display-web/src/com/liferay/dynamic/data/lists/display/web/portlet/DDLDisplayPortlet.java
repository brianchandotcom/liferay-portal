...
public class DDLDisplayPortlet extends MVCPortlet {
	...
	@Reference
	protected void setDDLDisplayRendererHelper(
		DDLDisplayRendererHelper ddlDisplayRendererHelper) {

		_ddlDisplayRendererHelper = ddlDisplayRendererHelper;
	}
	...
	protected void setRenderRequestAttributes(
		...
		renderRequest.setAttribute(
			"ddlDisplayRendererHelper", _ddlDisplayRendererHelper);
	}

	private static final Log _log = LogFactoryUtil.getLog(
		DDLDisplayPortlet.class);

	private DDLDisplayRendererHelper _ddlDisplayRendererHelper;
