...
import com.liferay.dynamic.data.mapping.constants.GooglePlacesAPIWebKeys;
 ...
 */
public class GooglePlacesAPIUtil {
	...
	public static String getGooglePlacesAPIKey(long companyId) {
		...
		return companyPortletPreferences.getValue(
			GooglePlacesAPIWebKeys.GOOGLE_PLACES_API_KEY, null);
	}
	...
	public static String getGooglePlacesAPIKey(
		...
		return GetterUtil.getString(
			group.getTypeSettingsProperty(
				GooglePlacesAPIWebKeys.GOOGLE_PLACES_API_KEY),
