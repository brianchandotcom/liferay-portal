			...
			>
				...
				<c:choose>
					<c:when test='<%= displayStyle.equals("descriptive") %>'>
						<liferay-ui:search-container-column-icon cssClass="asset-icon" icon="repository" />
						...
						<liferay-ui:search-container-column-jsp path="/data_provider_action.jsp" />
					</c:when>
					<c:otherwise>
						...
						<liferay-ui:search-container-column-date name="modified-date" value="<%= dataProviderInstance.getModifiedDate() %>" />
