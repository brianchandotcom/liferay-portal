...
import com.liferay.dynamic.data.mapping.util.PlacesProviderUtil;
...
public class PlacesPortalSettingsConfigurationScreenContributor
	...
	public String getName(Locale locale) {
		return LanguageUtil.get(
			ResourceBundleUtil.getBundle(
				locale,
				PlacesPortalSettingsConfigurationScreenContributor.class),
			"places");
	}
	...
	public void setAttributes(
		...
		httpServletRequest.setAttribute(
			PlacesProviderWebKeys.PLACES_INPUT_NAME_PREFIX, "settings");
		...
		httpServletRequest.setAttribute(
			...
			PlacesProviderUtil.getPlacesProviderKey(
