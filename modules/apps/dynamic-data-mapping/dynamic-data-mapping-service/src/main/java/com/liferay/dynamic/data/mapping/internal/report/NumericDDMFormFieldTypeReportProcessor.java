...
public class NumericDDMFormFieldTypeReportProcessor
	...
	public JSONObject process(
		...
		BigDecimal valueBigDecimal = _getBigDecimalValue(ddmFormFieldValue);
		...
		if (ddmFormInstanceReportEvent.equals(
			...
			BigDecimal maxValueBigDecimal = _getBigDecimalValuesStream(
				ddmFormFieldValue.getName(), streamSupplier.get()
			).max(
				comparator
			).get();

			BigDecimal minValueBigDecimal = _getBigDecimalValuesStream(
				ddmFormFieldValue.getName(), streamSupplier.get()
			).min(
				comparator
			).get();
