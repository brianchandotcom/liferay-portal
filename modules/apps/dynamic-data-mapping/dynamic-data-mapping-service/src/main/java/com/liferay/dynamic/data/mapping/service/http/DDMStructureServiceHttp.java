...
public class DDMStructureServiceHttp {
	...
	public static java.util.List
		<com.liferay.dynamic.data.mapping.model.DDMStructure>
			getStructuresByKeywords(
				HttpPrincipal httpPrincipal, long companyId, long[] groupIds,
				long classNameId, String keywords, int status, int start,
				int end,
				com.liferay.portal.kernel.util.OrderByComparator
					<com.liferay.dynamic.data.mapping.model.DDMStructure>
						orderByComparator) {
		...
		try {
			MethodKey methodKey = new MethodKey(
				DDMStructureServiceUtil.class, "getStructuresByKeywords",
				_getStructuresByKeywordsParameterTypes14);
	...
	public static int getStructuresCountByKeywords(
		HttpPrincipal httpPrincipal, long companyId, long[] groupIds,
		long classNameId, String keywords, int status) {

		try {
			MethodKey methodKey = new MethodKey(
				DDMStructureServiceUtil.class, "getStructuresCountByKeywords",
				_getStructuresCountByKeywordsParameterTypes16);
	...
	private static final Class<?>[] _getStructuresByKeywordsParameterTypes14 =
		new Class[] {
	...
	private static final Class<?>[]
		_getStructuresCountByKeywordsParameterTypes16 = new Class[] {
			long.class, long[].class, long.class, String.class, int.class
		};
