...
public class DDMStructureServiceImpl extends DDMStructureServiceBaseImpl {
	 ...
	 * @deprecated As of 4.0.0, As of Wilberforce, replaced by {@link #addStructure(long,
	 ...
	 * @deprecated As of 4.0.0, As of Wilberforce, replaced by {@link #updateStructure(long,
