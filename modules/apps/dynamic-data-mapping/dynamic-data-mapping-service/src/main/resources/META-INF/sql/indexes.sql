...
create unique index IX_74293D00 on DDMContent (uuid_[$COLUMN_LENGTH:75$], groupId, companyId);
...
create unique index IX_5A3DB1AF on DDMDataProviderInstance (uuid_[$COLUMN_LENGTH:75$], groupId, companyId);

create unique index IX_E9FF43A6 on DDMDataProviderInstanceLink (dataProviderInstanceId, structureId, companyId);
...
create unique index IX_CA7B946 on DDMFormInstance (uuid_[$COLUMN_LENGTH:75$], groupId, companyId);
...
create unique index IX_CF1656F5 on DDMFormInstanceRecord (uuid_[$COLUMN_LENGTH:75$], groupId, companyId);
...
create unique index IX_F27BE500 on DDMFormInstanceRecordVersion (formInstanceRecordId, version[$COLUMN_LENGTH:75$], companyId);
...
create unique index IX_6BF4960 on DDMFormInstanceVersion (formInstanceId, version[$COLUMN_LENGTH:75$], companyId);

create unique index IX_F0C74233 on DDMStorageLink (classPK, companyId);
...
create unique index IX_EC5697DA on DDMStructure (groupId, classNameId, structureKey[$COLUMN_LENGTH:75$], ctCollectionId, companyId);
...
create unique index IX_856DDDE8 on DDMStructure (uuid_[$COLUMN_LENGTH:75$], groupId, ctCollectionId, companyId);

create unique index IX_3227D78 on DDMStructureLayout (groupId, classNameId, structureLayoutKey[$COLUMN_LENGTH:75$], companyId);
...
create unique index IX_8BBA307C on DDMStructureLayout (uuid_[$COLUMN_LENGTH:75$], groupId, companyId);

create index IX_4C181B39 on DDMStructureLink (classNameId, classPK, ctCollectionId);
create unique index IX_47CB587 on DDMStructureLink (classNameId, classPK, structureId, ctCollectionId, companyId);
...
create unique index IX_731A5188 on DDMStructureVersion (structureId, version[$COLUMN_LENGTH:75$], ctCollectionId, companyId);
...
create unique index IX_86BD6906 on DDMTemplate (groupId, classNameId, templateKey[$COLUMN_LENGTH:75$], ctCollectionId, companyId);
...
create unique index IX_1240D447 on DDMTemplate (uuid_[$COLUMN_LENGTH:75$], groupId, ctCollectionId, companyId);

create unique index IX_3856A6EE on DDMTemplateLink (classNameId, classPK, ctCollectionId, companyId);
...
create unique index IX_EEC00CE2 on DDMTemplateVersion (templateId, version[$COLUMN_LENGTH:75$], ctCollectionId, companyId);