...
public class AddFormInstanceRecordMVCActionCommandTest {
	...
	public void testProcessActionWithCaptchaValidationFailureOnUpdate()
		...
		DDMFormInstanceRecord reloadedRecord =
			_ddmFormInstanceRecordLocalService.getFormInstanceRecord(
				ddmFormInstanceRecord.getFormInstanceRecordId());

		DDMFormValues reloadedDDMFormValues = reloadedRecord.getDDMFormValues();

		Map<String, List<DDMFormFieldValue>> ddmFormFieldValuesMap =
			reloadedDDMFormValues.getDDMFormFieldValuesMap(false);
