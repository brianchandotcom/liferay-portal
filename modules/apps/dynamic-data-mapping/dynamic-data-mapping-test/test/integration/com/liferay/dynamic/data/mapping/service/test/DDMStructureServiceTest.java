...
public class DDMStructureServiceTest extends BaseDDMServiceTestCase {
	...
	public void testGetChildDDMFormAfterParentUpdate() throws Exception {
		...
		DDMForm childFullHierarchyDDMForm =
			childStructure.getFullHierarchyDDMForm();

		Map<String, DDMFormField> childFullHierarchyDDMFormFieldsMap =
			childFullHierarchyDDMForm.getDDMFormFieldsMap(true);
		...
		childFullHierarchyDDMForm = childStructure.getFullHierarchyDDMForm();
