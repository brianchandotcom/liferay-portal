...
public class ExportImportReportEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newExportImportReportEntry.setEntityClassNameId(
			RandomTestUtil.nextLong());

		newExportImportReportEntry.setEntityExternalReferenceCode(
		...
		Assert.assertEquals(
			existingExportImportReportEntry.getEntityClassNameId(),
			newExportImportReportEntry.getEntityClassNameId());
		Assert.assertEquals(
			existingExportImportReportEntry.getEntityExternalReferenceCode(),
			newExportImportReportEntry.getEntityExternalReferenceCode());
		Assert.assertEquals(
	...
	protected ExportImportReportEntry addExportImportReportEntry()
		...
		exportImportReportEntry.setEntityClassNameId(RandomTestUtil.nextLong());

		exportImportReportEntry.setEntityExternalReferenceCode(
			RandomTestUtil.randomString());
