...
public interface ImportProcessResource {
	...
	public ValidationResult postSiteValidateImportFile(
			Long siteId, ImportProcess importProcess,
			Map<String, File> multipartFiles)
		throws Exception;

	public HttpInvoker.HttpResponse postSiteValidateImportFileHttpResponse(
			Long siteId, ImportProcess importProcess,
			Map<String, File> multipartFiles)
		throws Exception;

	public ValidationResult postValidateImportFile(
			ImportProcess importProcess, Map<String, File> multipartFiles)
		throws Exception;

	public HttpInvoker.HttpResponse postValidateImportFileHttpResponse(
			ImportProcess importProcess, Map<String, File> multipartFiles)
		throws Exception;
	...
	public static class ImportProcessResourceImpl
		...
		public ValidationResult postSiteValidateImportFile(
			...
			HttpInvoker.HttpResponse httpResponse =
				postSiteValidateImportFileHttpResponse(
					siteId, importProcess, multipartFiles);
			...
			try {
				return ValidationResultSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse postSiteValidateImportFileHttpResponse(
			...
			httpInvoker.part(
				"importProcess", ImportProcessSerDes.toJSON(importProcess));
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/export-import/v1.0/sites/{siteId}/validate-import-file");
		...
		public ValidationResult postValidateImportFile(
			...
			HttpInvoker.HttpResponse httpResponse =
				postValidateImportFileHttpResponse(
					importProcess, multipartFiles);
...
// LIFERAY-REST-BUILDER-HASH:403260293