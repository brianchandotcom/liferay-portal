...
<aui:script use="liferay-util-window">
	function <portlet:namespace />flag() {
		...
		A.io.request(
			'<liferay-portlet:actionURL portletName="<%= FlagsPortletKeys.FLAGS %>" windowState="<%= LiferayWindowState.EXCLUSIVE.toString() %>"><portlet:param name="mvcRenderCommandName" value="/flags/edit_entry" /></liferay-portlet:actionURL>',
			{
				data: data,
				on: {
					failure: function() {
