...
public class CalendarDisplayContext {
	...
	public String getEditCalendarBookingRedirect(
		HttpServletRequest request, String defaultRedirect) {
		...
		return ParamUtil.getString(request, "redirect", defaultRedirect);
	}
