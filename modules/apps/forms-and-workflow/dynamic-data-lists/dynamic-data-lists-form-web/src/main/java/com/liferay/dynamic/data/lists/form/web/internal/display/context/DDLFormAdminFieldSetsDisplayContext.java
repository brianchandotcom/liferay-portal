...
import com.liferay.dynamic.data.lists.form.web.internal.search.FieldSetsSearch;
import com.liferay.dynamic.data.lists.form.web.internal.search.FieldSetsSearchTerms;
 ...
 */
public class DDLFormAdminFieldSetsDisplayContext
	extends DDLFormAdminDisplayContext {

	public DDLFormAdminFieldSetsDisplayContext(
	...
	public PortletURL getPortletURL() {
		...
		portletURL.setParameter("currentTab", "field-sets");
	...
	public SearchContainer<?> getSearch() {
		...
		FieldSetsSearch fieldSetsSearch = new FieldSetsSearch(
	...
	protected void setFieldSetsSearchResults(FieldSetsSearch fieldSetsSearch) {

		FieldSetsSearchTerms fieldSetsSearchTerms =
			(FieldSetsSearchTerms)fieldSetsSearch.getSearchTerms();
	...
	protected void setFieldSetsSearchTotal(FieldSetsSearch fieldSetsSearch) {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DDLFormAdminFieldSetsDisplayContext.class);
