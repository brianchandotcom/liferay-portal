...
import com.liferay.dynamic.data.lists.form.web.internal.display.context.DDLFormAdminFieldSetsDisplayContext;
...
public class DDLFormAdminPortlet extends MVCPortlet {
	...
	protected void setRenderRequestAttributes(
		...
		if (currentTab.equals("field-sets")) {
			renderRequest.setAttribute(
				WebKeys.PORTLET_DISPLAY_CONTEXT,
				new DDLFormAdminFieldSetsDisplayContext(
