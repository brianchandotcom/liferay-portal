...
public class ChangesetEntryWrapper implements ChangesetEntry,
	...
	/**
	* Returns the changeset ID of this changeset entry.
	*
	* @return the changeset ID of this changeset entry
	*/
	@Override
	public long getChangesetId() {
		return _changesetEntry.getChangesetId();
	}
	...
	*/
	...
	/**
	* Returns the entry ID of this changeset entry.
	*
	* @return the entry ID of this changeset entry
	*/
	@Override
	public long getEntryId() {
		return _changesetEntry.getEntryId();
	}
	...
	*/
	...
	/**
	* Sets the changeset ID of this changeset entry.
	*
	* @param changesetId the changeset ID of this changeset entry
	*/
	@Override
	public void setChangesetId(long changesetId) {
		_changesetEntry.setChangesetId(changesetId);
	}
	...
	*/
	...
	/**
	* Sets the entry ID of this changeset entry.
	*
	* @param entryId the entry ID of this changeset entry
	*/
	@Override
	public void setEntryId(long entryId) {
		_changesetEntry.setEntryId(entryId);
	}
