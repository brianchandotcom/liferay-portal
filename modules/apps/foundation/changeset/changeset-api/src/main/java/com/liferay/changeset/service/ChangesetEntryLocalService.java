...
public interface ChangesetEntryLocalService extends BaseLocalService,
	...
	*/
	public ChangesetEntry addEntry(long userId, long changesetId,
		long classNameId, long classPK) throws PortalException;

	public ChangesetEntry addIfNotExists(long changesetId, long classNameId,
	...
	*/
	...
	public ChangesetEntry createChangesetEntry(long entryId);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ChangesetEntry deleteChangesetEntry(long entryId)
	...
	*/
	...
	public ChangesetEntry fetchChangesetEntry(long entryId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ChangesetEntry fetchEntry(long changesetId, long classNameId,
		long classPK);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ChangesetEntry getChangesetEntry(long entryId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ChangesetEntry getEntry(long changesetId, long classNameId,
