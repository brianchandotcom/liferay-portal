...
public class ChangesetEntryLocalServiceUtil {
	...
	*/
	public static com.liferay.changeset.model.ChangesetEntry addEntry(
		long userId, long changesetId, long classNameId, long classPK)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().addEntry(userId, changesetId, classNameId, classPK);
	}

	public static com.liferay.changeset.model.ChangesetEntry addIfNotExists(
		long changesetId, long classNameId, long classPK)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().addIfNotExists(changesetId, classNameId, classPK);
	}
	...
	*/
	public static com.liferay.changeset.model.ChangesetEntry createChangesetEntry(
		long entryId) {
		return getService().createChangesetEntry(entryId);
	}
	...
	*/
	public static com.liferay.changeset.model.ChangesetEntry deleteChangesetEntry(
		long entryId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteChangesetEntry(entryId);
	}
	...
	*/
	...
	public static com.liferay.changeset.model.ChangesetEntry fetchChangesetEntry(
		long entryId) {
		return getService().fetchChangesetEntry(entryId);
	}

	public static com.liferay.changeset.model.ChangesetEntry fetchEntry(
		long changesetId, long classNameId, long classPK) {
		return getService().fetchEntry(changesetId, classNameId, classPK);
	}
	...
	*/
	public static com.liferay.changeset.model.ChangesetEntry getChangesetEntry(
		long entryId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getChangesetEntry(entryId);
	}

	public static long getEntriesCount(long changesetId) {
		return getService().getEntriesCount(changesetId);
	}

	public static long getEntriesCount(long changesetId, long classNameId) {
		return getService().getEntriesCount(changesetId, classNameId);
	}

	public static com.liferay.changeset.model.ChangesetEntry getEntry(
		long changesetId, long classNameId, long classPK)
		throws com.liferay.changeset.exception.NoSuchEntryException {
		return getService().getEntry(changesetId, classNameId, classPK);
	}
