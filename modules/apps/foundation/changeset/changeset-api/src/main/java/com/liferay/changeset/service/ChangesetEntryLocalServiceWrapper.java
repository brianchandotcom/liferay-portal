...
public class ChangesetEntryLocalServiceWrapper
	...
	* NOTE FOR DEVELOPERS:
	*
	* Never reference this class directly. Always use {@link ChangesetEntryLocalServiceUtil} to access the changeset entry local service.
	*/
	@Override
	public com.liferay.changeset.model.ChangesetEntry addEntry(long userId,
		long changesetId, long classNameId, long classPK)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _changesetEntryLocalService.addEntry(userId, changesetId,
			classNameId, classPK);
	}

	@Override
	public com.liferay.changeset.model.ChangesetEntry addIfNotExists(
		long changesetId, long classNameId, long classPK)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _changesetEntryLocalService.addIfNotExists(changesetId,
			classNameId, classPK);
	}
	...
	*/
	...
	public com.liferay.changeset.model.ChangesetEntry createChangesetEntry(
		long entryId) {
		return _changesetEntryLocalService.createChangesetEntry(entryId);
	}
	...
	*/
	...
	public com.liferay.changeset.model.ChangesetEntry deleteChangesetEntry(
		long entryId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _changesetEntryLocalService.deleteChangesetEntry(entryId);
	}
	...
	*/
	...
	public com.liferay.changeset.model.ChangesetEntry fetchChangesetEntry(
		long entryId) {
		return _changesetEntryLocalService.fetchChangesetEntry(entryId);
	}

	@Override
	public com.liferay.changeset.model.ChangesetEntry fetchEntry(
		long changesetId, long classNameId, long classPK) {
		return _changesetEntryLocalService.fetchEntry(changesetId, classNameId,
			classPK);
	}
	...
	*/
	...
	public com.liferay.changeset.model.ChangesetEntry getChangesetEntry(
		long entryId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _changesetEntryLocalService.getChangesetEntry(entryId);
	}

	@Override
	public long getEntriesCount(long changesetId) {
		return _changesetEntryLocalService.getEntriesCount(changesetId);
	}
	...
	@Override
	public com.liferay.changeset.model.ChangesetEntry getEntry(
		long changesetId, long classNameId, long classPK)
		throws com.liferay.changeset.exception.NoSuchEntryException {
		return _changesetEntryLocalService.getEntry(changesetId, classNameId,
			classPK);
	}
