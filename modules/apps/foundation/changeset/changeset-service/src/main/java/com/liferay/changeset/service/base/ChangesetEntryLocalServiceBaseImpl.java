...
public abstract class ChangesetEntryLocalServiceBaseImpl
	...
	public ChangesetEntry createChangesetEntry(long entryId) {
		return changesetEntryPersistence.create(entryId);
	}
	...
	public ChangesetEntry deleteChangesetEntry(long entryId)
		...
		return changesetEntryPersistence.remove(entryId);
	}
	...
	public ChangesetEntry fetchChangesetEntry(long entryId) {
		return changesetEntryPersistence.fetchByPrimaryKey(entryId);
	}
	...
	public ChangesetEntry getChangesetEntry(long entryId)
		throws PortalException {
		return changesetEntryPersistence.findByPrimaryKey(entryId);
	}
	 ...
	 */
	public com.liferay.changeset.service.ChangesetLocalService getChangesetLocalService() {
	...
	public void setChangesetLocalService(
		com.liferay.changeset.service.ChangesetLocalService changesetLocalService) {
	...
	@BeanReference(type = com.liferay.changeset.service.ChangesetLocalService.class)
	protected com.liferay.changeset.service.ChangesetLocalService changesetLocalService;
