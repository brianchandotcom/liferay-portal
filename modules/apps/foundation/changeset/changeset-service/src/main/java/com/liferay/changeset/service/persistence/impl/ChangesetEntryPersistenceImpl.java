...
public class ChangesetEntryPersistenceImpl extends BasePersistenceImpl<ChangesetEntry>
	...
	public ChangesetEntry[] findByGroupId_PrevAndNext(long entryId,
		...
		throws NoSuchEntryException {
		ChangesetEntry changesetEntry = findByPrimaryKey(entryId);
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_CHANGESETID =
		new FinderPath(ChangesetEntryModelImpl.ENTITY_CACHE_ENABLED,
			ChangesetEntryModelImpl.FINDER_CACHE_ENABLED,
			ChangesetEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByChangesetId",
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CHANGESETID =
		new FinderPath(ChangesetEntryModelImpl.ENTITY_CACHE_ENABLED,
			ChangesetEntryModelImpl.FINDER_CACHE_ENABLED,
			ChangesetEntryImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByChangesetId",
			new String[] { Long.class.getName() },
			ChangesetEntryModelImpl.CHANGESETID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_CHANGESETID = new FinderPath(ChangesetEntryModelImpl.ENTITY_CACHE_ENABLED,
			ChangesetEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByChangesetId",
			new String[] { Long.class.getName() });
	 ...
	 */
	@Override
	public List<ChangesetEntry> findByChangesetId(long changesetId) {
		return findByChangesetId(changesetId, QueryUtil.ALL_POS,
	 ...
	 */
	@Override
	public List<ChangesetEntry> findByChangesetId(long changesetId, int start,
		int end) {
		return findByChangesetId(changesetId, start, end, null);
	}
	...
	public List<ChangesetEntry> findByChangesetId(long changesetId, int start,
		int end, OrderByComparator<ChangesetEntry> orderByComparator) {
		return findByChangesetId(changesetId, start, end, orderByComparator,
			true);
	}
	...
	public List<ChangesetEntry> findByChangesetId(long changesetId, int start,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CHANGESETID;
			finderArgs = new Object[] { changesetId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_CHANGESETID;
			finderArgs = new Object[] { changesetId, start, end, orderByComparator };
		}
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (ChangesetEntry changesetEntry : list) {
					if ((changesetId != changesetEntry.getChangesetId())) {
						list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_CHANGESETID_CHANGESETID_2);
	...
	public ChangesetEntry findByChangesetId_First(long changesetId,
		OrderByComparator<ChangesetEntry> orderByComparator)
		throws NoSuchEntryException {
		ChangesetEntry changesetEntry = fetchByChangesetId_First(changesetId,
				orderByComparator);
	...
	public ChangesetEntry fetchByChangesetId_First(long changesetId,
		OrderByComparator<ChangesetEntry> orderByComparator) {
		List<ChangesetEntry> list = findByChangesetId(changesetId, 0, 1,
				orderByComparator);
	...
	public ChangesetEntry findByChangesetId_Last(long changesetId,
		OrderByComparator<ChangesetEntry> orderByComparator)
		throws NoSuchEntryException {
		ChangesetEntry changesetEntry = fetchByChangesetId_Last(changesetId,
				orderByComparator);
	...
	public ChangesetEntry fetchByChangesetId_Last(long changesetId,
		OrderByComparator<ChangesetEntry> orderByComparator) {
		int count = countByChangesetId(changesetId);

		if (count == 0) {
			return null;
		}

		List<ChangesetEntry> list = findByChangesetId(changesetId, count - 1,
				count, orderByComparator);
	...
	public ChangesetEntry[] findByChangesetId_PrevAndNext(long entryId,
		long changesetId, OrderByComparator<ChangesetEntry> orderByComparator)
		throws NoSuchEntryException {
		ChangesetEntry changesetEntry = findByPrimaryKey(entryId);
		...
		try {
			...
			array[0] = getByChangesetId_PrevAndNext(session, changesetEntry,
					changesetId, orderByComparator, true);

			array[1] = changesetEntry;

			array[2] = getByChangesetId_PrevAndNext(session, changesetEntry,
					changesetId, orderByComparator, false);
	...
	protected ChangesetEntry getByChangesetId_PrevAndNext(Session session,
		ChangesetEntry changesetEntry, long changesetId,
		OrderByComparator<ChangesetEntry> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByChangesetId(long changesetId) {
		for (ChangesetEntry changesetEntry : findByChangesetId(changesetId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(changesetEntry);
		}
	}
	...
	public int countByChangesetId(long changesetId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_CHANGESETID;

		Object[] finderArgs = new Object[] { changesetId };
	...
	private static final String _FINDER_COLUMN_CHANGESETID_CHANGESETID_2 = "changesetEntry.changesetId = ?";
	 ...
	 */
	@Override
	public List<ChangesetEntry> findByC_C(long changesetId, long classNameId) {
		return findByC_C(changesetId, classNameId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<ChangesetEntry> findByC_C(long changesetId, long classNameId,
		int start, int end) {
		return findByC_C(changesetId, classNameId, start, end, null);
	}
	...
	public List<ChangesetEntry> findByC_C(long changesetId, long classNameId,
		int start, int end, OrderByComparator<ChangesetEntry> orderByComparator) {
		return findByC_C(changesetId, classNameId, start, end,
	...
	public List<ChangesetEntry> findByC_C(long changesetId, long classNameId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderArgs = new Object[] { changesetId, classNameId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C;
			finderArgs = new Object[] {
					changesetId, classNameId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_C_CHANGESETID_2);
	...
	public ChangesetEntry findByC_C_First(long changesetId, long classNameId,
		OrderByComparator<ChangesetEntry> orderByComparator)
		throws NoSuchEntryException {
		ChangesetEntry changesetEntry = fetchByC_C_First(changesetId,
	...
	public ChangesetEntry fetchByC_C_First(long changesetId, long classNameId,
		OrderByComparator<ChangesetEntry> orderByComparator) {
		List<ChangesetEntry> list = findByC_C(changesetId, classNameId, 0, 1,
				orderByComparator);
	...
	public ChangesetEntry findByC_C_Last(long changesetId, long classNameId,
		OrderByComparator<ChangesetEntry> orderByComparator)
		throws NoSuchEntryException {
		ChangesetEntry changesetEntry = fetchByC_C_Last(changesetId,
				classNameId, orderByComparator);
	...
	public ChangesetEntry fetchByC_C_Last(long changesetId, long classNameId,
		OrderByComparator<ChangesetEntry> orderByComparator) {
		int count = countByC_C(changesetId, classNameId);

		if (count == 0) {
			return null;
		}

		List<ChangesetEntry> list = findByC_C(changesetId, classNameId,
	...
	public ChangesetEntry[] findByC_C_PrevAndNext(long entryId,
		...
		try {
			...
			array[0] = getByC_C_PrevAndNext(session, changesetEntry,
					changesetId, classNameId, orderByComparator, true);

			array[1] = changesetEntry;

			array[2] = getByC_C_PrevAndNext(session, changesetEntry,
					changesetId, classNameId, orderByComparator, false);
	...
	protected ChangesetEntry getByC_C_PrevAndNext(Session session,
		ChangesetEntry changesetEntry, long changesetId, long classNameId,
		OrderByComparator<ChangesetEntry> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByC_C(long changesetId, long classNameId) {
		for (ChangesetEntry changesetEntry : findByC_C(changesetId,
	...
	public int countByC_C(long changesetId, long classNameId) {
		...
		Object[] finderArgs = new Object[] { changesetId, classNameId };
	...
	private static final String _FINDER_COLUMN_C_C_CHANGESETID_2 = "changesetEntry.changesetId = ? AND ";
	...
	public ChangesetEntry findByC_C_C(long changesetId, long classNameId,
		...
		ChangesetEntry changesetEntry = fetchByC_C_C(changesetId, classNameId,
				classPK);
	...
	public ChangesetEntry fetchByC_C_C(long changesetId, long classNameId,
		long classPK) {
		return fetchByC_C_C(changesetId, classNameId, classPK, true);
	}
	...
	public ChangesetEntry fetchByC_C_C(long changesetId, long classNameId,
		...
		Object[] finderArgs = new Object[] { changesetId, classNameId, classPK };
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_C_C_C_CHANGESETID_2);
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((changesetEntry.getChangesetId() != changesetId) ||
	...
	public ChangesetEntry removeByC_C_C(long changesetId, long classNameId,
		long classPK) throws NoSuchEntryException {
		ChangesetEntry changesetEntry = findByC_C_C(changesetId, classNameId,
				classPK);
	...
	private static final String _FINDER_COLUMN_C_C_C_CHANGESETID_2 = "changesetEntry.changesetId = ? AND ";
	...
	public void cacheResult(ChangesetEntry changesetEntry) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_C_C_C,
			new Object[] {
				changesetEntry.getChangesetId(), changesetEntry.getClassNameId(),
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
				changesetEntryModelImpl.getChangesetId(),
	...
	protected void clearUniqueFindersCache(
		...
		if ((changesetEntryModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
					changesetEntryModelImpl.getOriginalChangesetId(),
	...
	public ChangesetEntry create(long entryId) {
		...
		changesetEntry.setPrimaryKey(entryId);
	...
	public ChangesetEntry updateImpl(ChangesetEntry changesetEntry) {
		...
		if (!ChangesetEntryModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] { changesetEntryModelImpl.getChangesetId() };

			finderCache.removeResult(FINDER_PATH_COUNT_BY_CHANGESETID, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CHANGESETID,
				args);
			...
			if ((changesetEntryModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CHANGESETID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						changesetEntryModelImpl.getOriginalChangesetId()
					};
	...
	protected ChangesetEntry toUnwrappedModel(ChangesetEntry changesetEntry) {
		...
		changesetEntryImpl.setEntryId(changesetEntry.getEntryId());
		...
		changesetEntryImpl.setChangesetId(changesetEntry.getChangesetId());
	...
	private static final String _SQL_SELECT_CHANGESETENTRY_WHERE_PKS_IN = "SELECT changesetEntry FROM ChangesetEntry changesetEntry WHERE entryId IN (";
