...
public class ChangesetEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newChangesetEntry.setChangesetId(RandomTestUtil.nextLong());
		...
		Assert.assertEquals(existingChangesetEntry.getEntryId(),
			newChangesetEntry.getEntryId());
		...
		Assert.assertEquals(existingChangesetEntry.getChangesetId(),
			newChangesetEntry.getChangesetId());
	...
	@Test
	public void testCountByChangesetId() throws Exception {
		_persistence.countByChangesetId(RandomTestUtil.nextLong());

		_persistence.countByChangesetId(0L);
	}
	...
	protected OrderByComparator<ChangesetEntry> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("ChangesetEntry", "entryId",
			true, "groupId", true, "companyId", true, "userId", true,
			"userName", true, "createDate", true, "modifiedDate", true,
			"changesetId", true, "classNameId", true, "classPK", true);
	}
	...
	public void testDynamicQueryByProjectionExisting()
		...
		Object newEntryId = newChangesetEntry.getEntryId();
	...
	public void testResetOriginalValues() throws Exception {
		...
		Assert.assertEquals(Long.valueOf(
				existingChangesetEntry.getChangesetId()),
			ReflectionTestUtil.<Long>invoke(existingChangesetEntry,
				"getOriginalChangesetId", new Class<?>[0]));
		Assert.assertEquals(Long.valueOf(
	...
	protected ChangesetEntry addChangesetEntry() throws Exception {
		...
		changesetEntry.setChangesetId(RandomTestUtil.nextLong());
