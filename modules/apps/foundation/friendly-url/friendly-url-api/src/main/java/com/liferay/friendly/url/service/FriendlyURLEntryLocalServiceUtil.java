...
public class FriendlyURLEntryLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.friendly.url.model.FriendlyURLEntry addFriendlyURLEntry(
		...
		return getService()
				   .addFriendlyURLEntry(companyId, groupId, clazz, classPK,
			urlTitle);
	}
	...
	public static com.liferay.friendly.url.model.FriendlyURLEntry addFriendlyURLEntry(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .addFriendlyURLEntry(companyId, groupId, classNameId,
			classPK, urlTitle);
	}
	...
	*/
	...
	public static com.liferay.friendly.url.model.FriendlyURLEntry fetchFriendlyURLEntry(
		...
		java.lang.String urlTitle) {
		return getService()
				   .fetchFriendlyURLEntry(companyId, groupId, clazz, urlTitle);
	}
	...
	public static com.liferay.friendly.url.model.FriendlyURLEntry fetchFriendlyURLEntry(
		...
		java.lang.String urlTitle) {
		return getService()
				   .fetchFriendlyURLEntry(companyId, groupId, classNameId,
			urlTitle);
	}
	...
	*/
	...
	public static com.liferay.friendly.url.model.FriendlyURLEntry getMainFriendlyURLEntry(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .getMainFriendlyURLEntry(companyId, groupId, clazz, classPK);
	}
	...
	public static com.liferay.friendly.url.model.FriendlyURLEntry getMainFriendlyURLEntry(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .getMainFriendlyURLEntry(companyId, groupId, classNameId,
			classPK);
	}
	...
	*/
	...
	public static java.util.List<com.liferay.friendly.url.model.FriendlyURLEntry> getFriendlyURLEntries(
		long companyId, long groupId, long classNameId, long classPK) {
		return getService()
				   .getFriendlyURLEntries(companyId, groupId, classNameId,
			classPK);
	}
	...
	*/
	...
	public static void deleteFriendlyURLEntry(long companyId, long groupId,
		java.lang.Class<?> clazz, long classPK) {
		getService().deleteFriendlyURLEntry(companyId, groupId, clazz, classPK);
	}
	...
	public static void deleteFriendlyURLEntry(long companyId, long groupId,
		...
		getService()
			.deleteFriendlyURLEntry(companyId, groupId, clazz, classPK, urlTitle);
	}
	...
	public static void deleteFriendlyURLEntry(long companyId, long groupId,
		...
		throws com.liferay.friendly.url.exception.NoSuchFriendlyURLEntryException {
		getService()
			.deleteFriendlyURLEntry(companyId, groupId, classNameId, classPK,
			urlTitle);
	}
