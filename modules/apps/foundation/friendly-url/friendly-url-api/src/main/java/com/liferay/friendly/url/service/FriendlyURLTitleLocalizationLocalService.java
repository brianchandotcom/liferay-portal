...
/**
 * Provides the local service interface for FriendlyURLTitleLocalization. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FriendlyURLTitleLocalizationLocalServiceUtil
...
public interface FriendlyURLTitleLocalizationLocalService
	extends BaseLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FriendlyURLTitleLocalizationLocalServiceUtil} to access the friendly url title localization local service. Add custom service methods to {@link com.liferay.friendly.url.service.impl.FriendlyURLTitleLocalizationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public List<FriendlyURLTitleLocalization> updateFriendlyURLTitleLocalizations(
