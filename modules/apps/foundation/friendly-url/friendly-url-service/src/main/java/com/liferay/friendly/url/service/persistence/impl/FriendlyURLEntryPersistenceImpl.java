...
public class FriendlyURLEntryPersistenceImpl extends BasePersistenceImpl<FriendlyURLEntry>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_G_C_C = new FinderPath(FriendlyURLEntryModelImpl.ENTITY_CACHE_ENABLED,
			FriendlyURLEntryModelImpl.FINDER_CACHE_ENABLED,
			FriendlyURLEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC_G_C_C",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_C_G_C_C = new FinderPath(FriendlyURLEntryModelImpl.ENTITY_CACHE_ENABLED,
			FriendlyURLEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<FriendlyURLEntry> findByC_G_C_C(long companyId, long groupId,
	...
	public FriendlyURLEntry findByC_G_C_C_First(long companyId, long groupId,
		...
		OrderByComparator<FriendlyURLEntry> orderByComparator)
		throws NoSuchFriendlyURLEntryException {
		FriendlyURLEntry friendlyURLEntry = fetchByC_G_C_C_First(companyId,
	...
	public FriendlyURLEntry fetchByC_G_C_C_First(long companyId, long groupId,
		long classNameId, long classPK,
		OrderByComparator<FriendlyURLEntry> orderByComparator) {
		List<FriendlyURLEntry> list = findByC_G_C_C(companyId, groupId,
	...
	public FriendlyURLEntry findByC_G_C_C_Last(long companyId, long groupId,
		...
		OrderByComparator<FriendlyURLEntry> orderByComparator)
		throws NoSuchFriendlyURLEntryException {
		FriendlyURLEntry friendlyURLEntry = fetchByC_G_C_C_Last(companyId,
				groupId, classNameId, classPK, orderByComparator);
	...
	public FriendlyURLEntry[] findByC_G_C_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByC_G_C_C_PrevAndNext(session, friendlyURLEntry,
					companyId, groupId, classNameId, classPK,
					orderByComparator, true);

			array[1] = friendlyURLEntry;

			array[2] = getByC_G_C_C_PrevAndNext(session, friendlyURLEntry,
					companyId, groupId, classNameId, classPK,
					orderByComparator, false);
	...
	protected FriendlyURLEntry getByC_G_C_C_PrevAndNext(Session session,
		FriendlyURLEntry friendlyURLEntry, long companyId, long groupId,
		long classNameId, long classPK,
		OrderByComparator<FriendlyURLEntry> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByC_G_C_C(long companyId, long groupId, long classNameId,
		long classPK) {
		for (FriendlyURLEntry friendlyURLEntry : findByC_G_C_C(companyId,
	...
	private static final String _FINDER_COLUMN_C_G_C_C_COMPANYID_2 = "friendlyURLEntry.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_C_C_GROUPID_2 = "friendlyURLEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_C_C_CLASSNAMEID_2 = "friendlyURLEntry.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_C_C_CLASSPK_2 = "friendlyURLEntry.classPK = ?";
	public static final FinderPath FINDER_PATH_FETCH_BY_C_G_C_U = new FinderPath(FriendlyURLEntryModelImpl.ENTITY_CACHE_ENABLED,
			FriendlyURLEntryModelImpl.FINDER_CACHE_ENABLED,
			FriendlyURLEntryImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByC_G_C_U",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_C_G_C_U = new FinderPath(FriendlyURLEntryModelImpl.ENTITY_CACHE_ENABLED,
			FriendlyURLEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public FriendlyURLEntry findByC_G_C_U(long companyId, long groupId,
		...
		throws NoSuchFriendlyURLEntryException {
		FriendlyURLEntry friendlyURLEntry = fetchByC_G_C_U(companyId, groupId,
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							_log.warn(
								"FriendlyURLEntryPersistenceImpl.fetchByC_G_C_U(long, long, long, String, boolean) with parameters (" +
					...
					if ((friendlyURLEntry.getCompanyId() != companyId) ||
							(friendlyURLEntry.getGroupId() != groupId) ||
	...
	public FriendlyURLEntry removeByC_G_C_U(long companyId, long groupId,
		long classNameId, String urlTitle)
		throws NoSuchFriendlyURLEntryException {
		FriendlyURLEntry friendlyURLEntry = findByC_G_C_U(companyId, groupId,
				classNameId, urlTitle);
	...
	private static final String _FINDER_COLUMN_C_G_C_U_COMPANYID_2 = "friendlyURLEntry.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_C_U_GROUPID_2 = "friendlyURLEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_C_U_CLASSNAMEID_2 = "friendlyURLEntry.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_C_U_URLTITLE_1 = "friendlyURLEntry.urlTitle IS NULL";
	private static final String _FINDER_COLUMN_C_G_C_U_URLTITLE_2 = "friendlyURLEntry.urlTitle = ?";
	private static final String _FINDER_COLUMN_C_G_C_U_URLTITLE_3 = "(friendlyURLEntry.urlTitle IS NULL OR friendlyURLEntry.urlTitle = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_C_G_C_C_U = new FinderPath(FriendlyURLEntryModelImpl.ENTITY_CACHE_ENABLED,
			FriendlyURLEntryModelImpl.FINDER_CACHE_ENABLED,
			FriendlyURLEntryImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByC_G_C_C_U",
			new String[] {
			...
			FriendlyURLEntryModelImpl.CLASSPK_COLUMN_BITMASK |
			FriendlyURLEntryModelImpl.URLTITLE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C_G_C_C_U = new FinderPath(FriendlyURLEntryModelImpl.ENTITY_CACHE_ENABLED,
			FriendlyURLEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public FriendlyURLEntry findByC_G_C_C_U(long companyId, long groupId,
		...
		throws NoSuchFriendlyURLEntryException {
		FriendlyURLEntry friendlyURLEntry = fetchByC_G_C_C_U(companyId,
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							_log.warn(
								"FriendlyURLEntryPersistenceImpl.fetchByC_G_C_C_U(long, long, long, long, String, boolean) with parameters (" +
								StringUtil.merge(finderArgs) +
								") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
						}
					}
	...
	public FriendlyURLEntry removeByC_G_C_C_U(long companyId, long groupId,
		long classNameId, long classPK, String urlTitle)
		throws NoSuchFriendlyURLEntryException {
		FriendlyURLEntry friendlyURLEntry = findByC_G_C_C_U(companyId, groupId,
	...
	private static final String _FINDER_COLUMN_C_G_C_C_U_COMPANYID_2 = "friendlyURLEntry.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_C_C_U_GROUPID_2 = "friendlyURLEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_C_C_U_CLASSNAMEID_2 = "friendlyURLEntry.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_C_C_U_CLASSPK_2 = "friendlyURLEntry.classPK = ? AND ";
	private static final String _FINDER_COLUMN_C_G_C_C_U_URLTITLE_1 = "friendlyURLEntry.urlTitle IS NULL";
	private static final String _FINDER_COLUMN_C_G_C_C_U_URLTITLE_2 = "friendlyURLEntry.urlTitle = ?";
	private static final String _FINDER_COLUMN_C_G_C_C_U_URLTITLE_3 = "(friendlyURLEntry.urlTitle IS NULL OR friendlyURLEntry.urlTitle = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_C_G_C_C_M = new FinderPath(FriendlyURLEntryModelImpl.ENTITY_CACHE_ENABLED,
			FriendlyURLEntryModelImpl.FINDER_CACHE_ENABLED,
			FriendlyURLEntryImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByC_G_C_C_M",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_C_G_C_C_M = new FinderPath(FriendlyURLEntryModelImpl.ENTITY_CACHE_ENABLED,
			FriendlyURLEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public FriendlyURLEntry findByC_G_C_C_M(long companyId, long groupId,
		...
		throws NoSuchFriendlyURLEntryException {
		FriendlyURLEntry friendlyURLEntry = fetchByC_G_C_C_M(companyId,
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							_log.warn(
								"FriendlyURLEntryPersistenceImpl.fetchByC_G_C_C_M(long, long, long, long, boolean, boolean) with parameters (" +
								StringUtil.merge(finderArgs) +
								") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
						}
					}
	...
	public FriendlyURLEntry removeByC_G_C_C_M(long companyId, long groupId,
		long classNameId, long classPK, boolean main)
		throws NoSuchFriendlyURLEntryException {
		FriendlyURLEntry friendlyURLEntry = findByC_G_C_C_M(companyId, groupId,
	...
	private static final String _FINDER_COLUMN_C_G_C_C_M_COMPANYID_2 = "friendlyURLEntry.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_C_C_M_GROUPID_2 = "friendlyURLEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_C_C_M_CLASSNAMEID_2 = "friendlyURLEntry.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_C_G_C_C_M_CLASSPK_2 = "friendlyURLEntry.classPK = ? AND ";
	private static final String _FINDER_COLUMN_C_G_C_C_M_MAIN_2 = "friendlyURLEntry.main = ?";
	...
	public FriendlyURLEntry updateImpl(FriendlyURLEntry friendlyURLEntry) {
		...
		if (isNew || !FriendlyURLEntryModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
