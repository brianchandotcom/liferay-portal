		...
		alloyEditor = new A.LiferayAlloyEditor(
			{
				...
				namespace: '<%= name %>',
				onBlurMethod: '<%= HtmlUtil.escapeJS(onBlurMethod) %>',
				onChangeMethod: '<%= HtmlUtil.escapeJS(onChangeMethod) %>',
				onFocusMethod: '<%= HtmlUtil.escapeJS(onFocusMethod) %>',
				onInitMethod: '<%= HtmlUtil.escapeJS(onInitMethod) %>',
				plugins: plugins,
