...
public class PropertiesToConfigurationUpgradeUtilTest {
	...
	@Test
	public void testWillNotUpgradeNonExistentValues() throws Exception {
		...
		_portletPreferences.setValue(_propertyKey, value);
		...
		PropertiesToConfigurationUpgradeUtil.upgradePropertiesToConfiguration(
			_portletPreferences, configuration, upgradeKeys);

		configuration = _getConfiguration(_pid, StringPool.QUESTION);

		Dictionary properties = configuration.getProperties();

		Assert.assertEquals(value, properties.get(_configurationMethodName));

		Assert.assertNull(properties.get(dummyConfigurationMethodName));
	}
