...
public class FolderSearchFacetDisplayContext {
	...
	public FolderSearchFacetDisplayContext(
			...
			FolderTitleFinder folderTitleFinder)
		...
		_folderTitleFinder = folderTitleFinder;
	...
	protected List<FolderSearchFacetTermDisplayContext>
		...
		String title = _folderTitleFinder.getFolderTitle(_folderId);
	...
	protected FolderSearchFacetTermDisplayContext getTermDisplayContext(
		...
		String title = _folderTitleFinder.getFolderTitle(curFolderId);
	...
	private final FolderTitleFinder _folderTitleFinder;
