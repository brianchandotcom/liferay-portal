...
public class DefaultSearchResultPermissionFilter
	...
	public DefaultSearchResultPermissionFilter(
		...
		_searchResultPermissionFilterSearcher =
			searchResultPermissionFilterSearcher;
	...
	protected Hits getHits(SearchContext searchContext) throws SearchException {
		...
		return _searchResultPermissionFilterSearcher.search(searchContext);
	}
	...
	private final SearchResultPermissionFilterSearcher
		_searchResultPermissionFilterSearcher;
