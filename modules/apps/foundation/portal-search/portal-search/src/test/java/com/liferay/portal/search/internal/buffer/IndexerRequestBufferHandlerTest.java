...
public class IndexerRequestBufferHandlerTest {
		...
		Mockito.doAnswer(
			new Answer<Object>() {
				...
				public Object answer(InvocationOnMock invocationOnMock)
					...
					return deepReindex(invocationOnMock);
				}
	...
	protected Object deepReindex(InvocationOnMock invocationOnMock)
		throws Exception {

		Object[] arguments = invocationOnMock.getArguments();

		deepReindex((String)arguments[0], (Long)arguments[1]);

		return null;
	}

	protected void deepReindex(String className, long classPK)
		throws Exception {
