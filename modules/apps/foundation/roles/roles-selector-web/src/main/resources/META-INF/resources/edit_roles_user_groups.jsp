...
>
	...
	if (group.isSite()) {
		userGroupParams.put(UserGroupConstants.PARAM_USER_GROUPS_GROUPS, Long.valueOf(group.getGroupId()));
	}

	if (tabs1.equals("current")) {
		userGroupParams.put(UserGroupConstants.PARAM_USER_GROUP_GROUP_ROLE, new Long[] {Long.valueOf(roleId), Long.valueOf(group.getGroupId())});
	}
	%>
