		...
		processConcurrently(
			SQLTransformer.transform(
				StringBundler.concat(
					...
					"FragmentEntryLink1.originalFragmentEntryLinkId and ",
					"FragmentEntryLink2.ctCollectionId = COALESCE((select ",
					"temp.ctCollectionId from FragmentEntryLink temp where ",
					"temp.fragmentEntryLinkId = ",
					"FragmentEntryLink1.originalFragmentEntryLinkId and ",
					"temp.ctCollectionId = ",
					"FragmentEntryLink1.ctCollectionId), 0) left join ",
					"FragmentEntry on FragmentEntry.fragmentEntryId = ",
					"FragmentEntryLink1.fragmentEntryId and ",
					"FragmentEntry.ctCollectionId = COALESCE((select ",
					"temp.ctCollectionId from FragmentEntry temp where ",
					"temp.fragmentEntryId = ",
					"FragmentEntryLink1.fragmentEntryId and ",
					"temp.ctCollectionId = ",
					"FragmentEntryLink1.ctCollectionId), 0) left join Group_ ",
					"on Group_.groupId = FragmentEntry.groupId and ",
					"Group_.ctCollectionId = COALESCE((select ",
					"temp.ctCollectionId from Group_ temp where temp.groupId ",
					"= FragmentEntry.groupId and temp.ctCollectionId = ",
					"FragmentEntry.ctCollectionId), 0)")),
			StringBundler.concat(
