...
public class FragmentCompositionCacheModel
	...
	public FragmentComposition toEntityModel() {
		...
		if (composition == null) {
			fragmentCompositionImpl.setComposition("");
		}
		else {
			fragmentCompositionImpl.setComposition(composition);
		}
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		composition = objectInput.readUTF();
	...
	public void writeExternal(ObjectOutput objectOutput) throws IOException {
		...
		if (composition == null) {
			...
			objectOutput.writeUTF(composition);
		}
