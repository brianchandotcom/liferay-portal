...
public class FragmentCompositionModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"description", Types.VARCHAR}, {"composition", Types.CLOB},
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("composition", Types.CLOB);
	...
	public static FragmentComposition toModel(
		...
		model.setComposition(soapModel.getComposition());
	...
	static {
		...
		attributeGetterFunctions.put(
			"composition", FragmentComposition::getComposition);
		attributeSetterBiConsumers.put(
			"composition",
			(BiConsumer<FragmentComposition, String>)
				FragmentComposition::setComposition);
		attributeGetterFunctions.put(
	...
	public Object clone() {
		...
		fragmentCompositionImpl.setComposition(getComposition());
	...
	public CacheModel<FragmentComposition> toCacheModel() {
		...
		fragmentCompositionCacheModel.composition = getComposition();

		String composition = fragmentCompositionCacheModel.composition;

		if ((composition != null) && (composition.length() == 0)) {
			fragmentCompositionCacheModel.composition = null;
		}
