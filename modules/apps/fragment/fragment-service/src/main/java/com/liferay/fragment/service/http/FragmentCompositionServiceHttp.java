...
public class FragmentCompositionServiceHttp {
	...
	public static com.liferay.fragment.model.FragmentComposition
			addFragmentComposition(
				...
				String name, String description, String composition,
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				...
				fragmentCompositionKey, name, description, composition,
	...
	public static com.liferay.fragment.model.FragmentComposition
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, fragmentCompositionId, name, description,
				composition, previewFileEntryId, status);
