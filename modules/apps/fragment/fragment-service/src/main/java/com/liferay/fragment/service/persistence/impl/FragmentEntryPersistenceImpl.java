...
public class FragmentEntryPersistenceImpl extends BasePersistenceImpl<FragmentEntry>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_FCI_T_S =
		new FinderPath(FragmentEntryModelImpl.ENTITY_CACHE_ENABLED,
			FragmentEntryModelImpl.FINDER_CACHE_ENABLED,
			FragmentEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_FCI_T_S",
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_FCI_T_S =
		new FinderPath(FragmentEntryModelImpl.ENTITY_CACHE_ENABLED,
			FragmentEntryModelImpl.FINDER_CACHE_ENABLED,
			FragmentEntryImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByG_FCI_T_S",
	...
	public List<FragmentEntry> findByG_FCI_T_S(long groupId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_FCI_T_S;
			finderArgs = new Object[] {
					groupId, fragmentCollectionId, type, status
				};
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_G_FCI_T_S;
			finderArgs = new Object[] {
					groupId, fragmentCollectionId, type, status,
	...
	public FragmentEntry updateImpl(FragmentEntry fragmentEntry) {
		...
		if (!FragmentEntryModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_FCI_T_S,
				args);
			...
			if ((fragmentEntryModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_FCI_T_S.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						fragmentEntryModelImpl.getOriginalGroupId(),
						fragmentEntryModelImpl.getOriginalFragmentCollectionId(),
						fragmentEntryModelImpl.getOriginalType(),
