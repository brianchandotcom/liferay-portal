...
public class FragmentsImporterTest {
	...
	public void testImportFragmentsWithFolderResources() throws Exception {
		...
		Map<String, FileEntry> resources =
			fragmentCollection.getResourcesAsMap();

		Assert.assertEquals(resources.toString(), 2, resources.size());

		Assert.assertNotNull(resources.get("image1.png"));
		Assert.assertNotNull(resources.get("folder1/image2.png"));

		FileEntry fileEntry = resources.get("image1.png");

		Assert.assertEquals("image1.png", fileEntry.getTitle());

		fileEntry = resources.get("folder1/image2.png");
