...
public class FragmentCompositionPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newFragmentComposition.setComposition(RandomTestUtil.randomString());
		...
		Assert.assertEquals(
			existingFragmentComposition.getComposition(),
			newFragmentComposition.getComposition());
		Assert.assertEquals(
	...
	protected OrderByComparator<FragmentComposition> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			"composition", true, "previewFileEntryId", true, "lastPublishDate",
	...
	protected FragmentComposition addFragmentComposition() throws Exception {
		...
		fragmentComposition.setComposition(RandomTestUtil.randomString());
