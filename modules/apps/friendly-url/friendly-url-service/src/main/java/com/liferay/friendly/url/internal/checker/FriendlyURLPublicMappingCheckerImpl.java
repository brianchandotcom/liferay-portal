...
public class FriendlyURLPublicMappingCheckerImpl
	...
	@Override
	public List<FriendlyURLPublicMappingConflict> getConflicts(long companyId) {
		...
		conflicts.sort(_conflictComparator);
	...
	private void _collectLayoutConflict(
		...
		if (group.getGroupId() == groupId) {
			conflicts.add(
				new FriendlyURLPublicMappingConflict(
					Layout.class.getName(), plid, null, null, friendlyURL, name,
					FriendlyURLPublicMappingConflict.Type.SELF));
		}
		else {
			conflicts.add(
				new FriendlyURLPublicMappingConflict(
					...
					name, FriendlyURLPublicMappingConflict.Type.CROSS_SITE));
		}
	}
	...
	private static final Comparator<FriendlyURLPublicMappingConflict>
		_conflictComparator = Comparator.comparing(
