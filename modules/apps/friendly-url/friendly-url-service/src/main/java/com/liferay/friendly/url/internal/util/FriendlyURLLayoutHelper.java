 ...
 */
@Component(immediate = true, service = FriendlyURLLayoutHelper.class)
public class FriendlyURLLayoutHelper {

	public long getLayoutClassNameId(boolean privateLayout) {
