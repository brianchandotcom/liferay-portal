...
public class SetDataSetStartupSnapshotMVCResourceCommand
	...
	protected void doTransactionalCommand(
		...
		// The frontend data set management bar posts to this command from any
		// page, so the parameters are read from the original servlet request to
		// bypass the portlet's namespaced parameter filtering.
		...
		// Ensure only one startup snapshot entry is associated to a snapshot
		// for the given user.
		...
		// The response mirrors the startup snapshot serialized into the data
		// set props, so the client receives the same shape it renders.
