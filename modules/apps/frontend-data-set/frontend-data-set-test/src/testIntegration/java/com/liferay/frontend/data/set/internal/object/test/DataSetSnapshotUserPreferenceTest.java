...
public class DataSetSnapshotUserPreferenceTest {
	...
	@Test
	public void testStoreStartupViewDataSetSnapshotERC() throws Exception {
		String fdsName = RandomTestUtil.randomString();
		String startupViewDataSetSnapshotERC = RandomTestUtil.randomString();
		...
		ObjectEntry objectEntry = _objectEntryLocalService.addObjectEntry(
			...
			HashMapBuilder.<String, Serializable>put(
				...
				"startupViewDataSetSnapshotERC", startupViewDataSetSnapshotERC
			).build(),
		...
		try {
			...
			Assert.assertEquals(
				...
				values.get("startupViewDataSetSnapshotERC"));
		}
		finally {
