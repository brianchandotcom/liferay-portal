...
public class DataSetSnapshotUserPreferenceTest {
	...
	@Test
	public void testStoreDataSetSnapshotStartupViewERC() throws Exception {
		String fdsName = RandomTestUtil.randomString();
		String dataSetSnapshotStartupViewERC = RandomTestUtil.randomString();

		ObjectEntry objectEntry = _objectEntryLocalService.addObjectEntry(
			0, TestPropsValues.getUserId(),
			_objectDefinition.getObjectDefinitionId(), 0, null,
			HashMapBuilder.<String, Serializable>put(
				"dataSetSnapshotStartupViewERC", dataSetSnapshotStartupViewERC
			).put(
				"fdsName", fdsName
			).build(),
		...
		try {
			...
			Assert.assertEquals(
				...
				values.get("dataSetSnapshotStartupViewERC"));
		}
		finally {
