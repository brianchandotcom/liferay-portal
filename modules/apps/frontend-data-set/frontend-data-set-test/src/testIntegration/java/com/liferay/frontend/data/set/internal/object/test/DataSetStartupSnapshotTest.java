...
public class DataSetStartupSnapshotTest {
	...
	public void testSetDataSetStartupSnapshotReplacesExisting()
		...
		try {
			...
			// Re-pointing the startup snapshot deletes the existing edge child
			// and recreates it under the selected snapshot, reusing the same
	...
	public void testStartupSnapshotExternalReferenceCodeResolvesSnapshot()
		...
		try {
			...
			// The serializer reads the startup snapshot by its deterministic
