...
public class SaveDataSetUserConfigurationMVCResourceCommandTest {
	...
	@Test
	public void testBadRequestIsReturned() throws Exception {
	...
	@Test
	public void testDataSetUserConfigurationIsCleared() throws Exception {
	...
	@Test
	public void testDataSetUserConfigurationIsSaved() throws Exception {
	...
	@Test
	public void testForbiddenIsReturned() throws Exception {
		...
		_assertResponse(
			...
			_serveResource(
				...
				_dataSetSnapshotObjectEntry, _FDS_NAME));
	...
	private void _assertResponse(
		...
		_assertResponse(
			statusCode, testMockLiferayResourceResponse,
	...
	private TestMockLiferayResourceResponse _serveResource() throws Exception {
		return _serveResource(_user, _dataSetSnapshotObjectEntry, _FDS_NAME);
	}
	...
	private TestMockLiferayResourceResponse _serveResource(
		...
		return _serveResource(_user, objectEntry, _FDS_NAME);
	}

	private TestMockLiferayResourceResponse _serveResource(String configuration)
		throws Exception {

		return _serveResource(_user, configuration, _FDS_NAME);
	}

	private TestMockLiferayResourceResponse _serveResource(
			User user, ObjectEntry objectEntry, String fdsName)
		throws Exception {
