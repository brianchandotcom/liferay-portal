...
public class SnapshotsFDSSerializerTest {
	...
	public void setUp() throws Exception {
		FrontendDataSetTestUtil.initialize(SnapshotsFDSSerializerTest.class);
	...
	public void testSerializeSnapshotsSharedWithUserGroupMember()
		...
		Assert.assertNotNull(
			"The snapshot shared with the user group is not visible to a " +
