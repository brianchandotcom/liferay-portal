 ...
 */
public class ESMPortletDataPart implements PortletDataPart {

	public ESMPortletDataPart(
		String content, String amdRequire, Collection<ESMImport> esmImports) {

		_content = StringUtil.trim(content);
		_esmImports = esmImports;
	...
	public String getContent(
		...
		for (ESMImport esmImport : _esmImports) {
			String alias = esmImport.getAlias();

			ESMImport mappedESMImport = esmImportMap.get(esmImport);

			String variable = mappedESMImport.getAlias();
	...
	private final Collection<ESMImport> _esmImports;
