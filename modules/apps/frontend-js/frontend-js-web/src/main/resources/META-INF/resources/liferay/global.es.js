...
/**
 * @deprecated - import `BREAKPOINTS` from `frontend-js-web`
 */
...
/**
 * @deprecated as of 7.3 - import `isPhone` from `frontend-js-web`
 */
Liferay.Util.isPhone = isPhone;

/**
 * @deprecated as of 7.3 - import `isTablet` from `frontend-js-web`
 */
