 ...
 * @author Marco Leo
 */
@Component(immediate = true, service = ClayDataProviderRegistry.class)
public class ClayDataProviderRegistryImpl implements ClayDataProviderRegistry {
	...
	public ClayDataSetDataProvider getClayDataProvider(String key) {
		...
		if (clayDataProviderServiceWrapper == null) {
			if (_log.isDebugEnabled()) {
				_log.debug("No ClayDataProvider registered with key " + key);
			}
