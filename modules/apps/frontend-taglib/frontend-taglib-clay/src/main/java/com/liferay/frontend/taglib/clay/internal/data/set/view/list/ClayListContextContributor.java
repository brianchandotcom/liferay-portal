...
import com.liferay.frontend.taglib.clay.data.set.view.list.ClayListDataSetDisplayView;
 ...
 */
@Component(
	property = "clay.data.set.content.renderer.name=list",
	...
	private Map<String, Object> _serialize(
		...
		return HashMapBuilder.<String, Object>put(
			...
			HashMapBuilder.<String, Object>put(
				...
				"title", clayListDataSetDisplayView.getTitle()
			).build()
		).build();
	}
