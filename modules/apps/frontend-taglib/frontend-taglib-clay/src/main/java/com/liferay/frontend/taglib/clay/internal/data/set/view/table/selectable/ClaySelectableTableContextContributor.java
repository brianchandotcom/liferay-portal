...
import com.liferay.frontend.taglib.clay.data.set.view.table.selectable.ClaySelectableTableDataSetDisplayView;
 ...
 */
@Component(
	property = "clay.data.set.content.renderer.name=selectableTable",
