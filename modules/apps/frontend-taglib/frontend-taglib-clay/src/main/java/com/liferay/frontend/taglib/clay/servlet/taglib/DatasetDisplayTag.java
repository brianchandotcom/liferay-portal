...
import com.liferay.frontend.taglib.clay.data.set.util.ClayMenuActionItem;
...
public class DatasetDisplayTag extends IncludeTag {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			sb.append("/o/frontend-taglib-app/data-set/");
	...
	protected void setAttributes(HttpServletRequest httpServletRequest) {
		...
		request.setAttribute("clay:dataset-display:module", getModule());
