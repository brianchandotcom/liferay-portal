...
public class PaginationBarTag extends BaseContainerTag {
	...
	public List<PaginationBarDelta> getDeltas() {
		return _deltas;
	}
	...
	public PaginationBarLabels getLabels() {
		return _labels;
	}
	...
	public void setDeltas(List<PaginationBarDelta> deltas) {
		_deltas = deltas;
	}
	...
	public void setLabels(PaginationBarLabels labels) {
		_labels = labels;
	}
	...
	private List<PaginationBarDelta> _deltas;
	private List<Integer> _disabledPages;
	private Integer _ellipsisBuffer;
	private PaginationBarLabels _labels;
