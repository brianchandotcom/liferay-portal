...
/**
 * The base model interface for the FrontendViewStateActiveEntry service. Represents a row in the &quot;FrontendViewStateActiveEntry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.liferay.frontend.view.state.model.impl.FrontendViewStateActiveEntryModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.liferay.frontend.view.state.model.impl.FrontendViewStateActiveEntryImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface FrontendViewStateActiveEntryModel
	extends BaseModel<FrontendViewStateActiveEntry>, ContainerModel, MVCCModel,
			ShardedModel, StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a frontend view state active entry model instance should use the {@link FrontendViewStateActiveEntry} interface instead.
	 */
