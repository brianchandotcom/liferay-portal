...
/**
 * Provides the local service interface for FrontendViewStateEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FrontendViewStateEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FrontendViewStateEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.frontend.view.state.service.impl.FrontendViewStateEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the frontend view state entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FrontendViewStateEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
