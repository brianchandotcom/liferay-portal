...
/**
 * The persistence interface for the frontend view state active entry service.
 *
 * <p>
 ...
 * @see FrontendViewStateActiveEntryUtil
 * @generated
 */
@ProviderType
public interface FrontendViewStateActiveEntryPersistence
	extends BasePersistence<FrontendViewStateActiveEntry> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FrontendViewStateActiveEntryUtil} to access the frontend view state active entry persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<FrontendViewStateActiveEntry> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<FrontendViewStateActiveEntry> findByUuid(
	...
	public java.util.List<FrontendViewStateActiveEntry> findByUuid(
		...
		com.liferay.portal.kernel.util.OrderByComparator
			<FrontendViewStateActiveEntry> orderByComparator);
	 ...
	 */
	public FrontendViewStateActiveEntry findByUuid_First(
			String uuid,
			com.liferay.portal.kernel.util.OrderByComparator
				<FrontendViewStateActiveEntry> orderByComparator)
	 ...
	 */
	public FrontendViewStateActiveEntry fetchByUuid_First(
		String uuid,
		com.liferay.portal.kernel.util.OrderByComparator
			<FrontendViewStateActiveEntry> orderByComparator);
	 ...
	 * @throws NoSuchActiveEntryException if a matching frontend view state active entry could not be found
	 */
	public FrontendViewStateActiveEntry findByUuid_Last(
			String uuid,
			com.liferay.portal.kernel.util.OrderByComparator
				<FrontendViewStateActiveEntry> orderByComparator)
		throws NoSuchActiveEntryException;
	 ...
	 */
	public FrontendViewStateActiveEntry fetchByUuid_Last(
		String uuid,
		com.liferay.portal.kernel.util.OrderByComparator
			<FrontendViewStateActiveEntry> orderByComparator);
	 ...
	 */
	public FrontendViewStateActiveEntry[] findByUuid_PrevAndNext(
	 ...
	 * @return the matching frontend view state active entries
	 */
	public java.util.List<FrontendViewStateActiveEntry> findByUuid_C(
	 ...
	 * @throws NoSuchActiveEntryException if a matching frontend view state active entry could not be found
	 */
	public FrontendViewStateActiveEntry findByUuid_C_First(
			String uuid, long companyId,
			com.liferay.portal.kernel.util.OrderByComparator
				<FrontendViewStateActiveEntry> orderByComparator)
		throws NoSuchActiveEntryException;
	 ...
	 * @return the first matching frontend view state active entry, or <code>null</code> if a matching frontend view state active entry could not be found
	 */
	public FrontendViewStateActiveEntry fetchByUuid_C_First(
		String uuid, long companyId,
		com.liferay.portal.kernel.util.OrderByComparator
			<FrontendViewStateActiveEntry> orderByComparator);
	 ...
	 * @throws NoSuchActiveEntryException if a matching frontend view state active entry could not be found
	 */
	public FrontendViewStateActiveEntry findByUuid_C_Last(
			String uuid, long companyId,
			com.liferay.portal.kernel.util.OrderByComparator
				<FrontendViewStateActiveEntry> orderByComparator)
		throws NoSuchActiveEntryException;
	 ...
	 * @return the last matching frontend view state active entry, or <code>null</code> if a matching frontend view state active entry could not be found
	 */
	public FrontendViewStateActiveEntry fetchByUuid_C_Last(
		String uuid, long companyId,
		com.liferay.portal.kernel.util.OrderByComparator
			<FrontendViewStateActiveEntry> orderByComparator);
	 ...
	 * @throws NoSuchActiveEntryException if a frontend view state active entry with the primary key could not be found
	 */
	public FrontendViewStateActiveEntry[] findByUuid_C_PrevAndNext(
	 ...
	 * @throws NoSuchActiveEntryException if a matching frontend view state active entry could not be found
	 */
	public FrontendViewStateActiveEntry findByU_D_P_P(
	 ...
	 */
	public FrontendViewStateActiveEntry fetchByU_D_P_P(
		long userId, String datasetDisplayId, long plid, String portletId);
	 ...
	 */
	public FrontendViewStateActiveEntry removeByU_D_P_P(
			long userId, String datasetDisplayId, long plid, String portletId)
		throws NoSuchActiveEntryException;
	 ...
	 */
	public void cacheResult(
		java.util.List<FrontendViewStateActiveEntry>
			frontendViewStateActiveEntries);
	 ...
	 */
	public FrontendViewStateActiveEntry create(
	 ...
	 * @throws NoSuchActiveEntryException if a frontend view state active entry with the primary key could not be found
	 */
	public FrontendViewStateActiveEntry remove(
			long frontendViewStateActiveEntryId)
		throws NoSuchActiveEntryException;

	public FrontendViewStateActiveEntry updateImpl(
		FrontendViewStateActiveEntry frontendViewStateActiveEntry);
	 ...
	 * @throws NoSuchActiveEntryException if a frontend view state active entry with the primary key could not be found
	 */
	public FrontendViewStateActiveEntry findByPrimaryKey(
			long frontendViewStateActiveEntryId)
		throws NoSuchActiveEntryException;
	 ...
	 */
	public FrontendViewStateActiveEntry fetchByPrimaryKey(
		long frontendViewStateActiveEntryId);
	 ...
	 */
	public java.util.List<FrontendViewStateActiveEntry> findAll();
