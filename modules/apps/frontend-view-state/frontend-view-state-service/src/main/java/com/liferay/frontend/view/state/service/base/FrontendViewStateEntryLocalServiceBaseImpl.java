...
/**
 * Provides the base implementation for the frontend view state entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.frontend.view.state.service.impl.FrontendViewStateEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.frontend.view.state.service.impl.FrontendViewStateEntryLocalServiceImpl
 * @generated
 */
public abstract class FrontendViewStateEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FrontendViewStateEntryLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FrontendViewStateEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FrontendViewStateEntryLocalServiceUtil</code>.
	 */
	...
	@Override
	public FrontendViewStateEntry addFrontendViewStateEntry(
		FrontendViewStateEntry frontendViewStateEntry) {

		frontendViewStateEntry.setNew(true);

		return frontendViewStateEntryPersistence.update(frontendViewStateEntry);
	}
	...
	public FrontendViewStateEntry createFrontendViewStateEntry(
		...
		return frontendViewStateEntryPersistence.create(
	...
	@Override
	public FrontendViewStateEntry deleteFrontendViewStateEntry(
			long frontendViewStateEntryId)
		throws PortalException {

		return frontendViewStateEntryPersistence.remove(
			frontendViewStateEntryId);
	}
	...
	public FrontendViewStateEntry deleteFrontendViewStateEntry(
		...
		return frontendViewStateEntryPersistence.remove(frontendViewStateEntry);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return frontendViewStateEntryPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FrontendViewStateEntry.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return frontendViewStateEntryPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return frontendViewStateEntryPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public FrontendViewStateEntry fetchFrontendViewStateEntry(
		long frontendViewStateEntryId) {

		return frontendViewStateEntryPersistence.fetchByPrimaryKey(
			frontendViewStateEntryId);
	}
	 ...
	 */
	@Override
	public FrontendViewStateEntry fetchFrontendViewStateEntryByUuidAndCompanyId(
		String uuid, long companyId) {

		return frontendViewStateEntryPersistence.fetchByUuid_C_First(
			uuid, companyId, null);
	}
	...
	public FrontendViewStateEntry getFrontendViewStateEntry(
		...
		return frontendViewStateEntryPersistence.findByPrimaryKey(
			frontendViewStateEntryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(FrontendViewStateEntry.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, frontendViewStateEntry);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					FrontendViewStateEntry.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return frontendViewStateEntryLocalService.deleteFrontendViewStateEntry(
			(FrontendViewStateEntry)persistedModel);
	}

	@Override
	public BasePersistence<FrontendViewStateEntry> getBasePersistence() {
		return frontendViewStateEntryPersistence;
	}
	 ...
	 */
	@Override
	public FrontendViewStateEntry getFrontendViewStateEntryByUuidAndCompanyId(
			String uuid, long companyId)
		throws PortalException {

		return frontendViewStateEntryPersistence.findByUuid_C_First(
			uuid, companyId, null);
	}
	 ...
	 */
	@Override
	public List<FrontendViewStateEntry> getFrontendViewStateEntries(
		int start, int end) {

		return frontendViewStateEntryPersistence.findAll(start, end);
	}
	...
	public int getFrontendViewStateEntriesCount() {
		return frontendViewStateEntryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FrontendViewStateEntry updateFrontendViewStateEntry(
		FrontendViewStateEntry frontendViewStateEntry) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FrontendViewStateEntryLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		frontendViewStateEntryLocalService =
			(FrontendViewStateEntryLocalService)aopProxy;

		_setLocalServiceUtilService(frontendViewStateEntryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FrontendViewStateEntryLocalService.class.getName();
	}
	...
	protected String getModelClassName() {
		return FrontendViewStateEntry.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				frontendViewStateEntryPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				FrontendViewStateEntryLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, frontendViewStateEntryLocalService);
		}
	...
	@Reference
	protected FrontendViewStateEntryPersistence
