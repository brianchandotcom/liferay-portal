...
package com.liferay.headless.blog.rest.impl.resource;
...
import com.liferay.headless.aggregate.rating.rest.api.identifier.AggregateRatingId;
...
import com.liferay.headless.blog.rest.api.identifier.BlogsEntryId;
import com.liferay.headless.blog.rest.impl.form.BlogPostingForm;
...
public class BlogPostingNestedCollectionResource
	implements NestedCollectionResource<BlogsEntry, Long, BlogsEntryId, Long,
		WebSiteId> {
	...
	public Representor<BlogsEntry, Long> representor(
		...
		return builder.types(
			...
			"aggregateRating", AggregateRatingId.class,
