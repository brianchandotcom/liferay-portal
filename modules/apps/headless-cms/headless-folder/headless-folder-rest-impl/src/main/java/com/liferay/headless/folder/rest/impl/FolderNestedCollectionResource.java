...
package com.liferay.headless.folder.rest.impl;
...
import com.liferay.headless.folder.rest.impl.form.FolderForm;
...
public class FolderNestedCollectionResource
	implements
		NestedCollectionResource<DLFolder, Long, DLFolderId,
			Long, WebSiteId> {
	...
	public Representor<DLFolder, Long> representor(
		...
		return builder.types(
			...
			"webSite", "folders", WebSiteId.class, DLFolderModel::getGroupId
		).addDate(
