...
package com.liferay.headless.media.object.rest.impl.resource;
...
import com.liferay.headless.apio.api.auth.MockPermissions;
import com.liferay.headless.folder.rest.api.identifier.DLFolderId;
import com.liferay.headless.media.object.rest.api.identifier.DLFileEntryId;
import com.liferay.headless.person.rest.api.identifier.PersonId;
...
public class MediaObjectNestedCollectionResource
	implements NestedCollectionResource<DLFileEntry, Long, DLFileEntryId, Long,
		DLFolderId> {
	...
	public Representor<DLFileEntry, Long> representor(
		...
		return builder.types(
			...
			"folder", "mediaObjects", DLFolderId.class,
			...
			"author", PersonId.class, this::_getUserOptional
		).addNumber(
	...
	private long _getDLFolderOptional(DLFileEntry dlFileEntry) {
	...
	private long _getUserOptional(DLFileEntry dlFileEntry) {
