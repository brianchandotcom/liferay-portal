...
package com.liferay.headless.web.page.element.rest.impl.resource;
...
import com.liferay.headless.web.page.element.rest.api.identifier.JournalArticleId;
import com.liferay.headless.web.page.element.rest.impl.form.WebPageElementCreatorForm;
import com.liferay.headless.web.page.element.rest.impl.form.WebPageElementUpdaterForm;
...
public class WebPageElementNestedCollectionResource
	implements
		NestedCollectionResource<JournalArticle, Long,
			JournalArticleId, Long, WebSiteId> {
	...
	public Representor<JournalArticle, Long> representor(
		...
		return builder.types(
			...
			"webSite", "webPageElements", WebSiteId.class,
			this::_getWebSiteOptional
		).addDate(
			...
			"creator", PersonId.class, this::_getUserOptional
		).addString(
	...
	private Long _getWebSiteOptional(JournalArticle journalArticle) {
