...
public class CountryResourceTest extends BaseCountryResourceTestCase {
	...
	private void _testGetCountriesPageWithFilter() throws Exception {
		...
		// Sleep for 1 second to ensure that country1 and country2 are created
		// 1 second apart
		...
		country1.setName(keyword + country1.getName());
		...
		country2.setName(keyword + country2.getName());
		...
		page = countryResource.getCountriesPage(
			null, keyword,
			"dateCreated ge " + dateFormat.format(country1.getDateModified()),
			Pagination.of(1, 2), null);

		Assert.assertEquals(2, page.getTotalCount());

		// Sleep for 1 second to ensure that country1 and country2 are modified
		// 1 second apart
