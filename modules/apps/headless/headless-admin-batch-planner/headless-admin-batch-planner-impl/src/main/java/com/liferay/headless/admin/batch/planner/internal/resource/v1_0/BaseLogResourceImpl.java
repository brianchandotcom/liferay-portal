...
public abstract class BaseLogResourceImpl implements LogResource {
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-admin-batch-planner/v1.0/plans/{id}/logs'  -u 'test@liferay.com:test'
	 */
	@GET
	@Operation(description = "Retrieves the plan logs.")
	@Override
	@Parameters(
		value = {
