...
public abstract class BasePlanResourceImpl implements PlanResource {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-admin-batch-planner/v1.0/plans/{id}'  -u 'test@liferay.com:test'
	 */
	@DELETE
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-admin-batch-planner/v1.0/plans/{id}'  -u 'test@liferay.com:test'
	 */
	@GET
	@Operation(description = "Retrieves the plan.")
	@Override
	@Parameters(value = {@Parameter(in = ParameterIn.PATH, name = "id")})
	@Path("/plans/{id}")
	@Produces({"application/json", "application/xml"})
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PATCH' 'http://localhost:8080/o/headless-admin-batch-planner/v1.0/plans/{id}' -d $'{"active": ___, "export": ___, "externalType": ___, "externalURL": ___, "id": ___, "internalClassName": ___, "mappings": ___, "name": ___, "policies": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@Consumes({"application/json", "application/xml"})
