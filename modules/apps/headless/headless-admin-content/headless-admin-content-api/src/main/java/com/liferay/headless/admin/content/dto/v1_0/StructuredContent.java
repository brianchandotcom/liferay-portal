...
public class StructuredContent {
	...
	@Schema(
		description = "Information on each version of this structured content"
	)
	@Valid
	...
	public void setVersionInformation(
		UnsafeSupplier<VersionInformation, Exception>
			versionInformationUnsafeSupplier) {

		try {
			versionInformation = versionInformationUnsafeSupplier.get();
		}
		catch (RuntimeException re) {
			throw re;
		}
	...
	public String toString() {
		...
		if (versionInformation != null) {
			...
			sb.append(String.valueOf(versionInformation));
		}
	...
	@Schema(
		defaultValue = "com.liferay.headless.admin.content.dto.v1_0.StructuredContent",
		name = "x-class-name"
	)
