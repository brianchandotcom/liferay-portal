 ...
 */
@Generated("")
@GraphQLName("VersionInformation")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "VersionInformation")
public class VersionInformation {

	public static VersionInformation toDTO(String json) {
		return ObjectMapperUtil.readValue(VersionInformation.class, json);
	}
	...
	@Schema(
		defaultValue = "com.liferay.headless.admin.content.dto.v1_0.VersionInformation",
		name = "x-class-name"
	)
