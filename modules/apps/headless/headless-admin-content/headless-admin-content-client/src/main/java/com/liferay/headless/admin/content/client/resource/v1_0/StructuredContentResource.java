...
public interface StructuredContentResource {
	...
	public HttpInvoker.HttpResponse deleteStructuredContentVersionHttpResponse(
			Long structuredContentId, Double versionId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getStructuredContentVersionHttpResponse(
			Long structuredContentId, Double versionId)
		throws Exception;
	...
	public static class StructuredContentResourceImpl
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-admin-content/v1.0/structured-contents/{structuredContentId}/versions/{versionId}");

			httpInvoker.path("structuredContentId", structuredContentId);
			httpInvoker.path("versionId", versionId);
		...
		public StructuredContent getStructuredContentVersion(
			...
			HttpInvoker.HttpResponse httpResponse =
				getStructuredContentVersionHttpResponse(
					structuredContentId, versionId);
