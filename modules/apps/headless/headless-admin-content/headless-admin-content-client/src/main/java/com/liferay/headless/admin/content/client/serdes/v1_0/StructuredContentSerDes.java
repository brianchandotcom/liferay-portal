...
import com.liferay.headless.admin.content.client.dto.v1_0.ContentTemplate;
...
public class StructuredContentSerDes {
	...
	public static String toJSON(StructuredContent structuredContent) {
		...
		if (structuredContent.getVersionInformation() != null) {
			...
			sb.append(
				String.valueOf(structuredContent.getVersionInformation()));
		}
	...
	public static Map<String, String> toMap(
		...
		if (structuredContent.getVersionInformation() == null) {
			map.put("versionInformation", null);
		}
		else {
			map.put(
				"versionInformation",
			...
			if (Objects.equals(jsonParserFieldName, "actions")) {
				...
				if (jsonParserFieldValue != null) {
					structuredContent.setUuid((String)jsonParserFieldValue);
						...
						jsonParserFieldName, "versionInformation")) {

				if (jsonParserFieldValue != null) {
					structuredContent.setVersionInformation(
						VersionInformationSerDes.toDTO(
							(String)jsonParserFieldValue));
				}
			}
