...
import com.liferay.headless.admin.content.internal.dto.v1_0.extension.StructuredContentVersionInformation;
	...
	public class StructuredContentVersionInformationTypeExtension {
		...
		public VersionInformation versionInformation() {
			if (_structuredContent instanceof
					StructuredContentVersionInformation) {

				StructuredContentVersionInformation
					structuredContentVersionInformation =
						(StructuredContentVersionInformation)_structuredContent;

				return structuredContentVersionInformation.
