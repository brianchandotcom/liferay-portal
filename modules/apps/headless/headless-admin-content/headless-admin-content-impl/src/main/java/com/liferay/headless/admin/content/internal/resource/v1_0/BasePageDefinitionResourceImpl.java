...
public abstract class BasePageDefinitionResourceImpl
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-admin-content/v1.0/sites/{siteId}/page-definitions/preview' -d $'{"pageElement": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@Override
