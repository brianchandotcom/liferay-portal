...
public abstract class BaseStructuredContentResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-admin-content/v1.0/structured-contents/{structuredContentId}/versions/{versionId}'  -u 'test@liferay.com:test'
	 */
	@DELETE
	@Operation(
	...
	@Parameters(
		value = {
			@Parameter(in = ParameterIn.PATH, name = "structuredContentId"),
			@Parameter(in = ParameterIn.PATH, name = "versionId")
		}
	)
	@Path("/structured-contents/{structuredContentId}/versions/{versionId}")
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "StructuredContent")})
	public void deleteStructuredContentVersion(
			@NotNull @Parameter(hidden = true) @PathParam("structuredContentId")
				Long structuredContentId,
			@NotNull @Parameter(hidden = true) @PathParam("versionId") Double
				versionId)
		throws Exception {
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-admin-content/v1.0/structured-contents/{structuredContentId}/versions/{versionId}'  -u 'test@liferay.com:test'
	 */
	@GET
	...
	public com.liferay.headless.delivery.dto.v1_0.StructuredContent
			getStructuredContentVersion(
				...
				@PathParam("structuredContentId")
				Long structuredContentId,
				@NotNull @Parameter(hidden = true) @PathParam("versionId")
					Double versionId)
		throws Exception {
