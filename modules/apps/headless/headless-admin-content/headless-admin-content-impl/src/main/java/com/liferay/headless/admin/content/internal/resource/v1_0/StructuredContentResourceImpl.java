...
public class StructuredContentResourceImpl
	...
	public Page<StructuredContent> getStructuredContentsVersionsPage(
		...
		List<JournalArticle> journalArticleVersions =
		...
		for (JournalArticle journalArticleVersion : journalArticleVersions) {
			structuredContents.add(
				_toExtensionStructuredContent(journalArticleVersion));
		}
