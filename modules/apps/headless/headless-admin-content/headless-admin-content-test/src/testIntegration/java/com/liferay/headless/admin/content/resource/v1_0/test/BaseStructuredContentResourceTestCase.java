...
public abstract class BaseStructuredContentResourceTestCase {
	...
	@Test
	public void testGetStructuredContentsVersionsPageWithFilterDateTimeEquals()
		throws Exception {
		...
		structuredContent1 =
			testGetStructuredContentsVersionsPage_addStructuredContent(
				structuredContentId, structuredContent1);
	...
	@Test
	public void testGetStructuredContentsVersionsPageWithFilterStringEquals()
		throws Exception {
	...
	@Test
	public void testGetStructuredContentsVersionsPageWithPagination()
		throws Exception {
		...
		Page<StructuredContent> page2 =
			structuredContentResource.getStructuredContentsVersionsPage(
				structuredContentId, null, null, null, Pagination.of(2, 2),
				null);
		...
		Page<StructuredContent> page3 =
			structuredContentResource.getStructuredContentsVersionsPage(
				structuredContentId, null, null, null, Pagination.of(1, 3),
				null);
	...
	@Test
	public void testGetStructuredContentsVersionsPageWithSortDateTime()
		throws Exception {

		testGetStructuredContentsVersionsPageWithSort(
			EntityField.Type.DATE_TIME,
	...
	@Test
	public void testGetStructuredContentsVersionsPageWithSortInteger()
		throws Exception {
	...
	@Test
	public void testGetStructuredContentsVersionsPageWithSortString()
		throws Exception {
	...
	protected void testGetStructuredContentsVersionsPageWithSort(
		...
		structuredContent2 =
			testGetStructuredContentsVersionsPage_addStructuredContent(
				structuredContentId, structuredContent2);
	...
	protected void assertValid(StructuredContent structuredContent) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
					"versionInformation", additionalAssertFieldName)) {

				if (structuredContent.getVersionInformation() == null) {
					valid = false;
				}
	...
	protected boolean equals(
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
				...
				if (!Objects.deepEquals(
						structuredContent1.getVersionInformation(),
						structuredContent2.getVersionInformation())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("versionInformation")) {
			throw new IllegalArgumentException(
				"Invalid entity field " + entityFieldName);
		}
