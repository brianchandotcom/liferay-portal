...
public class LocalizationConfig implements Serializable {
	...
	public FragmentInlineValue
		...
		if (_unlocalizedFieldsMessageFragmentInlineValueSupplier != null) {
			unlocalizedFieldsMessageFragmentInlineValue =
				_unlocalizedFieldsMessageFragmentInlineValueSupplier.get();

			_unlocalizedFieldsMessageFragmentInlineValueSupplier = null;
		}
	...
	public void setUnlocalizedFieldsMessageFragmentInlineValue(
		...
		_unlocalizedFieldsMessageFragmentInlineValueSupplier = () -> {
			try {
				return unlocalizedFieldsMessageFragmentInlineValueUnsafeSupplier.
					get();
			}
	...
	public String toString() {
		...
		if (unlocalizedFieldsMessageFragmentInlineValue != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(
				String.valueOf(unlocalizedFieldsMessageFragmentInlineValue));
		}
...
// LIFERAY-REST-BUILDER-HASH:-1365856371