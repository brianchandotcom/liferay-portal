...
public class Query {
	 ...
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query":"query {getKeyword(keywordId:___){creator, dateCreated, dateModified, id, keywordUsageCount, name, siteId}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	 ...
	 *
	 * or a CURL request like:
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query":"query {getSiteKeywordsPage(siteId:___, search:___, filter:___, pageSize:___, page:___, sorts:___){page, pageSize, totalCount, items {__}}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	 ...
	 *
	 * or a CURL request like:
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query":"query {getTaxonomyCategoryTaxonomyCategoriesPage(parentTaxonomyCategoryId:___, search:___, filter:___, pageSize:___, page:___, sorts:___){page, pageSize, totalCount, items {__}}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	 ...
	 *
	 * or a CURL request like:
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query":"query {getTaxonomyCategory(taxonomyCategoryId:___){availableLanguages, creator, dateCreated, dateModified, description, id, name, numberOfTaxonomyCategories, parentTaxonomyCategory, parentTaxonomyVocabulary, viewableBy}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	 ...
	 *
	 * or a CURL request like:
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query":"query {getTaxonomyVocabularyTaxonomyCategoriesPage(taxonomyVocabularyId:___, search:___, filter:___, pageSize:___, page:___, sorts:___){page, pageSize, totalCount, items {__}}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	 ...
	 *
	 * or a CURL request like:
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query":"query {getSiteTaxonomyVocabulariesPage(siteId:___, search:___, filter:___, pageSize:___, page:___, sorts:___){page, pageSize, totalCount, items {__}}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	 ...
	 *
	 * or a CURL request like:
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query":"query {getTaxonomyVocabulary(taxonomyVocabularyId:___){assetTypes, availableLanguages, creator, dateCreated, dateModified, description, id, name, numberOfTaxonomyCategories, siteId, viewableBy}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
