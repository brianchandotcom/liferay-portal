...
public abstract class BaseKeywordResourceImpl
	...
	@Override
	@Parameters(value = {@Parameter(in = ParameterIn.PATH, name = "keywordId")})
	@Path("/keywords/{keywordId}/subscribe")
	@Produces({"application/json", "application/xml"})
	@PUT
	@Tags(value = {@Tag(name = "Keyword")})
	...
	@Override
	@Parameters(value = {@Parameter(in = ParameterIn.PATH, name = "keywordId")})
	@Path("/keywords/{keywordId}/unsubscribe")
	@Produces({"application/json", "application/xml"})
	@PUT
	@Tags(value = {@Tag(name = "Keyword")})
	...
	public void create(
		...
		UnsafeConsumer<Keyword, Exception> keywordConsumer = keyword -> {
		};

		if (parameters.containsKey("assetLibraryId")) {
			keywordConsumer = keyword -> postAssetLibraryKeyword(
				(Long)parameters.get("assetLibraryId"), keyword);
		}
		else if (parameters.containsKey("siteId")) {
			keywordConsumer = keyword -> postSiteKeyword(
