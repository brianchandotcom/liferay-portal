...
public abstract class BaseSiteResourceImpl
	implements SiteResource, BatchEngineTaskItemDelegate<Site>,
			   EntityModelResource {
	...
	@Override
	public com.liferay.batch.engine.pagination.Page<Site> read(
			Filter filter,
	...
	protected void preparePatch(Site site, Site existingSite) {
	}
