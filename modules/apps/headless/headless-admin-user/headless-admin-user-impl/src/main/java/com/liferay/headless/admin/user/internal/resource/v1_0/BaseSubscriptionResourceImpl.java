...
public abstract class BaseSubscriptionResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-admin-user/v1.0/subscriptions'  -u 'test@liferay.com:test'
	 */
	@Override
	@GET
	@Parameters(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-admin-user/v1.0/subscriptions/{subscriptionId}'  -u 'test@liferay.com:test'
	 */
	@Override
	@DELETE
	@Parameters(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-admin-user/v1.0/subscriptions/{subscriptionId}'  -u 'test@liferay.com:test'
	 */
	@Override
	@GET
	@Parameters(
