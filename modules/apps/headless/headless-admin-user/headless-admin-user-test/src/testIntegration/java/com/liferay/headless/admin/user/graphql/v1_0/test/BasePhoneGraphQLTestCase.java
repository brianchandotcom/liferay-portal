...
public abstract class BasePhoneGraphQLTestCase {
	...
	public void testGetPhone() throws Exception {
		...
		JSONObject jsonObject = dataJSONObject.getJSONObject("getPhone");

		Assert.assertTrue(equals(postPhone, jsonObject));
	}
	...
	protected boolean equals(Phone phone, JSONObject jsonObject) {
		...
		for (String field : fields) {
			if (Objects.equals("extension", field)) {
				if (!Objects.equals(
						phone.getExtension(),
			...
			if (Objects.equals("phoneNumber", field)) {
				if (!Objects.equals(
			...
			if (Objects.equals("phoneType", field)) {
				if (!Objects.equals(
						phone.getPhoneType(),
