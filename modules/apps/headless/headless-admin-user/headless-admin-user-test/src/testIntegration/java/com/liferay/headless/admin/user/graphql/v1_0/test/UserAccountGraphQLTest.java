...
public class UserAccountGraphQLTest extends BaseUserAccountGraphQLTestCase {
	...
	public void testGetUserAccountsPage() throws Exception {
		...
		List<GraphQLField> pageGraphQLFields = new ArrayList<>();

		pageGraphQLFields.add(new GraphQLField("page"));
		pageGraphQLFields.add(new GraphQLField("totalCount"));
		pageGraphQLFields.add(
			new GraphQLField(
				"items", graphQLFields.toArray(new GraphQLField[0])));
		...
		GraphQLField graphQLField = new GraphQLField(
			...
			new GraphQLField(
				...
				pageGraphQLFields.toArray(new GraphQLField[0])));
