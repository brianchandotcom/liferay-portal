...
public abstract class BaseSubscriptionResourceTestCase {
	...
	@Test
	public void testGetSubscriptionsPage() throws Exception {
		Page<Subscription> page = subscriptionResource.getSubscriptionsPage(
			RandomTestUtil.randomString(), Pagination.of(1, 2));

		Assert.assertEquals(0, page.getTotalCount());

		Subscription subscription1 = testGetSubscriptionsPage_addSubscription(
			randomSubscription());

		Subscription subscription2 = testGetSubscriptionsPage_addSubscription(
			randomSubscription());

		page = subscriptionResource.getSubscriptionsPage(
		...
		subscriptionResource.deleteSubscription(subscription1.getId());

		subscriptionResource.deleteSubscription(subscription2.getId());
	}

	@Test
	public void testGetSubscriptionsPageWithPagination() throws Exception {
		Subscription subscription1 = testGetSubscriptionsPage_addSubscription(
			randomSubscription());
		...
		Subscription subscription3 = testGetSubscriptionsPage_addSubscription(
			randomSubscription());

		Page<Subscription> page1 = subscriptionResource.getSubscriptionsPage(
			null, Pagination.of(1, 2));
		...
		Page<Subscription> page2 = subscriptionResource.getSubscriptionsPage(
		...
		Page<Subscription> page3 = subscriptionResource.getSubscriptionsPage(
	...
	protected Subscription testGetSubscriptionsPage_addSubscription(
	...
	@Test
	public void testGraphQLGetSubscriptionsPage() throws Exception {
		...
		JSONObject subscriptionsJSONObject = dataJSONObject.getJSONObject(
			"subscriptions");

		Assert.assertEquals(0, subscriptionsJSONObject.get("totalCount"));

		Subscription subscription1 = testGraphQLSubscription_addSubscription();
		Subscription subscription2 = testGraphQLSubscription_addSubscription();
		...
		subscriptionsJSONObject = dataJSONObject.getJSONObject("subscriptions");

		Assert.assertEquals(2, subscriptionsJSONObject.get("totalCount"));

		assertEqualsJSONArray(
			Arrays.asList(subscription1, subscription2),
			subscriptionsJSONObject.getJSONArray("items"));
	}

	@Test
	public void testDeleteSubscription() throws Exception {
		Subscription subscription = testDeleteSubscription_addSubscription();

		assertHttpResponseStatusCode(
			204,
			subscriptionResource.deleteSubscriptionHttpResponse(
				subscription.getId()));

		assertHttpResponseStatusCode(
			404,
			subscriptionResource.getSubscriptionHttpResponse(
				subscription.getId()));

		assertHttpResponseStatusCode(
			404, subscriptionResource.getSubscriptionHttpResponse(0L));
	}

	protected Subscription testDeleteSubscription_addSubscription()
		throws Exception {
	...
	@Test
	public void testGraphQLDeleteSubscription() throws Exception {
		...
		Assert.assertTrue(dataJSONObject.getBoolean("deleteSubscription"));
	...
	public void testGetSubscription() throws Exception {
		Subscription postSubscription = testGetSubscription_addSubscription();

		Subscription getSubscription = subscriptionResource.getSubscription(
	...
	protected Subscription testGetSubscription_addSubscription()
		throws Exception {
	...
	@Test
	public void testGraphQLGetSubscription() throws Exception {
		Subscription subscription = testGraphQLSubscription_addSubscription();
		...
		Assert.assertTrue(
			equalsJSONObject(
				subscription, dataJSONObject.getJSONObject("subscription")));
	}
