 ...
 */
@Generated("")
@GraphQLName("WorkflowTaskAssignableUsersBag")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "WorkflowTaskAssignableUsersBag")
public class WorkflowTaskAssignableUsersBag {
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof WorkflowTaskAssignableUsersBag)) {
			return false;
		}

		WorkflowTaskAssignableUsersBag workflowTaskAssignableUsersBag =
			(WorkflowTaskAssignableUsersBag)object;

		return Objects.equals(
			toString(), workflowTaskAssignableUsersBag.toString());
	}
	...
	@Schema(
		defaultValue = "com.liferay.headless.admin.workflow.dto.v1_0.WorkflowTaskAssignableUsersBag",
		name = "x-class-name"
	)
