...
@Generated("")
@Path("/v1.0")
public abstract class BaseWorkflowTaskAssignableUsersBagResourceImpl
	implements WorkflowTaskAssignableUsersBagResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-admin-workflow/v1.0/workflow-tasks/assignable-users-bag'  -u 'test@liferay.com:test'
	 */
	@Override
	@GET
	@Parameters(
	...
	@Path("/workflow-tasks/assignable-users-bag")
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "WorkflowTaskAssignableUsersBag")})
	...
	protected void preparePatch(
		...
		WorkflowTaskAssignableUsersBag existingWorkflowTaskAssignableUsersBag) {
	}
