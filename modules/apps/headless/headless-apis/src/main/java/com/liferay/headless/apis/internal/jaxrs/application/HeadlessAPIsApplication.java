...
package com.liferay.headless.apis.internal.jaxrs.application;

import com.liferay.headless.apis.internal.dto.Hint;
import com.liferay.headless.apis.internal.dto.Resource;
import com.liferay.headless.apis.internal.dto.Resources;
...
@Component(
	property = {
		JaxrsWhiteboardConstants.JAX_RS_APPLICATION_BASE + "=/apis",
		JaxrsWhiteboardConstants.JAX_RS_EXTENSION_SELECT + "=(osgi.jaxrs.name=Liferay.Vulcan)",
		JaxrsWhiteboardConstants.JAX_RS_NAME + "=Liferay.Headless.APIs"
	},
	service = Application.class
)
public class HeadlessAPIsApplication extends Application {
	...
	private Map<String, List<ResourceMethodInfoDTO>>
		...
		String serverURL = StringUtil.replace(absolutePath, "/apis/", "");
