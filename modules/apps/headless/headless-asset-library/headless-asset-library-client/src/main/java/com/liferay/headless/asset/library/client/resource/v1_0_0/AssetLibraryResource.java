...
import com.liferay.headless.asset.library.client.dto.v1_0_0.AssetLibrary;
...
import com.liferay.headless.asset.library.client.serdes.v1_0_0.AssetLibrarySerDes;
	...
	public static class AssetLibraryResourceImpl
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-asset-library/1.0.0/asset-libraries");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-asset-library/1.0.0/asset-libraries/by-external-reference-code/{externalReferenceCode}");
		...
		public HttpInvoker.HttpResponse deleteAssetLibraryHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-asset-library/1.0.0/asset-libraries/{assetLibraryId}");
