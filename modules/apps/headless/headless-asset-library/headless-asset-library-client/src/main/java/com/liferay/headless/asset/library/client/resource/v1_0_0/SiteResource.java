...
import com.liferay.headless.asset.library.client.serdes.v1_0_0.SiteSerDes;
	...
	public static class SiteResourceImpl implements SiteResource {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-asset-library/1.0.0/asset-libraries/by-external-reference-code/{assetLibraryExternalReferenceCode}/sites/by-external-reference-code/{siteExternalReferenceCode}");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-asset-library/1.0.0/asset-libraries/by-external-reference-code/{externalReferenceCode}/sites");
		...
		public HttpInvoker.HttpResponse getAssetLibrarySitesPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-asset-library/1.0.0/asset-libraries/{assetLibraryId}/sites");
		...
		public HttpInvoker.HttpResponse deleteAssetLibrarySiteHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-asset-library/1.0.0/asset-libraries/{assetLibraryId}/sites/{siteId}");
