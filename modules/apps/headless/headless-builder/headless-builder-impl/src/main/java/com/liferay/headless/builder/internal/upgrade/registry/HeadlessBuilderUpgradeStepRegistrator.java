...
import com.liferay.headless.builder.internal.upgrade.v0_2_0.ModifyAPIBuilderListTypeDefinitionsUpgradeProcess;
...
public class HeadlessBuilderUpgradeStepRegistrator
	...
	public void register(Registry registry) {
		...
		registry.register(
			"0.1.0", "0.2.0",
			new ModifyAPIBuilderListTypeDefinitionsUpgradeProcess(
