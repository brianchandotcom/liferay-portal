...
public interface UserAccountResource {
	...
	public HttpInvoker.HttpResponse getProjectAssignableUsersPageHttpResponse(
			Long projectId, String search, Pagination pagination)
		throws Exception;
	...
	public static class UserAccountResourceImpl implements UserAccountResource {
		...
		public Page<UserAccount> getProjectAssignableUsersPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getProjectAssignableUsersPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-cmp/v1.0/projects/{projectId}/assignable-users");
...
// LIFERAY-REST-BUILDER-HASH:-376351446