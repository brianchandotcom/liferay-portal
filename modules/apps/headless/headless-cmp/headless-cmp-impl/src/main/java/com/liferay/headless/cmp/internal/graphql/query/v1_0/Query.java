...
public class Query {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {projectAssignableUsers(page: ___, pageSize: ___, projectId: ___, search: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public UserAccountPage projectAssignableUsers(
			@GraphQLName("projectId") Long projectId,
			@GraphQLName("search") String search,
...
// LIFERAY-REST-BUILDER-HASH:1430586409