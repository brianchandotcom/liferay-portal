...
public abstract class BaseUserAccountResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-cmp/v1.0/projects/{projectId}/assignable-users'  -u 'test@liferay.com:test'
	 */
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/projects/{projectId}/assignable-users")
...
// LIFERAY-REST-BUILDER-HASH:-1468823999