...
public abstract class BaseUserAccountResourceTestCase {
	...
	@Test
	public void testGetProjectAssignableUsersPage() throws Exception {
		Long projectId = testGetProjectAssignableUsersPage_getProjectId();
		Long irrelevantProjectId =
			testGetProjectAssignableUsersPage_getIrrelevantProjectId();

		Page<UserAccount> page =
			userAccountResource.getProjectAssignableUsersPage(
				projectId, null, Pagination.of(1, 10));

		long totalCount = page.getTotalCount();

		if (irrelevantProjectId != null) {
			UserAccount irrelevantUserAccount =
				testGetProjectAssignableUsersPage_addUserAccount(
					irrelevantProjectId, randomIrrelevantUserAccount());

			page = userAccountResource.getProjectAssignableUsersPage(
				irrelevantProjectId, null,
			...
			assertValid(
				page,
				testGetProjectAssignableUsersPage_getExpectedActions(
					irrelevantProjectId));
		}

		UserAccount userAccount1 =
			testGetProjectAssignableUsersPage_addUserAccount(
				projectId, randomUserAccount());
		...
		assertValid(
			page,
			testGetProjectAssignableUsersPage_getExpectedActions(projectId));
	}

	protected Map<String, Map<String, String>>
			testGetProjectAssignableUsersPage_getExpectedActions(Long projectId)
		throws Exception {
	...
	@Test
	public void testGetProjectAssignableUsersPageWithPagination()
		throws Exception {
		...
		if (totalCount >= (pageSizeLimit - 2)) {
			...
			Page<UserAccount> page1 =
				userAccountResource.getProjectAssignableUsersPage(
					projectId, null, Pagination.of(1, totalCount + 2));
			...
			Page<UserAccount> page2 =
				userAccountResource.getProjectAssignableUsersPage(
					projectId, null, Pagination.of(2, totalCount + 2));
			...
			Page<UserAccount> page3 =
				userAccountResource.getProjectAssignableUsersPage(
					projectId, null, Pagination.of(1, (int)totalCount + 3));
	...
	protected UserAccount testGetProjectAssignableUsersPage_addUserAccount(
	...
	protected Long testGetProjectAssignableUsersPage_getProjectId()
		throws Exception {
	...
	protected Long testGetProjectAssignableUsersPage_getIrrelevantProjectId()
		throws Exception {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.headless.cmp.dto.v1_0.UserAccount.class)) {
	...
	@Inject
	private com.liferay.headless.cmp.resource.v1_0.UserAccountResource
		_userAccountResource;

}
// LIFERAY-REST-BUILDER-HASH:-47422018