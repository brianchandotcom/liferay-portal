 ...
 */
@Generated("")
@GraphQLName("EntryDefinition")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "EntryDefinition")
public class EntryDefinition implements Serializable {

	public static EntryDefinition toDTO(String json) {
		return ObjectMapperUtil.readValue(EntryDefinition.class, json);
	}

	public static EntryDefinition unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(EntryDefinition.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.cms.dto.v1_0.EntryDefinition",
		name = "x-class-name"
	)
