 ...
 */
@Generated("")
@GraphQLName("MoveAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "MoveAction")
public class MoveAction extends DocumentBulkAction implements Serializable {

	public static MoveAction toDTO(String json) {
		return ObjectMapperUtil.readValue(MoveAction.class, json);
	}

	public static MoveAction unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(MoveAction.class, json);
	}
	...
	public boolean equals(Object object) {
		...
		return Objects.equals(toString(), moveAction.toString());
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.cms.dto.v1_0.MoveAction",
		name = "x-class-name"
	)
