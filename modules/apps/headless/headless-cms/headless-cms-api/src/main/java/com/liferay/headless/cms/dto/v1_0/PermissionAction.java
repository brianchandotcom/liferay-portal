 ...
 */
@Generated("")
@GraphQLName("PermissionAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "PermissionAction")
public class PermissionAction
	extends DocumentBulkAction implements Serializable {

	public static PermissionAction toDTO(String json) {
		return ObjectMapperUtil.readValue(PermissionAction.class, json);
	}

	public static PermissionAction unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(PermissionAction.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.cms.dto.v1_0.PermissionAction",
		name = "x-class-name"
	)
