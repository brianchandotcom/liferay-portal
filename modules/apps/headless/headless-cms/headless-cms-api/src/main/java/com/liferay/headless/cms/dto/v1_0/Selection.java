...
public class Selection implements Serializable {
	...
	public String getModelClassName() {
		if (_modelClassNameSupplier != null) {
			modelClassName = _modelClassNameSupplier.get();

			_modelClassNameSupplier = null;
		}
	...
	public void setModelClassName(
		...
		_modelClassNameSupplier = () -> {
			try {
				return modelClassNameUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<String> _modelClassNameSupplier;
	...
	public String toString() {
		...
		if (modelClassName != null) {
			...
			sb.append(_escape(modelClassName));
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.cms.dto.v1_0.Selection",
		name = "x-class-name"
	)
