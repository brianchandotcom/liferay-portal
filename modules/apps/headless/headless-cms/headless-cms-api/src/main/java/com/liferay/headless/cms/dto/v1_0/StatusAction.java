 ...
 */
@Generated("")
@GraphQLName("StatusAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "StatusAction")
public class StatusAction extends DocumentBulkAction implements Serializable {

	public static StatusAction toDTO(String json) {
		return ObjectMapperUtil.readValue(StatusAction.class, json);
	}

	public static StatusAction unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(StatusAction.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.cms.dto.v1_0.StatusAction",
		name = "x-class-name"
	)
