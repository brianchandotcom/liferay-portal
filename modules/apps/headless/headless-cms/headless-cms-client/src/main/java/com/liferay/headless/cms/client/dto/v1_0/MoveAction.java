...
import com.liferay.headless.cms.client.serdes.v1_0.MoveActionSerDes;
...
public class MoveAction
	...
	public static MoveAction toDTO(String json) {
		return MoveActionSerDes.toDTO(json);
	}
	...
	@Override
	public MoveAction clone() throws CloneNotSupportedException {
	...
	public String toString() {
		return MoveActionSerDes.toJSON(this);
	}
