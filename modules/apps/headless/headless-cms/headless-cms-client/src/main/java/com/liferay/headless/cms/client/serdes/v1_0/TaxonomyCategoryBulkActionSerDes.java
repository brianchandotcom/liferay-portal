...
public class TaxonomyCategoryBulkActionSerDes {
	...
	public static String toJSON(
		...
		if (taxonomyCategoryBulkAction.getAction() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(taxonomyCategoryBulkAction.getAction());
		...
		if (taxonomyCategoryBulkAction.getSelections() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			for (int i = 0;
				 i < taxonomyCategoryBulkAction.getSelections().length; i++) {

				sb.append(
					String.valueOf(
						taxonomyCategoryBulkAction.getSelections()[i]));

				if ((i + 1) <
						taxonomyCategoryBulkAction.getSelections().length) {
	...
	public static Map<String, String> toMap(
		...
		if (taxonomyCategoryBulkAction.getAction() == null) {
			...
			map.put(
				"action",
				String.valueOf(taxonomyCategoryBulkAction.getAction()));
		}
		...
		if (taxonomyCategoryBulkAction.getSelections() == null) {
			...
			map.put(
				"selections",
				String.valueOf(taxonomyCategoryBulkAction.getSelections()));
		}
	...
	public static class TaxonomyCategoryBulkActionJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "taxonomyCategoryIds")) {
				...
				if (jsonParserFieldValue != null) {
					taxonomyCategoryBulkAction.setAction(
						TaxonomyCategoryBulkAction.Action.create(
				...
				if (jsonParserFieldValue != null) {
					...
					taxonomyCategoryBulkAction.setSelections(selectionsArray);
				}
			}
		}
