...
public abstract class BaseBulkActionResourceTestCase {
	...
	protected void assertEquals(
		TaskReport taskReport1, TaskReport taskReport2) {

		Assert.assertTrue(
			taskReport1 + " does not equal " + taskReport2,
			equals(taskReport1, taskReport2));
	}
	...
	protected void assertValid(TaskReport taskReport) {
		boolean valid = true;
		...
		for (String additionalAssertFieldName :
				getAdditionalTaskReportAssertFieldNames()) {
			...
			if (Objects.equals("result", additionalAssertFieldName)) {
	...
	protected String[] getAdditionalTaskReportAssertFieldNames() {
		return new String[0];
	}
	...
	protected boolean equals(TaskReport taskReport1, TaskReport taskReport2) {
		if (taskReport1 == taskReport2) {
			return true;
		}
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("action", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						taskReport1.getAction(), taskReport2.getAction())) {
			...
			if (Objects.equals("author", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						taskReport1.getAuthor(), taskReport2.getAuthor())) {
			...
			if (Objects.equals("dateCompletion", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						taskReport1.getDateCompletion(),
						taskReport2.getDateCompletion())) {
			...
			if (Objects.equals("dateCreated", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						taskReport1.getDateCreated(),
						taskReport2.getDateCreated())) {
			...
			if (Objects.equals(
				...
				if (!Objects.deepEquals(
						taskReport1.getExternalReferenceCode(),
						taskReport2.getExternalReferenceCode())) {
			...
			if (Objects.equals("id", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						taskReport1.getId(), taskReport2.getId())) {
			...
			if (Objects.equals("numberOfItems", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						taskReport1.getNumberOfItems(),
						taskReport2.getNumberOfItems())) {
			...
			if (Objects.equals("result", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						taskReport1.getResult(), taskReport2.getResult())) {
			...
			if (Objects.equals("type", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						taskReport1.getType(), taskReport2.getType())) {
	...
	protected TaskReport randomTaskReport() throws Exception {
		return new TaskReport() {
			{
				...
				result = RandomTestUtil.randomString();
