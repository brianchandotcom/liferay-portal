...
public class Mutation {
	...
	@GraphQLName("blog-posting-id") Long blogPostingId,@GraphQLName("BlogPosting") BlogPostingImpl blogPostingImpl)
			throws Exception {
	...
	@GraphQLName("content-space-id") Long contentSpaceId,@GraphQLName("BlogPosting") BlogPostingImpl blogPostingImpl)
			throws Exception {

				return (BlogPostingImpl)_getBlogPostingResourceImpl().postContentSpaceBlogPosting(
					contentSpaceId,blogPostingImpl);
	}
	@GraphQLField
	@GraphQLInvokeDetached
	public CommentImpl postBlogPostingComment(
	@GraphQLName("blog-posting-id") Long blogPostingId,@GraphQLName("Comment") CommentImpl commentImpl)
			throws Exception {
	...
	@GraphQLName("comment-id") Long commentId)
			throws Exception {
				...
				return (boolean)_getCommentResourceImpl().deleteComment(
					commentId);
	}
	@GraphQLInvokeDetached
	public CommentImpl putComment(
	@GraphQLName("comment-id") Long commentId,@GraphQLName("Comment") CommentImpl commentImpl)
			throws Exception {
	...
	@GraphQLName("content-space-id") Long contentSpaceId,@GraphQLName("MultipartBody") MultipartBody multipartBody)
			throws Exception {
				...
				return (BlogPostingImageImpl)_getBlogPostingImageResourceImpl().postContentSpaceBlogPostingImage(
