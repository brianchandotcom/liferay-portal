...
import com.liferay.headless.collaboration.dto.ImageObjectCollection;
...
public class ImageObjectResourceImpl implements ImageObjectResource {
	...
	@Override
	public ImageObjectCollection<ImageObject> getImageObjectCollection(
			Pagination pagination, String size)
		throws Exception {

		return new ImageObjectCollection(Collections.emptyList(), 0);
	}
