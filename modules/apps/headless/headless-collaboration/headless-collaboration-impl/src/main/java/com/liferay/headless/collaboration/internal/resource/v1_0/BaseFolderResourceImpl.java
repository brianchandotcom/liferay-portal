...
public abstract class BaseFolderResourceImpl implements FolderResource {
	...
	@Path("/content-space/{content-space-id}/folders")
	...
	public Folder patchFolder(
		...
		if (Validator.isNotNull(folder.getParentFolderId())) {
			existingFolder.setParentFolderId(folder.getParentFolderId());
		}
		...
		if (Validator.isNotNull(folder.getHasKnowledgeBaseArticles())) {
			existingFolder.setHasKnowledgeBaseArticles(
				folder.getHasKnowledgeBaseArticles());
		}
