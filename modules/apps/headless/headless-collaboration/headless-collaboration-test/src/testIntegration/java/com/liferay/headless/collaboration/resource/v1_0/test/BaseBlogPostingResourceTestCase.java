...
public abstract class BaseBlogPostingResourceTestCase {
	...
	protected static class BlogPostingImpl implements BlogPosting {
		...
		public void setArticleBody(
			...
			try {
				articleBody = (String)articleBodyUnsafeSupplier.get();
			}
			catch (Throwable t) {
				throw new RuntimeException(t);
			}
		...
		public void setCaption(
			...
			try {
				caption = (String)captionUnsafeSupplier.get();
			}
			catch (Throwable t) {
				throw new RuntimeException(t);
			}
		...
		public void setFriendlyUrlPath(
			...
			try {
				friendlyUrlPath = (String)friendlyUrlPathUnsafeSupplier.get();
			}
			catch (Throwable t) {
				throw new RuntimeException(t);
			}
		...
		public void setImage(
			...
			try {
				image = (ImageImpl)imageUnsafeSupplier.get();
			}
			catch (Throwable t) {
				throw new RuntimeException(t);
			}
