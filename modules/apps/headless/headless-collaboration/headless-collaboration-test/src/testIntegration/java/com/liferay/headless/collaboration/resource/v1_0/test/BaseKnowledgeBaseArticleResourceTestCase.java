...
public abstract class BaseKnowledgeBaseArticleResourceTestCase {
	...
	public void testGetFolderKnowledgeBaseArticlesPage() throws Exception {
		...
		KnowledgeBaseArticle knowledgeBaseArticle1 =
			testGetFolderKnowledgeBaseArticlesPage_addKnowledgeBaseArticle(
				folderId, randomKnowledgeBaseArticle());
		KnowledgeBaseArticle knowledgeBaseArticle2 =
			testGetFolderKnowledgeBaseArticlesPage_addKnowledgeBaseArticle(
				folderId, randomKnowledgeBaseArticle());

		Page<KnowledgeBaseArticle> page =
			invokeGetFolderKnowledgeBaseArticlesPage(
	...
	@Test
	public void testGetFolderKnowledgeBaseArticlesPageWithPagination()
		throws Exception {
	...
	protected Long testGetFolderKnowledgeBaseArticlesPage_getFolderId()
		throws Exception {
	...
	protected Page<KnowledgeBaseArticle>
		...
		String location =
			_resourceURL +
				_toPath(
					"/folders/{folder-id}/knowledge-base-articles", folderId);
	...
	protected Http.Response invokeGetFolderKnowledgeBaseArticlesPageResponse(
			Long folderId, Pagination pagination)
		throws Exception {
