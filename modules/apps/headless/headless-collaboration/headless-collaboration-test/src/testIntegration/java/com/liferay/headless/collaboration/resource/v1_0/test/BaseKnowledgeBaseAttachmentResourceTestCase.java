...
public abstract class BaseKnowledgeBaseAttachmentResourceTestCase {
	...
	@Test
	public void testGetKnowledgeBaseArticleAttachmentsPage() throws Exception {
		Long knowledgeBaseArticleId =
			testGetKnowledgeBaseArticleAttachmentsPage_getKnowledgeBaseArticleId();

		KnowledgeBaseAttachment knowledgeBaseAttachment1 =
			testGetKnowledgeBaseArticleAttachmentsPage_addKnowledgeBaseAttachment(
		...
		Page<KnowledgeBaseAttachment> page =
			invokeGetKnowledgeBaseArticleAttachmentsPage(
	...
	protected Http.Response
			invokeGetKnowledgeBaseArticleAttachmentsPageResponse(
				Long knowledgeBaseArticleId)
		throws Exception {
	...
	protected KnowledgeBaseAttachment
			testPostKnowledgeBaseArticleAttachment_addKnowledgeBaseAttachment(
				KnowledgeBaseAttachment knowledgeBaseAttachment)
		throws Exception {
	...
	public void testDeleteAttachment() throws Exception {
		KnowledgeBaseAttachment knowledgeBaseAttachment =
			testDeleteAttachment_addKnowledgeBaseAttachment();

		assertResponseCode(
			200,
			invokeDeleteAttachmentResponse(knowledgeBaseAttachment.getId()));

		assertResponseCode(
			404, invokeGetAttachmentResponse(knowledgeBaseAttachment.getId()));
	}
	...
	protected boolean invokeDeleteAttachment(Long attachmentId)
		throws Exception {
		...
		String location =
			_resourceURL +
				_toPath("/attachments/{attachment-id}", attachmentId);
	...
	protected Http.Response invokeDeleteAttachmentResponse(Long attachmentId)
		throws Exception {
	...
	public void testGetAttachment() throws Exception {
		KnowledgeBaseAttachment postKnowledgeBaseAttachment =
			testGetAttachment_addKnowledgeBaseAttachment();

		KnowledgeBaseAttachment getKnowledgeBaseAttachment =
			invokeGetAttachment(postKnowledgeBaseAttachment.getId());
	...
	protected KnowledgeBaseAttachment invokeGetAttachment(Long attachmentId)
		throws Exception {
	...
	protected Http.Response invokeGetAttachmentResponse(Long attachmentId)
		throws Exception {
