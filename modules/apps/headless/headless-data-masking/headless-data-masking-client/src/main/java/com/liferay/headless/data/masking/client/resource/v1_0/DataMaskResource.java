...
public interface DataMaskResource {
	...
	public HttpInvoker.HttpResponse previewDataMaskHttpResponse(
			DataMaskPreviewRequest dataMaskPreviewRequest)
		throws Exception;
	...
	public static class DataMaskResourceImpl implements DataMaskResource {
		...
		public DataMaskPreviewResult previewDataMask(
			...
			HttpInvoker.HttpResponse httpResponse = previewDataMaskHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-data-masking/v1.0/data-masks/preview");
...
// LIFERAY-REST-BUILDER-HASH:1082133164