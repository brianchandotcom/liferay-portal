...
public class ContentSet implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The asset entry subtype of the content set."
	)
	...
	@GraphQLField(description = "The asset entry subtype of the content set.")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The asset entry type of the content set."
	)
	...
	@GraphQLField(description = "The asset entry type of the content set.")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
...
// LIFERAY-REST-BUILDER-HASH:1959086517