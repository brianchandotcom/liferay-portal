 ...
 */
@Generated("")
public class AdaptedImageLiferayPage {

	public AdaptedImage[] getItems() {
		return items;
	}

	public void setItems(AdaptedImage[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<AdaptedImage[], Exception> itemsUnsafeSupplier) {
