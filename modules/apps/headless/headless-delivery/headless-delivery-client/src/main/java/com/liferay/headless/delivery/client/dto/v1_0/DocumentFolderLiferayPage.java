 ...
 */
@Generated("")
public class DocumentFolderLiferayPage {

	public DocumentFolder[] getItems() {
		return items;
	}

	public void setItems(DocumentFolder[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<DocumentFolder[], Exception> itemsUnsafeSupplier) {
	...
	protected DocumentFolder[] items;
