 ...
 */
@Generated("")
public class MessageBoardAttachmentLiferayPage {

	public MessageBoardAttachment[] getItems() {
		return items;
	}

	public void setItems(MessageBoardAttachment[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<MessageBoardAttachment[], Exception>
			itemsUnsafeSupplier) {
	...
	protected MessageBoardAttachment[] items;
