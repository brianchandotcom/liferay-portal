 ...
 */
@Generated("")
public class RatingLiferayPage {

	public Rating[] getItems() {
		return items;
	}

	public void setItems(Rating[] items) {
		this.items = items;
	}

	public void setItems(
		UnsafeSupplier<Rating[], Exception> itemsUnsafeSupplier) {
