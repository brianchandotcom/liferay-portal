...
public class StructuredContentDTOConverter implements DTOConverter {
		...
		return new StructuredContent() {
			{
				...
				contentFields = _toContentFields(
					dtoConverterContext.isAcceptAllLanguages(), journalArticle,
					dtoConverterContext.getLocale(), _dlAppService,
				...
				description = journalArticle.getDescription(
					dtoConverterContext.getLocale());
				descriptions = LocalizedMapUtil.getLocalizedMap(
					dtoConverterContext.isAcceptAllLanguages(),
					journalArticle.getDescriptionMap());
				friendlyUrlPath = journalArticle.getUrlTitle(
					dtoConverterContext.getLocale());
				friendlyUrlPaths = LocalizedMapUtil.getLocalizedMap(
					dtoConverterContext.isAcceptAllLanguages(),
				...
				title = journalArticle.getTitle(
					dtoConverterContext.getLocale());
				titles = LocalizedMapUtil.getLocalizedMap(
					dtoConverterContext.isAcceptAllLanguages(),
	...
	private ContentField _toContentField(
			boolean acceptAllLanguages, DDMFormFieldValue ddmFormFieldValue,
			Locale locale, DLAppService dlAppService, DLURLHelper dlURLHelper,
			JournalArticleService journalArticleService,
		...
		return new ContentField() {
			{
				...
				labels = LocalizedMapUtil.getLocalizedMap(
				...
				nestedContentFields = TransformUtil.transformToArray(
					...
					value -> _toContentField(
						acceptAllLanguages, value, locale, dlAppService,
	...
	private ContentField[] _toContentFields(
			boolean acceptAllLanguages, JournalArticle journalArticle,
			Locale locale, DLAppService dlAppService, DLURLHelper dlURLHelper,
		...
		return TransformUtil.transformToArray(
			...
			aDDMFormFieldValue -> _toContentField(
				acceptAllLanguages, aDDMFormFieldValue, locale, dlAppService,
				dlURLHelper, journalArticleService, layoutLocalService),
			ContentField.class);
	}
			...
			ddmTemplate -> new RenderedContent() {
				{
					...
					templateNames = LocalizedMapUtil.getLocalizedMap(
