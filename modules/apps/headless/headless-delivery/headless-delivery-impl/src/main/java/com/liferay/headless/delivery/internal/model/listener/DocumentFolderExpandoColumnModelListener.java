...
public class DocumentFolderExpandoColumnModelListener
	extends BaseModelListener<ExpandoColumn> {

	@Activate
	public void activate(BundleContext bundleContext) {
		_customFieldsModelListener = new CustomFieldsModelListener(
			bundleContext, _classNameLocalService, DLFolder.class,
			entityFields -> new KnowledgeBaseArticleEntityModel(
