...
public class MessageBoardMessageExpandoColumnModelListener
	extends BaseModelListener<ExpandoColumn> {

	@Activate
	public void activate(BundleContext bundleContext) {
		_customFieldsModelListener = new CustomFieldsModelListener(
			bundleContext, _classNameLocalService, MBMessage.class,
			entityFields -> new MessageBoardMessageEntityModel(
