...
public class MessageBoardSectionExpandoColumnModelListener
	extends BaseModelListener<ExpandoColumn> {

	@Activate
	public void activate(BundleContext bundleContext) {
		_customFieldsModelListener = new CustomFieldsModelListener(
			bundleContext, _classNameLocalService, MBCategory.class,
			entityFields -> new MessageBoardSectionEntityModel(
