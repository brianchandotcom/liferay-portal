...
public class StructuredContentFolderExpandoColumnModelListener
	extends BaseModelListener<ExpandoColumn> {

	@Activate
	public void activate(BundleContext bundleContext) {
		_customFieldsModelListener = new CustomFieldsModelListener(
			bundleContext, _classNameLocalService, JournalFolder.class,
			entityFields -> new StructuredContentFolderEntityModel(
