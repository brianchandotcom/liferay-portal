...
import com.liferay.headless.delivery.dto.v1_0.KnowledgeBaseFolder.ViewableBy;
...
public abstract class BaseKnowledgeBaseFolderResourceImpl
	...
	public List<String> getCreateEntityScopes() {
		return Arrays.asList("knowledgeBaseFolder", "site");
	}

	@Override
	public String getEntityClassName() {
		return KnowledgeBaseFolder.class.getName();
	}
	...
	public List<com.liferay.portal.vulcan.batch.engine.Field>
		...
		return Arrays.asList(
			...
			com.liferay.portal.vulcan.batch.engine.Field.of(
				...
				Date.class, false),
			com.liferay.portal.vulcan.batch.engine.Field.of(
				"The last time the folder was modified.", "dateModified", true,
			...
			com.liferay.portal.vulcan.batch.engine.Field.of(
				...
				"numberOfKnowledgeBaseFolders", true, false, Integer.class,
				false),
			com.liferay.portal.vulcan.batch.engine.Field.of(
