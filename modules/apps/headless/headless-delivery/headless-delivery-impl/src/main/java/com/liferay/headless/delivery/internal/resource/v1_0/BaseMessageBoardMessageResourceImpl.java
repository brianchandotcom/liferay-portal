...
public abstract class BaseMessageBoardMessageResourceImpl
	implements MessageBoardMessageResource,
			   BatchEngineTaskItemDelegate<MessageBoardMessage>,
			   EntityModelResource {
	...
	@Override
	public com.liferay.batch.engine.pagination.Page<MessageBoardMessage> read(
			Filter filter,
			com.liferay.batch.engine.pagination.Pagination pagination,
			Sort[] sorts, Map<String, Serializable> parameters, String search)
		throws Exception {

		Page<MessageBoardMessage> page = getSiteMessageBoardMessagesPage(
