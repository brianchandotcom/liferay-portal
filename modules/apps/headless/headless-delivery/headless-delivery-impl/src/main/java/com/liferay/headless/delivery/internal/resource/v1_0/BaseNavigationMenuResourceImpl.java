...
public abstract class BaseNavigationMenuResourceImpl
	...
	public void create(
		...
		UnsafeConsumer<NavigationMenu, Exception> navigationMenuConsumer =
			navigationMenu -> {
			};

		if (parameters.containsKey("siteId")) {
			navigationMenuConsumer = navigationMenu -> postSiteNavigationMenu(
				(Long)parameters.get("siteId"), navigationMenu);
		}

		for (NavigationMenu navigationMenu : navigationMenus) {
			navigationMenuConsumer.accept(navigationMenu);
		}
	}
