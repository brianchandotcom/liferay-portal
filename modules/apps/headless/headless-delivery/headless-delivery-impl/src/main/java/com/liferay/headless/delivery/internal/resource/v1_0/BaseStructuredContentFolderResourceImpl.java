...
public abstract class BaseStructuredContentFolderResourceImpl
	implements StructuredContentFolderResource,
			   BatchEngineTaskItemDelegate<StructuredContentFolder>,
			   EntityModelResource {
	...
	@Override
	public com.liferay.batch.engine.pagination.Page<StructuredContentFolder>
			read(
				Filter filter,
				com.liferay.batch.engine.pagination.Pagination pagination,
				Sort[] sorts, Map<String, Serializable> parameters,
				String search)
		throws Exception {
		...
		Page<StructuredContentFolder> page =
			getSiteStructuredContentFoldersPage(
				...
				(Boolean)parameters.get("flatten"), search, filter,
