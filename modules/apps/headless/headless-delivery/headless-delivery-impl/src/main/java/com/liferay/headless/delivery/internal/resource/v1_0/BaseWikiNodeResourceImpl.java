...
import com.liferay.headless.delivery.dto.v1_0.WikiNode.ViewableBy;
...
public abstract class BaseWikiNodeResourceImpl
	...
	public List<com.liferay.portal.vulcan.batch.engine.Field>
		...
		return Arrays.asList(
			...
			com.liferay.portal.vulcan.batch.engine.Field.of(
				"The wiki node's creator.", "creator", true, false,
				Creator.class, false),
			com.liferay.portal.vulcan.batch.engine.Field.of(
				"The date the wiki node was created.", "dateCreated", true,
				false, Date.class, false),
			com.liferay.portal.vulcan.batch.engine.Field.of(
				"The last time any of the wiki node's fields changed.",
				"dateModified", true, false, Date.class, false),
			com.liferay.portal.vulcan.batch.engine.Field.of(
				"The wiki node's description.", "description", false, false,
				String.class, false),
			com.liferay.portal.vulcan.batch.engine.Field.of(
				"The wiki node's external reference code.",
				"externalReferenceCode", false, false, String.class, false),
			com.liferay.portal.vulcan.batch.engine.Field.of(
				"The wiki node's ID.", "id", true, false, Long.class, false),
			com.liferay.portal.vulcan.batch.engine.Field.of(
				"The wiki node's name.", "name", false, false, String.class,
				false),
			com.liferay.portal.vulcan.batch.engine.Field.of(
