...
public abstract class BaseWikiPageAttachmentResourceImpl
	implements WikiPageAttachmentResource,
			   BatchEngineTaskItemDelegate<WikiPageAttachment>,
			   EntityModelResource {
	...
	@Override
	public com.liferay.batch.engine.pagination.Page<WikiPageAttachment> read(
			Filter filter,
			com.liferay.batch.engine.pagination.Pagination pagination,
			Sort[] sorts, Map<String, Serializable> parameters, String search)
		throws Exception {

		Page<WikiPageAttachment> page = getWikiPageWikiPageAttachmentsPage(
