...
import com.liferay.portal.events.ServicePreActionHelper;
...
public class StructuredContentResourceImpl
	...
	private ThemeDisplay _getThemeDisplay(JournalArticle journalArticle)
		...
		ServicePreActionHelper servicePreActionHelper =
			new ServicePreActionHelper();

		servicePreActionHelper.servicePre(
