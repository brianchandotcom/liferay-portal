...
public abstract class BaseBlogPostingGraphQLTestCase {
	...
	public void testGetBlogPosting() throws Exception {
		...
		JSONObject jsonObject = dataJSONObject.getJSONObject("getBlogPosting");

		Assert.assertTrue(equals(postBlogPosting, jsonObject));
	}
	...
	protected boolean equals(BlogPosting blogPosting, JSONObject jsonObject) {
		...
		for (String field : fields) {
			if (Objects.equals("alternativeHeadline", field)) {
				if (!Objects.equals(
