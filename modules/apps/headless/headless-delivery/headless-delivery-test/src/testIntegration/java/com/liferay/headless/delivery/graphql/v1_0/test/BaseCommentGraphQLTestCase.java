...
public abstract class BaseCommentGraphQLTestCase {
	...
	public void testGetComment() throws Exception {
		...
		JSONObject jsonObject = dataJSONObject.getJSONObject("getComment");

		Assert.assertTrue(equals(postComment, jsonObject));
	}
