 ...
 */
@Generated("")
public abstract class BaseMessageBoardMessageGraphQLTestCase {
	...
	public void testGetMessageBoardMessage() throws Exception {
		...
		Map<String, Object> parameterMap = new HashMap<String, Object>() {
			{
				put("messageBoardMessageId", postMessageBoardMessage.getId());
			}
		};
		...
		GraphQLField graphQLField = GraphQLQueryUtil.field(
			...
			GraphQLQueryUtil.field(
				"getMessageBoardMessage", parameterMap,
		...
		Assert.assertTrue(equals(postMessageBoardMessage, jsonObject));
	}
	...
	protected boolean equals(
		...
		for (String field : fields) {
			if (Objects.equals("anonymous", field)) {
				if (!Objects.equals(
			...
			if (Objects.equals("showAsAnswer", field)) {
				if (!Objects.equals(
