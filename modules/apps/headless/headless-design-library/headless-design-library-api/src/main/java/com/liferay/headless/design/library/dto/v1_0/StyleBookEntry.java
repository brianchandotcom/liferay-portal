...
@GraphQLName(
	...
	value = "StyleBookEntry"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "StyleBookEntry")
public class StyleBookEntry implements Serializable {

	public static StyleBookEntry toDTO(String json) {
		return ObjectMapperUtil.readValue(StyleBookEntry.class, json);
	}

	public static StyleBookEntry unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(StyleBookEntry.class, json);
	}
	...
	public Boolean getDefaultStyleBookEntry() {
		if (_defaultStyleBookEntrySupplier != null) {
			defaultStyleBookEntry = _defaultStyleBookEntrySupplier.get();

			_defaultStyleBookEntrySupplier = null;
		}
	...
	public void setDefaultStyleBookEntry(
		...
		_defaultStyleBookEntrySupplier = () -> {
			try {
				return defaultStyleBookEntryUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<Boolean> _defaultStyleBookEntrySupplier;
	...
	public String toString() {
		...
		Boolean defaultStyleBookEntry = getDefaultStyleBookEntry();
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.design.library.dto.v1_0.StyleBookEntry",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:1831325439