...
public interface DocumentResource {
	...
	public Page<Document> getDocumentsRepositoryDocument(
	...
	@Produces({"*/*"})
	@RequiresScope("headless-document-library-application.read")
	public Page<Folder> getDocumentsRepositoryFolder(
			@PathParam("parent-id") Integer parentId,
			@Context Pagination pagination)
		throws Exception;
	...
	@Produces({"*/*"})
	@RequiresScope("headless-document-library-application.read")
	public Page<Document> getFolderDocument(
			@PathParam("parent-id") Integer parentId,
			@Context Pagination pagination)
		throws Exception;
	...
	@Produces({"*/*"})
	@RequiresScope("headless-document-library-application.read")
	public Page<Folder> getFolderFolder(
			@PathParam("parent-id") Integer parentId,
			@Context Pagination pagination)
		throws Exception;
