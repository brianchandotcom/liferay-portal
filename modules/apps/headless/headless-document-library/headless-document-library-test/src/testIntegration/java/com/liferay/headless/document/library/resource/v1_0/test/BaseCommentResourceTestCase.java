...
public abstract class BaseCommentResourceTestCase {
	...
	protected Page<Comment> invokeGetDocumentCommentsPage(
			...
			options.setLocation(_resourceURL + _toPath("/documents/{document-id}/comments", documentId,filter,sorts));
	...
	protected Comment invokePostDocumentComment(
			...
			options.setLocation(_resourceURL + _toPath("/documents/{document-id}/comments", documentId,comment));
