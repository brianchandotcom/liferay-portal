...
public class UserAccountResourceTest extends BaseUserAccountResourceTestCase {
	...
	public void setUp() throws Exception {
		...
		_userAccountResource = _getUserAccountResource(
	...
	private void _testPatchRoomUserAccountAsContentContributor()
		...
		User contentContributorUser1 = _addRoomUser(
			password, DSRRoleConstants.NAME_DSR_CONTENT_CONTRIBUTOR);

		UserAccountResource userAccountResource = _getUserAccountResource(
			password, contentContributorUser1);

		_assertPatchRoomUserAccountForbidden(
			userAccountResource, contentContributorUser1.getUserId());

		User contentContributorUser2 = _addRoomUser(
			RandomTestUtil.randomString(),
			DSRRoleConstants.NAME_DSR_CONTENT_CONTRIBUTOR);

		_assertPatchRoomUserAccountForbidden(
			userAccountResource, contentContributorUser2.getUserId());
	...
	private void _testPostRoomUserAccountSiteMember() throws Exception {
		try {
			_userAccountResource.postRoomUserAccount(
