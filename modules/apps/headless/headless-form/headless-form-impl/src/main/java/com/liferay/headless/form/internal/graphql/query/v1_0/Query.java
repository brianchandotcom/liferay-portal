...
public class Query {
	...
	@GraphQLName("form-id") Long formId)
			throws Exception {
				...
				return formResourceImpl.getForm(
					formId);
	}
	...
	@GraphQLName("form-id") Long formId)
			throws Exception {
				...
				return formResourceImpl.getFormFetchLatestDraft(
					formId);
	}
	...
	@GraphQLName("form-document-id") Long formDocumentId)
			throws Exception {
				...
				return formDocumentResourceImpl.getFormDocument(
					formDocumentId);
	}
	...
	@GraphQLName("form-record-id") Long formRecordId)
			throws Exception {
				...
				return formRecordResourceImpl.getFormRecord(
					formRecordId);
	}
	...
	@GraphQLName("form-structure-id") Long formStructureId)
			throws Exception {
				...
				return formStructureResourceImpl.getFormStructure(
					formStructureId);
	}
