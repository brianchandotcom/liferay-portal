...
public abstract class BaseFormGraphQLTestCase {
	...
	public void testGetForm() throws Exception {
		...
		JSONObject jsonObject = dataJSONObject.getJSONObject("getForm");

		Assert.assertTrue(equals(postForm, jsonObject));
	}
	...
	protected boolean equals(Form form, JSONObject jsonObject) {
		...
		for (String field : fields) {
			if (Objects.equals("defaultLanguage", field)) {
				if (!Objects.equals(
			...
			if (Objects.equals("structureId", field)) {
				if (!Objects.equals(
						form.getStructureId(),
