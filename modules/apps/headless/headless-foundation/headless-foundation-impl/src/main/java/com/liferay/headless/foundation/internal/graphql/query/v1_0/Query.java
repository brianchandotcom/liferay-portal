...
public class Query {
	...
	@GraphQLName("category-id") Long categoryId)
			throws Exception {
				...
				return categoryResourceImpl.getCategory(
					categoryId);
	}
	...
	@GraphQLName("email-id") Long emailId)
			throws Exception {
				...
				return emailResourceImpl.getEmail(
					emailId);
	}
	...
	@GraphQLName("keyword-id") Long keywordId)
			throws Exception {
				...
				return keywordResourceImpl.getKeyword(
					keywordId);
	}
	...
	@GraphQLName("organization-id") Long organizationId)
			throws Exception {
				...
				return organizationResourceImpl.getOrganization(
					organizationId);
	}
	...
	@GraphQLName("phone-id") Long phoneId)
			throws Exception {
				...
				return phoneResourceImpl.getPhone(
					phoneId);
	}
	...
	@GraphQLName("address-id") Long addressId)
			throws Exception {
				...
				return postalAddressResourceImpl.getAddress(
					addressId);
	}
	...
	@GraphQLName("role-id") Long roleId)
			throws Exception {
				...
				return roleResourceImpl.getRole(
					roleId);
	}
	...
	@GraphQLName("my-user-account-id") Long myUserAccountId)
			throws Exception {
				...
				return userAccountResourceImpl.getMyUserAccount(
					myUserAccountId);
	}
	...
	@GraphQLName("user-account-id") Long userAccountId)
			throws Exception {
				...
				return userAccountResourceImpl.getUserAccount(
					userAccountId);
	}
	...
	@GraphQLName("vocabulary-id") Long vocabularyId)
			throws Exception {
				...
				return vocabularyResourceImpl.getVocabulary(
					vocabularyId);
	}
	...
	@GraphQLName("web-url-id") Long webUrlId)
			throws Exception {
				...
				return webUrlResourceImpl.getWebUrl(
					webUrlId);
	}
