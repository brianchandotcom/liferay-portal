	...
	private static final ObjectMapper _objectMapper = new ObjectMapper() {
		{
			...
			resolver.addMapping(ContactInformation.class, ContactInformationImpl.class);
			resolver.addMapping(Creator.class, CreatorImpl.class);
			resolver.addMapping(Email.class, EmailImpl.class);
			resolver.addMapping(HoursAvailable.class, HoursAvailableImpl.class);
			resolver.addMapping(Keyword.class, KeywordImpl.class);
			resolver.addMapping(Location.class, LocationImpl.class);
			resolver.addMapping(Organization.class, OrganizationImpl.class);
			resolver.addMapping(Phone.class, PhoneImpl.class);
			resolver.addMapping(PostalAddress.class, PostalAddressImpl.class);
			resolver.addMapping(Role.class, RoleImpl.class);
			resolver.addMapping(Services.class, ServicesImpl.class);
			resolver.addMapping(UserAccount.class, UserAccountImpl.class);
			resolver.addMapping(Vocabulary.class, VocabularyImpl.class);
			resolver.addMapping(WebUrl.class, WebUrlImpl.class);
