...
public interface ObjectEntryCMSBulkActionResource {
	...
	public ObjectEntryCMSBulkActionResult postObjectEntryCMSBulkAction(
			String action, String search, String filterString,
	...
	public static class ObjectEntryCMSBulkActionResourceImpl
		...
		public ObjectEntryCMSBulkActionResult postObjectEntryCMSBulkAction(
			...
			HttpInvoker.HttpResponse httpResponse =
				postObjectEntryCMSBulkActionHttpResponse(
					action, search, filterString, objectEntryCMSBulkAction);
			...
			try {
				return ObjectEntryCMSBulkActionResultSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(
				objectEntryCMSBulkAction.toString(), "application/json");
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-object/v1.0/object-entry-cms-bulk-action/{action}");

			httpInvoker.path("action", action);
		...
		public void postObjectEntryCMSBulkActionBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postObjectEntryCMSBulkActionBatchHttpResponse(
					action, search, filterString, callbackURL, object);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-object/v1.0/object-entry-cms-bulk-action/{action}/batch");
