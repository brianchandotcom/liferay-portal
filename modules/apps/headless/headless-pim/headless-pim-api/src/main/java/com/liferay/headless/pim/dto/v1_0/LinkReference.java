 ...
 */
@Generated("")
@GraphQLName("LinkReference")
@io.swagger.v3.oas.annotations.media.Schema(
	requiredProperties = {"className", "externalReferenceCode"}
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "LinkReference")
public class LinkReference implements Serializable {

	public static LinkReference toDTO(String json) {
		return ObjectMapperUtil.readValue(LinkReference.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.pim.dto.v1_0.LinkReference",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:2139439368