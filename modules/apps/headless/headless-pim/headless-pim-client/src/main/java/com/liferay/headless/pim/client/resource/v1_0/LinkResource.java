...
package com.liferay.headless.pim.client.resource.v1_0;
...
public interface LinkResource {
	...
	public HttpInvoker.HttpResponse postScopeScopeKeyLinkHttpResponse(
	...
	public static class Builder {
		...
		public LinkResource build() {
			return new LinkResourceImpl(this);
		}
	...
	public static class LinkResourceImpl implements LinkResource {
		...
		public void deleteScopeScopeKeyLink(
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteScopeScopeKeyLinkHttpResponse(
		...
		public void postScopeScopeKeyLink(String scopeKey, Link link)
			...
			HttpInvoker.HttpResponse httpResponse =
				postScopeScopeKeyLinkHttpResponse(scopeKey, link);
		...
		public HttpInvoker.HttpResponse postScopeScopeKeyLinkHttpResponse(
			...
			httpInvoker.body(link.toString(), "application/json");
		...
		private LinkResourceImpl(Builder builder) {
			_builder = builder;
		}
