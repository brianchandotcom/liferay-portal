...
package com.liferay.headless.space.dto.v1_0;
 ...
 */
@Generated("")
@GraphQLName(description = "Represents a Space", value = "Space")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "Space")
public class Space implements Serializable {

	public static Space toDTO(String json) {
		return ObjectMapperUtil.readValue(Space.class, json);
	}

	public static Space unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Space.class, json);
	}

	@Schema(description = "The space's creation date.")
	...
	@GraphQLField(description = "The space's creation date.")
	...
	@Schema(description = "The last time a field of the space changed.")
	...
	@GraphQLField(description = "The last time a field of the space changed.")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	...
	@Schema(description = "The space's description.")
	...
	@GraphQLField(description = "The space's description.")
	...
	@Schema(description = "The localized space's description.")
	@Valid
	...
	@GraphQLField(description = "The localized space's description.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@Schema(description = "The space's group external reference code.")
	...
	@GraphQLField(description = "The space's group external reference code.")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	...
	@Schema(description = "The space's ID.")
	public Long getId() {
		if (_idSupplier != null) {
			id = _idSupplier.get();
	...
	@GraphQLField(description = "The space's ID.")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	protected Long id;
	...
	@Schema(description = "The space linked site ids.")
	...
	@GraphQLField(description = "The space linked site ids.")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	...
	@Schema(description = "The space linked sites external reference codes.")
	...
	@GraphQLField(
		description = "The space linked sites external reference codes."
	)
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	...
	@Schema(description = "The space's name.")
	...
	@GraphQLField(description = "The space's name.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@Schema(description = "The localized space's name.")
	@Valid
	...
	@GraphQLField(description = "The localized space's name.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	public boolean equals(Object object) {
		...
		return Objects.equals(toString(), space.toString());
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.space.dto.v1_0.Space",
		name = "x-class-name"
	)
