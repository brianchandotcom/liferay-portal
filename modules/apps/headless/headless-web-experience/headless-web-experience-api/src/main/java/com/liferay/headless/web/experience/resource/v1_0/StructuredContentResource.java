...
public interface StructuredContentResource {
	...
	public Page<? extends StructuredContent> getContentSpaceContentStructureStructuredContentsPage(
				Long contentSpaceId,Long contentStructureId,Filter filter,Pagination pagination,Sort[] sorts)
			throws Exception;

	public Page<? extends StructuredContent> getContentSpaceStructuredContentsPage(
