...
public class ODataHelper {
	...
	public List<JournalArticle> getJournalArticles(
		...
		return _journalHelper.getArticles(
			getHits(group, locale, pagination, filterString, sortString));
	}
	...
	protected Query getQuery(
			Locale locale, SearchContext searchContext, String filterString)
		throws SearchException {
		...
		com.liferay.portal.kernel.search.filter.Filter searchFilter =
			_getSearchFilter(_getFilter(filterString), locale);
	...
	protected void setFilterParser(FilterParser filterParser) {
	...
	protected void setSortParser(SortParser sortParser) {
	...
	protected void unbind(FilterParser filterParser) {
		_filterParser = null;
	}

	protected void unbind(SortParser sortParser) {
		_sortParser = null;
	}
