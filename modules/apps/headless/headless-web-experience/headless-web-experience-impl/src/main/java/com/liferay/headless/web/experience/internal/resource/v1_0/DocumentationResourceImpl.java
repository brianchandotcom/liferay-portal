...
public class DocumentationResourceImpl {
	...
	public Response getOpenApi(
		...
		resourceClasses.add(CommentResourceImpl.class);
		resourceClasses.add(ContentStructureResourceImpl.class);
		resourceClasses.add(StructuredContentResourceImpl.class);
		resourceClasses.add(StructuredContentImageResourceImpl.class);
