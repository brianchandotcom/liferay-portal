	...
	private static final ObjectMapper _objectMapper = new ObjectMapper() {
		{
			...
			resolver.addMapping(ObjectReviewed.class, ObjectReviewedImpl.class);
			resolver.addMapping(WorkflowLog.class, WorkflowLogImpl.class);
			resolver.addMapping(WorkflowTask.class, WorkflowTaskImpl.class);
