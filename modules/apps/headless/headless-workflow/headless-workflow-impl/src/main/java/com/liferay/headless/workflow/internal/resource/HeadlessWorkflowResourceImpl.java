...
public class HeadlessWorkflowResourceImpl implements HeadlessWorkflowResource {
	...
	public WorkflowTaskCollection<WorkflowTask> getRolesWorkflowTasks(
			Integer page, Integer perPage, String parentId)
		throws Exception {
	...
	@Override
	public WorkflowTask getWorkflowTasks(Integer id) throws Exception {
		return new WorkflowTask();
	}

	@Override
	public WorkflowTaskCollection<WorkflowTask> getWorkflowTasks(
			Integer page, Integer perPage, Object genericparentid)
		throws Exception {
	...
	public WorkflowLogCollection<WorkflowLog> getWorkflowTasksWorkflowLogs(
			Integer page, Integer perPage, Integer parentId)
		throws Exception {
