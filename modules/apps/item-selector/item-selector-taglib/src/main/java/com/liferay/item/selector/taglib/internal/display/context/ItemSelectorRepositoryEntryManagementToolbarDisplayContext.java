...
public class ItemSelectorRepositoryEntryManagementToolbarDisplayContext {
	...
	public CreationMenu getCreationMenu() {
		...
		Set<String> creationMenuFilter = _getCreationMenuFilter();
		...
		for (Menu menu : menus) {
			...
			for (URLMenuItem urlMenuItem : urlMenuItems) {
				if (Objects.equals(
					...
					creationMenuFilter.contains(urlMenuItem.getKey())) {
	...
	private Set<String> _getCreationMenuFilter() {
		Set<String> creationMenuFilter = (Set)_httpServletRequest.getAttribute(
			"liferay-item-selector:repository-entry-browser:" +
				"creationMenuFilter");

		if (SetUtil.isEmpty(creationMenuFilter)) {
			return Collections.emptySet();
		}

		return creationMenuFilter;
	}
