...
<c:if test="<%= article != null %>">
	...
	<clay:sheet-section>
		...
		%>
			...
			<aui:input checked="<%= selectedUserToolAssetAddonEntries.contains(userToolAssetAddonEntry) %>" id='<%= "userToolAssetAddonEntryKeys_" + userToolAssetAddonEntry.getKey() %>' label="<%= userToolAssetAddonEntry.getLabel(locale) %>" name="userToolAssetAddonEntryKeys" type="checkbox" value="<%= userToolAssetAddonEntry.getKey() %>" />
