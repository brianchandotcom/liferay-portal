...
create unique index IX_8C69049E on JournalArticle (groupId, articleId[$COLUMN_LENGTH:75$], version, ctCollectionId, companyId);
...
create unique index IX_E4924CCF on JournalArticle (uuid_[$COLUMN_LENGTH:75$], groupId, ctCollectionId, companyId);

create index IX_E69312A1 on JournalArticleLocalization (articlePK, ctCollectionId);
create unique index IX_61BA5AC0 on JournalArticleLocalization (articlePK, languageId[$COLUMN_LENGTH:75$], ctCollectionId, companyId);
...
create unique index IX_62DD0F80 on JournalArticleResource (groupId, articleId[$COLUMN_LENGTH:75$], ctCollectionId, companyId);
...
create unique index IX_C82C8661 on JournalArticleResource (uuid_[$COLUMN_LENGTH:75$], groupId, ctCollectionId, companyId);
...
create unique index IX_95346D70 on JournalContentSearch (groupId, privateLayout, layoutId, portletId[$COLUMN_LENGTH:200$], articleId[$COLUMN_LENGTH:75$], companyId);
create index IX_8DAF8A35 on JournalContentSearch (portletId[$COLUMN_LENGTH:200$]);

create unique index IX_23FC89EC on JournalFeed (groupId, feedId[$COLUMN_LENGTH:75$], companyId);
create index IX_CB37A10F on JournalFeed (uuid_[$COLUMN_LENGTH:75$], companyId);
create unique index IX_E6D2D837 on JournalFeed (uuid_[$COLUMN_LENGTH:75$], groupId, companyId);
...
create unique index IX_4D1284E5 on JournalFolder (groupId, parentFolderId, name[$COLUMN_LENGTH:100$], ctCollectionId, companyId);
...
create unique index IX_8767D209 on JournalFolder (uuid_[$COLUMN_LENGTH:75$], groupId, ctCollectionId, companyId);