...
<c:choose>
	...
	<c:otherwise>
		<div class="journal-content-article <%= Validator.isNotNull(wrapperCssClass) ? wrapperCssClass : StringPool.BLANK %>" <%= dataAnalyticsTrackingEnabled ? String.format("data-analytics-asset-external-reference-code=\"%s\" data-analytics-asset-id=\"%s\" data-analytics-asset-title=\"%s\" data-analytics-asset-type=\"web-content\" data-analytics-web-content-resource-pk=\"%s\"", articleDisplay.getExternalReferenceCode(), articleDisplay.getGroupId(), articleDisplay.getArticleId(), HtmlUtil.escapeAttribute(articleDisplay.getTitle()), articleDisplay.getResourcePrimKey()) : "" %>>
