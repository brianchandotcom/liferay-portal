...
if (!workflowAssetPreview && article.isApproved()) {
	articleDisplay = JournalContentUtil.getDisplay(articleResource.getGroupId(), articleResource.getArticleId(), article.getVersion(), null, languageId, 1, new PortletRequestModel(renderRequest, renderResponse), themeDisplay);
}
else {
