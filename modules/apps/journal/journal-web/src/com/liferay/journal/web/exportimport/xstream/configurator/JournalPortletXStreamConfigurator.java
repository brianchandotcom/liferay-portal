...
package com.liferay.journal.web.exportimport.xstream.configurator;
...
public class JournalPortletXStreamConfigurator implements XStreamConfigurator {

	@Override
	public List<XStreamAlias> getXStreamAliases() {
		return ListUtil.toList(new XStreamAlias[] {
