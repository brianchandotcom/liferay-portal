...
<clay:management-toolbar
	displayContext="<%= new JournalViewMoreMenuItemsManagementToolbarDisplayContext(liferayPortletRequest, liferayPortletReponse, request, journalViewMoreMenuItemsDisplayContext) %>"
/>
