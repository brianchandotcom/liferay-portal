...
<div class="kb-article-tools">
	...
	<c:if test="<%= enableRSS && (kbArticle.isApproved() || !kbArticle.isFirstVersion()) && !Validator.equals(portletDisplay.getRootPortletId(), KnowledgeBasePortletKeys.KNOWLEDGE_BASE_ADMIN) %>">
