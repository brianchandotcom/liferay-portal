...
import com.liferay.layout.admin.web.internal.constants.LayoutUtilityPageConstants;
...
public class LayoutUtilityPageEntryManagementToolbarDisplayContext
	...
	public CreationMenu getCreationMenu() {
		return new CreationMenu() {
			{
				for (LayoutUtilityPageConstants.Type type :
						LayoutUtilityPageConstants.Type.values()) {
	...
	private String _getSelectMasterLayoutURL(int type) {
		return PortletURLBuilder.createRenderURL(
			...
			"/select_layout_utility_page_master_layout.jsp"
		).setRedirect(
