...
public class LayoutsAdminDisplayContextTest {
	...
	public void testGetVerticalNavItemList() throws Exception {
		...
		try (MockedStatic<LayoutPageTemplateCollectionServiceUtil>
			...
			_testGetVerticalNavItemList(
				layoutsAdminDisplayContext, false, false, 2);
			_testGetVerticalNavItemList(
				layoutsAdminDisplayContext, false, true, 3);
			_testGetVerticalNavItemList(
				layoutsAdminDisplayContext, true, false, 3);
			_testGetVerticalNavItemList(
				layoutsAdminDisplayContext, true, true, 4);
		}
	}
	...
	private void _testGetVerticalNavItemList(
		LayoutsAdminDisplayContext layoutsAdminDisplayContext,
		boolean showGlobalTemplates, boolean featureFlagEnabled,
		int expectedVerticalNavItemsCount) {
