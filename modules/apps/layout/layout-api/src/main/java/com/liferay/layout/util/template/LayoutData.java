...
public class LayoutData {
	...
	public JSONObject getLayoutDataJSONObject() {
		...
		ContainerStyledLayoutStructureItem containerLayoutStructureItem =
			(ContainerStyledLayoutStructureItem)
				layoutStructure.addContainerLayoutStructureItem(
					rootLayoutStructureItem.getItemId(), 0);

		boolean wrapWidgetPage = GetterUtil.getBoolean(
			_layout.getThemeSetting("wrap-widget-page-content", "regular"));

		if (wrapWidgetPage) {
			containerLayoutStructureItem.setWidthType("fixed");
		}
