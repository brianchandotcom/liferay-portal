...
public interface LayoutContentVersionPreviewPersistence
	 ...
	 * @return the matching layout content version preview, or <code>null</code> if a matching layout content version preview could not be found
	 */
	public default LayoutContentVersionPreview fetchByL_LCVI_SEERC(
		String languageId, long layoutContentVersionId,
		String segmentsExperienceERC) {

		return fetchByL_LCVI_SEERC(
			languageId, layoutContentVersionId, segmentsExperienceERC, true);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:371037851