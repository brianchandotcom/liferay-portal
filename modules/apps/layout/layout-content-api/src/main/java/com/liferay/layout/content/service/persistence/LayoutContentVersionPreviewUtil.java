...
public class LayoutContentVersionPreviewUtil {
	 ...
	 * @throws NoSuchLayoutContentVersionPreviewException if a matching layout content version preview could not be found
	 */
	public static LayoutContentVersionPreview findByL_LCVI_SEERC(
			String languageId, long layoutContentVersionId,
			String segmentsExperienceERC)
		throws com.liferay.layout.content.exception.
			NoSuchLayoutContentVersionPreviewException {

		return getPersistence().findByL_LCVI_SEERC(
	 ...
	 */
	public static LayoutContentVersionPreview fetchByL_LCVI_SEERC(
		String languageId, long layoutContentVersionId,
		String segmentsExperienceERC, boolean useFinderCache) {

		return getPersistence().fetchByL_LCVI_SEERC(
			languageId, layoutContentVersionId, segmentsExperienceERC,
			useFinderCache);
	}
	 ...
	 */
	public static LayoutContentVersionPreview removeByL_LCVI_SEERC(
			String languageId, long layoutContentVersionId,
			String segmentsExperienceERC)
		throws com.liferay.layout.content.exception.
			NoSuchLayoutContentVersionPreviewException {

		return getPersistence().removeByL_LCVI_SEERC(
			languageId, layoutContentVersionId, segmentsExperienceERC);
	}
	 ...
	 * @return the number of matching layout content version previews
	 */
	public static int countByL_LCVI_SEERC(
		String languageId, long layoutContentVersionId,
		String segmentsExperienceERC) {

		return getPersistence().countByL_LCVI_SEERC(
			languageId, layoutContentVersionId, segmentsExperienceERC);
	}
	...
	/**
	 * Returns the layout content version preview where languageId = &#63; and layoutContentVersionId = &#63; and segmentsExperienceERC = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param languageId the language ID
	 * @param layoutContentVersionId the layout content version ID
	 * @param segmentsExperienceERC the segments experience erc
...
// LIFERAY-SERVICE-BUILDER-HASH:-38185087