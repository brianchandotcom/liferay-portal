...
public class LayoutContentVersionPreviewLocalServiceImpl
	...
	public LayoutContentVersionPreview fetchLayoutContentVersionPreview(
		...
		return layoutContentVersionPreviewPersistence.fetchByL_LCVI_SEERC(
			languageId, layoutContentVersionId, segmentsExperienceERC);
	}
	...
	private void _checkDuplicateLayoutContentVersionPreview(
		...
		LayoutContentVersionPreview layoutContentVersionPreview =
			layoutContentVersionPreviewPersistence.fetchByL_LCVI_SEERC(
				languageId, layoutContentVersionId, segmentsExperienceERC);
		...
		throw new DuplicateLayoutContentVersionPreviewException(
			StringBundler.concat(
				"Duplicate layout content version preview for language ID ",
				languageId, ", layout content version ", layoutContentVersionId,
