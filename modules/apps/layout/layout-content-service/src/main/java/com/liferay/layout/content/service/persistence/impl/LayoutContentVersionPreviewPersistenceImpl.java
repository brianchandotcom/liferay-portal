...
public class LayoutContentVersionPreviewPersistenceImpl
	...
	private UniquePersistenceFinder
		<LayoutContentVersionPreview,
		 NoSuchLayoutContentVersionPreviewException>
			_uniquePersistenceFinderByL_LCVI_SEERC;

	/**
	 * Returns the layout content version preview where languageId = &#63; and layoutContentVersionId = &#63; and segmentsExperienceERC = &#63; or throws a <code>NoSuchLayoutContentVersionPreviewException</code> if it could not be found.
	 *
	 ...
	 */
	@Override
	public LayoutContentVersionPreview findByL_LCVI_SEERC(
			String languageId, long layoutContentVersionId,
			String segmentsExperienceERC)
		throws NoSuchLayoutContentVersionPreviewException {

		return _uniquePersistenceFinderByL_LCVI_SEERC.find(
			finderCache,
			new Object[] {
	...
	/**
	 * Returns the layout content version preview where languageId = &#63; and layoutContentVersionId = &#63; and segmentsExperienceERC = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param languageId the language ID
	 * @param layoutContentVersionId the layout content version ID
	 * @param segmentsExperienceERC the segments experience erc
	 ...
	 */
	@Override
	public LayoutContentVersionPreview fetchByL_LCVI_SEERC(
		String languageId, long layoutContentVersionId,
		String segmentsExperienceERC, boolean useFinderCache) {

		return _uniquePersistenceFinderByL_LCVI_SEERC.fetch(
			finderCache,
			new Object[] {
				languageId, layoutContentVersionId, segmentsExperienceERC
			},
	...
	/**
	 * Removes the layout content version preview where languageId = &#63; and layoutContentVersionId = &#63; and segmentsExperienceERC = &#63; from the database.
	 *
	 * @param languageId the language ID
	 * @param layoutContentVersionId the layout content version ID
	 * @param segmentsExperienceERC the segments experience erc
	 ...
	 */
	@Override
	public LayoutContentVersionPreview removeByL_LCVI_SEERC(
			String languageId, long layoutContentVersionId,
			String segmentsExperienceERC)
		throws NoSuchLayoutContentVersionPreviewException {
	...
	/**
	 * Returns the number of layout content version previews where languageId = &#63; and layoutContentVersionId = &#63; and segmentsExperienceERC = &#63;.
	 *
	 * @param languageId the language ID
	 * @param layoutContentVersionId the layout content version ID
	 * @param segmentsExperienceERC the segments experience erc
	 ...
	 */
	@Override
	public int countByL_LCVI_SEERC(
		String languageId, long layoutContentVersionId,
		String segmentsExperienceERC) {

		return _uniquePersistenceFinderByL_LCVI_SEERC.count(
			finderCache,
			new Object[] {
				languageId, layoutContentVersionId, segmentsExperienceERC
			});
	...
	public void activate() {
		...
		_uniquePersistenceFinderByL_LCVI_SEERC = new UniquePersistenceFinder<>(
			this,
			createUniqueFinderPath(
				FINDER_CLASS_NAME_ENTITY, "fetchByL_LCVI_SEERC",
				new String[] {
					String.class.getName(), Long.class.getName(),
					String.class.getName()
				},
				new String[] {
					"languageId", "layoutContentVersionId",
...
// LIFERAY-SERVICE-BUILDER-HASH:1391911592