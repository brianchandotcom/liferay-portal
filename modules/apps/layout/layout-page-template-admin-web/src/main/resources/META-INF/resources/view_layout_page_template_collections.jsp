...
<aui:script require="metal-dom/src/dom as dom, frontend-js-web/liferay/ItemSelectorDialog.es as ItemSelectorDialog">
	...
	var importEntries = function() {
		Liferay.Util.openWindow({
			...
			uri:
				'<portlet:renderURL windowState="<%= LiferayWindowState.POP_UP.toString() %>"><portlet:param name="mvcRenderCommandName" value="/layout_page_template/view_import_layout_page_template" /></portlet:renderURL>',
		});
	};
