...
public class LayoutPageTemplatesAdminDisplayContextTest {
	...
	public void testIsShowWidgetPageTemplates() {
		_testIsShowWidgetPageTemplates(false, false, 0);
		_testIsShowWidgetPageTemplates(true, false, RandomTestUtil.randomInt());
		_testIsShowWidgetPageTemplates(true, true, 0);
	}
	...
	private void _testIsShowWidgetPageTemplates(
		boolean expectedIsShowWidgetPageTemplates, boolean featureFlagEnabled,
