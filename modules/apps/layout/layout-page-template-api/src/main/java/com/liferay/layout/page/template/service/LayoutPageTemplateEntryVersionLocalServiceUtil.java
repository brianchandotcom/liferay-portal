...
/**
 * Provides the local service utility for LayoutPageTemplateEntryVersion. This utility wraps
 * <code>com.liferay.layout.page.template.service.impl.LayoutPageTemplateEntryVersionLocalServiceImpl</code> and
 ...
 */
@ProviderType
public class LayoutPageTemplateEntryVersionLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.layout.page.template.service.impl.LayoutPageTemplateEntryVersionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static
		...
		return getService().createLayoutPageTemplateEntryVersion(
	...
	public static
		...
		return getService().fetchLayoutPageTemplateEntryVersion(
			layoutPageTemplateEntryVersionId);
	}
	...
	public static
		...
		return getService().getLayoutPageTemplateEntryVersion(
			layoutPageTemplateEntryVersionId);
	}
	...
	public static java.util.List
		...
		return getService().getLayoutPageTemplateEntryVersions(start, end);
	}
	 ...
	 */
	public static int getLayoutPageTemplateEntryVersionsCount() {
		return getService().getLayoutPageTemplateEntryVersionsCount();
	}
	...
	public static
		...
		return getService().updateLayoutPageTemplateEntryVersion(
			layoutPageTemplateEntryVersion);
	}

	public static LayoutPageTemplateEntryVersionLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<LayoutPageTemplateEntryVersionLocalService,
		 LayoutPageTemplateEntryVersionLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(
			LayoutPageTemplateEntryVersionLocalService.class);

		ServiceTracker
			<LayoutPageTemplateEntryVersionLocalService,
			 LayoutPageTemplateEntryVersionLocalService> serviceTracker =
				new ServiceTracker
					<LayoutPageTemplateEntryVersionLocalService,
					 LayoutPageTemplateEntryVersionLocalService>(
