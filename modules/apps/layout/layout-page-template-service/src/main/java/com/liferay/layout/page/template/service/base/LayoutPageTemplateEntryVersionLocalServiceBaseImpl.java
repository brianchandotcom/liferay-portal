...
import com.liferay.layout.page.template.service.LayoutPageTemplateEntryVersionLocalService;
...
/**
 * Provides the base implementation for the layout page template entry version local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.layout.page.template.service.impl.LayoutPageTemplateEntryVersionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.layout.page.template.service.impl.LayoutPageTemplateEntryVersionLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class LayoutPageTemplateEntryVersionLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LayoutPageTemplateEntryVersionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.layout.page.template.service.LayoutPageTemplateEntryVersionLocalServiceUtil</code>.
	 */
	...
	public LayoutPageTemplateEntryVersion createLayoutPageTemplateEntryVersion(
		...
		return layoutPageTemplateEntryVersionPersistence.create(
	...
	public LayoutPageTemplateEntryVersion deleteLayoutPageTemplateEntryVersion(
		...
		return layoutPageTemplateEntryVersionPersistence.remove(
			layoutPageTemplateEntryVersionId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LayoutPageTemplateEntryVersion.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return layoutPageTemplateEntryVersionPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return layoutPageTemplateEntryVersionPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public LayoutPageTemplateEntryVersion fetchLayoutPageTemplateEntryVersion(
		...
		return layoutPageTemplateEntryVersionPersistence.fetchByPrimaryKey(
			layoutPageTemplateEntryVersionId);
	}
	...
	public LayoutPageTemplateEntryVersion getLayoutPageTemplateEntryVersion(
		...
		return layoutPageTemplateEntryVersionPersistence.findByPrimaryKey(
			layoutPageTemplateEntryVersionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(
			LayoutPageTemplateEntryVersion.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return layoutPageTemplateEntryVersionLocalService.
			deleteLayoutPageTemplateEntryVersion(
				(LayoutPageTemplateEntryVersion)persistedModel);
	}
	...
	public List<LayoutPageTemplateEntryVersion>
		...
		return layoutPageTemplateEntryVersionPersistence.findAll(start, end);
	}
	...
	public int getLayoutPageTemplateEntryVersionsCount() {
		return layoutPageTemplateEntryVersionPersistence.countAll();
	}
	 ...
	 */
	public LayoutPageTemplateEntryVersionLocalService
	...
	public String getOSGiServiceIdentifier() {
		return LayoutPageTemplateEntryVersionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				layoutPageTemplateEntryVersionPersistence.getDataSource();
	...
	@BeanReference(type = LayoutPageTemplateEntryVersionLocalService.class)
	protected LayoutPageTemplateEntryVersionLocalService
		layoutPageTemplateEntryVersionLocalService;
