...
/**
 * Provides the local service interface for LayoutSEOCanonicalURL. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LayoutSEOCanonicalURLLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LayoutSEOCanonicalURLLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LayoutSEOCanonicalURLLocalServiceUtil} to access the layout seo canonical url local service. Add custom service methods to <code>com.liferay.layout.seo.service.impl.LayoutSEOCanonicalURLLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
