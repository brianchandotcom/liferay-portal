...
/**
 * The persistence interface for the layout seo open graph entry service.
 *
 * <p>
 ...
 * @see LayoutSEOOpenGraphEntryUtil
 * @generated
 */
@ProviderType
public interface LayoutSEOOpenGraphEntryPersistence
	extends BasePersistence<LayoutSEOOpenGraphEntry> {

	/**
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LayoutSEOOpenGraphEntryUtil} to access the layout seo open graph entry persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<LayoutSEOOpenGraphEntry> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<LayoutSEOOpenGraphEntry> findByUuid(
	...
	public java.util.List<LayoutSEOOpenGraphEntry> findByUuid(
		...
		com.liferay.portal.kernel.util.OrderByComparator
			<LayoutSEOOpenGraphEntry> orderByComparator);
	 ...
	 * @return the matching layout seo open graph entries
	 */
	public java.util.List<LayoutSEOOpenGraphEntry> findByUuid_C(
	...
	public void cacheResult(
		java.util.List<LayoutSEOOpenGraphEntry> layoutSEOOpenGraphEntries);
	 ...
	 */
	public java.util.List<LayoutSEOOpenGraphEntry> findAll();
	 ...
	 */
	public java.util.List<LayoutSEOOpenGraphEntry> findAll(int start, int end);
