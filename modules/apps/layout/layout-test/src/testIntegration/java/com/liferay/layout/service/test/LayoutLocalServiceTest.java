...
public class LayoutLocalServiceTest {
	...
	public void testSearchLayoutByTitleOrName() throws Exception {
		...
		_verifySearchOnlyByTitle(keyword, name, true, 0);
		_verifySearchOnlyByTitle(keyword, name, false, 1);
		_verifySearchOnlyByTitle(name, name, true, 1);
		_verifySearchOnlyByTitle(name, name, false, 1);
	}
	...
	private void _verifySearchOnlyByTitle(
			String keyword, String name, boolean searchOnlyByTitle, int count)
		throws Exception {
