...
public class LayoutUtilityPageEntryServiceTest {
	...
	public void testCopyLayoutUtilityPageEntry() throws Exception {
		...
		LayoutUtilityPageEntry layoutUtilityPageEntryCopy =
		...
		Assert.assertEquals(
			...
			layoutUtilityPageEntryCopy.getCompanyId());
		Assert.assertEquals(
			layoutUtilityPageEntry.getGroupId(),
			layoutUtilityPageEntryCopy.getGroupId());
		Assert.assertEquals(
			0, layoutUtilityPageEntryCopy.getPreviewFileEntryId());
		Assert.assertEquals(
			layoutUtilityPageEntry.getType(),
			layoutUtilityPageEntryCopy.getType());

		Assert.assertNotEquals(
			layoutUtilityPageEntry.getExternalReferenceCode(),
			layoutUtilityPageEntryCopy.getExternalReferenceCode());
		Assert.assertNotEquals(
			layoutUtilityPageEntry.getPlid(),
			layoutUtilityPageEntryCopy.getPlid());

		Assert.assertTrue(
			StringUtil.startsWith(
				layoutUtilityPageEntryCopy.getName(),
	...
	public void testCopyLayoutUtilityPageEntryWithPreviewFileEntry()
		...
		Assert.assertNotEquals(
			...
			layoutUtilityPageEntryCopy.getPreviewFileEntryId());

		FileEntry fileEntryCopy = _portletFileRepository.getPortletFileEntry(
			layoutUtilityPageEntryCopy.getPreviewFileEntryId());

		Assert.assertEquals(
			layoutUtilityPageEntryCopy.getLayoutUtilityPageEntryId() +
				"_preview.png",
