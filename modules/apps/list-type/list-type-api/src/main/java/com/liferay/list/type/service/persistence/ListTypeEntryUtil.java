...
public class ListTypeEntryUtil {
	...
	/**
	 * Returns the list type entry where listTypeDefinitionId = &#63; and name = &#63; or throws a <code>NoSuchListTypeEntryException</code> if it could not be found.
	 *
	 * @param listTypeDefinitionId the list type definition ID
	 * @param name the name
	 ...
	 * @throws NoSuchListTypeEntryException if a matching list type entry could not be found
	 */
	public static ListTypeEntry findByLTDI_N(
			long listTypeDefinitionId, String name)
		throws com.liferay.list.type.exception.NoSuchListTypeEntryException {

		return getPersistence().findByLTDI_N(listTypeDefinitionId, name);
	}

	/**
	 * Returns the list type entry where listTypeDefinitionId = &#63; and name = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param listTypeDefinitionId the list type definition ID
	 * @param name the name
	 * @return the matching list type entry, or <code>null</code> if a matching list type entry could not be found
	 */
	public static ListTypeEntry fetchByLTDI_N(
		long listTypeDefinitionId, String name) {

		return getPersistence().fetchByLTDI_N(listTypeDefinitionId, name);
	}

	/**
	 * Returns the list type entry where listTypeDefinitionId = &#63; and name = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param listTypeDefinitionId the list type definition ID
	 * @param name the name
	 * @param useFinderCache whether to use the finder cache
	 ...
	 */
	public static ListTypeEntry fetchByLTDI_N(
		long listTypeDefinitionId, String name, boolean useFinderCache) {

		return getPersistence().fetchByLTDI_N(
			listTypeDefinitionId, name, useFinderCache);
	}

	/**
	 * Removes the list type entry where listTypeDefinitionId = &#63; and name = &#63; from the database.
	 *
	 * @param listTypeDefinitionId the list type definition ID
	 * @param name the name
	 * @return the list type entry that was removed
	 */
	public static ListTypeEntry removeByLTDI_N(
			long listTypeDefinitionId, String name)
		throws com.liferay.list.type.exception.NoSuchListTypeEntryException {

		return getPersistence().removeByLTDI_N(listTypeDefinitionId, name);
	}

	/**
	 * Returns the number of list type entries where listTypeDefinitionId = &#63; and name = &#63;.
	 *
	 * @param listTypeDefinitionId the list type definition ID
	 * @param name the name
	 * @return the number of matching list type entries
	 */
	public static int countByLTDI_N(long listTypeDefinitionId, String name) {
		return getPersistence().countByLTDI_N(listTypeDefinitionId, name);
	}
