...
public class ListTypeEntryModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"listTypeDefinitionId", Types.BIGINT}, {"label", Types.VARCHAR},
	...
	public static final String TABLE_SQL_CREATE =
		"create table ListTypeEntry (mvccVersion LONG default 0 not null,uuid_ VARCHAR(75) null,listTypeEntryId LONG not null primary key,companyId LONG,listTypeDefinitionId LONG,label STRING null,name VARCHAR(75) null,type_ VARCHAR(75) null)";
	...
	static {
		...
		attributeGetterFunctions.put("label", ListTypeEntry::getLabel);
		attributeSetterBiConsumers.put(
			"label",
			(BiConsumer<ListTypeEntry, String>)ListTypeEntry::setLabel);
	...
	public Object clone() {
		...
		listTypeEntryImpl.setLabel(getLabel());
	...
	public CacheModel<ListTypeEntry> toCacheModel() {
		...
		listTypeEntryCacheModel.label = getLabel();

		String label = listTypeEntryCacheModel.label;

		if ((label != null) && (label.length() == 0)) {
			listTypeEntryCacheModel.label = null;
		}
	...
	static {
		...
		columnBitmasks.put("listTypeDefinitionId", 16L);

		columnBitmasks.put("label", 32L);
