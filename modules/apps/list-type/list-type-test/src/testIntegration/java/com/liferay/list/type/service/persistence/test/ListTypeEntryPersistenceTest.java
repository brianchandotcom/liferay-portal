...
public class ListTypeEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newListTypeEntry.setLabel(RandomTestUtil.randomString());
		...
		Assert.assertEquals(
			existingListTypeEntry.getLabel(), newListTypeEntry.getLabel());
		Assert.assertEquals(
	...
	@Test
	public void testCountByLTDI_N() throws Exception {
		_persistence.countByLTDI_N(RandomTestUtil.nextLong(), "");

		_persistence.countByLTDI_N(0L, "null");

		_persistence.countByLTDI_N(0L, (String)null);
	}
	...
	protected OrderByComparator<ListTypeEntry> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			"listTypeEntryId", true, "companyId", true, "listTypeDefinitionId",
			true, "label", true, "name", true, "type", true);
	}
	...
	protected ListTypeEntry addListTypeEntry() throws Exception {
		...
		listTypeEntry.setLabel(RandomTestUtil.randomString());
