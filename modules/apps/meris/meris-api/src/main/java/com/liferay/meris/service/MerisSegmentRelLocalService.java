...
/**
 * Provides the local service interface for MerisSegmentRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Eduardo Garcia
 * @see MerisSegmentRelLocalServiceUtil
...
public interface MerisSegmentRelLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MerisSegmentRelLocalServiceUtil} to access the meris segment rel local service. Add custom service methods to {@link com.liferay.meris.service.impl.MerisSegmentRelLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
