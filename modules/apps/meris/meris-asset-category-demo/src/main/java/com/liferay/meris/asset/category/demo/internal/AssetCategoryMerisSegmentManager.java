...
public class AssetCategoryMerisSegmentManager
	...
	public List<AssetCategoryMerisProfile> getMerisProfiles(
		...
		AssetCategoryMerisSegment assetCategoryMerisSegment =
			getMerisSegment(merisSegmentId);
	...
	public List<AssetCategoryMerisSegment> getMerisSegments(
		...
		AssetCategoryMerisProfile assetCategoryMerisProfile =
			getMerisProfile(merisProfileId);
