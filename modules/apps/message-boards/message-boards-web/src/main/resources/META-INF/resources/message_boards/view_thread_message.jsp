...
<liferay-util:dynamic-include key="<%= DynamicIncludeKeys.MESSAGE_BOARDS_VIEW_THREAD_MESSAGE_PRE %>" />
...
<liferay-util:dynamic-include key="<%= DynamicIncludeKeys.MESSAGE_BOARDS_VIEW_THREAD_MESSAGE_POST %>" />