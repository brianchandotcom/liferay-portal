...
/**
 * Provides the local service interface for NotificationQueueEntryRecipient. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gabriel Albuquerque
 * @see NotificationQueueEntryRecipientLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NotificationQueueEntryRecipientLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.notification.service.impl.NotificationQueueEntryRecipientLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the notification queue entry recipient local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NotificationQueueEntryRecipientLocalServiceUtil} if injection and service tracking are not available.
	 */
