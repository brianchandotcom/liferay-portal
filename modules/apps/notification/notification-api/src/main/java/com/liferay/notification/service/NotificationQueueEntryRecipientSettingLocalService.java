...
/**
 * Provides the local service interface for NotificationQueueEntryRecipientSetting. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gabriel Albuquerque
 * @see NotificationQueueEntryRecipientSettingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NotificationQueueEntryRecipientSettingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.notification.service.impl.NotificationQueueEntryRecipientSettingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the notification queue entry recipient setting local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NotificationQueueEntryRecipientSettingLocalServiceUtil} if injection and service tracking are not available.
	 */
