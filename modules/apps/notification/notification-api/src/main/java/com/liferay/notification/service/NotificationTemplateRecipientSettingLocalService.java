...
/**
 * Provides the local service interface for NotificationTemplateRecipientSetting. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gabriel Albuquerque
 * @see NotificationTemplateRecipientSettingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NotificationTemplateRecipientSettingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.notification.service.impl.NotificationTemplateRecipientSettingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the notification template recipient setting local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NotificationTemplateRecipientSettingLocalServiceUtil} if injection and service tracking are not available.
	 */
