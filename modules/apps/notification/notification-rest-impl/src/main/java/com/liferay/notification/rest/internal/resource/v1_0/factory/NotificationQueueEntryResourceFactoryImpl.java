...
public class NotificationQueueEntryResourceFactoryImpl
	implements NotificationQueueEntryResource.Factory {

	@Override
	public NotificationQueueEntryResource.Builder create() {
		return new NotificationQueueEntryResource.Builder() {
			...
			@Override
			public NotificationQueueEntryResource.Builder checkPermissions(
			...
			@Override
			public NotificationQueueEntryResource.Builder httpServletRequest(
			...
			@Override
			public NotificationQueueEntryResource.Builder httpServletResponse(
			...
			@Override
			public NotificationQueueEntryResource.Builder preferredLocale(
	...
	protected void activate() {
		NotificationQueueEntryResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		NotificationQueueEntryResource.FactoryHolder.factory = null;
	}

	private static Function<InvocationHandler, NotificationQueueEntryResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			NotificationQueueEntryResource.class.getClassLoader(),
			NotificationQueueEntryResource.class);

		try {
			Constructor<NotificationQueueEntryResource> constructor =
				(Constructor<NotificationQueueEntryResource>)
