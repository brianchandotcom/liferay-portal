...
public abstract class BaseNotificationTemplateResourceTestCase {
	...
	@Test
	public void testPostNotificationTemplatesPageExportBatch()
		throws Exception {
		...
		NotificationTemplate[] notificationTemplates = getNotificationTemplates(
			exportTask);

		long totalCount = notificationTemplates.length;
		...
		notificationTemplates = getNotificationTemplates(exportTask);

		Assert.assertEquals(totalCount + 2, notificationTemplates.length);

		assertContains(
			notificationTemplate1, Arrays.asList(notificationTemplates));
		assertContains(
			notificationTemplate2, Arrays.asList(notificationTemplates));
	}
	...
	protected NotificationTemplate[] getNotificationTemplates(
		...
		try {
			return NotificationTemplateSerDes.toDTOs(
