...
create index IX_B4DC5C8B on NTemplateRecipient (notificationTemplateId);

create index IX_9E66544 on NTemplateRecipientSetting (NTemplateRecipientId, name[$COLUMN_LENGTH:75$]);
