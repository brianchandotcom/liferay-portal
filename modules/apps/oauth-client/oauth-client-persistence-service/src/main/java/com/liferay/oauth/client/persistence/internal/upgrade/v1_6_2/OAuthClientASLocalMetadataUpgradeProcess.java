...
public class OAuthClientASLocalMetadataUpgradeProcess extends UpgradeProcess {
	...
	private String _generateOAuthASLocalWellKnownURI(
		...
		try {
			...
			return _generatePlaceholderOAuthASLocalWellKnownURI(
				oAuthClientASLocalMetadataId, "its issuer is not a valid URI");
		}
	...
	private String _generateOAuthASMetadataJSON(
		...
		try {
			...
			URI introspectionEndpointURI = _getIntrospectionEndpointURI(
				tokenEndpointURI);
	...
	private URI _getIntrospectionEndpointURI(URI tokenEndpointURI) {
		if (tokenEndpointURI == null) {
			return null;
		}

		String tokenEndpoint = _removeTrailingSlash(
		...
		return URI.create(
			StringUtil.replaceLast(tokenEndpoint, "/token", "/introspect"));
	}
