...
public class OAuthClientEntryServiceHttp {
	...
	public static com.liferay.oauth.client.persistence.model.OAuthClientEntry
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, userId, authServerIssuer, infoJSON,
				requestParamsJSON);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				"getCompanyOAuthClientEntries",
				_getCompanyOAuthClientEntriesParameterTypes3);
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				OAuthClientEntryServiceUtil.class,
				"getOAuthClientEntriesByAuthServerType",
				_getOAuthClientEntriesByAuthServerTypeParameterTypes6);
	...
	private static final Class<?>[]
		_getCompanyOAuthClientEntriesParameterTypes3 = new Class[] {long.class};
	private static final Class<?>[]
		_getCompanyOAuthClientEntriesParameterTypes4 = new Class[] {
			long.class, int.class, int.class
		};
	private static final Class<?>[] _getOAuthClientEntriesParameterTypes5 =
		new Class[] {long.class, String.class};
	private static final Class<?>[]
		_getOAuthClientEntriesByAuthServerTypeParameterTypes6 = new Class[] {
