...
public class OAuthClientEntryServiceHttp {
	...
	public static com.liferay.oauth.client.persistence.model.OAuthClientEntry
			addOAuthClientEntry(
				...
				String authServerWellKnownURI, String authRequestParametersJSON,
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, userId, authServerWellKnownURI,
				authRequestParametersJSON, infoJSON,
	...
	public static com.liferay.oauth.client.persistence.model.OAuthClientEntry
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, oAuthClientEntryId, authServerWellKnownURI,
				authRequestParametersJSON, infoJSON,
				tokenRequestParametersJSON);
