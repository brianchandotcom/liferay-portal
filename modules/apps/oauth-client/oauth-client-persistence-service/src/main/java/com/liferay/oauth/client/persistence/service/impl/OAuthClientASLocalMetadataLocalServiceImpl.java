...
import com.liferay.oauth.client.persistence.exception.OAuthClientASLocalMetadataLocalWellKnownURILengthException;
...
public class OAuthClientASLocalMetadataLocalServiceImpl
	...
	private void _validateWellKnownURILength(
		...
		if (wellKnownURI.length() > maxLength) {
			throw new OAuthClientASLocalMetadataLocalWellKnownURILengthException(
				StringBundler.concat(
					"Issuer is too long to generate ", fieldName,
					", which is limited to ", maxLength, " characters"));
		}
	}
