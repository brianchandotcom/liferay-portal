...
public class OAuthClientEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newOAuthClientEntry.setRequestParamsJSON(RandomTestUtil.randomString());
		...
		Assert.assertEquals(
			existingOAuthClientEntry.getRequestParamsJSON(),
			newOAuthClientEntry.getRequestParamsJSON());
	}
	...
	protected OAuthClientEntry addOAuthClientEntry() throws Exception {
		...
		oAuthClientEntry.setRequestParamsJSON(RandomTestUtil.randomString());
