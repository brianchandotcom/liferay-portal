...
public class OAuth2AccessTokenWrapper implements OAuth2AccessToken,
	...
	*/
	...
	/**
	* Returns the o auth2 access token content of this o auth2 access token.
	*
	* @return the o auth2 access token content of this o auth2 access token
	*/
	@Override
	public java.lang.String getOAuth2AccessTokenContent() {
		return _oAuth2AccessToken.getOAuth2AccessTokenContent();
	}
	...
	*/
	...
	/**
	* Returns the o auth2 access token type of this o auth2 access token.
	*
	* @return the o auth2 access token type of this o auth2 access token
	*/
	@Override
	public java.lang.String getOAuth2AccessTokenType() {
		return _oAuth2AccessToken.getOAuth2AccessTokenType();
	}
	...
	*/
	...
	/**
	* Sets the o auth2 access token content of this o auth2 access token.
	*
	* @param OAuth2AccessTokenContent the o auth2 access token content of this o auth2 access token
	*/
	@Override
	public void setOAuth2AccessTokenContent(
		java.lang.String OAuth2AccessTokenContent) {
		_oAuth2AccessToken.setOAuth2AccessTokenContent(OAuth2AccessTokenContent);
	}
	...
	*/
	...
	/**
	* Sets the o auth2 access token type of this o auth2 access token.
	*
	* @param OAuth2AccessTokenType the o auth2 access token type of this o auth2 access token
	*/
	@Override
	public void setOAuth2AccessTokenType(java.lang.String OAuth2AccessTokenType) {
		_oAuth2AccessToken.setOAuth2AccessTokenType(OAuth2AccessTokenType);
	}
