...
public interface OAuth2ScopeGrant extends OAuth2ScopeGrantModel, PersistedModel {
	...
	public static final Accessor<OAuth2ScopeGrant, String> APPLICATION_NAME_ACCESSOR =
	...
	public static final Accessor<OAuth2ScopeGrant, String> BUNDLE_SYMBOLIC_NAME_ACCESSOR =
		new Accessor<OAuth2ScopeGrant, String>() {
			@Override
			public String get(OAuth2ScopeGrant oAuth2ScopeGrant) {
	...
	public static final Accessor<OAuth2ScopeGrant, String> O_AUTH2_SCOPE_NAME_ACCESSOR =
		new Accessor<OAuth2ScopeGrant, String>() {
			@Override
			public String get(OAuth2ScopeGrant oAuth2ScopeGrant) {
				return oAuth2ScopeGrant.getOAuth2ScopeName();
			}
