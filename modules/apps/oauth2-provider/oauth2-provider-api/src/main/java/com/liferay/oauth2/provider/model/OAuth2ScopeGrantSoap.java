...
public class OAuth2ScopeGrantSoap implements Serializable {
	...
	public OAuth2ScopeGrantPK getPrimaryKey() {
		return new OAuth2ScopeGrantPK(_oAuth2ScopeGrantId, _applicationName,
			_bundleSymbolicName, _companyId, _oAuth2ScopeName, _oAuth2TokenId);
	}

	public void setPrimaryKey(OAuth2ScopeGrantPK pk) {
		setOAuth2ScopeGrantId(pk.oAuth2ScopeGrantId);
