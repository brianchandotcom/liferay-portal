...
public interface OAuth2AccessTokenPersistence extends BasePersistence<OAuth2AccessToken> {
	...
	*/
	...
	/**
	* Returns the o auth2 access token where OAuth2AccessTokenContent = &#63; or throws a {@link NoSuchOAuth2AccessTokenException} if it could not be found.
	*
	* @param OAuth2AccessTokenContent the o auth2 access token content
	* @return the matching o auth2 access token
	* @throws NoSuchOAuth2AccessTokenException if a matching o auth2 access token could not be found
	*/
	public OAuth2AccessToken findByTokenContent(
		java.lang.String OAuth2AccessTokenContent)
		throws NoSuchOAuth2AccessTokenException;

	/**
	* Returns the o auth2 access token where OAuth2AccessTokenContent = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	*
	* @param OAuth2AccessTokenContent the o auth2 access token content
	...
	*/
	...
	/**
	* Returns the o auth2 access token where OAuth2AccessTokenContent = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	*
	* @param OAuth2AccessTokenContent the o auth2 access token content
	* @param retrieveFromCache whether to retrieve from the finder cache
	* @return the matching o auth2 access token, or <code>null</code> if a matching o auth2 access token could not be found
	*/
	public OAuth2AccessToken fetchByTokenContent(
		java.lang.String OAuth2AccessTokenContent, boolean retrieveFromCache);

	/**
	* Removes the o auth2 access token where OAuth2AccessTokenContent = &#63; from the database.
	*
	* @param OAuth2AccessTokenContent the o auth2 access token content
	* @return the o auth2 access token that was removed
	*/
	public OAuth2AccessToken removeByTokenContent(
		java.lang.String OAuth2AccessTokenContent)
		throws NoSuchOAuth2AccessTokenException;

	/**
	* Returns the number of o auth2 access tokens where OAuth2AccessTokenContent = &#63;.
	*
	* @param OAuth2AccessTokenContent the o auth2 access token content
	* @return the number of matching o auth2 access tokens
	*/
	public int countByTokenContent(java.lang.String OAuth2AccessTokenContent);
