...
public class OAuth2AccessTokenUtil {
	...
	*/
	public static OAuth2AccessToken findByTokenContent(
		...
		throws com.liferay.oauth2.provider.exception.NoSuchOAuth2AccessTokenException {
		return getPersistence().findByTokenContent(OAuth2AccessTokenContent);
	}
	...
	*/
	public static OAuth2AccessToken fetchByTokenContent(
		java.lang.String OAuth2AccessTokenContent) {
		return getPersistence().fetchByTokenContent(OAuth2AccessTokenContent);
	}
	...
	*/
	public static OAuth2AccessToken fetchByTokenContent(
		...
		return getPersistence()
				   .fetchByTokenContent(OAuth2AccessTokenContent,
			retrieveFromCache);
	}
	...
	*/
	public static OAuth2AccessToken removeByTokenContent(
		java.lang.String OAuth2AccessTokenContent)
		throws com.liferay.oauth2.provider.exception.NoSuchOAuth2AccessTokenException {
		return getPersistence().removeByTokenContent(OAuth2AccessTokenContent);
	}
	...
	*/
	public static int countByTokenContent(
		java.lang.String OAuth2AccessTokenContent) {
		return getPersistence().countByTokenContent(OAuth2AccessTokenContent);
	}
