...
public class OAuth2RefreshTokenUtil {
	...
	*/
	public static OAuth2RefreshToken findByTokenContent(
		...
		throws com.liferay.oauth2.provider.exception.NoSuchOAuth2RefreshTokenException {
		return getPersistence().findByTokenContent(oAuth2RefreshTokenContent);
	}
	...
	*/
	public static OAuth2RefreshToken fetchByTokenContent(
		java.lang.String oAuth2RefreshTokenContent) {
		return getPersistence().fetchByTokenContent(oAuth2RefreshTokenContent);
	}
	...
	*/
	public static OAuth2RefreshToken fetchByTokenContent(
		...
		return getPersistence()
				   .fetchByTokenContent(oAuth2RefreshTokenContent,
			retrieveFromCache);
	}
	...
	*/
	public static OAuth2RefreshToken removeByTokenContent(
		java.lang.String oAuth2RefreshTokenContent)
		throws com.liferay.oauth2.provider.exception.NoSuchOAuth2RefreshTokenException {
		return getPersistence().removeByTokenContent(oAuth2RefreshTokenContent);
	}
	...
	* @return the number of matching o auth2 refresh tokens
	*/
	public static int countByTokenContent(
		java.lang.String oAuth2RefreshTokenContent) {
		return getPersistence().countByTokenContent(oAuth2RefreshTokenContent);
	}
