...
public class OAuth2ScopeGrantPK implements Comparable<OAuth2ScopeGrantPK>,
	...
	public OAuth2ScopeGrantPK(long oAuth2ScopeGrantId, String applicationName,
	...
	public int compareTo(OAuth2ScopeGrantPK pk) {
		...
		if (oAuth2ScopeGrantId < pk.oAuth2ScopeGrantId) {
			value = -1;
		}
		else if (oAuth2ScopeGrantId > pk.oAuth2ScopeGrantId) {
			value = 1;
		}
		else {
			value = 0;
	...
	public boolean equals(Object obj) {
		...
		if ((oAuth2ScopeGrantId == pk.oAuth2ScopeGrantId) &&
				(applicationName.equals(pk.applicationName)) &&
	...
	public int hashCode() {
		...
		hashCode = HashUtil.hash(hashCode, oAuth2ScopeGrantId);
