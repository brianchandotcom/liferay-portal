...
public class OAuth2ScopeGrantModelImpl extends BaseModelImpl<OAuth2ScopeGrant>
	...
	public static final String TABLE_SQL_CREATE = "create table OAuth2ScopeGrant (oAuth2ScopeGrantId LONG not null,createDate DATE null,applicationName VARCHAR(75) not null,bundleSymbolicName VARCHAR(75) not null,companyId LONG not null,oAuth2ScopeName VARCHAR(75) not null,oAuth2TokenId LONG not null,primary key (oAuth2ScopeGrantId, applicationName, bundleSymbolicName, companyId, oAuth2ScopeName, oAuth2TokenId))";
	public static final String TABLE_SQL_DROP = "drop table OAuth2ScopeGrant";
	public static final String ORDER_BY_JPQL = " ORDER BY oAuth2ScopeGrant.id.oAuth2ScopeGrantId ASC, oAuth2ScopeGrant.id.applicationName ASC, oAuth2ScopeGrant.id.bundleSymbolicName ASC, oAuth2ScopeGrant.id.companyId ASC, oAuth2ScopeGrant.id.oAuth2ScopeName ASC, oAuth2ScopeGrant.id.oAuth2TokenId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY OAuth2ScopeGrant.oAuth2ScopeGrantId ASC, OAuth2ScopeGrant.applicationName ASC, OAuth2ScopeGrant.bundleSymbolicName ASC, OAuth2ScopeGrant.companyId ASC, OAuth2ScopeGrant.oAuth2ScopeName ASC, OAuth2ScopeGrant.oAuth2TokenId ASC";
	...
	public static final long OAUTH2SCOPENAME_COLUMN_BITMASK = 8L;
	...
	public void setPrimaryKey(OAuth2ScopeGrantPK primaryKey) {
		setOAuth2ScopeGrantId(primaryKey.oAuth2ScopeGrantId);
	...
	public void setOAuth2TokenId(long oAuth2TokenId) {
		...
		if (!_setOriginalOAuth2TokenId) {
			_setOriginalOAuth2TokenId = true;
	...
	public long getOriginalOAuth2TokenId() {
		return _originalOAuth2TokenId;
	}
	...
	public void resetOriginalValues() {
		...
		oAuth2ScopeGrantModelImpl._setOriginalOAuth2TokenId = false;
	...
	private long _originalOAuth2TokenId;
	private boolean _setOriginalOAuth2TokenId;
