...
public class OAuth2AccessTokenPersistenceImpl extends BasePersistenceImpl<OAuth2AccessToken>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_TOKENCONTENT = new FinderPath(OAuth2AccessTokenModelImpl.ENTITY_CACHE_ENABLED,
			...
			OAuth2AccessTokenModelImpl.OAUTH2ACCESSTOKENCONTENT_COLUMN_BITMASK);
	 ...
	 */
	@Override
	public OAuth2AccessToken findByTokenContent(String OAuth2AccessTokenContent)
		throws NoSuchOAuth2AccessTokenException {
		OAuth2AccessToken oAuth2AccessToken = fetchByTokenContent(OAuth2AccessTokenContent);
		...
		if (oAuth2AccessToken == null) {
			...
			msg.append("OAuth2AccessTokenContent=");
			msg.append(OAuth2AccessTokenContent);
	...
	public OAuth2AccessToken fetchByTokenContent(
		...
		return fetchByTokenContent(OAuth2AccessTokenContent, true);
	}
	...
	@Override
	public OAuth2AccessToken fetchByTokenContent(
		String OAuth2AccessTokenContent, boolean retrieveFromCache) {
		Object[] finderArgs = new Object[] { OAuth2AccessTokenContent };
		...
		if (result instanceof OAuth2AccessToken) {
			...
			if (!Objects.equals(OAuth2AccessTokenContent,
						oAuth2AccessToken.getOAuth2AccessTokenContent())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			boolean bindOAuth2AccessTokenContent = false;

			if (OAuth2AccessTokenContent == null) {
				query.append(_FINDER_COLUMN_TOKENCONTENT_OAUTH2ACCESSTOKENCONTENT_1);
			}
			else if (OAuth2AccessTokenContent.equals("")) {
				query.append(_FINDER_COLUMN_TOKENCONTENT_OAUTH2ACCESSTOKENCONTENT_3);
			}
			else {
				bindOAuth2AccessTokenContent = true;

				query.append(_FINDER_COLUMN_TOKENCONTENT_OAUTH2ACCESSTOKENCONTENT_2);
			}
			...
			try {
				...
				if (bindOAuth2AccessTokenContent) {
					qPos.add(OAuth2AccessTokenContent);
				}
				...
				if (list.isEmpty()) {
					...
					if ((oAuth2AccessToken.getOAuth2AccessTokenContent() == null) ||
							!oAuth2AccessToken.getOAuth2AccessTokenContent()
												  .equals(OAuth2AccessTokenContent)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_TOKENCONTENT,
	...
	public OAuth2AccessToken removeByTokenContent(
		String OAuth2AccessTokenContent)
		throws NoSuchOAuth2AccessTokenException {
		OAuth2AccessToken oAuth2AccessToken = findByTokenContent(OAuth2AccessTokenContent);
	 ...
	 */
	@Override
	public int countByTokenContent(String OAuth2AccessTokenContent) {
	...
	private static final String _FINDER_COLUMN_TOKENCONTENT_OAUTH2ACCESSTOKENCONTENT_1 =
		"oAuth2AccessToken.OAuth2AccessTokenContent IS NULL";
	private static final String _FINDER_COLUMN_TOKENCONTENT_OAUTH2ACCESSTOKENCONTENT_2 =
		"oAuth2AccessToken.OAuth2AccessTokenContent = ?";
	private static final String _FINDER_COLUMN_TOKENCONTENT_OAUTH2ACCESSTOKENCONTENT_3 =
		"(oAuth2AccessToken.OAuth2AccessTokenContent IS NULL OR oAuth2AccessToken.OAuth2AccessTokenContent = '')";
	...
	public void cacheResult(OAuth2AccessToken oAuth2AccessToken) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_TOKENCONTENT,
			new Object[] { oAuth2AccessToken.getOAuth2AccessTokenContent() },
			oAuth2AccessToken);
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
				oAuth2AccessTokenModelImpl.getOAuth2AccessTokenContent()
			};
	...
	protected void clearUniqueFindersCache(
		...
		if ((oAuth2AccessTokenModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
					oAuth2AccessTokenModelImpl.getOriginalOAuth2AccessTokenContent()
				};
	...
	protected OAuth2AccessToken toUnwrappedModel(
		...
		oAuth2AccessTokenImpl.setOAuth2AccessTokenContent(oAuth2AccessToken.getOAuth2AccessTokenContent());
		oAuth2AccessTokenImpl.setOAuth2AccessTokenType(oAuth2AccessToken.getOAuth2AccessTokenType());
