...
public class OAuth2RefreshTokenPersistenceImpl extends BasePersistenceImpl<OAuth2RefreshToken>
	 ...
	 */
	@Override
	public OAuth2RefreshToken findByTokenContent(
		String oAuth2RefreshTokenContent)
		throws NoSuchOAuth2RefreshTokenException {
		OAuth2RefreshToken oAuth2RefreshToken = fetchByTokenContent(oAuth2RefreshTokenContent);
	...
	public OAuth2RefreshToken fetchByTokenContent(
		String oAuth2RefreshTokenContent) {
		return fetchByTokenContent(oAuth2RefreshTokenContent, true);
	}
	...
	@Override
	public OAuth2RefreshToken fetchByTokenContent(
		String oAuth2RefreshTokenContent, boolean retrieveFromCache) {
		...
		if (result == null) {
			...
			if (oAuth2RefreshTokenContent == null) {
				query.append(_FINDER_COLUMN_TOKENCONTENT_OAUTH2REFRESHTOKENCONTENT_1);
			}
			else if (oAuth2RefreshTokenContent.equals("")) {
				query.append(_FINDER_COLUMN_TOKENCONTENT_OAUTH2REFRESHTOKENCONTENT_3);
			}
			else {
				bindOAuth2RefreshTokenContent = true;

				query.append(_FINDER_COLUMN_TOKENCONTENT_OAUTH2REFRESHTOKENCONTENT_2);
			}
	...
	public OAuth2RefreshToken removeByTokenContent(
		String oAuth2RefreshTokenContent)
		throws NoSuchOAuth2RefreshTokenException {
		OAuth2RefreshToken oAuth2RefreshToken = findByTokenContent(oAuth2RefreshTokenContent);
	 ...
	 */
	@Override
	public int countByTokenContent(String oAuth2RefreshTokenContent) {
	...
	private static final String _FINDER_COLUMN_TOKENCONTENT_OAUTH2REFRESHTOKENCONTENT_1 =
		"oAuth2RefreshToken.oAuth2RefreshTokenContent IS NULL";
	private static final String _FINDER_COLUMN_TOKENCONTENT_OAUTH2REFRESHTOKENCONTENT_2 =
		"oAuth2RefreshToken.oAuth2RefreshTokenContent = ?";
	private static final String _FINDER_COLUMN_TOKENCONTENT_OAUTH2REFRESHTOKENCONTENT_3 =
		"(oAuth2RefreshToken.oAuth2RefreshTokenContent IS NULL OR oAuth2RefreshToken.oAuth2RefreshTokenContent = '')";
	...
	public void cacheResult(OAuth2RefreshToken oAuth2RefreshToken) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_TOKENCONTENT,
			new Object[] { oAuth2RefreshToken.getOAuth2RefreshTokenContent() },
			oAuth2RefreshToken);
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
				oAuth2RefreshTokenModelImpl.getOAuth2RefreshTokenContent()
			};
	...
	protected void clearUniqueFindersCache(
		...
		if ((oAuth2RefreshTokenModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
					oAuth2RefreshTokenModelImpl.getOriginalOAuth2RefreshTokenContent()
				};
