...
public class OAuth2ApplicationLDPDomainUpgradeProcessTest {
	...
	public void testUpgrade() throws Exception {
		...
		Assert.assertEquals(
			"https://ldp.liferay.com", _selectColumn("homePageURL"));
		Assert.assertEquals(
	...
	private List<String> _getRedirectURIs() throws Exception {
		return ListUtil.fromArray(
			StringUtil.split(_selectColumn("redirectURIs"), CharPool.NEW_LINE));
	}
	...
	private String _selectColumn(String columnName) throws Exception {
