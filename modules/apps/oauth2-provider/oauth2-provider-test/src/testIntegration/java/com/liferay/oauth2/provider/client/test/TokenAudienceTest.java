...
public class TokenAudienceTest extends BaseClientTestCase {
	...
	public void testTokenIntrospectionAudienceWithAuthorizationCodeGrant()
		...
		JSONObject tokenJSONObject = _getAuthorizationCodeTokenJSONObject();

		Assert.assertEquals(
			Collections.singletonList(_RESOURCE_URI),
			_getAudiences(tokenJSONObject.getString("access_token")));
	}
	...
	public void testTokenIntrospectionAudienceWithRefreshTokenGrant()
		...
		JSONObject refreshTokenJSONObject = _getRefreshTokenJSONObject(
			tokenJSONObject.getString("refresh_token"), null);
	...
	@Test
	public void testTokenRefreshWithGrantedResource() throws Exception {
		JSONObject tokenJSONObject = _getAuthorizationCodeTokenJSONObject();

		JSONObject refreshTokenJSONObject = _getRefreshTokenJSONObject(
			tokenJSONObject.getString("refresh_token"), _RESOURCE_URI);
	...
	@Test
	public void testTokenRefreshWithInvalidResource() throws Exception {
		_testTokenRefreshWithInvalidResource(RandomTestUtil.randomString());
		_testTokenRefreshWithInvalidResource(
			StringBundler.concat(
				Http.HTTPS_WITH_SLASH, RandomTestUtil.randomString(), "/#",
				RandomTestUtil.randomString()));
		_testTokenRefreshWithInvalidResource(StringPool.SPACE);
	}

	@Test
	public void testTokenRefreshWithUngrantedResource() throws Exception {
		JSONObject tokenJSONObject = _getAuthorizationCodeTokenJSONObject();

		Response response = _getRefreshTokenResponse(
			tokenJSONObject.getString("refresh_token"),
			Http.HTTPS_WITH_SLASH + RandomTestUtil.randomString());
	...
	private void _testTokenRefreshWithInvalidResource(String resource)
		throws Exception {

		JSONObject tokenJSONObject = _getAuthorizationCodeTokenJSONObject();

		Response response = _getRefreshTokenResponse(
			tokenJSONObject.getString("refresh_token"), resource);
