...
public abstract class BaseObjectActionResourceImpl
	...
	public void create(
		...
		contextBatchStrategy.apply(objectActions, objectActionUnsafeConsumer);
	}
	...
	public List<com.liferay.portal.vulcan.batch.engine.Field>
		...
		return Arrays.asList(
			...
			com.liferay.portal.vulcan.batch.engine.Field.of(
				"", "objectActionExecutorKey", false, false, String.class,
				false),
			com.liferay.portal.vulcan.batch.engine.Field.of(
				"", "objectActionTriggerKey", false, false, String.class,
				false),
			com.liferay.portal.vulcan.batch.engine.Field.of(
				"", "parameters", false, false, Map.class, false));
	}
