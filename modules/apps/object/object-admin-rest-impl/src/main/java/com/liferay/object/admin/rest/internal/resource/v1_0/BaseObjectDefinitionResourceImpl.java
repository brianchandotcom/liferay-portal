...
public abstract class BaseObjectDefinitionResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/object-admin/v1.0/object-definitions' -d $'{"name": ___, "objectFields": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
