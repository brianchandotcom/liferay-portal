...
public abstract class BaseObjectFieldResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/object-admin/v1.0/object-definitions/{objectDefinitionId}/fields'  -u 'test@liferay.com:test'
	 */
	@GET
	@Override
	@Parameters(
	...
	@Path("/object-definitions/{objectDefinitionId}/fields")
