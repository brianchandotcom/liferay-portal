...
public abstract class BaseObjectViewResourceTestCase {
	...
	@Test
	public void testGetObjectDefinitionByExternalReferenceCodeObjectDefinitionExternalReferenceCodeObjectViewsPage()
		throws Exception {

		String objectDefinitionExternalReferenceCode =
			testGetObjectDefinitionByExternalReferenceCodeObjectDefinitionExternalReferenceCodeObjectViewsPage_getObjectDefinitionExternalReferenceCode();
		String irrelevantObjectDefinitionExternalReferenceCode =
			testGetObjectDefinitionByExternalReferenceCodeObjectDefinitionExternalReferenceCodeObjectViewsPage_getIrrelevantObjectDefinitionExternalReferenceCode();
		...
		if (irrelevantObjectDefinitionExternalReferenceCode != null) {
			ObjectView irrelevantObjectView =
				testGetObjectDefinitionByExternalReferenceCodeObjectDefinitionExternalReferenceCodeObjectViewsPage_addObjectView(
		...
		ObjectView objectView1 =
			testGetObjectDefinitionByExternalReferenceCodeObjectDefinitionExternalReferenceCodeObjectViewsPage_addObjectView(
				objectDefinitionExternalReferenceCode, randomObjectView());
	...
	@Test
	public void testGetObjectDefinitionByExternalReferenceCodeObjectDefinitionExternalReferenceCodeObjectViewsPageWithPagination()
		throws Exception {
	...
	@Test
	public void testPostObjectDefinitionByExternalReferenceCodeObjectDefinitionExternalReferenceCodeObjectView()
		throws Exception {

		ObjectView randomObjectView = randomObjectView();

		ObjectView postObjectView =
			testPostObjectDefinitionByExternalReferenceCodeObjectDefinitionExternalReferenceCodeObjectView_addObjectView(
				randomObjectView);
