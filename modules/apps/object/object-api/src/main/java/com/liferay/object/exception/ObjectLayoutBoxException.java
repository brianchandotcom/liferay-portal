...
public class ObjectLayoutBoxException extends PortalException {
	...
	public static class MustBeDefaultStorageType
		...
		public MustBeDefaultStorageType(String name) {
			super(
				StringBundler.concat(
					"The ", name, " layout box only can be used in object ",
	...
	public static class MustBeEnabled extends ObjectLayoutBoxException {
		...
		public MustBeEnabled(String name) {
			super(
				StringBundler.concat(
					"The ", name, " layout box must be enabled on the object ",
	...
	public static class MustNotHaveObjectLayoutRows
		...
		public MustNotHaveObjectLayoutRows(String name) {
			super(
				StringBundler.concat(
					"The ", name, " layout box must not have layout rows"));
		}

	}

	public static class MustOnlyContainOnePerLayout
		extends ObjectLayoutBoxException {

		public MustOnlyContainOnePerLayout(String name) {
			super(
				StringBundler.concat(
					"There can only be one ", name, " layout box per layout"));
		}
