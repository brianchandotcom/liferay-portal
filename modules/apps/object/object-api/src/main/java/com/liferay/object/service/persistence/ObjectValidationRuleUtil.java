...
public class ObjectValidationRuleUtil {
	 ...
	 * @return the matching object validation rules
	 */
	public static List<ObjectValidationRule> findByO_A(
		long objectDefinitionId, boolean active) {

		return getPersistence().findByO_A(objectDefinitionId, active);
	}
	...
	public static List<ObjectValidationRule> findByO_A(
		...
		return getPersistence().findByO_A(
	 ...
	 * @throws NoSuchObjectValidationRuleException if a matching object validation rule could not be found
	 */
	public static ObjectValidationRule findByO_A_First(
			long objectDefinitionId, boolean active,
			OrderByComparator<ObjectValidationRule> orderByComparator)
		throws com.liferay.object.exception.
			NoSuchObjectValidationRuleException {

		return getPersistence().findByO_A_First(
	 ...
	 * @return the first matching object validation rule, or <code>null</code> if a matching object validation rule could not be found
	 */
	public static ObjectValidationRule fetchByO_A_First(
		long objectDefinitionId, boolean active,
		OrderByComparator<ObjectValidationRule> orderByComparator) {

		return getPersistence().fetchByO_A_First(
			objectDefinitionId, active, orderByComparator);
	}
	 ...
	 * @throws NoSuchObjectValidationRuleException if a matching object validation rule could not be found
	 */
	public static ObjectValidationRule findByO_A_Last(
			long objectDefinitionId, boolean active,
			OrderByComparator<ObjectValidationRule> orderByComparator)
		throws com.liferay.object.exception.
			NoSuchObjectValidationRuleException {

		return getPersistence().findByO_A_Last(
			objectDefinitionId, active, orderByComparator);
	}
	 ...
	 * @return the last matching object validation rule, or <code>null</code> if a matching object validation rule could not be found
	 */
	public static ObjectValidationRule fetchByO_A_Last(
		long objectDefinitionId, boolean active,
		OrderByComparator<ObjectValidationRule> orderByComparator) {

		return getPersistence().fetchByO_A_Last(
			objectDefinitionId, active, orderByComparator);
	}
	 ...
	 * @throws NoSuchObjectValidationRuleException if a object validation rule with the primary key could not be found
	 */
	public static ObjectValidationRule[] findByO_A_PrevAndNext(
			long objectValidationRuleId, long objectDefinitionId,
			boolean active,
			OrderByComparator<ObjectValidationRule> orderByComparator)
		throws com.liferay.object.exception.
		...
		return getPersistence().findByO_A_PrevAndNext(
	 ...
	 * @param active the active
	 */
	public static void removeByO_A(long objectDefinitionId, boolean active) {
		getPersistence().removeByO_A(objectDefinitionId, active);
	}
	 ...
	 * @return the number of matching object validation rules
	 */
	public static int countByO_A(long objectDefinitionId, boolean active) {
		return getPersistence().countByO_A(objectDefinitionId, active);
	}
