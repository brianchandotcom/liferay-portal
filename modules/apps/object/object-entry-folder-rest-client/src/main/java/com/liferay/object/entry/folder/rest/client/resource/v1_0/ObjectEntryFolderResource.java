...
package com.liferay.object.entry.folder.rest.client.resource.v1_0;

import com.liferay.object.entry.folder.rest.client.dto.v1_0.ObjectEntryFolder;
import com.liferay.object.entry.folder.rest.client.http.HttpInvoker;
import com.liferay.object.entry.folder.rest.client.pagination.Page;
import com.liferay.object.entry.folder.rest.client.pagination.Pagination;
import com.liferay.object.entry.folder.rest.client.problem.Problem;
...
public interface ObjectEntryFolderResource {
	...
	public HttpInvoker.HttpResponse
			patchScopeScopeKeyObjectEntryFolderByExternalReferenceCodeHttpResponse(
				String scopeKey, String externalReferenceCode,
				ObjectEntryFolder objectEntryFolder)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			putScopeScopeKeyObjectEntryFolderByExternalReferenceCodeHttpResponse(
				String scopeKey, String externalReferenceCode,
				ObjectEntryFolder objectEntryFolder)
		throws Exception;
	...
	public HttpInvoker.HttpResponse
			getScopeScopeKeyObjectEntryFoldersPageHttpResponse(
				String scopeKey, Boolean flatten, String search,
				List<String> aggregations, String filterString,
				Pagination pagination, String sortString)
		throws Exception;
	...
	public static class ObjectEntryFolderResourceImpl
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/object-entry-folder-rest/v1.0/object-entry-folders/{objectEntryFolderId}");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/object-entry-folder-rest/v1.0/object-entry-folders/batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/object-entry-folder-rest/v1.0/scopes/{scopeKey}/object-entry-folder/by-external-reference-code/{externalReferenceCode}");
		...
		public Page<ObjectEntryFolder> getScopeScopeKeyObjectEntryFoldersPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getScopeScopeKeyObjectEntryFoldersPageHttpResponse(
					scopeKey, flatten, search, aggregations, filterString,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/object-entry-folder-rest/v1.0/scopes/{scopeKey}/object-entry-folders");
