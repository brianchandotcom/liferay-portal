...
public class ValidationError implements Serializable {
	...
	public static ValidationError toDTO(String json) {
		return ObjectMapperUtil.readValue(ValidationError.class, json);
	}

	public static ValidationError unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ValidationError.class, json);
	}
	...
	public boolean equals(Object object) {
		...
		return Objects.equals(toString(), validationError.toString());
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.object.rest.dto.v1_0.ValidationError",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-470027769