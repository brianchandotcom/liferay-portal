...
public class ObjectEntryDTOConverter
	...
	public ObjectEntry toDTO(
		...
		return _toDTO(dtoConverterContext, objectEntry, 0);
	}
	...
	private ObjectEntry _toDTO(
			DTOConverterContext dtoConverterContext,
			com.liferay.object.model.ObjectEntry objectEntry,
			int objectNestedFieldsQueryDepth)
		throws Exception {
	...
	private Map<String, Object> _toProperties(
		...
		for (ObjectField objectField : objectFields) {
			...
			else if ((objectNestedFieldsQueryDepth <
						...
						map.put(
							...
							_toDTO(
								...
								_objectEntryLocalService.getObjectEntry(
									objectEntryId),
								objectNestedFieldsQueryDepth + 1));
					}
				}
