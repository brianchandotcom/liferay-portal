...
public abstract class BaseObjectEntryResourceImpl
	...
	@Path("/sites/{siteId}/by-external-reference-code/{externalReferenceCode}")
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "ObjectEntry")})
	...
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "ObjectEntry")})
	public ObjectEntry getSiteByExternalReferenceCode(
			@NotNull @Parameter(hidden = true) @PathParam("siteId") Long siteId,
			@NotNull @Parameter(hidden = true)
			@PathParam("externalReferenceCode")
			String externalReferenceCode)
	...
	@PUT
	@Tags(value = {@Tag(name = "ObjectEntry")})
	public ObjectEntry putSiteByExternalReferenceCode(
			@NotNull @Parameter(hidden = true) @PathParam("siteId") Long siteId,
			@NotNull @Parameter(hidden = true)
			@PathParam("externalReferenceCode")
			String externalReferenceCode,
