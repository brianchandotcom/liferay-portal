...
public class ObjectEntryRelatedObjectsResourceTest {
	...
	private void _assertSystemObjectFieldEmailValue(
	...
	private void _testPostCustomObjectEntryWithNestedSystemObjectEntry(
		...
		_assertSystemObjectFieldEmailValue(
			objectEntryId, objectRelationship, userEmailAddress, manyToOne);
	}
	...
	private void _testPutCustomObjectEntryWithNestedSystemObjectEntry(
		...
		_assertSystemObjectFieldEmailValue(
			objectEntryId, objectRelationship, newEmailAddress, manyToOne);
	}
