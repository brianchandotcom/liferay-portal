...
public class ObjectEntryResourceTest {
	...
	@Test
	public void testPostCustomObjectEntryWithWrongNestedCustomObjectEntriesInRelationship()
		throws Exception {
		...
		try (LogCapture logCapture = LoggerTestUtil.configureLog4JLogger(
			...
			_testPostCustomObjectEntryWithWrongNestedCustomObjectEntriesManyToManyRelationship(
			...
			_testPostCustomObjectEntryWithWrongNestedCustomObjectEntriesManyToOneRelationship(
				_objectDefinition2.getRESTContextPath(), _objectRelationship);

			_testPostCustomObjectEntryWithWrongNestedCustomObjectEntriesOneToManyRelationship(
				_objectDefinition1.getRESTContextPath(), _objectRelationship);
		}
	}
