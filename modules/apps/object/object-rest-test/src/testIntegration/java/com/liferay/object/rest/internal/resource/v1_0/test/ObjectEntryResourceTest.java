...
public class ObjectEntryResourceTest {
	...
	private void _testPatchPutCustomObjectEntryWithAttachmentField(
		...
		// Documents and media source - file with external reference code
		...
		// Documents and media source - file with nested fields
		...
		// Documents and media source - user without permission
		...
		// User computer to cms basic document source
		...
		// User computer to documents and media source
		...
		// User computer to documents and media source - existing file name
		...
		// User computer to documents and media source - file with nested fields
	...
	private void _testPostCustomObjectEntryWithAttachmentObjectField(
		...
		// Documents and media source - file with generated thumbnail
		...
		// User computer to documents and media source - file with external
		// reference code
