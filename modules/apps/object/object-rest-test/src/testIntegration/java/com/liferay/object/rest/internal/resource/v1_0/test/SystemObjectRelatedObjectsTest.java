...
public class SystemObjectRelatedObjectsTest {
	...
	public void testPostSystemObjectEntryWithNestedCustomObjectEntries()
		...
		_testPostSystemObjectEntryWithNestedCustomObjectEntriesInManyToManyRelationship(
			objectRelationship);
		...
		_testPostSystemObjectEntryWithNestedCustomObjectEntriesInOneToOneRelationship(
			objectRelationship);
	}
	...
	@Test
	public void testPutCustomObjectEntryWithNestedCustomObjectEntries()
		throws Exception {
		...
		_testPutCustomObjectEntryWithNestedCustomObjectEntriesInManyToManyRelationship(
			objectRelationship);
		...
		_testPutCustomObjectEntryWithNestedCustomObjectEntriesInOneToManyRelationship(
			objectRelationship);
	}
