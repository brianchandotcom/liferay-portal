 ...
 */
@Component(
	property = "object.field.business.type.key=" + ObjectFieldConstants.BUSINESS_TYPE_MULTI_SELECT_PICKLIST,
	service = {
...
public class MultiSelectPicklistObjectFieldBusinessType
	...
	public String getName() {
		return ObjectFieldConstants.BUSINESS_TYPE_MULTI_SELECT_PICKLIST;
	}
