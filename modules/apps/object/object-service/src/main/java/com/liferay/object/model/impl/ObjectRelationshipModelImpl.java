...
public class ObjectRelationshipModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"objectDefinitionId1FieldId", Types.BIGINT},
		{"objectDefinitionId2", Types.BIGINT},
		{"objectDefinitionId2FieldId", Types.BIGINT}, {"type_", Types.VARCHAR}
	};
	...
	public static ObjectRelationship toModel(ObjectRelationshipSoap soapModel) {
		...
		model.setObjectDefinitionId1FieldId(
			soapModel.getObjectDefinitionId1FieldId());
		model.setObjectDefinitionId2(soapModel.getObjectDefinitionId2());
		model.setObjectDefinitionId2FieldId(
			soapModel.getObjectDefinitionId2FieldId());
	...
	static {
		...
		attributeGetterFunctions.put(
			...
			ObjectRelationship::getObjectDefinitionId1FieldId);
		attributeSetterBiConsumers.put(
			"objectDefinitionId1FieldId",
			(BiConsumer<ObjectRelationship, Long>)
		...
		attributeGetterFunctions.put(
			...
			ObjectRelationship::getObjectDefinitionId2FieldId);
		attributeSetterBiConsumers.put(
			"objectDefinitionId2FieldId",
			(BiConsumer<ObjectRelationship, Long>)
	...
	public ObjectRelationship cloneWithOriginalValues() {
		...
		objectRelationshipImpl.setObjectDefinitionId1(
			this.<Long>getColumnOriginalValue("objectDefinitionId1"));
		objectRelationshipImpl.setObjectDefinitionId1FieldId(
			this.<Long>getColumnOriginalValue("objectDefinitionId1FieldId"));
		objectRelationshipImpl.setObjectDefinitionId2(
			this.<Long>getColumnOriginalValue("objectDefinitionId2"));
		objectRelationshipImpl.setObjectDefinitionId2FieldId(
			this.<Long>getColumnOriginalValue("objectDefinitionId2FieldId"));
	...
	public CacheModel<ObjectRelationship> toCacheModel() {
		...
		objectRelationshipCacheModel.objectDefinitionId1FieldId =
			getObjectDefinitionId1FieldId();

		objectRelationshipCacheModel.objectDefinitionId2 =
			getObjectDefinitionId2();

		objectRelationshipCacheModel.objectDefinitionId2FieldId =
			getObjectDefinitionId2FieldId();
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put(
			"objectDefinitionId1FieldId", _objectDefinitionId1FieldId);
		_columnOriginalValues.put("objectDefinitionId2", _objectDefinitionId2);
		_columnOriginalValues.put(
			"objectDefinitionId2FieldId", _objectDefinitionId2FieldId);
	...
	static {
		...
		columnBitmasks.put("objectDefinitionId1FieldId", 2048L);

		columnBitmasks.put("objectDefinitionId2", 4096L);

		columnBitmasks.put("objectDefinitionId2FieldId", 8192L);
