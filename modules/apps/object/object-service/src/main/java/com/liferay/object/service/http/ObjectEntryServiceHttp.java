...
public class ObjectEntryServiceHttp {
	...
	public static com.liferay.object.model.ObjectEntry addObjectEntry(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_addObjectEntryParameterTypes2);
	...
	public static java.util.List<com.liferay.object.model.ObjectEntry>
			getObjectEntries(
				HttpPrincipal httpPrincipal, long objectDefinitionId, int start,
				int end)
		throws com.liferay.portal.kernel.exception.PortalException {
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getObjectEntriesParameterTypes5);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, objectDefinitionId, start, end);
	...
	public static int getObjectEntriesCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getObjectEntriesCountParameterTypes6);
	...
	private static final Class<?>[] _addObjectEntryParameterTypes2 =
		new Class[] {
	...
	private static final Class<?>[] _getObjectEntriesParameterTypes5 =
		new Class[] {long.class, int.class, int.class};
	private static final Class<?>[] _getObjectEntriesCountParameterTypes6 =
		new Class[] {long.class};
