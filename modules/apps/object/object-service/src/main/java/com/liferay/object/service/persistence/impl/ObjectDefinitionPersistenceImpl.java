...
public class ObjectDefinitionPersistenceImpl
	...
	public ObjectDefinition findByC_ERC_ODI(
		...
		ObjectDefinition objectDefinition = fetchByC_ERC_ODI(
	...
	public ObjectDefinition removeByC_ERC_ODI(
		...
		ObjectDefinition objectDefinition = findByC_ERC_ODI(
			companyId, externalReferenceCode, objectDefinitionId);
	...
	protected void cacheUniqueFindersCache(
		...
		args = new Object[] {
			...
			objectDefinitionModelImpl.getObjectDefinitionId()
		};

		finderCache.putResult(
			_finderPathCountByC_ERC_ODI, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByC_ERC_ODI, args, objectDefinitionModelImpl);
