...
public class ObjectEntryPersistenceImpl
	...
	/**
	 * Returns the object entry where companyId = &#63; and externalReferenceCode = &#63; or throws a <code>NoSuchObjectEntryException</code> if it could not be found.
	 *
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public ObjectEntry findByC_ERC(long companyId, String externalReferenceCode)
		throws NoSuchObjectEntryException {

		ObjectEntry objectEntry = fetchByC_ERC(
	...
	/**
	 * Returns the object entry where companyId = &#63; and externalReferenceCode = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param companyId the company ID
	 * @param externalReferenceCode the external reference code
	 * @return the matching object entry, or <code>null</code> if a matching object entry could not be found
	 */
	@Override
	public ObjectEntry fetchByC_ERC(
	...
	/**
	 * Returns the object entry where companyId = &#63; and externalReferenceCode = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param companyId the company ID
	 * @param externalReferenceCode the external reference code
	 * @param useFinderCache whether to use the finder cache
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"ObjectEntryPersistenceImpl.fetchByC_ERC(long, String, boolean) with parameters (" +
	...
	/**
	 * Removes the object entry where companyId = &#63; and externalReferenceCode = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @param externalReferenceCode the external reference code
	 * @return the object entry that was removed
	 */
	@Override
	public ObjectEntry removeByC_ERC(
			long companyId, String externalReferenceCode)
		throws NoSuchObjectEntryException {

		ObjectEntry objectEntry = findByC_ERC(companyId, externalReferenceCode);

		return remove(objectEntry);
	}

	/**
	 * Returns the number of object entries where companyId = &#63; and externalReferenceCode = &#63;.
	 *
	 * @param companyId the company ID
	 * @param externalReferenceCode the external reference code
	 * @return the number of matching object entries
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_finderPathFetchByC_ERC, args, objectEntryModelImpl);
	}
