...
public class ObjectFieldPersistenceImpl
	...
	public ObjectField findByC_ERC(long companyId, String externalReferenceCode)
		...
		ObjectField objectField = fetchByC_ERC(
	...
	public ObjectField removeByC_ERC(
		...
		ObjectField objectField = findByC_ERC(companyId, externalReferenceCode);
	...
	private static final String _FINDER_COLUMN_C_ERC_EXTERNALREFERENCECODE_3 =
		"(objectField.externalReferenceCode IS NULL OR objectField.externalReferenceCode = '')";
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_finderPathFetchByC_ERC, args, objectFieldModelImpl);
