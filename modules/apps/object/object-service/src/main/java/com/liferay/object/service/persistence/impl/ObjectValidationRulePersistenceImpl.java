...
public class ObjectValidationRulePersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByO_A;
	private FinderPath _finderPathWithoutPaginationFindByO_A;
	private FinderPath _finderPathCountByO_A;
	 ...
	 */
	@Override
	public List<ObjectValidationRule> findByO_A(
	...
	public List<ObjectValidationRule> findByO_A(
		...
		return findByO_A(objectDefinitionId, active, start, end, null);
	}
	...
	public List<ObjectValidationRule> findByO_A(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByO_A;
				finderArgs = new Object[] {objectDefinitionId, active};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByO_A;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_O_A_OBJECTDEFINITIONID_2);

			sb.append(_FINDER_COLUMN_O_A_ACTIVE_2);
	 ...
	 */
	@Override
	public ObjectValidationRule findByO_A_First(
			long objectDefinitionId, boolean active,
			OrderByComparator<ObjectValidationRule> orderByComparator)
		throws NoSuchObjectValidationRuleException {

		ObjectValidationRule objectValidationRule = fetchByO_A_First(
	 ...
	 */
	@Override
	public ObjectValidationRule fetchByO_A_First(
		long objectDefinitionId, boolean active,
		OrderByComparator<ObjectValidationRule> orderByComparator) {

		List<ObjectValidationRule> list = findByO_A(
	 ...
	 */
	@Override
	public ObjectValidationRule findByO_A_Last(
			long objectDefinitionId, boolean active,
			OrderByComparator<ObjectValidationRule> orderByComparator)
		throws NoSuchObjectValidationRuleException {

		ObjectValidationRule objectValidationRule = fetchByO_A_Last(
			objectDefinitionId, active, orderByComparator);
	 ...
	 */
	@Override
	public ObjectValidationRule fetchByO_A_Last(
		long objectDefinitionId, boolean active,
		OrderByComparator<ObjectValidationRule> orderByComparator) {

		int count = countByO_A(objectDefinitionId, active);
	 ...
	 */
	@Override
	public ObjectValidationRule[] findByO_A_PrevAndNext(
			long objectValidationRuleId, long objectDefinitionId,
			boolean active,
			OrderByComparator<ObjectValidationRule> orderByComparator)
		throws NoSuchObjectValidationRuleException {
		...
		try {
			...
			array[0] = getByO_A_PrevAndNext(
				session, objectValidationRule, objectDefinitionId, active,
				orderByComparator, true);

			array[1] = objectValidationRule;

			array[2] = getByO_A_PrevAndNext(
				session, objectValidationRule, objectDefinitionId, active,
				orderByComparator, false);
	...
	protected ObjectValidationRule getByO_A_PrevAndNext(
		Session session, ObjectValidationRule objectValidationRule,
		long objectDefinitionId, boolean active,
		OrderByComparator<ObjectValidationRule> orderByComparator,
		boolean previous) {
	 ...
	 */
	@Override
	public void removeByO_A(long objectDefinitionId, boolean active) {
		for (ObjectValidationRule objectValidationRule :
				findByO_A(
	 ...
	 */
	@Override
	public int countByO_A(long objectDefinitionId, boolean active) {
		FinderPath finderPath = _finderPathCountByO_A;
	...
	private static final String _FINDER_COLUMN_O_A_OBJECTDEFINITIONID_2 =
		"objectValidationRule.objectDefinitionId = ? AND ";

	private static final String _FINDER_COLUMN_O_A_ACTIVE_2 =
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByO_A = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByO_A",
			new String[] {
		...
		_finderPathWithoutPaginationFindByO_A = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByO_A",
			new String[] {Long.class.getName(), Boolean.class.getName()},
			new String[] {"objectDefinitionId", "active_"}, true);

		_finderPathCountByO_A = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByO_A",
			new String[] {Long.class.getName(), Boolean.class.getName()},
