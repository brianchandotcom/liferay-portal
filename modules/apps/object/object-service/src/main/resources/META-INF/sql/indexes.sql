create index IX_D9467C4E on ObjectActionEntry (objectDefinitionId, active_, triggerName[$COLUMN_LENGTH:75$]);
create index IX_CF5322B7 on ObjectActionEntry (uuid_[$COLUMN_LENGTH:75$], companyId);
