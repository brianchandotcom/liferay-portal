...
public class ObjectRelatedModelsProviderTest {
	...
	@Test
	public void testObjectEntry1toMMoveRelatedModelToTrash() throws Exception {
		_testMoveRelatedModelToTrash(
	...
	@FeatureFlag("LPD-53981")
	@Test
	public void testObjectEntryMtoMMoveRelatedModelToTrash() throws Exception {
		_testMoveRelatedModelToTrash(
	...
	private void _testMoveRelatedModelToTrash(String relationshipType)
		throws Exception {
