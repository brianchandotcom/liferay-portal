...
public class ObjectLayoutBoxRowPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newObjectLayoutBoxRow.setOrder(RandomTestUtil.nextInt());
		...
		Assert.assertEquals(
			existingObjectLayoutBoxRow.getOrder(),
			newObjectLayoutBoxRow.getOrder());
	}
	...
	protected OrderByComparator<ObjectLayoutBoxRow> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			"objectLayoutBoxId", true, "order", true);
	}
	...
	protected ObjectLayoutBoxRow addObjectLayoutBoxRow() throws Exception {
		...
		objectLayoutBoxRow.setOrder(RandomTestUtil.nextInt());
