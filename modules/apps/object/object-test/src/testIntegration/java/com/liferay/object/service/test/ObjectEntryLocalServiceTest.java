...
public class ObjectEntryLocalServiceTest {
	...
	public void testAddObjectEntryWithObjectValidationRule() throws Exception {
		...
		_testAddObjectEntryWithObjectValidationRuleUsingOldValue();
	}
	...
	private void _testAddObjectEntryWithObjectValidationRuleUsingOldValue()
		throws Exception {
			...
			ObjectDefinitionTestUtil.addObjectDefinition(
				...
				Arrays.asList(
					ObjectFieldUtil.createObjectField(
						ObjectFieldConstants.BUSINESS_TYPE_TEXT,
						ObjectFieldConstants.DB_TYPE_STRING,
						RandomTestUtil.randomString(), "alfa"),
		...
		ObjectValidationRule objectValidationRule =
			_objectValidationRuleLocalService.addObjectValidationRule(
				...
				LocalizedMapUtil.getLocalizedMap(RandomTestUtil.randomString()),
				LocalizedMapUtil.getLocalizedMap(RandomTestUtil.randomString()),
				"oldValue(\"bravo\") == \"listTypeEntryKey1\"");
