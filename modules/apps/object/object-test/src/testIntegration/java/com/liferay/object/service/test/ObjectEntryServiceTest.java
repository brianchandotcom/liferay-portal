...
public class ObjectEntryServiceTest {
	...
	public void testDeleteObjectEntry() throws Exception {
		try {
			_testDeleteObjectEntry(_defaultUser, _user);
	...
	public void testGetObjectEntry() throws Exception {
		try {
			_testGetObjectEntry(_defaultUser, _user);
	...
	private void _testDeleteObjectEntry(User user, User ownerUser)
		throws Exception {
	...
	private void _testGetObjectEntry(User user, User ownerUser)
		throws Exception {
