		...
		<div class="side-panel-content">
			<div class="side-panel-content__body">
				<div class="sheet">
					...
					<aui:input disabled="<%= Validator.isNotNull(objectField.getRelationshipType()) || objectDefinition.isApproved() || !objectDefinitionsFieldsDisplayContext.hasUpdateObjectDefinitionPermission() %>" name="name" required="<%= true %>" value="<%= objectField.getName() %>" />

					<aui:select disabled="<%= Validator.isNotNull(objectField.getRelationshipType()) || objectDefinition.isApproved() || !objectDefinitionsFieldsDisplayContext.hasUpdateObjectDefinitionPermission() %>" name="type" onChange='<%= liferayPortletResponse.getNamespace() + "onChangeFieldType(event);" %>' required="<%= true %>">
