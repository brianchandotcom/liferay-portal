...
public class ObjectDefinitionsDetailsDisplayContextTest {
	...
	public void setUp() {
		...
		_registerPanelCategory(
			bundleContext, _ROOT_PANEL_CATEGORY_KEY, null, 0);
		_registerPanelCategory(
			bundleContext, _PANEL_CATEGORY_KEY, _ROOT_PANEL_CATEGORY_KEY, 100);
		_registerPanelCategory(
			bundleContext, _DEPRECATED_PANEL_CATEGORY_KEY,
			_ROOT_PANEL_CATEGORY_KEY, 200);
		...
		Mockito.when(
			...
			new String[] {_ROOT_PANEL_CATEGORY_KEY}
		);
	...
	private void _registerPanelCategory(
		...
		String parentPanelCategoryKey, int panelCategoryOrder) {
	...
	private static final String _DEPRECATED_PANEL_CATEGORY_KEY =
		"deprecated_" + RandomTestUtil.randomString();
	...
	private static class TestPanelCategory extends BasePanelCategory {
		...
		public boolean isDeprecated() {
			return _key.startsWith("deprecated_");
		}
