...
package com.liferay.on.demand.admin.internal.generator;
 ...
 * @author Pei-Jung Lan
 */
@Component(immediate = true, service = OnDemandAdminTokenGenerator.class)
public class OnDemandAdminTokenGeneratorImpl
	implements OnDemandAdminTokenGenerator {
