AUI.add(
	...
	function(A) {
		...
		var TPL_CLOSE_BUTTON =
			'<a class="gadget-editor-tab-close icon-remove" href="javascript:;"></a>';
			...
			prototype: {
				initializer: function(config) {
					...
					instance._createEditor(
						instance.get('panelNode'),
						config.editorContent
					);
				...
				updateEditorMode: function(fileName) {
					...
					if (editorModes.css[extension]) {
						...
						editorModes.gadget[extension] ||
						editorModes.html[extension]
					) {
						mode = 'ace/mode/html';
