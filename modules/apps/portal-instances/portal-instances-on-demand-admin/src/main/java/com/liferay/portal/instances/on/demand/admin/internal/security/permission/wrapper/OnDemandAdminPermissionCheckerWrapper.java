...
package com.liferay.portal.instances.on.demand.admin.internal.security.permission.wrapper;
...
public class OnDemandAdminPermissionCheckerWrapper
	...
	public OnDemandAdminPermissionCheckerWrapper(
		...
		OnDemandAdminHelper onDemandAdminHelper,
		UserLocalService userLocalService) {

		super(permissionChecker);

		_onDemandAdminHelper = onDemandAdminHelper;
	...
	private boolean _hasPermission(
		...
		if ((user != null) && _onDemandAdminHelper.isOnDemandAdminUser(user)) {
			return false;
		}
	...
	private final OnDemandAdminHelper _onDemandAdminHelper;
