...
import com.liferay.portal.language.rest.client.resource.v1_0.LanguageResource;
...
public abstract class BaseLanguageResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		language.setKey(regex);
		language.setLanguageId(regex);
		language.setValue(regex);
		...
		Assert.assertEquals(regex, language.getKey());
		Assert.assertEquals(regex, language.getLanguageId());
		Assert.assertEquals(regex, language.getValue());
	}

	@Test
	public void testGetLanguagesPage() throws Exception {
		Page<Language> page = languageResource.getLanguagesPage(
			null, RandomTestUtil.randomString());

		long totalCount = page.getTotalCount();

		Language language1 = testGetLanguagesPage_addLanguage(randomLanguage());

		Language language2 = testGetLanguagesPage_addLanguage(randomLanguage());

		page = languageResource.getLanguagesPage(null, null);

		Assert.assertEquals(totalCount + 2, page.getTotalCount());

		assertContains(language1, (List<Language>)page.getItems());
		assertContains(language2, (List<Language>)page.getItems());
		assertValid(page, testGetLanguagesPage_getExpectedActions());
	}

	protected Map<String, Map<String, String>>
			testGetLanguagesPage_getExpectedActions()
		throws Exception {
	...
	protected Language testGetLanguagesPage_addLanguage(Language language)
		throws Exception {
	...
	@Test
	public void testGraphQLGetLanguagesPage() throws Exception {
		...
		Language language1 = testGraphQLGetLanguagesPage_addLanguage();
		Language language2 = testGraphQLGetLanguagesPage_addLanguage();
	...
	protected Language testGraphQLGetLanguagesPage_addLanguage()
		throws Exception {
	...
	@Test
	public void testPostLanguage() throws Exception {
		@SuppressWarnings("PMD.UnusedLocalVariable")
		Language language = testPostLanguage_addLanguage();

		assertHttpResponseStatusCode(
			204, languageResource.postLanguageHttpResponse(null, null));

		assertHttpResponseStatusCode(
			404, languageResource.postLanguageHttpResponse(null, null));
	}

	protected Language testPostLanguage_addLanguage() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}
	...
	public void testPutLanguage() throws Exception {
		Language postLanguage = testPutLanguage_addLanguage();

		Language randomLanguage = randomLanguage();

		Language putLanguage = languageResource.putLanguage(randomLanguage);

		assertEquals(randomLanguage, putLanguage);
		assertValid(putLanguage);

		Language getLanguage = languageResource.getLanguage();

		assertEquals(randomLanguage, getLanguage);
		assertValid(getLanguage);
	}

	protected Language testPutLanguage_addLanguage() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}

	@Test
	public void testDeleteLanguageByKey() throws Exception {
		@SuppressWarnings("PMD.UnusedLocalVariable")
		Language language = testDeleteLanguageByKey_addLanguage();

		assertHttpResponseStatusCode(
			204, languageResource.deleteLanguageByKeyHttpResponse(null, null));
	}

	protected Language testDeleteLanguageByKey_addLanguage() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.portal.language.rest.dto.v1_0.Language.class)) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("createDate", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						language1.getCreateDate(), language2.getCreateDate())) {
			...
			if (Objects.equals("key", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						language1.getKey(), language2.getKey())) {
			...
			if (Objects.equals("modifiedDate", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						language1.getModifiedDate(),
						language2.getModifiedDate())) {
			...
			if (Objects.equals("override", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						language1.getOverride(), language2.getOverride())) {
			...
			if (Objects.equals("value", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						language1.getValue(), language2.getValue())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("createDate")) {
			if (operator.equals("between")) {
				Date date = language.getCreateDate();
				...
				sb.append(_dateFormat.format(language.getCreateDate()));
			}
		...
		if (entityFieldName.equals("languageId")) {
			Object object = language.getLanguageId();
		...
		if (entityFieldName.equals("modifiedDate")) {
			if (operator.equals("between")) {
				Date date = language.getModifiedDate();
				...
				sb.append(_dateFormat.format(language.getModifiedDate()));
			}
		...
		if (entityFieldName.equals("value")) {
			Object object = language.getValue();
	...
	@Inject
	private com.liferay.portal.language.rest.resource.v1_0.LanguageResource
		_languageResource;
