	...
	private void _addCryptoOfficerPasswordPolicy(long companyId, User user)
		...
		PasswordPolicy passwordPolicy =
			_passwordPolicyLocalService.fetchPasswordPolicy(
				companyId, FIPSConstants.CRYPTO_OFFICER_PASSWORD_POLICY_NAME);
		...
		_passwordPolicyLocalService.addPasswordPolicy(
			...
			FIPSConstants.CRYPTO_OFFICER_PASSWORD_POLICY_NAME,
			FIPSConstants.CRYPTO_OFFICER_PASSWORD_POLICY_NAME, true, true,
