...
public class EditLDAPServerMVCActionCommandTest {
	...
	public void testProcessAction() throws Exception {
		...
		portletURLFactoryUtil.setPortletURLFactory(_getPortletURLFactory());
			...
			try (SafeCloseable safeCloseable =
				...
				Assert.assertArrayEquals(
					...
					ldapConfigurationModelListenerException.
						getMessageArguments());
				Assert.assertEquals(
					"the-base-provider-url-x-must-use-the-x-scheme-in-fips-" +
						"mode",
	...
	private PortletURLFactory _getPortletURLFactory() {
		return (PortletURLFactory)ProxyUtil.newProxyInstance(
