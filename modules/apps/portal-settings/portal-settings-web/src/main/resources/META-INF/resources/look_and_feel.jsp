...
<aui:fieldset>
	...
	<liferay-frontend:logo-selector
		currentLogoURL='<%= themeDisplay.getPathImage() + "/liferay_instance_logo?img_id=" + company.getLogoId() %>'
		defaultLogoURL='<%= themeDisplay.getPathImage() + "/liferay_instance_logo?img_id=0" %>'
	/>
</aui:fieldset>
