...
@Meta.OCD(
	...
	localization = "content/Language", name = "vulcan-configuration-name"
)
public interface VulcanConfiguration {
	...
	@Meta.AD(deflt = "true", name = "graphql-enabled", required = false)
	public boolean graphQLEnabled();

	@Meta.AD(deflt = "true", name = "rest-enabled", required = false)
