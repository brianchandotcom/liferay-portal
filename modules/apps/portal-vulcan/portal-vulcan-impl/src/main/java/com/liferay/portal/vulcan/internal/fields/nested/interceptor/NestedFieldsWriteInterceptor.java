 ...
 */
@Provider
public class NestedFieldsWriteInterceptor implements WriterInterceptor {

	public NestedFieldsWriteInterceptor(BundleContext bundleContext) {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NestedFieldsWriteInterceptor.class);
