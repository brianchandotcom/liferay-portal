...
package com.liferay.portal.vulcan.internal.fields.nested.interceptor;
 ...
 * @author Ivica Cardic
 */
public class NestedFieldsWriteInterceptorTest {
	...
	public void setUp() throws Exception {
		...
		_nestedFieldsWriteInterceptor = Mockito.spy(
			new NestedFieldsWriteInterceptor(bundleContext));
	...
	public void testGetNestedFields() throws Exception {
		...
		_nestedFieldsWriteInterceptor.aroundWriteTo(_context);
	...
	private NestedFieldsWriteInterceptor _nestedFieldsWriteInterceptor;
