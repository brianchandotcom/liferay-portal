...
public class BaseGraphQLServlet {
	...
	public static class MockQuery {
		...
		public static void setTestId(long testId) {
			MockQuery._testId = testId;
		}

		public static void setTestString(String testString) {
			MockQuery._testString = testString;
		}

		@com.liferay.portal.vulcan.graphql.annotation.GraphQLField
		public BaseGraphQLServlet.MockQuery.MockDTO mock() throws Exception {
			return new MockDTO() {
				{
					id = _testId;
				}
		...
		@GraphQLTypeExtension(MockDTO.class)
		public class MockGraphQLTypeExtension {

			public MockGraphQLTypeExtension(MockDTO mockDTO) {
				_mockDTO = mockDTO;
			}
			...
			private final MockDTO _mockDTO;
	...
	public static class MockServletDataImpl implements ServletData {

		public MockServletDataImpl(long testId, String testString) {
			MockQuery.setTestId(testId);
			MockQuery.setTestString(testString);
		}
