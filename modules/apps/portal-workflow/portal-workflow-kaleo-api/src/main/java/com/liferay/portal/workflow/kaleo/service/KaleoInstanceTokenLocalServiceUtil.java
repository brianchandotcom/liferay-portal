...
public class KaleoInstanceTokenLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.portal.kernel.search.Hits search(
		...
		com.liferay.portal.kernel.service.ServiceContext serviceContext) {
		return getService()
				   .search(assetDescription, assetTitle, assetType,
			currentKaleoNodeName, kaleoDefinitionName, completed, start, end,
			sorts, serviceContext);
	}

	public static int searchCount(String assetDescription, String assetTitle,
		String assetType, String currentKaleoNodeName,
		String kaleoDefinitionName, Boolean completed,
		com.liferay.portal.kernel.service.ServiceContext serviceContext) {
		return getService()
				   .searchCount(assetDescription, assetTitle, assetType,
