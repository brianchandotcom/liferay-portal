...
public class KaleoInstanceTokenLocalServiceWrapper
	...
	*/
	...
	public com.liferay.portal.workflow.kaleo.model.KaleoInstanceToken addKaleoInstanceToken(
		...
		return _kaleoInstanceTokenLocalService.addKaleoInstanceToken(currentKaleoNodeId,
	...
	*/
	...
	public com.liferay.portal.kernel.search.Hits search(
		String assetDescription, String assetTitle, String assetType,
		String currentKaleoNodeName, String kaleoDefinitionName,
		Boolean completed, int start, int end,
		com.liferay.portal.kernel.search.Sort[] sorts,
		com.liferay.portal.kernel.service.ServiceContext serviceContext) {
		return _kaleoInstanceTokenLocalService.search(assetDescription,
			assetTitle, assetType, currentKaleoNodeName, kaleoDefinitionName,
			completed, start, end, sorts, serviceContext);
	}

	@Override
	public int searchCount(String assetDescription, String assetTitle,
		String assetType, String currentKaleoNodeName,
		String kaleoDefinitionName, Boolean completed,
		com.liferay.portal.kernel.service.ServiceContext serviceContext) {
		return _kaleoInstanceTokenLocalService.searchCount(assetDescription,
			assetTitle, assetType, currentKaleoNodeName, kaleoDefinitionName,
