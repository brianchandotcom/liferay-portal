...
import com.liferay.portal.workflow.kaleo.definition.exception.KaleoDefinitionValidationException.InvalidRecipientType;
...
public enum RecipientType {
	...
	public static RecipientType parse(String value)
		...
		if (Objects.equals(ADDRESS.getValue(), value)) {
			...
			throw new InvalidRecipientType(value);
		}
	}
