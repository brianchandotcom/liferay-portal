...
public class KaleoDefinitionValidationException extends WorkflowException {
	...
	public static class InvalidScriptType
		extends KaleoDefinitionValidationException {

		public InvalidScriptType(String scriptType) {
			super(String.format("Invalid script type %s", scriptType));
		...
		private final String _scriptType;
