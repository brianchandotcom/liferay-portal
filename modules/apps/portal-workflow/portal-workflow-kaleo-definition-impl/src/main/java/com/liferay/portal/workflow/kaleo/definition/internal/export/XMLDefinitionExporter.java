...
import com.liferay.portal.workflow.kaleo.definition.exception.KaleoDefinitionValidationException.InvalidNodeType;
...
public class XMLDefinitionExporter implements DefinitionExporter {
	...
	protected String doExport(Definition definition) throws InvalidNodeType {
		try {
