 ...
 */
@Component(service = PortalDefaultPermissionsCompanyConfiguration.class)
public class PortalDefaultPermissionsCompanyConfigurationImpl
	implements PortalDefaultPermissionsCompanyConfiguration {
			...
			PortalDefaultPermissionsConfiguration
				portalDefaultPermissionsConfiguration =
					_configurationProvider.getCompanyConfiguration(
						PortalDefaultPermissionsConfiguration.class, companyId);

			String defaultPermissions =
				portalDefaultPermissionsConfiguration.defaultPermissions();
