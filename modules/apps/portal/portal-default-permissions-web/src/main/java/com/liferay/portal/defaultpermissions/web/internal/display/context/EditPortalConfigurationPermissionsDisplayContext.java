 ...
 */
public class EditPortalConfigurationPermissionsDisplayContext {

	public EditPortalConfigurationPermissionsDisplayContext(
	...
	private Map<String, Map<String, String[]>> _getDefaultPermissions() {
		...
		_defaultPermissions =
			_portalDefaultPermissionsCompanyConfiguration.getDefaultPermissions(
	...
	private final PortalDefaultPermissionsCompanyConfiguration
		_portalDefaultPermissionsCompanyConfiguration;
