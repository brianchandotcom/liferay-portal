...
@Component(
	property = {
		...
		"mvc.command.name=/configuration/edit_portal_configuration_permissions"
	},
	service = MVCActionCommand.class
)
public class EditPortalConfigurationPermissionsMVCActionCommand
	...
	protected void doProcessAction(
		...
		try {
			...
			Map<String, Map<String, String[]>> defaultPermissions =
				_portalDefaultPermissionsCompanyConfiguration.
			...
			_portalDefaultPermissionsCompanyConfiguration.setDefaultPermissions(
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EditPortalConfigurationPermissionsMVCActionCommand.class);

	@Reference
	private JSONFactory _jsonFactory;

	@Reference
	private PortalDefaultPermissionsCompanyConfiguration
		_portalDefaultPermissionsCompanyConfiguration;
