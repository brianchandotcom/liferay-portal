...
public class EditPortalConfigurationPermissionsMVCRenderCommand
	...
	public String render(
		...
		RequestDispatcher requestDispatcher =
			_servletContext.getRequestDispatcher(
				"/configuration/edit_portal_configuration_permissions.jsp");
		...
		try {
			...
			renderRequest.setAttribute(
				PortalDefaultPermissionsWebKeys.
					PORTAL_DEFAULT_PERMISSIONS_COMPANY_CONFIGURATION,
