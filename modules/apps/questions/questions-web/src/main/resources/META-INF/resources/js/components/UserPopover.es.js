	...
	return (
			...
			header={
				<div className="align-items-center d-flex">
					...
					<div className="c-ml-2">
						<h4 className="font-weight-light h6 text-secondary">{statistics.rank}</h4>
		...
		>
			<div className="text-secondary">
				...
				<p className="c-mb-0">Join Date: {dateToBriefInternationalHuman(statistics.joinDate)}</p>
				<p className="c-mb-0">Last Post Date: {dateToBriefInternationalHuman(statistics.lastPostDate)}</p>
			</div>
