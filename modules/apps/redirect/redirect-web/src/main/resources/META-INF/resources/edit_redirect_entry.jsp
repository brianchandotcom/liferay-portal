...
>
	...
	<liferay-frontend:edit-form-body>
		...
		<aui:select label="type" name="permanent">
			<aui:option label="permanent" selected="<%= (redirectEntry != null) ? redirectEntry.isPermanent() : false %>" value="<%= true %>" />
			<aui:option label="temporary" selected="<%= (redirectEntry != null) ? !redirectEntry.isPermanent() : false %>" value="<%= false %>" />
		</aui:select>
