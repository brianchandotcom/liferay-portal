...
/**
 * The persistence interface for the remote app entry localization service.
 *
 * <p>
 ...
 * @see RemoteAppEntryLocalizationUtil
 * @generated
 */
@ProviderType
public interface RemoteAppEntryLocalizationPersistence
	extends BasePersistence<RemoteAppEntryLocalization> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RemoteAppEntryLocalizationUtil} to access the remote app entry localization persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<RemoteAppEntryLocalization> findByRemoteAppEntryId(
	...
	public java.util.List<RemoteAppEntryLocalization> findByRemoteAppEntryId(
		...
		com.liferay.portal.kernel.util.OrderByComparator
			<RemoteAppEntryLocalization> orderByComparator);
	 ...
	 */
	public void cacheResult(
		java.util.List<RemoteAppEntryLocalization> remoteAppEntryLocalizations);
	 ...
	 */
	public RemoteAppEntryLocalization create(long remoteAppEntryLocalizationId);
	 ...
	 */
	public java.util.List<RemoteAppEntryLocalization> findAll();
