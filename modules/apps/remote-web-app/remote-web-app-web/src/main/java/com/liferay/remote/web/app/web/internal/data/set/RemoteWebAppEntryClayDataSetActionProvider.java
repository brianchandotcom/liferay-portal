...
public class RemoteWebAppEntryClayDataSetActionProvider
	...
	public List<DropdownItem> getDropdownItems(
		...
		RemoteWebAppClayDataSetEntry remoteWebAppClayDataSetEntry =
			(RemoteWebAppClayDataSetEntry)model;

		return DropdownItemListBuilder.add(
			dropdownItem -> _buildEditAction(
				dropdownItem, httpServletRequest, remoteWebAppClayDataSetEntry)
		).add(
	...
	private void _buildDeleteAction(
		...
		deleteEntryURL.setParameter(
			"entryId",
			String.valueOf(remoteWebAppClayDataSetEntry.getEntryId()));
