...
@Component(
	immediate = true,
	property = "clay.data.set.display.name=" + DataSetDisplayConstants.REMOTE_WEB_APP_ENTRY_DATA_SET_DISPLAY,
	service = ClayDataSetDisplayView.class
)
public class RemoteWebAppEntryTableClayDataSetDisplayView
