...
@Component(
	immediate = true,
	property = {
		"com.liferay.portlet.css-class-wrapper=portlet-remote-web-app-admin",
		...
		"javax.portlet.display-name=Remote Web Apps",
...
public class RemoteWebAppAdminPortlet extends MVCPortlet {
}