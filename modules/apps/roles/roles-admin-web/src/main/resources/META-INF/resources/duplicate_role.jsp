...
<portlet:actionURL name="duplicateRole" var="duplicateRoleURL" />

<aui:form action="<%= duplicateRoleURL %>" cssClass="p-4" method="post" name="fm">
...
<liferay-frontend:component
	...
	%>'
	module="{duplicateRoleRedirect} from roles-admin-web"
/>