...
page import="com.liferay.roles.admin.web.internal.role.type.RoleType" %><%@
page import="com.liferay.roles.admin.web.internal.role.type.util.RoleTypeRetrieverUtil" %><%@
