...
public class SavedContentEntryWrapper
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("savedContentId", getSavedContentId());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		Long savedContentId = (Long)attributes.get("savedContentId");

		if (savedContentId != null) {
			setSavedContentId(savedContentId);
		}
	...
	/**
	 * Returns the saved content ID of this saved content entry.
	 *
	 * @return the saved content ID of this saved content entry
	 */
	@Override
	public long getSavedContentId() {
		return model.getSavedContentId();
	}
	...
	/**
	 * Sets the saved content ID of this saved content entry.
	 *
	 * @param savedContentId the saved content ID of this saved content entry
	 */
	@Override
	public void setSavedContentId(long savedContentId) {
		model.setSavedContentId(savedContentId);
	}
