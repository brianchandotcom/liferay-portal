...
public interface SavedContentEntryLocalService
	...
	public SavedContentEntry createSavedContentEntry(long savedContentId);
	...
	public SavedContentEntry deleteSavedContentEntry(long savedContentId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SavedContentEntry fetchSavedContentEntry(long savedContentId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SavedContentEntry getSavedContentEntry(long savedContentId)
		throws PortalException;
