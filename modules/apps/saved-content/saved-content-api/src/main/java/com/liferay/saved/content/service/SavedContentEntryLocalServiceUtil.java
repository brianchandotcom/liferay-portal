...
public class SavedContentEntryLocalServiceUtil {
	...
	public static SavedContentEntry createSavedContentEntry(
		...
		return getService().createSavedContentEntry(savedContentId);
	}
	 ...
	 */
	public static SavedContentEntry deleteSavedContentEntry(long savedContentId)
		throws PortalException {

		return getService().deleteSavedContentEntry(savedContentId);
	}
	...
	public static SavedContentEntry fetchSavedContentEntry(
		...
		return getService().fetchSavedContentEntry(savedContentId);
	}
	 ...
	 * @throws PortalException if a saved content entry with the primary key could not be found
	 */
	public static SavedContentEntry getSavedContentEntry(long savedContentId)
		throws PortalException {

		return getService().getSavedContentEntry(savedContentId);
	}
