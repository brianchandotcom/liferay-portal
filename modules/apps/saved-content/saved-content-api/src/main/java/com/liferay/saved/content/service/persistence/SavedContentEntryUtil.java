...
public class SavedContentEntryUtil {
	 ...
	 *
	 * @param savedContentId the primary key of the current saved content entry
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public static SavedContentEntry[] findByGroupId_PrevAndNext(
			long savedContentId, long groupId,
			OrderByComparator<SavedContentEntry> orderByComparator)
		throws com.liferay.saved.content.exception.
			NoSuchSavedContentEntryException {

		return getPersistence().findByGroupId_PrevAndNext(
			savedContentId, groupId, orderByComparator);
	}
	...
	public static SavedContentEntry[] findByUserId_PrevAndNext(
			long savedContentId, long userId,
			OrderByComparator<SavedContentEntry> orderByComparator)
		throws com.liferay.saved.content.exception.
			NoSuchSavedContentEntryException {

		return getPersistence().findByUserId_PrevAndNext(
			savedContentId, userId, orderByComparator);
	}
	...
	public static SavedContentEntry[] findByG_U_PrevAndNext(
			long savedContentId, long groupId, long userId,
			OrderByComparator<SavedContentEntry> orderByComparator)
		throws com.liferay.saved.content.exception.
			NoSuchSavedContentEntryException {

		return getPersistence().findByG_U_PrevAndNext(
			savedContentId, groupId, userId, orderByComparator);
	}
	...
	public static SavedContentEntry[] findByU_C_PrevAndNext(
			long savedContentId, long userId, long classNameId,
			OrderByComparator<SavedContentEntry> orderByComparator)
		throws com.liferay.saved.content.exception.
			NoSuchSavedContentEntryException {

		return getPersistence().findByU_C_PrevAndNext(
			savedContentId, userId, classNameId, orderByComparator);
	}
	...
	public static SavedContentEntry[] findByC_C_C_PrevAndNext(
			long savedContentId, long companyId, long classNameId, long classPK,
			OrderByComparator<SavedContentEntry> orderByComparator)
		throws com.liferay.saved.content.exception.
			NoSuchSavedContentEntryException {

		return getPersistence().findByC_C_C_PrevAndNext(
			savedContentId, companyId, classNameId, classPK, orderByComparator);
	}
	 ...
	 *
	 * @param savedContentId the primary key for the new saved content entry
	 * @return the new saved content entry
	 */
	public static SavedContentEntry create(long savedContentId) {
		return getPersistence().create(savedContentId);
	}

	/**
	 * Removes the saved content entry with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param savedContentId the primary key of the saved content entry
	 * @return the saved content entry that was removed
	 * @throws NoSuchSavedContentEntryException if a saved content entry with the primary key could not be found
	 */
	public static SavedContentEntry remove(long savedContentId)
		throws com.liferay.saved.content.exception.
			NoSuchSavedContentEntryException {

		return getPersistence().remove(savedContentId);
	}
	 ...
	 * @throws NoSuchSavedContentEntryException if a saved content entry with the primary key could not be found
	 */
	public static SavedContentEntry findByPrimaryKey(long savedContentId)
		throws com.liferay.saved.content.exception.
			NoSuchSavedContentEntryException {

		return getPersistence().findByPrimaryKey(savedContentId);
	}
	 ...
	 */
	public static SavedContentEntry fetchByPrimaryKey(long savedContentId) {
		return getPersistence().fetchByPrimaryKey(savedContentId);
	}
