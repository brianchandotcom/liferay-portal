...
public class SavedContentEntryCacheModel
	...
	public boolean equals(Object object) {
		...
		if ((savedContentId == savedContentEntryCacheModel.savedContentId) &&
	...
	@Override
	public int hashCode() {
		int hashCode = HashUtil.hash(0, savedContentId);
	...
	public SavedContentEntry toEntityModel() {
		...
		savedContentEntryImpl.setSavedContentId(savedContentId);
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		savedContentId = objectInput.readLong();
	...
	public void writeExternal(ObjectOutput objectOutput) throws IOException {
		...
		objectOutput.writeLong(savedContentId);
