...
public class SavedContentEntryModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"savedContentId", Types.BIGINT}, {"groupId", Types.BIGINT},
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("savedContentId", Types.BIGINT);
	...
	public static final String TABLE_SQL_CREATE =
		"create table SavedContentEntry (mvccVersion LONG default 0 not null,ctCollectionId LONG default 0 not null,savedContentId LONG not null,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,classNameId LONG,classPK LONG,primary key (savedContentId, ctCollectionId))";

	public static final String TABLE_SQL_DROP = "drop table SavedContentEntry";

	public static final String ORDER_BY_JPQL =
		" ORDER BY savedContentEntry.savedContentId ASC";
	 ...
	 */
	@Deprecated
	public static final long SAVEDCONTENTID_COLUMN_BITMASK = 32L;
	...
	public long getPrimaryKey() {
		return _savedContentId;
	}

	@Override
	public void setPrimaryKey(long primaryKey) {
		setSavedContentId(primaryKey);
	}
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put(
				"savedContentId", SavedContentEntry::getSavedContentId);
			attributeGetterFunctions.put(
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"savedContentId",
				(BiConsumer<SavedContentEntry, Long>)
					SavedContentEntry::setSavedContentId);
			attributeSetterBiConsumers.put(
				"groupId",
				(BiConsumer<SavedContentEntry, Long>)
	...
	public void setSavedContentId(long savedContentId) {
		...
		_savedContentId = savedContentId;
	}
	...
	public Object clone() {
		...
		savedContentEntryImpl.setSavedContentId(getSavedContentId());
	...
	public SavedContentEntry cloneWithOriginalValues() {
		...
		savedContentEntryImpl.setSavedContentId(
			this.<Long>getColumnOriginalValue("savedContentId"));
	...
	public CacheModel<SavedContentEntry> toCacheModel() {
		...
		savedContentEntryCacheModel.savedContentId = getSavedContentId();
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("savedContentId", _savedContentId);
	...
	static {
		...
		columnBitmasks.put("savedContentId", 4L);
