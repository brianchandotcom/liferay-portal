...
public class SavedContentEntryPersistenceImpl
	...
	public SavedContentEntry[] findByGroupId_PrevAndNext(
		...
		SavedContentEntry savedContentEntry = findByPrimaryKey(savedContentId);
	 ...
	 */
	@Override
	public SavedContentEntry create(long savedContentId) {
		SavedContentEntry savedContentEntry = new SavedContentEntryImpl();

		savedContentEntry.setNew(true);
		savedContentEntry.setPrimaryKey(savedContentId);
	 ...
	 */
	@Override
	public SavedContentEntry remove(long savedContentId)
		throws NoSuchSavedContentEntryException {

		return remove((Serializable)savedContentId);
	}
	 ...
	 */
	@Override
	public SavedContentEntry findByPrimaryKey(long savedContentId)
		throws NoSuchSavedContentEntryException {

		return findByPrimaryKey((Serializable)savedContentId);
	}
	 ...
	 */
	@Override
	public SavedContentEntry fetchByPrimaryKey(long savedContentId) {
		return fetchByPrimaryKey((Serializable)savedContentId);
	}
	...
	static {
		...
		_ctColumnNamesMap.put(
			CTColumnResolutionType.PK, Collections.singleton("savedContentId"));
		_ctColumnNamesMap.put(
