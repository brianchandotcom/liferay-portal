...
public class SavedContentEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertEquals(
			existingSavedContentEntry.getSavedContentId(),
			newSavedContentEntry.getSavedContentId());
		Assert.assertEquals(
	...
	protected OrderByComparator<SavedContentEntry> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			"savedContentId", true, "groupId", true, "companyId", true,
	...
	public void testDynamicQueryByPrimaryKeyExisting() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"savedContentId", newSavedContentEntry.getSavedContentId()));
	...
	public void testDynamicQueryByPrimaryKeyMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"savedContentId", RandomTestUtil.nextLong()));
	...
	public void testDynamicQueryByProjectionExisting() throws Exception {
		...
		dynamicQuery.setProjection(
			ProjectionFactoryUtil.property("savedContentId"));

		Object newSavedContentId = newSavedContentEntry.getSavedContentId();

		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"savedContentId", new Object[] {newSavedContentId}));

		List<Object> result = _persistence.findWithDynamicQuery(dynamicQuery);

		Assert.assertEquals(1, result.size());

		Object existingSavedContentId = result.get(0);

		Assert.assertEquals(existingSavedContentId, newSavedContentId);
	}
	...
	public void testDynamicQueryByProjectionMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"savedContentId", new Object[] {RandomTestUtil.nextLong()}));
