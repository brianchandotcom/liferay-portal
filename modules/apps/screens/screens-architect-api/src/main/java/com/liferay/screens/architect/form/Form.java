...
package com.liferay.screens.architect.form;

import static com.liferay.screens.architect.form.FieldType.BOOLEAN;
import static com.liferay.screens.architect.form.FieldType.DATE;
import static com.liferay.screens.architect.form.FieldType.DOUBLE;
import static com.liferay.screens.architect.form.FieldType.LONG;
import static com.liferay.screens.architect.form.FieldType.STRING;
import static com.liferay.screens.architect.form.FormUtil.getOptionalBoolean;
import static com.liferay.screens.architect.form.FormUtil.getOptionalDate;
import static com.liferay.screens.architect.form.FormUtil.getOptionalDouble;
import static com.liferay.screens.architect.form.FormUtil.getOptionalFormFieldStream;
import static com.liferay.screens.architect.form.FormUtil.getOptionalLong;
import static com.liferay.screens.architect.form.FormUtil.getOptionalString;
import static com.liferay.screens.architect.form.FormUtil.getRequiredBoolean;
import static com.liferay.screens.architect.form.FormUtil.getRequiredDate;
import static com.liferay.screens.architect.form.FormUtil.getRequiredDouble;
import static com.liferay.screens.architect.form.FormUtil.getRequiredFormFieldStream;
import static com.liferay.screens.architect.form.FormUtil.getRequiredLong;
import static com.liferay.screens.architect.form.FormUtil.getRequiredString;

import com.liferay.screens.architect.language.Language;
...
public class Form<T> {
	...
	public T get(Map<String, Object> body) {
		...
		_optionalBooleans.forEach(FormUtil.getOptionalBoolean(body, t));
		_optionalDates.forEach(FormUtil.getOptionalDate(body, t));
		_optionalDoubles.forEach(FormUtil.getOptionalDouble(body, t));
		_optionalLongs.forEach(FormUtil.getOptionalLong(body, t));
		_optionalStrings.forEach(FormUtil.getOptionalString(body, t));
		_requiredBooleans.forEach(FormUtil.getRequiredBoolean(body, t));
		_requiredDates.forEach(FormUtil.getRequiredDate(body, t));
		_requiredDoubles.forEach(FormUtil.getRequiredDouble(body, t));
		_requiredLongs.forEach(FormUtil.getRequiredLong(body, t));
		_requiredStrings.forEach(FormUtil.getRequiredString(body, t));
	...
	public List<FormField> getFormFields() {
		Stream<Stream<FormField>> stream = Stream.of(
			FormUtil.getOptionalFormFieldStream(_optionalBooleans, BOOLEAN),
			FormUtil.getOptionalFormFieldStream(_optionalDates, DATE),
			FormUtil.getOptionalFormFieldStream(_optionalDoubles, DOUBLE),
			FormUtil.getOptionalFormFieldStream(_optionalLongs, LONG),
			FormUtil.getOptionalFormFieldStream(_optionalStrings, STRING),
			FormUtil.getRequiredFormFieldStream(_requiredBooleans, BOOLEAN),
			FormUtil.getRequiredFormFieldStream(_requiredDates, DATE),
			FormUtil.getRequiredFormFieldStream(_requiredDoubles, DOUBLE),
			FormUtil.getRequiredFormFieldStream(_requiredLongs, LONG),
			FormUtil.getRequiredFormFieldStream(_requiredStrings, STRING));
