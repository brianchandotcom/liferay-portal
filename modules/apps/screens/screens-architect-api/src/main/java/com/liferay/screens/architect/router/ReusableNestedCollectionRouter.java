...
package com.liferay.screens.architect.router;
...
import com.liferay.screens.architect.routes.NestedCollectionRoutes.Builder;
 ...
 * com.liferay.screens.architect.representor.Representable} creates a complete
...
public interface ReusableNestedCollectionRouter<T, S, U extends Identifier<S>> {
	 ...
	 * @see   NestedCollectionRoutes.Builder
	 */
	public NestedCollectionRoutes<T, S> collectionRoutes(
