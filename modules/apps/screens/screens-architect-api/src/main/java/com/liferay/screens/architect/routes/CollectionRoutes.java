...
import com.liferay.screens.architect.alias.routes.CreateItemFunction;
import com.liferay.screens.architect.alias.routes.GetPageFunction;
 ...
 * com.liferay.screens.architect.router.CollectionRouter}.
 *
 * <p>
...
public class CollectionRoutes<T> {
	...
	public static class Builder<T> {
		...
		public <R> Builder<T> addCreator(
			...
			_createItemFunction = httpServletRequest -> body ->
				function.andThen(
					...
					Unsafe.unsafeCast(_form.get(body))
				);
		...
		public <A, B, C, D> Builder<T> addGetter(
			...
			_getPageFunction = httpServletRequest -> RoutesBuilderUtil.provide(
