...
import static com.liferay.screens.architect.operation.Method.POST;
...
import com.liferay.screens.architect.alias.routes.NestedGetPageFunction;
...
import com.liferay.screens.architect.pagination.PageItems;
import com.liferay.screens.architect.pagination.Pagination;
 ...
 * com.liferay.screens.architect.router.NestedCollectionRouter}.
 *
 * <p>
		...
		public <R> Builder<T, S> addCreator(
			...
			_nestedCreateItemFunction =
				httpServletRequest -> identifier -> body -> biFunction.andThen(
					...
					identifier, Unsafe.unsafeCast(_form.get(body))
				);
			...
			_nestedCreateItemFunction =
				httpServletRequest -> identifier -> body -> provide(
					...
					a -> b -> c -> d -> hexaFunction.andThen(
						...
						identifier, Unsafe.unsafeCast(_form.get(body)), a, b, c,
						d
					));
			...
			_nestedCreateItemFunction =
				httpServletRequest -> identifier -> body -> provide(
					...
					a -> b -> tetraFunction.andThen(
						...
						identifier, Unsafe.unsafeCast(_form.get(body)), a, b
					));
			...
			_nestedCreateItemFunction =
				httpServletRequest -> identifier -> body -> provide(
					...
					a -> triFunction.andThen(
						...
						identifier, Unsafe.unsafeCast(_form.get(body)), a
					));
