 ...
 * {@link com.liferay.segments.service.impl.SegmentsEntryRelLocalServiceImpl} and is the
...
public class SegmentsEntryRelLocalServiceUtil {
	...
	*/
	public static com.liferay.segments.model.SegmentsEntryRel createSegmentsEntryRel(
	...
	*/
	...
	public static com.liferay.segments.model.SegmentsEntryRel fetchSegmentsEntryRel(
		long segmentsEntryRelId) {
	...
	* @throws PortalException if a segments entry rel with the primary key could not be found
	*/
	public static com.liferay.segments.model.SegmentsEntryRel getSegmentsEntryRel(
		long segmentsEntryRelId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getSegmentsEntryRel(segmentsEntryRelId);
	}

	public static int getSegmentsEntryRelCount(long segmentsEntryId) {
		return getService().getSegmentsEntryRelCount(segmentsEntryId);
	}

	public static int getSegmentsEntryRelCount(long classNameId, long classPK) {
		return getService().getSegmentsEntryRelCount(classNameId, classPK);
	}

	public static int getSegmentsEntryRelCount(long groupId, long classNameId,
		long classPK) {
		return getService()
				   .getSegmentsEntryRelCount(groupId, classNameId, classPK);
	}
	...
	*/
	public static com.liferay.segments.model.SegmentsEntryRel updateSegmentsEntryRel(
		com.liferay.segments.model.SegmentsEntryRel segmentsEntryRel) {
	...
	private static ServiceTracker<SegmentsEntryRelLocalService, SegmentsEntryRelLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(SegmentsEntryRelLocalService.class);

		ServiceTracker<SegmentsEntryRelLocalService, SegmentsEntryRelLocalService> serviceTracker =
			new ServiceTracker<SegmentsEntryRelLocalService, SegmentsEntryRelLocalService>(bundle.getBundleContext(),
