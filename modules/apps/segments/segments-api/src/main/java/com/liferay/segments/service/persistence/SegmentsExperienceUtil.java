...
public class SegmentsExperienceUtil {
	...
	* @throws NoSuchExperienceException if a matching segments experience could not be found
	*/
	public static SegmentsExperience findByG_C_C_S(long groupId,
		long classNameId, long classPK, long segmentsEntryId)
		throws com.liferay.segments.exception.NoSuchExperienceException {
		return getPersistence()
				   .findByG_C_C_S(groupId, classNameId, classPK, segmentsEntryId);
	}
	...
	*/
	public static SegmentsExperience fetchByG_C_C_S(long groupId,
		long classNameId, long classPK, long segmentsEntryId) {
		return getPersistence()
				   .fetchByG_C_C_S(groupId, classNameId, classPK,
			segmentsEntryId);
	}
	...
	*/
	public static SegmentsExperience fetchByG_C_C_S(long groupId,
		...
		return getPersistence()
				   .fetchByG_C_C_S(groupId, classNameId, classPK,
			segmentsEntryId, retrieveFromCache);
	}
	...
	*/
	public static SegmentsExperience removeByG_C_C_S(long groupId,
		long classNameId, long classPK, long segmentsEntryId)
		throws com.liferay.segments.exception.NoSuchExperienceException {
		return getPersistence()
				   .removeByG_C_C_S(groupId, classNameId, classPK,
			segmentsEntryId);
	}
	...
	* @return the number of matching segments experiences
	*/
	public static int countByG_C_C_S(long groupId, long classNameId,
		long classPK, long segmentsEntryId) {
		return getPersistence()
				   .countByG_C_C_S(groupId, classNameId, classPK,
			segmentsEntryId);
	}
