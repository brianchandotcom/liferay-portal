...
public class SegmentsExperiencePersistenceImpl extends BasePersistenceImpl<SegmentsExperience>
	...
	private FinderPath _finderPathFetchByG_C_C_S;
	private FinderPath _finderPathCountByG_C_C_S;

	/**
	 * Returns the segments experience where groupId = &#63; and classNameId = &#63; and classPK = &#63; and segmentsEntryId = &#63; or throws a <code>NoSuchExperienceException</code> if it could not be found.
	 *
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public SegmentsExperience findByG_C_C_S(long groupId, long classNameId,
		long classPK, long segmentsEntryId) throws NoSuchExperienceException {
		SegmentsExperience segmentsExperience = fetchByG_C_C_S(groupId,
				classNameId, classPK, segmentsEntryId);
	...
	/**
	 * Returns the segments experience where groupId = &#63; and classNameId = &#63; and classPK = &#63; and segmentsEntryId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 ...
	 */
	@Override
	public SegmentsExperience fetchByG_C_C_S(long groupId, long classNameId,
		long classPK, long segmentsEntryId) {
		return fetchByG_C_C_S(groupId, classNameId, classPK, segmentsEntryId,
			true);
	}

	/**
	 * Returns the segments experience where groupId = &#63; and classNameId = &#63; and classPK = &#63; and segmentsEntryId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	...
	@Override
	public SegmentsExperience fetchByG_C_C_S(long groupId, long classNameId,
		long classPK, long segmentsEntryId, boolean retrieveFromCache) {
		Object[] finderArgs = new Object[] {
				groupId, classNameId, classPK, segmentsEntryId
			};

		Object result = null;

		if (retrieveFromCache) {
			result = finderCache.getResult(_finderPathFetchByG_C_C_S,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_G_C_C_S_SEGMENTSENTRYID_2);
			...
			try {
				...
				if (list.isEmpty()) {
					finderCache.putResult(_finderPathFetchByG_C_C_S,
						finderArgs, list);
				}
				else {
				...
				finderCache.removeResult(_finderPathFetchByG_C_C_S, finderArgs);
	...
	/**
	 * Removes the segments experience where groupId = &#63; and classNameId = &#63; and classPK = &#63; and segmentsEntryId = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 ...
	 */
	@Override
	public SegmentsExperience removeByG_C_C_S(long groupId, long classNameId,
		long classPK, long segmentsEntryId) throws NoSuchExperienceException {
		SegmentsExperience segmentsExperience = findByG_C_C_S(groupId,
				classNameId, classPK, segmentsEntryId);
	...
	/**
	 * Returns the number of segments experiences where groupId = &#63; and classNameId = &#63; and classPK = &#63; and segmentsEntryId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 ...
	 */
	@Override
	public int countByG_C_C_S(long groupId, long classNameId, long classPK,
		long segmentsEntryId) {
	...
	private static final String _FINDER_COLUMN_G_C_C_S_GROUPID_2 = "segmentsExperience.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_C_S_CLASSNAMEID_2 = "segmentsExperience.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_G_C_C_S_CLASSPK_2 = "segmentsExperience.classPK = ? AND ";
	private static final String _FINDER_COLUMN_G_C_C_S_SEGMENTSENTRYID_2 = "segmentsExperience.segmentsEntryId = ?";
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(_finderPathCountByG_C_C_S, args, Long.valueOf(1),
			false);
		finderCache.putResult(_finderPathFetchByG_C_C_S, args,
	...
	protected void clearUniqueFindersCache(
		...
		if (clearCurrent) {
			...
			finderCache.removeResult(_finderPathFetchByG_C_C_S, args);
		}

		if ((segmentsExperienceModelImpl.getColumnBitmask() &
				_finderPathFetchByG_C_C_S.getColumnBitmask()) != 0) {
			Object[] args = new Object[] {
	...
	public void afterPropertiesSet() {
		...
		_finderPathFetchByG_C_C_S = new FinderPath(SegmentsExperienceModelImpl.ENTITY_CACHE_ENABLED,
				SegmentsExperienceModelImpl.FINDER_CACHE_ENABLED,
		...
		_finderPathCountByG_C_C_S = new FinderPath(SegmentsExperienceModelImpl.ENTITY_CACHE_ENABLED,
				SegmentsExperienceModelImpl.FINDER_CACHE_ENABLED, Long.class,
