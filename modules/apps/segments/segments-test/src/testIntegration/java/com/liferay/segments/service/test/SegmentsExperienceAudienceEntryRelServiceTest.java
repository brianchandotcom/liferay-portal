...
public class SegmentsExperienceAudienceEntryRelServiceTest {
	...
	public void setUp() throws Exception {
		...
		_segmentsExperience = SegmentsTestUtil.addSegmentsExperience(
			_group.getGroupId(), _segmentsEntry.getExternalReferenceCode(),
	...
	public void testUpdateSegmentsExperienceAudienceEntryRels()
		...
		_segmentsExperienceAudienceEntryRelService.
			updateSegmentsExperienceAudienceEntryRels(
				_group.getGroupId(), new String[0],
				_segmentsExperience.getExternalReferenceCode());
	...
	@Test
	public void testUpdateSegmentsExperienceAudienceEntryRelsThrowsException()
		throws Exception {
		...
		Assert.assertThrows(
			...
			() ->
				_segmentsExperienceAudienceEntryRelService.
					updateSegmentsExperienceAudienceEntryRels(
						_group.getGroupId(), new String[] {audienceEntryERC},
