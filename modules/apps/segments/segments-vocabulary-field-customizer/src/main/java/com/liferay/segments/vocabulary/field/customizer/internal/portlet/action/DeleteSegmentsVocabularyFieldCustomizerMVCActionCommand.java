...
@Component(
	...
	property = {
		...
		"mvc.command.name=/delete_segments_vocabulary_field_customizer"
	},
	service = MVCActionCommand.class
)
public class DeleteSegmentsVocabularyFieldCustomizerMVCActionCommand
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DeleteSegmentsVocabularyFieldCustomizerMVCActionCommand.class);
