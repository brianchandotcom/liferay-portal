			...
			<aui:fieldset>
				...
				<div id="<portlet:namespace />criteriaWrapper">
					...
					%>
							...
							<aui:select name='<%= "criterionConjunction" + segmentsCriteriaContributor.getKey() %>'>

								<%
								for (Criteria.Conjunction conjunction : Criteria.Conjunction.values()) {
								%>

									<aui:option label="<%= conjunction.getValue() %>" selected="<%= conjunction.equals(criterion.getConjunction()) %>" />
