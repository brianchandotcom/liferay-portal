...
create unique index IX_7CF9E522 on SharingEntry (toUserId, classNameId, classPK, companyId);
...
create unique index IX_BD1A3416 on SharingEntry (uuid_[$COLUMN_LENGTH:75$], groupId, companyId);