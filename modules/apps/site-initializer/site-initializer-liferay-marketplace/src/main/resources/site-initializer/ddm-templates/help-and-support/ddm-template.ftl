<div class="bg-whiteColor" style="background-color: var(--white);border-radius: var(--border-radius-sm);border-style: solid; border-width: 0px;margin-bottom: 2px;">
	<div class="f-text font-size-paragraph-base font-size-small-caps pl-4 pr-4 pt-4">
		${languageUtil.get(locale, "help-and-support", "Help & Support")}
	</div>

	<#if (_CUSTOM_FIELD_Documentation.getData())?has_content && (_CUSTOM_FIELD_Documentation.getData())?starts_with("https")>
		<a class="bg-whiteColor pt-2 pb-2 pl-4 pr-4" href="${_CUSTOM_FIELD_Documentation.getData()}" style="border-color: var(--neutral-9);border-style: solid; border-width: 0 0 2px 0;align-items:center;color:var(--body-color);cursor:pointer;display:flex;justify-content:space-between;text-decoration:none;" target="_blank">
	...
	<#if (_CUSTOM_FIELD_Source.getData())?has_content && (_CUSTOM_FIELD_Source.getData())?starts_with("https")>
		<a class="bg-whiteColor pt-2 pb-2 pl-4 pr-4" href="${_CUSTOM_FIELD_Source.getData()}" style="border-color: var(--neutral-9);border-style: solid; border-width: 0 0 2px 0;align-items:center;color:var(--body-color);cursor:pointer;display:flex;justify-content:space-between;text-decoration:none;" target="_blank">
	...
	<#if (_CUSTOM_FIELD_Support.getData())?has_content && (_CUSTOM_FIELD_Terms.getData())?starts_with("https")>
		<a class="bg-whiteColor pt-2 pb-2 pl-4 pr-4" href="${_CUSTOM_FIELD_Terms.getData()}" style="border-color: var(--neutral-9);border-style: solid; border-width: 0 0 2px 0;align-items:center;color:var(--body-color);cursor:pointer;display:flex;justify-content:space-between;text-decoration:none;" target="_blank">
