		...
		>
			...
			<div className="d-flex flex-wrap p-0">
				<div className="align-items-start align-self-start col-12 d-flex flex-wrap justify-content-between mb-0 p-0">
					<label
						className={classNames("d-flex flex-wrap radio-card-label flex-lg-nowrap font-weight-bolder text-paragraph-lg col-8 col-sm-8 col-md-10 col-lg-auto p-0 ",{
							'text-brand-primary':selected,
						})}
						htmlFor={name}
					>
						<p className='col-12 col-lg-auto col-md-auto col-sm-12 p-0'>{label} &nbsp;</p>
					...
					<div className='col-4 col-lg-auto col-md-auto col-sm-4 d-flex justify-content-end p-0'>{renderActions}</div>
				</div>
