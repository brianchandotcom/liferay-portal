...
public class SiteInitializerTestrayImportResultsDispatchTaskExecutor
		...
		if (testrayCaseId == 0) {
			ObjectEntry objectEntry =
				SiteInitializerTestrayObjectUtil.addObjectEntry(
					_defaultDTOConverterContext, _objectEntryManager, "Case",
	...
	private void _addTestrayFactor(
		...
		SiteInitializerTestrayObjectUtil.addObjectEntry(
			_defaultDTOConverterContext, _objectEntryManager, "Factor",
			HashMapBuilder.<String, Object>put(
	...
	private long _getTestrayBuildId(
		...
		ObjectEntry objectEntry =
			SiteInitializerTestrayObjectUtil.addObjectEntry(
				_defaultDTOConverterContext, _objectEntryManager, "Build",
				HashMapBuilder.<String, Object>put(
	...
	private long _getTestrayCaseResultId(
		...
		ObjectEntry objectEntry =
			SiteInitializerTestrayObjectUtil.addObjectEntry(
				_defaultDTOConverterContext, _objectEntryManager, "CaseResult",
				properties);
	...
	private long _getTestrayCaseTypeId(
		...
		ObjectEntry objectEntry =
			SiteInitializerTestrayObjectUtil.addObjectEntry(
				_defaultDTOConverterContext, _objectEntryManager, "CaseType",
				HashMapBuilder.<String, Object>put(
	...
	private long _getTestrayComponentId(
		...
		ObjectEntry objectEntry =
			SiteInitializerTestrayObjectUtil.addObjectEntry(
				_defaultDTOConverterContext, _objectEntryManager, "Component",
				HashMapBuilder.<String, Object>put(
	...
	private long _getTestrayFactorCategoryId(
		...
		ObjectEntry objectEntry =
			SiteInitializerTestrayObjectUtil.addObjectEntry(
				_defaultDTOConverterContext, _objectEntryManager,
				"FactorCategory",
				HashMapBuilder.<String, Object>put(
	...
	private long _getTestrayProjectId(long companyId, String testrayProjectName)
		...
		ObjectEntry objectEntry =
			SiteInitializerTestrayObjectUtil.addObjectEntry(
				_defaultDTOConverterContext, _objectEntryManager, "Project",
				HashMapBuilder.<String, Object>put(
	...
	private long _getTestrayRoutineId(
		...
		ObjectEntry objectEntry =
			SiteInitializerTestrayObjectUtil.addObjectEntry(
				_defaultDTOConverterContext, _objectEntryManager, "Routine",
				HashMapBuilder.<String, Object>put(
	...
	private long _getTestrayRunId(
		...
		ObjectEntry objectEntry =
			SiteInitializerTestrayObjectUtil.addObjectEntry(
				_defaultDTOConverterContext, _objectEntryManager, "Run",
				HashMapBuilder.<String, Object>put(
	...
	private long _getTestrayTeamId(
		...
		ObjectEntry objectEntry =
			SiteInitializerTestrayObjectUtil.addObjectEntry(
				_defaultDTOConverterContext, _objectEntryManager, "Team",
				HashMapBuilder.<String, Object>put(
