...
public class SiteNavigationBreadcrumbPortletDisplayTemplateHandler
	...
	public String getName(Locale locale) {
		...
		String portletTitle = PortalUtil.getPortletTitle(
			SiteNavigationBreadcrumbPortletKeys.SITE_NAVIGATION_BREADCRUMB, resourceBundle);
	...
	protected String getTemplatesConfigPath() {
		return SiteNavigationBreadcrumbConfigurationValues.DISPLAY_TEMPLATES_CONFIG;
	}

	private volatile SiteNavigationBreadcrumbWebConfiguration _breadcrumbWebConfiguration;
