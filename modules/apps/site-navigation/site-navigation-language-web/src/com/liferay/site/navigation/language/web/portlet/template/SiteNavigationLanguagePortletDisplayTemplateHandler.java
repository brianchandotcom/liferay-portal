...
public class SiteNavigationLanguagePortletDisplayTemplateHandler
	...
	public String getName(Locale locale) {
		...
		String portletTitle = PortalUtil.getPortletTitle(
			SiteNavigationLanguagePortletKeys.SITE_NAVIGATION_LANGUAGE, resourceBundle);
	...
	private volatile SiteNavigationLanguageWebConfiguration _languageWebConfiguration;
