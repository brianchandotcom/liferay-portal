...
public class ObjectEntryModelListenerTest {
	...
	public void testOnAfterRemove() throws Exception {
		...
		// Deleting a draft project deletes its asset library
		...
		// Deleting a project with a staged asset library rolls back
		...
		// Deleting an approved project deletes its asset library and its tasks
