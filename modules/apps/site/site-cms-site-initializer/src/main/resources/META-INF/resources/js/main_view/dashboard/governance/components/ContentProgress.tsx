...
export function ContentProgress({
	...
	useEffect(() => {
		...
		async function fetchContentProgress() {
			...
			const {data, error} = await GovernanceService.getContentProgress(
				additionalProps.contentProgressFilterString,
				space.siteId
			);
	...
	}, [additionalProps.contentProgressFilterString, space.siteId]);
	...
	return (
		<BaseCard
			...
			description={Liferay.Language.get(
				'progress-of-content-creation-and-completion-across-the-selected-spaces'
			)}
