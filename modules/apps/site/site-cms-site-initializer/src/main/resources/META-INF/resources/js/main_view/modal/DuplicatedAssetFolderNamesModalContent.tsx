					...
					{sub(
						itemData.entryClassName ===
							...
							? Liferay.Language.get(
									'an-older-folder-named-x-already-exists-in-this-folder.-please-choose-one-of-options'
								)
							: Liferay.Language.get(
									'an-older-asset-named-x-already-exists-in-this-folder.-please-choose-one-of-options'
								),
						itemData.title
					)}
				</p>
