...
public interface SitemapCompanyConfiguration {
	...
	@Meta.AD(
		deflt = "true", name = "include-category-urls-in-the-sitemap-xml",
		required = false
	)
	public boolean includeCategories();

	@Meta.AD(
		deflt = "true", name = "include-page-urls-in-the-sitemap-xml",
		required = false
	)
	public boolean includePages();

	@Meta.AD(
		deflt = "true", name = "include-web-content-urls-in-the-sitemap-xml",
		required = false
	)
