...
public class SitemapManagerImpl implements SitemapManager {
	...
	public String getAssetTypeClassName(String assetTypeKey) {
		return _classNamesByKeyMap.get(assetTypeKey);
	}

	@Override
	public Map<String, String> getAssetTypeKeys() {
		return _keysByClassNameMap;
	}
	...
	private static final Map<String, String> _classNamesByKeyMap;
	private static final Map<String, String> _keysByClassNameMap = Map.of(
	...
	static {
		Map<String, String> classNamesByKeyMap = new ConcurrentHashMap<>();

		for (Map.Entry<String, String> entry : _keysByClassNameMap.entrySet()) {
			classNamesByKeyMap.put(entry.getValue(), entry.getKey());
		}

		_classNamesByKeyMap = Collections.unmodifiableMap(classNamesByKeyMap);
	}
