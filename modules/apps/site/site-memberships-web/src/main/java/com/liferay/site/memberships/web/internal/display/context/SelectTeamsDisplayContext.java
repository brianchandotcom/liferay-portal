...
public class SelectTeamsDisplayContext {
	...
	public SearchContainer<Team> getTeamSearchSearchContainer()
		...
		List<Team> teams = TeamLocalServiceUtil.search(
			getGroupId(), getKeywords(), getKeywords(), new LinkedHashMap<>(),
			teamSearch.getStart(), teamSearch.getEnd(),
			teamSearch.getOrderByComparator());

		List<Team> filteredTeams = ListUtil.copy(teams);

		Iterator<Team> iterator = filteredTeams.iterator();
		...
		teamSearch.setResultsAndTotal(filteredTeams);
