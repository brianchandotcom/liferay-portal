	...
	>
		...
		>
			<clay:checkbox
				...
				label='<%= LanguageUtil.get(request, "include-page-urls-in-the-sitemap-xml") %>'
	...
	>
		...
		>
			<clay:checkbox
				...
				label='<%= LanguageUtil.get(request, "include-web-content-urls-in-the-sitemap-xml") %>'
	...
	>
		...
		>
			<clay:checkbox
				...
				label='<%= LanguageUtil.get(request, "include-category-urls-in-the-sitemap-xml") %>'
