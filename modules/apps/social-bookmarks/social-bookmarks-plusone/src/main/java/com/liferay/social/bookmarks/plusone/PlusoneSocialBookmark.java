...
package com.liferay.social.bookmarks.plusone;
...
public class PlusoneSocialBookmark implements SocialBookmark {
	...
	@Reference(
		target = "(bundle.symbolic.name=com.liferay.social.bookmarks.plusone)"
	)
	private ResourceBundleLoader _resourceBundleLoader;

	@Reference(
		target = "(osgi.web.symbolicname=com.liferay.social.bookmarks.plusone)"
	)
