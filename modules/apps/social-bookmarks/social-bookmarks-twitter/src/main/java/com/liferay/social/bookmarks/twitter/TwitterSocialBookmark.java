...
package com.liferay.social.bookmarks.twitter;
...
public class TwitterSocialBookmark implements SocialBookmark {
	...
	@Reference(
		target = "(bundle.symbolic.name=com.liferay.social.bookmarks.twitter)"
	)
	private ResourceBundleLoader _resourceBundleLoader;

	@Reference(
		target = "(osgi.web.symbolicname=com.liferay.social.bookmarks.twitter)"
	)
