...
<%
UserStatisticsPortletInstanceConfiguration userStatisticsPortletInstanceConfiguration = ConfigurationFactoryUtil.getConfiguration(UserStatisticsPortletInstanceConfiguration.class, new PortletInstanceSettingsLocator(themeDisplay.getLayout(), portletDisplay.getId()));
%>
