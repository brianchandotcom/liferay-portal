...
public interface StyleBookTokenSetPersistence
	 ...
	 * @throws NoSuchTokenSetException if a matching style book token set could not be found
	 */
	public StyleBookTokenSet findByFTCN_N_SBEI_T(
	 ...
	 * @return the matching style book token set, or <code>null</code> if a matching style book token set could not be found
	 */
	public StyleBookTokenSet fetchByFTCN_N_SBEI_T(
	 ...
	 * @return the style book token set that was removed
	 */
	public StyleBookTokenSet removeByFTCN_N_SBEI_T(
			String frontendTokenCategoryName, String name,
			long styleBookEntryId, String themeId)
		throws NoSuchTokenSetException;
	 ...
	 * @return the number of matching style book token sets
	 */
	public int countByFTCN_N_SBEI_T(
		String frontendTokenCategoryName, String name, long styleBookEntryId,
		String themeId);
	 ...
	 * @return the matching style book token set, or <code>null</code> if a matching style book token set could not be found
	 */
	public default StyleBookTokenSet fetchByFTCN_N_SBEI_T(
		String frontendTokenCategoryName, String name, long styleBookEntryId,
		String themeId) {

		return fetchByFTCN_N_SBEI_T(
			frontendTokenCategoryName, name, styleBookEntryId, themeId, true);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:-1456954008