...
public interface StyleBookTokenSetPersistence
	 ...
	 * @throws NoSuchTokenSetException if a matching style book token set could not be found
	 */
	public StyleBookTokenSet findBySBEI_FTDI_FTCN_N(
	 ...
	 * @return the matching style book token set, or <code>null</code> if a matching style book token set could not be found
	 */
	public StyleBookTokenSet fetchBySBEI_FTDI_FTCN_N(
		long styleBookEntryId, String frontendTokenDefinitionId,
	 ...
	 * @return the style book token set that was removed
	 */
	public StyleBookTokenSet removeBySBEI_FTDI_FTCN_N(
			long styleBookEntryId, String frontendTokenDefinitionId,
			String frontendTokenCategoryName, String name)
		throws NoSuchTokenSetException;
	 ...
	 * @return the number of matching style book token sets
	 */
	public int countBySBEI_FTDI_FTCN_N(
		long styleBookEntryId, String frontendTokenDefinitionId,
		String frontendTokenCategoryName, String name);
	 ...
	 * @return the matching style book token set, or <code>null</code> if a matching style book token set could not be found
	 */
	public default StyleBookTokenSet fetchBySBEI_FTDI_FTCN_N(
		long styleBookEntryId, String frontendTokenDefinitionId,
		String frontendTokenCategoryName, String name) {

		return fetchBySBEI_FTDI_FTCN_N(
			styleBookEntryId, frontendTokenDefinitionId,
			frontendTokenCategoryName, name, true);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:1733143685