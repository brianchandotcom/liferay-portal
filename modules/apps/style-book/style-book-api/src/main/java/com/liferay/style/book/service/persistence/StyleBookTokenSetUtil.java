...
public class StyleBookTokenSetUtil {
	...
	/**
	 * Returns the style book token set where frontendTokenCategoryName = &#63; and name = &#63; and styleBookEntryId = &#63; and themeId = &#63; or throws a <code>NoSuchTokenSetException</code> if it could not be found.
	 *
	 ...
	 * @throws NoSuchTokenSetException if a matching style book token set could not be found
	 */
	public static StyleBookTokenSet findByFTCN_N_SBEI_T(
			String frontendTokenCategoryName, String name,
			long styleBookEntryId, String themeId)
		throws com.liferay.style.book.exception.NoSuchTokenSetException {

		return getPersistence().findByFTCN_N_SBEI_T(
			frontendTokenCategoryName, name, styleBookEntryId, themeId);
	}

	/**
	 * Returns the style book token set where frontendTokenCategoryName = &#63; and name = &#63; and styleBookEntryId = &#63; and themeId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param frontendTokenCategoryName the frontend token category name
	 * @param name the name
	 * @param styleBookEntryId the style book entry ID
	 ...
	 * @return the matching style book token set, or <code>null</code> if a matching style book token set could not be found
	 */
	public static StyleBookTokenSet fetchByFTCN_N_SBEI_T(
		String frontendTokenCategoryName, String name, long styleBookEntryId,
		String themeId, boolean useFinderCache) {

		return getPersistence().fetchByFTCN_N_SBEI_T(
			frontendTokenCategoryName, name, styleBookEntryId, themeId,
			useFinderCache);
	}

	/**
	 * Removes the style book token set where frontendTokenCategoryName = &#63; and name = &#63; and styleBookEntryId = &#63; and themeId = &#63; from the database.
	 *
	 * @param frontendTokenCategoryName the frontend token category name
	 * @param name the name
	 * @param styleBookEntryId the style book entry ID
	 ...
	 * @return the style book token set that was removed
	 */
	public static StyleBookTokenSet removeByFTCN_N_SBEI_T(
			String frontendTokenCategoryName, String name,
			long styleBookEntryId, String themeId)
		throws com.liferay.style.book.exception.NoSuchTokenSetException {

		return getPersistence().removeByFTCN_N_SBEI_T(
			frontendTokenCategoryName, name, styleBookEntryId, themeId);
	}

	/**
	 * Returns the number of style book token sets where frontendTokenCategoryName = &#63; and name = &#63; and styleBookEntryId = &#63; and themeId = &#63;.
	 *
	 * @param frontendTokenCategoryName the frontend token category name
	 * @param name the name
	 * @param styleBookEntryId the style book entry ID
	 ...
	 * @return the number of matching style book token sets
	 */
	public static int countByFTCN_N_SBEI_T(
		String frontendTokenCategoryName, String name, long styleBookEntryId,
		String themeId) {

		return getPersistence().countByFTCN_N_SBEI_T(
			frontendTokenCategoryName, name, styleBookEntryId, themeId);
	}
	...
	/**
	 * Returns the style book token set where frontendTokenCategoryName = &#63; and name = &#63; and styleBookEntryId = &#63; and themeId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param frontendTokenCategoryName the frontend token category name
	 * @param name the name
	 * @param styleBookEntryId the style book entry ID
...
// LIFERAY-SERVICE-BUILDER-HASH:-1438564876