...
public class StyleBookTokenSetUtil {
	...
	/**
	 * Returns the style book token set where styleBookEntryId = &#63; and frontendTokenDefinitionId = &#63; and frontendTokenCategoryName = &#63; and name = &#63; or throws a <code>NoSuchTokenSetException</code> if it could not be found.
	 *
	 * @param styleBookEntryId the style book entry ID
	 ...
	 * @throws NoSuchTokenSetException if a matching style book token set could not be found
	 */
	public static StyleBookTokenSet findBySBEI_FTDI_FTCN_N(
			long styleBookEntryId, String frontendTokenDefinitionId,
			String frontendTokenCategoryName, String name)
		throws com.liferay.style.book.exception.NoSuchTokenSetException {

		return getPersistence().findBySBEI_FTDI_FTCN_N(
			styleBookEntryId, frontendTokenDefinitionId,
			frontendTokenCategoryName, name);
	}

	/**
	 * Returns the style book token set where styleBookEntryId = &#63; and frontendTokenDefinitionId = &#63; and frontendTokenCategoryName = &#63; and name = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param styleBookEntryId the style book entry ID
	 * @param frontendTokenDefinitionId the frontend token definition ID
	 * @param frontendTokenCategoryName the frontend token category name
	 ...
	 * @return the matching style book token set, or <code>null</code> if a matching style book token set could not be found
	 */
	public static StyleBookTokenSet fetchBySBEI_FTDI_FTCN_N(
		long styleBookEntryId, String frontendTokenDefinitionId,
		String frontendTokenCategoryName, String name, boolean useFinderCache) {

		return getPersistence().fetchBySBEI_FTDI_FTCN_N(
			styleBookEntryId, frontendTokenDefinitionId,
			frontendTokenCategoryName, name, useFinderCache);
	}

	/**
	 * Removes the style book token set where styleBookEntryId = &#63; and frontendTokenDefinitionId = &#63; and frontendTokenCategoryName = &#63; and name = &#63; from the database.
	 *
	 * @param styleBookEntryId the style book entry ID
	 * @param frontendTokenDefinitionId the frontend token definition ID
	 * @param frontendTokenCategoryName the frontend token category name
	 ...
	 * @return the style book token set that was removed
	 */
	public static StyleBookTokenSet removeBySBEI_FTDI_FTCN_N(
			long styleBookEntryId, String frontendTokenDefinitionId,
			String frontendTokenCategoryName, String name)
		throws com.liferay.style.book.exception.NoSuchTokenSetException {

		return getPersistence().removeBySBEI_FTDI_FTCN_N(
			styleBookEntryId, frontendTokenDefinitionId,
			frontendTokenCategoryName, name);
	}

	/**
	 * Returns the number of style book token sets where styleBookEntryId = &#63; and frontendTokenDefinitionId = &#63; and frontendTokenCategoryName = &#63; and name = &#63;.
	 *
	 * @param styleBookEntryId the style book entry ID
	 * @param frontendTokenDefinitionId the frontend token definition ID
	 * @param frontendTokenCategoryName the frontend token category name
	 ...
	 * @return the number of matching style book token sets
	 */
	public static int countBySBEI_FTDI_FTCN_N(
		long styleBookEntryId, String frontendTokenDefinitionId,
		String frontendTokenCategoryName, String name) {

		return getPersistence().countBySBEI_FTDI_FTCN_N(
			styleBookEntryId, frontendTokenDefinitionId,
			frontendTokenCategoryName, name);
	}
	...
	/**
	 * Returns the style book token set where styleBookEntryId = &#63; and frontendTokenDefinitionId = &#63; and frontendTokenCategoryName = &#63; and name = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param styleBookEntryId the style book entry ID
	 * @param frontendTokenDefinitionId the frontend token definition ID
	 * @param frontendTokenCategoryName the frontend token category name
...
// LIFERAY-SERVICE-BUILDER-HASH:238027721