...
public class StyleBookTokenSetUtil {
	 ...
	 * @throws NoSuchTokenSetException if a matching style book token set could not be found
	 */
	public static StyleBookTokenSet findByFTCN_FTDI_N_SBEI(
			String frontendTokenCategoryName, String frontendTokenDefinitionId,
			String name, long styleBookEntryId)
		throws com.liferay.style.book.exception.NoSuchTokenSetException {

		return getPersistence().findByFTCN_FTDI_N_SBEI(
	 ...
	 * @return the matching style book token set, or <code>null</code> if a matching style book token set could not be found
	 */
	public static StyleBookTokenSet fetchByFTCN_FTDI_N_SBEI(
		String frontendTokenCategoryName, String frontendTokenDefinitionId,
		String name, long styleBookEntryId, boolean useFinderCache) {

		return getPersistence().fetchByFTCN_FTDI_N_SBEI(
			frontendTokenCategoryName, frontendTokenDefinitionId, name,
			styleBookEntryId, useFinderCache);
	}
	 ...
	 * @return the style book token set that was removed
	 */
	public static StyleBookTokenSet removeByFTCN_FTDI_N_SBEI(
			String frontendTokenCategoryName, String frontendTokenDefinitionId,
			String name, long styleBookEntryId)
		throws com.liferay.style.book.exception.NoSuchTokenSetException {

		return getPersistence().removeByFTCN_FTDI_N_SBEI(
			frontendTokenCategoryName, frontendTokenDefinitionId, name,
			styleBookEntryId);
	}
	 ...
	 * @return the number of matching style book token sets
	 */
	public static int countByFTCN_FTDI_N_SBEI(
		String frontendTokenCategoryName, String frontendTokenDefinitionId,
		String name, long styleBookEntryId) {

		return getPersistence().countByFTCN_FTDI_N_SBEI(
			frontendTokenCategoryName, frontendTokenDefinitionId, name,
			styleBookEntryId);
	}
	...
	/**
	 * Returns the style book token set where frontendTokenCategoryName = &#63; and frontendTokenDefinitionId = &#63; and name = &#63; and styleBookEntryId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param frontendTokenCategoryName the frontend token category name
	 * @param frontendTokenDefinitionId the frontend token definition ID
	 * @param name the name
...
// LIFERAY-SERVICE-BUILDER-HASH:-813541291