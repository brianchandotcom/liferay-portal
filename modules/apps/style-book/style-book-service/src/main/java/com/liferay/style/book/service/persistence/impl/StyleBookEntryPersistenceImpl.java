...
public class StyleBookEntryPersistenceImpl
	...
	/**
	 * Returns the style book entries before and after the current style book entry in the ordered set where groupId = &#63; and name = &#63;.
	 *
	 * @param styleBookEntryId the primary key of the current style book entry
	 * @param groupId the group ID
	 * @param name the name
	 ...
	 */
	@Override
	public StyleBookEntry[] findByG_N_PrevAndNext(
	...
	protected StyleBookEntry getByG_N_PrevAndNext(
		Session session, StyleBookEntry styleBookEntry, long groupId,
	...
	/**
	 * Returns the style book entries before and after the current style book entry in the ordered set where groupId = &#63; and name = &#63; and head = &#63;.
	 *
	 * @param styleBookEntryId the primary key of the current style book entry
	 * @param groupId the group ID
	 * @param name the name
	 ...
	 */
	@Override
	public StyleBookEntry[] findByG_N_Head_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_N_Head_PrevAndNext(
				session, styleBookEntry, groupId, name, head, orderByComparator,
				true);

			array[1] = styleBookEntry;

			array[2] = getByG_N_Head_PrevAndNext(
				session, styleBookEntry, groupId, name, head, orderByComparator,
				false);
	...
	protected StyleBookEntry getByG_N_Head_PrevAndNext(
		Session session, StyleBookEntry styleBookEntry, long groupId,
...
// LIFERAY-SERVICE-BUILDER-HASH:-87510252