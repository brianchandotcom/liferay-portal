...
public class StyleBookTokenSetPersistenceImpl
	...
	private UniquePersistenceFinder<StyleBookTokenSet, NoSuchTokenSetException>
		_uniquePersistenceFinderBySBEI_FTDI_FTCN_N;
	...
	public StyleBookTokenSet findBySBEI_FTDI_FTCN_N(
		...
		return _uniquePersistenceFinderBySBEI_FTDI_FTCN_N.find(
			finderCache,
			new Object[] {
	...
	public StyleBookTokenSet fetchBySBEI_FTDI_FTCN_N(
		...
		return _uniquePersistenceFinderBySBEI_FTDI_FTCN_N.fetch(
			finderCache,
			new Object[] {
				styleBookEntryId, frontendTokenDefinitionId,
				frontendTokenCategoryName, name
	...
	public StyleBookTokenSet removeBySBEI_FTDI_FTCN_N(
		...
		StyleBookTokenSet styleBookTokenSet = findBySBEI_FTDI_FTCN_N(
			styleBookEntryId, frontendTokenDefinitionId,
			frontendTokenCategoryName, name);
	...
	public int countBySBEI_FTDI_FTCN_N(
		...
		return _uniquePersistenceFinderBySBEI_FTDI_FTCN_N.count(
			finderCache,
			new Object[] {
				styleBookEntryId, frontendTokenDefinitionId,
				frontendTokenCategoryName, name
	...
	public void activate() {
		...
		_uniquePersistenceFinderBySBEI_FTDI_FTCN_N =
			new UniquePersistenceFinder<>(
				this,
				createUniqueFinderPath(
					FINDER_CLASS_NAME_ENTITY, "fetchBySBEI_FTDI_FTCN_N",
					new String[] {
...
// LIFERAY-SERVICE-BUILDER-HASH:-1934603936