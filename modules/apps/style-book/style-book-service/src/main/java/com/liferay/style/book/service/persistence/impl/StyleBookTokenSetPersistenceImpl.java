...
public class StyleBookTokenSetPersistenceImpl
	...
	private UniquePersistenceFinder<StyleBookTokenSet, NoSuchTokenSetException>
		_uniquePersistenceFinderBySBEI_FTCN_FTDI_N;
	...
	public StyleBookTokenSet findBySBEI_FTCN_FTDI_N(
		...
		return _uniquePersistenceFinderBySBEI_FTCN_FTDI_N.find(
			finderCache,
			new Object[] {
	...
	public StyleBookTokenSet fetchBySBEI_FTCN_FTDI_N(
		...
		return _uniquePersistenceFinderBySBEI_FTCN_FTDI_N.fetch(
			finderCache,
			new Object[] {
				styleBookEntryId, frontendTokenCategoryName,
				frontendTokenDefinitionId, name
	...
	public StyleBookTokenSet removeBySBEI_FTCN_FTDI_N(
		...
		StyleBookTokenSet styleBookTokenSet = findBySBEI_FTCN_FTDI_N(
			styleBookEntryId, frontendTokenCategoryName,
			frontendTokenDefinitionId, name);
	...
	public int countBySBEI_FTCN_FTDI_N(
		...
		return _uniquePersistenceFinderBySBEI_FTCN_FTDI_N.count(
			finderCache,
			new Object[] {
				styleBookEntryId, frontendTokenCategoryName,
				frontendTokenDefinitionId, name
	...
	public void activate() {
		...
		_uniquePersistenceFinderBySBEI_FTCN_FTDI_N =
			new UniquePersistenceFinder<>(
				this,
				createUniqueFinderPath(
					FINDER_CLASS_NAME_ENTITY, "fetchBySBEI_FTCN_FTDI_N",
					new String[] {
...
// LIFERAY-SERVICE-BUILDER-HASH:1199032126