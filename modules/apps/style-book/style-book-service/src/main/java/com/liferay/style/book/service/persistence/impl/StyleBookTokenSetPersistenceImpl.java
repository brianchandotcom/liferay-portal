...
public class StyleBookTokenSetPersistenceImpl
	...
	private UniquePersistenceFinder<StyleBookTokenSet, NoSuchTokenSetException>
		_uniquePersistenceFinderByFTCN_N_SBEI_T;
	...
	public StyleBookTokenSet findByFTCN_N_SBEI_T(
		...
		return _uniquePersistenceFinderByFTCN_N_SBEI_T.find(
			finderCache,
			new Object[] {
	...
	public StyleBookTokenSet fetchByFTCN_N_SBEI_T(
		...
		return _uniquePersistenceFinderByFTCN_N_SBEI_T.fetch(
			finderCache,
			new Object[] {
				frontendTokenCategoryName, name, styleBookEntryId, themeId
			},
	...
	public StyleBookTokenSet removeByFTCN_N_SBEI_T(
		...
		StyleBookTokenSet styleBookTokenSet = findByFTCN_N_SBEI_T(
			frontendTokenCategoryName, name, styleBookEntryId, themeId);
	...
	public int countByFTCN_N_SBEI_T(
		...
		return _uniquePersistenceFinderByFTCN_N_SBEI_T.count(
			finderCache,
			new Object[] {
				frontendTokenCategoryName, name, styleBookEntryId, themeId
			});
	...
	static {
		...
		_uniqueIndexColumnNames.add(
			new String[] {
				"frontendTokenCategoryName", "name", "styleBookEntryId",
				"themeId"
			});
	...
	public void activate() {
		...
		_uniquePersistenceFinderByFTCN_N_SBEI_T = new UniquePersistenceFinder<>(
			this,
			createUniqueFinderPath(
				FINDER_CLASS_NAME_ENTITY, "fetchByFTCN_N_SBEI_T",
				new String[] {
...
// LIFERAY-SERVICE-BUILDER-HASH:-1823930904