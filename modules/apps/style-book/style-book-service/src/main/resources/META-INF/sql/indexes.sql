...
create unique index IX_A07EEEB2 on StyleBookTokenSet (styleBookEntryId, frontendTokenCategoryName[$COLUMN_LENGTH:75$], frontendTokenDefinitionId[$COLUMN_LENGTH:75$], name[$COLUMN_LENGTH:75$], ctCollectionId);
