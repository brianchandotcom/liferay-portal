...
public class StyleBookEntryLocalServiceImplTest {
	...
	public void testUpdateFrontendToken() throws Exception {
		_testUpdateFrontendTokenWithDuplicateName();
		_testUpdateFrontendTokenWithExistingUnrelatedValue();
		_testUpdateFrontendTokenWithMalformedFrontendTokenDefinition();
	}
	...
	private void _assertUpdateFrontendTokenFailure(
	...
	private void _testUpdateFrontendTokenWithDuplicateName() throws Exception {
		long styleBookEntryId = RandomTestUtil.randomLong();
		...
		_assertUpdateFrontendTokenFailure(
			DuplicateStyleBookEntryFrontendTokenException.class,
	...
	private void _testUpdateFrontendTokenWithExistingUnrelatedValue()
		throws Exception {
		...
		_styleBookEntryLocalService.updateFrontendToken(
			...
			RandomTestUtil.randomString(), _PRIMARY_COLOR_TOKEN_NAME,
			RandomTestUtil.randomString(), RandomTestUtil.randomString(),
			RandomTestUtil.randomString(), value, serviceContext);
	...
	private void _testUpdateFrontendTokenWithMalformedFrontendTokenDefinition()
		throws Exception {
