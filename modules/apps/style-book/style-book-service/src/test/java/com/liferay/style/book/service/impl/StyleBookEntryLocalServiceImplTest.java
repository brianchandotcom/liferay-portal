...
public class StyleBookEntryLocalServiceImplTest {
	...
	public void testUpdateFrontendTokensValues() throws Exception {
		...
		_testUpdateFrontendTokensValuesMustBeValidJSON();
		_testUpdateFrontendTokensValuesMustNotContainInvalidCharacters(
	...
	private void _testUpdateFrontendTokensValuesMustBeValidJSON()
		throws Exception {
	...
	private void _testUpdateFrontendTokensValuesMustNotContainInvalidCharacters(
