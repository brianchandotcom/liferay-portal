...
public class StyleBookTokenSetPersistenceTest {
	...
	@Test
	public void testCountBySBEI_FTDI_FTCN_N() throws Exception {
		_persistence.countBySBEI_FTDI_FTCN_N(
			RandomTestUtil.nextLong(), "", "", "");

		_persistence.countBySBEI_FTDI_FTCN_N(0L, "null", "null", "null");
	...
	protected OrderByComparator<StyleBookTokenSet> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			"styleBookEntryId", true, "frontendTokenDefinitionId", true,
			"frontendTokenCategoryName", true, "name", true, "description",
			true);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:-74345280