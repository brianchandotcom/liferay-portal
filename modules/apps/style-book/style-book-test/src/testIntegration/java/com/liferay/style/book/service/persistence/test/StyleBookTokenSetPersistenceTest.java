...
public class StyleBookTokenSetPersistenceTest {
	...
	@Test
	public void testCountBySBEI_FTCN_FTDI_N() throws Exception {
		_persistence.countBySBEI_FTCN_FTDI_N(
			RandomTestUtil.nextLong(), "", "", "");

		_persistence.countBySBEI_FTCN_FTDI_N(0L, "null", "null", "null");
	...
	protected OrderByComparator<StyleBookTokenSet> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			"styleBookEntryId", true, "frontendTokenCategoryName", true,
			"frontendTokenDefinitionId", true, "name", true, "description",
			true);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:-899085458