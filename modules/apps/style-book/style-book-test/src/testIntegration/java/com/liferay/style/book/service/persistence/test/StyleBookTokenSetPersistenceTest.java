...
public class StyleBookTokenSetPersistenceTest {
	...
	@Test
	public void testCountByFTCN_N_SBEI_T() throws Exception {
		_persistence.countByFTCN_N_SBEI_T(
			"", "", RandomTestUtil.nextLong(), "");

		_persistence.countByFTCN_N_SBEI_T("null", "null", 0L, "null");

		_persistence.countByFTCN_N_SBEI_T(
			(String)null, (String)null, 0L, (String)null);
	}
	...
	protected OrderByComparator<StyleBookTokenSet> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			"description", true, "frontendTokenCategoryName", true, "name",
			true, "styleBookEntryId", true, "themeId", true);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:1397447783