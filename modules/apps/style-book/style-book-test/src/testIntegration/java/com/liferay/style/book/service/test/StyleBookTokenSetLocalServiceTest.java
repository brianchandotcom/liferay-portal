	...
	public void testAddStyleBookTokenSetWhenNameIsDuplicate() throws Exception {
		Assert.assertThrows(
			...
			() -> _styleBookTokenSetLocalService.addStyleBookTokenSet(
				...
				"brandColors", _styleBookEntry.getStyleBookEntryId(),
				_THEME_ID_CLASSIC));
		...
		_styleBookTokenSetLocalService.addStyleBookTokenSet(
			RandomTestUtil.randomString(), TestPropsValues.getUserId(),
			RandomTestUtil.randomString(), _FRONTEND_TOKEN_CATEGORY_NAME, name,
			_styleBookEntry.getStyleBookEntryId(), _THEME_ID_CLASSIC);
		...
		Assert.assertThrows(
			...
			() -> _styleBookTokenSetLocalService.addStyleBookTokenSet(
				RandomTestUtil.randomString(), TestPropsValues.getUserId(),
				RandomTestUtil.randomString(), _FRONTEND_TOKEN_CATEGORY_NAME,
				name, _styleBookEntry.getStyleBookEntryId(),
				_THEME_ID_CLASSIC));
	}

	@Test
	public void testAddStyleBookTokenSetWhenNameIsDuplicateInDifferentScope()
		throws Exception {
		...
		StyleBookTokenSet styleBookEntryStyleBookTokenSet =
			_styleBookTokenSetLocalService.addStyleBookTokenSet(
				RandomTestUtil.randomString(), TestPropsValues.getUserId(),
				RandomTestUtil.randomString(), _FRONTEND_TOKEN_CATEGORY_NAME,
				name, styleBookEntry.getStyleBookEntryId(), _THEME_ID_CLASSIC);
	...
	public void testAddStyleBookTokenSetWhenNameIsInvalid() throws Exception {
		Assert.assertThrows(
			...
			() -> _styleBookTokenSetLocalService.addStyleBookTokenSet(
				RandomTestUtil.randomString(), TestPropsValues.getUserId(),
				RandomTestUtil.randomString(), RandomTestUtil.randomString(),
				StringPool.BLANK, _styleBookEntry.getStyleBookEntryId(),
				RandomTestUtil.randomString()));
		Assert.assertThrows(
			StyleBookTokenSetNameException.class,
			() -> _styleBookTokenSetLocalService.addStyleBookTokenSet(
				RandomTestUtil.randomString(), TestPropsValues.getUserId(),
				RandomTestUtil.randomString(), RandomTestUtil.randomString(),
				null, _styleBookEntry.getStyleBookEntryId(),
				RandomTestUtil.randomString()));
		Assert.assertThrows(
			StyleBookTokenSetNameException.class,
			() -> _styleBookTokenSetLocalService.addStyleBookTokenSet(
