...
create unique index IX_C4615761 on SyncDLFileVersionDiff (fileEntryId, sourceFileVersionId, targetFileVersionId, companyId);
...
create unique index IX_2759E692 on SyncDLObject (type_[$COLUMN_LENGTH:75$], typePK, companyId);
