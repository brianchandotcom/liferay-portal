...
import com.liferay.template.exception.NoSuchEntryException;
...
public interface TemplateEntryPersistence
	 ...
	 * @throws NoSuchEntryException if a matching template entry could not be found
	 */
	 ...
	 * @throws NoSuchEntryException if a template entry with the primary key could not be found
	 */
	...
	/**
	 * Returns the template entry where uuid = &#63; and groupId = &#63; or throws a <code>NoSuchEntryException</code> if it could not be found.
	 *
	 * @param uuid the uuid
	...
	/**
	 * Returns the template entry where DDMTemplateId = &#63; or throws a <code>NoSuchEntryException</code> if it could not be found.
	 *
	 ...
	 * @return the matching template entries
	 */
	public java.util.List<TemplateEntry> findByG_I(
	 ...
	 * @throws NoSuchEntryException if a matching template entry could not be found
	 */
	public TemplateEntry findByG_I_First(
			long groupId, String infoItemClassName,
			com.liferay.portal.kernel.util.OrderByComparator<TemplateEntry>
				orderByComparator)
		throws NoSuchEntryException;
	 ...
	 * @return the first matching template entry, or <code>null</code> if a matching template entry could not be found
	 */
	public TemplateEntry fetchByG_I_First(
		long groupId, String infoItemClassName,
		com.liferay.portal.kernel.util.OrderByComparator<TemplateEntry>
			orderByComparator);
	 ...
	 * @throws NoSuchEntryException if a matching template entry could not be found
	 */
	public TemplateEntry findByG_I_Last(
			long groupId, String infoItemClassName,
			com.liferay.portal.kernel.util.OrderByComparator<TemplateEntry>
				orderByComparator)
		throws NoSuchEntryException;
	 ...
	 * @return the last matching template entry, or <code>null</code> if a matching template entry could not be found
	 */
	public TemplateEntry fetchByG_I_Last(
		long groupId, String infoItemClassName,
		com.liferay.portal.kernel.util.OrderByComparator<TemplateEntry>
			orderByComparator);
	 ...
	 * @throws NoSuchEntryException if a template entry with the primary key could not be found
	 */
	public TemplateEntry[] findByG_I_PrevAndNext(
	 ...
	 * @param infoItemClassName the info item class name
	 */
	public void removeByG_I(long groupId, String infoItemClassName);
	 ...
	 * @return the number of matching template entries
	 */
	public int countByG_I(long groupId, String infoItemClassName);
	...
	/**
	 * Returns the template entry with the primary key or throws a <code>NoSuchEntryException</code> if it could not be found.
	 *
	 * @param templateEntryId the primary key of the template entry
