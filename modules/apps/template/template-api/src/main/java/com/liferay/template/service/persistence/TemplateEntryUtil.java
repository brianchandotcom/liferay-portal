...
public class TemplateEntryUtil {
	...
	public static TemplateEntry findByUuid_First(
		...
		throws com.liferay.template.exception.NoSuchEntryException {
	 ...
	 * @return the matching template entries
	 */
	public static List<TemplateEntry> findByG_I(
		long groupId, String infoItemClassName) {

		return getPersistence().findByG_I(groupId, infoItemClassName);
	}
	 ...
	 * @throws NoSuchEntryException if a matching template entry could not be found
	 */
	public static TemplateEntry findByG_I_First(
			long groupId, String infoItemClassName,
			OrderByComparator<TemplateEntry> orderByComparator)
		throws com.liferay.template.exception.NoSuchEntryException {
	 ...
	 * @return the first matching template entry, or <code>null</code> if a matching template entry could not be found
	 */
	public static TemplateEntry fetchByG_I_First(
		long groupId, String infoItemClassName,
		OrderByComparator<TemplateEntry> orderByComparator) {
	 ...
	 * @throws NoSuchEntryException if a matching template entry could not be found
	 */
	public static TemplateEntry findByG_I_Last(
			long groupId, String infoItemClassName,
			OrderByComparator<TemplateEntry> orderByComparator)
		throws com.liferay.template.exception.NoSuchEntryException {
	 ...
	 * @return the last matching template entry, or <code>null</code> if a matching template entry could not be found
	 */
	public static TemplateEntry fetchByG_I_Last(
		long groupId, String infoItemClassName,
		OrderByComparator<TemplateEntry> orderByComparator) {
	 ...
	 * @throws NoSuchEntryException if a template entry with the primary key could not be found
	 */
	public static TemplateEntry[] findByG_I_PrevAndNext(
	 ...
	 * @param infoItemClassName the info item class name
	 */
	public static void removeByG_I(long groupId, String infoItemClassName) {
		getPersistence().removeByG_I(groupId, infoItemClassName);
	}
	 ...
	 * @return the number of matching template entries
	 */
	public static int countByG_I(long groupId, String infoItemClassName) {
		return getPersistence().countByG_I(groupId, infoItemClassName);
	}
