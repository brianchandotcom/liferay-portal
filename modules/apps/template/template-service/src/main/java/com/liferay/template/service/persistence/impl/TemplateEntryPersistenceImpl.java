...
public class TemplateEntryPersistenceImpl
	 ...
	 */
	@Override
	public List<TemplateEntry> findByG_I(
	...
	public List<TemplateEntry> findByG_I(
		...
		return findByG_I(groupId, infoItemClassName, start, end, null);
	}
	...
	public List<TemplateEntry> findByG_I(
		...
		if (list == null) {
			...
			if (infoItemClassName.isEmpty()) {
				sb.append(_FINDER_COLUMN_G_I_INFOITEMCLASSNAME_3);
			}
			else {
				bindInfoItemClassName = true;

				sb.append(_FINDER_COLUMN_G_I_INFOITEMCLASSNAME_2);
			}
	...
	public TemplateEntry findByG_I_First(
		...
		TemplateEntry templateEntry = fetchByG_I_First(
	...
	public TemplateEntry fetchByG_I_First(
		...
		List<TemplateEntry> list = findByG_I(
	...
	public TemplateEntry findByG_I_Last(
		...
		TemplateEntry templateEntry = fetchByG_I_Last(
			groupId, infoItemClassName, orderByComparator);
	...
	public TemplateEntry fetchByG_I_Last(
		...
		int count = countByG_I(groupId, infoItemClassName);
	...
	protected TemplateEntry getByG_I_PrevAndNext(
		Session session, TemplateEntry templateEntry, long groupId,
	...
	private static final String _FINDER_COLUMN_G_I_INFOITEMCLASSNAME_2 =
		"templateEntry.infoItemClassName = ?";

	private static final String _FINDER_COLUMN_G_I_INFOITEMCLASSNAME_3 =
