...
public class TemplateEntryPersistenceTest {
	...
	@Test
	public void testCountByG_I() throws Exception {
		_persistence.countByG_I(RandomTestUtil.nextLong(), "");

		_persistence.countByG_I(0L, "null");

		_persistence.countByG_I(0L, (String)null);
	}
	...
	protected OrderByComparator<TemplateEntry> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			"templateEntryId", true, "companyId", true, "userId", true,
			"userName", true, "createDate", true, "modifiedDate", true,
			"groupId", true, "infoItemClassName", true,
			"infoItemFormVariationKey", true, "DDMTemplateId", true);
	}
