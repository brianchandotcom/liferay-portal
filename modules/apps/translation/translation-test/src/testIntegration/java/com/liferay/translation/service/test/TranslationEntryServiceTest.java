...
public class TranslationEntryServiceTest {
	...
	@Test
	public void testAddOrUpdateTranslationEntryPendingArticleApprovedTranslation()
		throws Exception {
		...
		Assert.assertEquals(
			...
			latestArticle.getTitle(LocaleUtil.US));
		...
		latestArticle = _journalArticleService.getLatestArticle(
			journalArticle.getGroupId(), journalArticle.getArticleId(),
			WorkflowConstants.STATUS_ANY);

		Assert.assertEquals(
			"Este es el titulo", latestArticle.getTitle(LocaleUtil.SPAIN));
	}

	@Test
	public void testAddOrUpdateTranslationEntryPendingArticleRejectedTranslation()
		throws Exception {
		...
		Assert.assertEquals(
			...
			latestArticle.getTitle(LocaleUtil.SPAIN));
	...
	@Test
	public void testAddOrUpdateTranslationEntryUpdateArticle()
		throws Exception {
		...
		TranslationTestUtil.withRegularUser(
			(user, role) -> {
				...
				Assert.assertTrue(version < latestArticle.getVersion());
			});
	}

	@Test
	public void testAddOrUpdateTranslationEntryUpdateArticleApprovedTranslation()
		throws Exception {
		...
		Assert.assertEquals(
			"newTitle", latestArticle.getTitle(LocaleUtil.SPAIN));
	...
	@Test
	public void testAddOrUpdateTranslationEntryUpdateArticleRejectedTranslation()
		throws Exception {
