...
<liferay-frontend:management-bar includeCheckBox="<%= true %>" searchContainerId="userGroups">
...
<div class="container-fluid-1280" id="<portlet:namespace />userGroupSelectorWrapper">
	<liferay-ui:search-container id="userGroups" searchContainer="<%= userGroupItemSelectorViewDisplayContext.getSearchContainer() %>">
