...
page import="com.liferay.portlet.usergroupsadmin.search.AddUserUserGroupChecker" %><%@
page import="com.liferay.portlet.usergroupsadmin.search.RemoveUserUserGroupChecker" %><%@
