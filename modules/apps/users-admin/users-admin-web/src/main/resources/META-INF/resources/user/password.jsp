...
<aui:fieldset>
	...
	<aui:input autocomplete="off" label="new-password" name="password1" size="30" required="<%= true %>" type="password" />

	<aui:input autocomplete="off" label="enter-again" name="password2" size="30" required="<%= true %>" type="password">
