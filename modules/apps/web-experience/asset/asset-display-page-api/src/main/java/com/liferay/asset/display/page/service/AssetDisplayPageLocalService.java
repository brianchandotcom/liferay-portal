...
/**
 * Provides the local service interface for AssetDisplayPage. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AssetDisplayPageLocalServiceUtil
 * @see com.liferay.asset.display.page.service.base.AssetDisplayPageLocalServiceBaseImpl
 * @see com.liferay.asset.display.page.service.impl.AssetDisplayPageLocalServiceImpl
 * @generated
 */
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface AssetDisplayPageLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AssetDisplayPageLocalServiceUtil} to access the asset display page local service. Add custom service methods to {@link com.liferay.asset.display.page.service.impl.AssetDisplayPageLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public AssetDisplayPage addAssetDisplayPage(long assetEntryId, long layoutId);
	...
	*/
	...
	public AssetDisplayPage createAssetDisplayPage(long assetDisplayPageId);
	...
	*/
	...
	public AssetDisplayPage deleteAssetDisplayPage(
		AssetDisplayPage assetDisplayPage);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public AssetDisplayPage deleteAssetDisplayPage(long assetDisplayPageId)
	...
	*/
	...
	public AssetDisplayPage fetchAssetDisplayPage(long assetDisplayPageId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AssetDisplayPage fetchAssetDisplayPage(long assetEntryId,
		long layoutId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AssetDisplayPage getAssetDisplayPage(long assetDisplayPageId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AssetDisplayPage> getAssetDisplayPages(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public AssetDisplayPage updateAssetDisplayPage(
		AssetDisplayPage assetDisplayPage);
}