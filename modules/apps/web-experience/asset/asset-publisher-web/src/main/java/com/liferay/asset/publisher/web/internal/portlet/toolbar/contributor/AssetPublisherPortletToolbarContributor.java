...
public class AssetPublisherPortletToolbarContributor
	...
	protected void addPortletTitleAddAssetEntryMenuItems(
		...
		Map<Long, List<AssetPublisherAddItemHolder>>
			scopeAssetPublisherAddItemHolders =
				assetPublisherDisplayContext.getScopeAssetPublisherAddItemHolders(
					1);
		...
		if (scopeAssetPublisherAddItemHolders.size() == 1) {
			...
			Iterator<Map.Entry<Long, List<AssetPublisherAddItemHolder>>> iterator =
				entrySet.iterator();

			Map.Entry<Long, List<AssetPublisherAddItemHolder>> scopeAddPortletURL =
				iterator.next();
	...
	private URLMenuItem _getPortletTitleAddAssetEntryMenuItem(
		...
		if (!group.isStagedPortlet(assetPublisherAddItemHolder.getPortletId()) &&
