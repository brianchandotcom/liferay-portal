...
<c:if test="<%= fragmentDisplayContext.isShowAddButton(FragmentActionKeys.ADD_FRAGMENT_ENTRY) %>">
	...
	<aui:script require="metal-dom/src/all/dom as dom">
		function handleAddFragmentEntryMenuItemClickHandler(event) {
		...
		function handleDestroyPortlet () {
			addFragmentEntryMenuItem.removeListener('click', handleAddFragmentEntryMenuItemClickHandler);
		...
		addFragmentEntryMenuItem.addEventListener('click', handleFragmentEntryMenuItemClick);
