...
public class SiteNavigationMenuItemServiceHttp {
	...
	public static com.liferay.site.navigation.model.SiteNavigationMenuItem updateSiteNavigationMenuItem(
		...
		try {
			MethodKey methodKey = new MethodKey(SiteNavigationMenuItemServiceUtil.class,
					...
					_updateSiteNavigationMenuItemParameterTypes1);
	...
	private static final Class<?>[] _updateSiteNavigationMenuItemParameterTypes1 =
		new Class[] {
			long.class, long.class, java.lang.String.class,
			com.liferay.portal.kernel.service.ServiceContext.class
		};
	private static final Class<?>[] _deleteSiteNavigationMenuItemParameterTypes2 =
		new Class[] { long.class };
	private static final Class<?>[] _deleteSiteNavigationMenuItemsParameterTypes3 =
		new Class[] { long.class };
	private static final Class<?>[] _getSiteNavigationMenuItemsParameterTypes4 = new Class[] {
			long.class
		};
}