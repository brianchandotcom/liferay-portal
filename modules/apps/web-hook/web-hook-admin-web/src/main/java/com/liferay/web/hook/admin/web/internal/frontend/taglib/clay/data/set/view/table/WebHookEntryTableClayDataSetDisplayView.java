...
package com.liferay.web.hook.admin.web.internal.frontend.taglib.clay.data.set.view.table;
...
@Component(
	immediate = true,
	property = "clay.data.set.display.name=" + WebHookAdminConstants.WEB_HOOK_ENTRY_DATA_SET_DISPLAY,
...
public class WebHookEntryTableClayDataSetDisplayView
	...
	public ClayTableSchema getClayTableSchema() {
		...
		_addClayTableSchemaField(
			clayTableSchemaBuilder, "destination", "destination");
