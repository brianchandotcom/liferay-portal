...
import com.liferay.web.hook.admin.web.internal.constants.WebHookAdminWebKeys;
import com.liferay.web.hook.admin.web.internal.display.context.WebHookAdminDisplayContext;
...
public class ViewMVCRenderCommand implements MVCRenderCommand {
	...
	public String render(
		...
		renderRequest.setAttribute(
			WebHookAdminWebKeys.WEB_HOOK_ADMIN_DISPLAY_CONTEXT,
			new WebHookAdminDisplayContext(
				renderRequest, renderResponse, _messageBus,
				_webHookEntryLocalService));
