 ...
 * @generated
 */
@ImplementationClassName("com.liferay.web.hook.model.impl.WebHookEntryImpl")
@ProviderType
public interface WebHookEntry extends PersistedModel, WebHookEntryModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>com.liferay.web.hook.model.impl.WebHookEntryImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<WebHookEntry, Long>
		WEB_HOOK_ENTRY_ID_ACCESSOR = new Accessor<WebHookEntry, Long>() {
