...
public class WebhookEntryPersistenceImpl
	 ...
	 */
	@Override
	public List<WebhookEntry> findByCompanyId(long companyId) {
	 ...
	 */
	@Override
	public List<WebhookEntry> findByCompanyId(
	...
	public WebhookEntry findByCompanyId_First(
		...
		WebhookEntry webhookEntry = fetchByCompanyId_First(
	...
	public WebhookEntry fetchByCompanyId_First(
		...
		List<WebhookEntry> list = findByCompanyId(
	...
	public WebhookEntry findByCompanyId_Last(
		...
		WebhookEntry webhookEntry = fetchByCompanyId_Last(
			companyId, orderByComparator);
	...
	public WebhookEntry[] findByCompanyId_PrevAndNext(
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(
				session, webhookEntry, companyId, orderByComparator, true);

			array[1] = webhookEntry;

			array[2] = getByCompanyId_PrevAndNext(
				session, webhookEntry, companyId, orderByComparator, false);
	...
	protected WebhookEntry getByCompanyId_PrevAndNext(
		Session session, WebhookEntry webhookEntry, long companyId,
		OrderByComparator<WebhookEntry> orderByComparator, boolean previous) {
	...
	public WebhookEntry findByC_N(long companyId, String name)
		...
		WebhookEntry webhookEntry = fetchByC_N(companyId, name);
	...
	public WebhookEntry fetchByC_N(
		...
		if (result instanceof WebhookEntry) {
			...
			if ((companyId != webhookEntry.getCompanyId()) ||
				!Objects.equals(name, webhookEntry.getName())) {
	...
	public WebhookEntry removeByC_N(long companyId, String name)
		...
		WebhookEntry webhookEntry = findByC_N(companyId, name);
	...
	private static final String _FINDER_COLUMN_C_N_NAME_3 =
		"(webhookEntry.name IS NULL OR webhookEntry.name = '')";
	...
	public void cacheResult(WebhookEntry webhookEntry) {
		...
		finderCache.putResult(
			...
			new Object[] {webhookEntry.getCompanyId(), webhookEntry.getName()},
			webhookEntry);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
			...
			webhookEntryModelImpl.getName()
		};

		finderCache.putResult(_finderPathCountByC_N, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByC_N, args, webhookEntryModelImpl);
	}
