...
public class AgentInstanceResourceImpl extends BaseAgentInstanceResourceImpl {
	...
	public AgentInstance postAgentInstance(AgentInstance agentInstance)
		...
		long workflowInstanceId = _defaultAgent.invoke(
			AgentContext.builder(
				...
				_getInputVariableNames(agentDefinition)
	...
	private List<String> _getInputVariableNames(
		AgentDefinition agentDefinition) {

		List<String> inputVariableNames = new ArrayList<>();

		Variable[] variables = agentDefinition.getInputVariables();

		if (variables != null) {
			for (Variable variable : variables) {
				inputVariableNames.add(variable.getName());
			}
		}
