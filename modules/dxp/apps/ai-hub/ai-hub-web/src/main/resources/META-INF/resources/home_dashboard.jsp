		...
		<div aria-hidden="true" class="home-dashboard home-dashboard--server">
			<div class="home-dashboard__hero">
				<h2 class="home-dashboard__hero-title">
					<liferay-ui:message key="start-creating-something" />
				</h2>

				<p class="home-dashboard__hero-subtitle">
					<liferay-ui:message key="an-agent-or-automation-can-help-you-and-your-customers-with-daily-tasks-doing-your-day-to-day-easier" />
				</p>
