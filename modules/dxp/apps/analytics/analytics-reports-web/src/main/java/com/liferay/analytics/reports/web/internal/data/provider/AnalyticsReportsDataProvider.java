...
public class AnalyticsReportsDataProvider {
	...
	public List<ReferringURL> getReferringURLDomains(long companyId, String url)
		throws PortalException {
	...
	public List<ReferringURL> getReferringURLPages(long companyId, String url)
		throws PortalException {
	...
	public Map<String, TrafficChannel> getTrafficChannels(
		...
		try {
			...
			List<ReferringURL> referringURLDomains = getReferringURLDomains(
				companyId, url);

			List<ReferringURL> referringURLPages = getReferringURLPages(
				companyId, url);
			...
			return stream.map(
				acquisitionChannel -> TrafficChannelUtil.toTrafficChannel(
					acquisitionChannel, referringURLDomains, referringURLPages,
