...
public class AnalyticsReportsDataProviderTest {
	...
	@Test
	public void testGetReferringURLDomains() throws Exception {
		AnalyticsReportsDataProvider analyticsReportsDataProvider =
			new AnalyticsReportsDataProvider(
				_getHttp(
					Collections.singletonMap(
		...
		List<ReferringURL> referringURLS =
			analyticsReportsDataProvider.getReferringURLDomains(
				RandomTestUtil.randomLong(), RandomTestUtil.randomString());
	...
	@Test
	public void testGetReferringURLPages() throws Exception {
		AnalyticsReportsDataProvider analyticsReportsDataProvider =
			new AnalyticsReportsDataProvider(
				_getHttp(
					Collections.singletonMap(
		...
		List<ReferringURL> referringURLS =
			analyticsReportsDataProvider.getReferringURLPages(
				RandomTestUtil.randomLong(), RandomTestUtil.randomString());
