...
@Component(
	...
	property = {
		"commerce.data.integration.process.type.key=" + AnalyticsDownloadCommerceAccountCommerceMLForecastProcessType.KEY,
		"commerce.data.integration.process.type.order=100"
	},
	service = ProcessType.class
)
@Deprecated
public class AnalyticsDownloadCommerceAccountCommerceMLForecastProcessType
