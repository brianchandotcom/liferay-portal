 ...
 */
public class NoSuchCPDefinitionDiagramSettingException extends NoSuchModelException {
	...
	public NoSuchCPDefinitionDiagramSettingException(String msg, Throwable throwable) {
		super(msg, throwable);
	}
