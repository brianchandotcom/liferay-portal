...
public class CPDefinitionDiagramEntryUtil {
	 ...
	 * @throws NoSuchCPDefinitionDiagramEntryException if a matching cp definition diagram entry could not be found
	 */
	public static CPDefinitionDiagramEntry findByC_N(
			long CPDefinitionId, int number)
		throws com.liferay.commerce.shop.by.diagram.exception.
			NoSuchCPDefinitionDiagramEntryException {

		return getPersistence().findByC_N(CPDefinitionId, number);
	}
	 ...
	 */
	public static CPDefinitionDiagramEntry fetchByC_N(
		long CPDefinitionId, int number) {

		return getPersistence().fetchByC_N(CPDefinitionId, number);
	}
	 ...
	 */
	public static CPDefinitionDiagramEntry removeByC_N(
			long CPDefinitionId, int number)
		throws com.liferay.commerce.shop.by.diagram.exception.
			NoSuchCPDefinitionDiagramEntryException {

		return getPersistence().removeByC_N(CPDefinitionId, number);
	}
	 ...
	 * @return the number of matching cp definition diagram entries
	 */
	public static int countByC_N(long CPDefinitionId, int number) {
		return getPersistence().countByC_N(CPDefinitionId, number);
	}
