...
import com.liferay.commerce.shop.by.diagram.internal.type.comparator.CPDefinitionDiagramTypeOrderComparator;
	...
	public CPDefinitionDiagramType getCPDefinitionDiagramType(String key) {
		...
		if (cpDefinitionDiagramTypeServiceWrapper == null) {
			if (_log.isDebugEnabled()) {
				_log.debug(
					"No CPDefinitionDiagramType registered with key " + key);
			}
