...
@Component(
	...
	property = {
		"commerce.product.content.list.entry.renderer.key=" + DiagramCPContentListEntryRenderer.KEY,
...
public class DiagramCPContentListEntryRenderer
	...
	public void render(
		...
		httpServletRequest.setAttribute(
			"diagramCPTypeHelper", _diagramCPTypeHelper);
	...
	@Reference
	private DiagramCPTypeHelper _diagramCPTypeHelper;
