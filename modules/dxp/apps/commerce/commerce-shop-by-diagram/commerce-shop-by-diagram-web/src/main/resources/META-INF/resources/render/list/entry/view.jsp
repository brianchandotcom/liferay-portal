...
<%
CSDiagramCPTypeHelper csDiagramCPTypeHelper = (CSDiagramCPTypeHelper)request.getAttribute("csDiagramCPTypeHelper");
	...
	<div class="card d-flex flex-column product-card">
		<div class="aspect-ratio aspect-ratio-4-to-3 card-item-first">
			<a href="<%= productDetailURL %>">
				<div class="aspect-ratio-bg-cover aspect-ratio-item aspect-ratio-item-center-middle aspect-ratio-item-fluid card-type-asset-icon h-100 w-100" style="background-image: url('<%= csDiagramCPTypeHelper.getImageURL(cpCatalogEntry.getCPDefinitionId()) %>');"></div>
			</a>
		</div>
