...
public class Order implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Date the order was created, in ISO 8601. Read-only.",
		example = "2017-07-21"
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Date the order was last modified, in ISO 8601. Read-only.",
		example = "2017-08-21"
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Date the order was placed by the buyer, in ISO 8601. Distinct from the create date when the order was imported.",
		example = "2017-07-21"
	)
...
// LIFERAY-REST-BUILDER-HASH:2092071457