...
public class Product implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Date the product was created, in ISO 8601. Read-only.",
		example = "2017-07-21"
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Date from which the product is visible on the storefront, in ISO 8601.",
		example = "2017-07-21"
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Date from which the product is no longer visible on the storefront, in ISO 8601.",
		example = "2017-08-21"
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Date the product was last modified, in ISO 8601. Read-only.",
		example = "2017-08-21"
	)
...
// LIFERAY-REST-BUILDER-HASH:-1698550947