...
@Generated("")
@ProviderType
public interface DiagramEntryResource {

	public static Builder builder() {
		return FactoryHolder.factory.create();
	}

	public Response deleteDiagramEntry(Long id) throws Exception;

	public Response deleteDiagramEntryBatch(
			Long id, String callbackURL, Object object)
		throws Exception;

	public Response patchDiagramEntry(Long id, DiagramEntry diagramEntry)
		throws Exception;
	...
	public DiagramEntry postProductIdDiagramEntry(
			Long id, DiagramEntry diagramEntry)
		throws Exception;
	...
	public interface Builder {
		...
		public DiagramEntryResource build();
