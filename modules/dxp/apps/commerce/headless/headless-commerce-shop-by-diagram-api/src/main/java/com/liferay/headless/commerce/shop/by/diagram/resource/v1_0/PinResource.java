...
public interface PinResource {
	...
	public Response deletePin(Long id) throws Exception;

	public Response deletePinBatch(Long id, String callbackURL, Object object)
		throws Exception;

	public Response patchPin(Long id, Pin pin) throws Exception;
