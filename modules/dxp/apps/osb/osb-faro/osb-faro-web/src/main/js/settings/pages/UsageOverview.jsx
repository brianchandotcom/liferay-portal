	...
	switch (alertStatusCode) {
		...
		case SubscriptionStatuses.Over:
			return {
				message: admin
					? Liferay.Language.get(
							'usage-limit-has-been-exceeded.-please-contact-your-sales-representative-to-upgrade-the-plan'
					  )
					: Liferay.Language.get(
							'usage-limit-has-been-exceeded.-please-contact-your-workspace-administrator-to-upgrade-the-plan'
					  ),
				title: Liferay.Language.get('alert')
			};
		default:
