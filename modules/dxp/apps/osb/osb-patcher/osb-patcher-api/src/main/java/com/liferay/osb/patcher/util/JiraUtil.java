...
public class JiraUtil {
	...
	public static String buildIssueURL(
		...
		return StringBundler.concat(
			...
			StringPool.QUESTION, JiraConstants.ISSUE_FIELDS, StringPool.EQUAL,
	...
	public static JSONObject getIssue(
		...
		options.addHeader(
			"Authorization", _getBasicAuthorization(patcherConfiguration));
		options.setLocation(buildIssueURL(patcherConfiguration, issueKey));
	...
	private static String _getBasicAuthorization(
