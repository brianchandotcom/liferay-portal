...
public class PatcherFixPersistenceTest {
	...
	protected OrderByComparator<PatcherFix> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			"patcherProjectVersionId", true, "name", true, "key", true,
			"keyVersion", true, "type", true, "latestFix", true, "obsolete",
			true, "committish", true, "gitHash", true, "gitRemoteURL", true,
			"dependencies", true, "requirements", true, "requestKey", true,
			"jenkinsResults", true, "comments", true, "fixPackStatus", true,
