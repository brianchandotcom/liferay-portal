...
create unique index IX_AEECA239 on Reports_Definition (uuid_[$COLUMN_LENGTH:75$], groupId, companyId);
...
create unique index IX_8F2F6471 on Reports_Source (uuid_[$COLUMN_LENGTH:75$], groupId, companyId);