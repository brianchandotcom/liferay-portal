...
/**
 * Provides the local service interface for Ranking. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Bryan Engler
 * @see RankingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RankingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.portal.search.tuning.rankings.service.impl.RankingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ranking local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RankingLocalServiceUtil} if injection and service tracking are not available.
	 */
