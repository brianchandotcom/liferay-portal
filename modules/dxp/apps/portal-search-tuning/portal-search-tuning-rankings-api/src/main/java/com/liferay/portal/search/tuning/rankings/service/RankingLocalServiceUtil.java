 ...
 * <code>com.liferay.portal.search.tuning.rankings.service.impl.RankingLocalServiceImpl</code> and
 ...
 * @generated
 */
public class RankingLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.portal.search.tuning.rankings.service.impl.RankingLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Ranking createRanking(long rankingId) {
		return getService().createRanking(rankingId);
	}
	 ...
	 */
	public static Ranking deleteRanking(long rankingId) throws PortalException {
		return getService().deleteRanking(rankingId);
	}
	 ...
	 * @return the ranking that was removed
	 */
	public static Ranking deleteRanking(Ranking ranking) {
		return getService().deleteRanking(ranking);
	}
	...
	public static Ranking fetchRanking(long rankingId) {
		return getService().fetchRanking(rankingId);
	}
	 ...
	 * @throws PortalException if a ranking with the primary key could not be found
	 */
	public static Ranking getRanking(long rankingId) throws PortalException {
		return getService().getRanking(rankingId);
	}
	 ...
	 */
	public static List<Ranking> getRankings(int start, int end) {
	 ...
	 */
	public static Ranking updateRanking(Ranking ranking) {
		return getService().updateRanking(ranking);
	}

	public static RankingLocalService getService() {
		return _service;
	}

	private static volatile RankingLocalService _service;
