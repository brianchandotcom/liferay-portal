...
/**
 * The extended model implementation for the Ranking service. Represents a row in the &quot;Ranking&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * Helper methods and all application logic should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.liferay.portal.search.tuning.rankings.model.Ranking</code> interface.
 * </p>
 *
 * @author Bryan Engler
 */
public class RankingImpl extends RankingBaseImpl {

	/**
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. All methods that expect a ranking model instance should use the {@link com.liferay.portal.search.tuning.rankings.model.Ranking} interface instead.
	 */
	public RankingImpl() {
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(RankingImpl.class);
