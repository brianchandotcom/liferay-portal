...
import com.liferay.portal.search.tuning.rankings.storage.RankingDatabaseImporter;
 ...
 * @author Bryan Engler
 */
@Component(service = RankingDatabaseImporter.class)
public class RankingDatabaseImporterImpl implements RankingDatabaseImporter {
	...
	@Reference(
		target = "(model.class.name=com.liferay.portal.search.tuning.rankings.model.Ranking)"
	)
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RankingDatabaseImporterImpl.class);
