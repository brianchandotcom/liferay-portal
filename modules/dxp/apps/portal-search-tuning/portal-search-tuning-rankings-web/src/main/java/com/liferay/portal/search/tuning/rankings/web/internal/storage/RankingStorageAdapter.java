...
public class RankingStorageAdapter {
	...
	public void delete(
		...
		stRankingsEntryLocalService.deleteSTRankingsEntry(
			_getSTRankingsEntryId(rankingDocumentId));
	...
	public void update(RankingIndexName rankingIndexName, Ranking ranking)
		...
		stRankingsEntryLocalService.updateSTRankingsEntry(
			_getSTRankingsEntryId(ranking.getRankingDocumentId()),
			ranking.getAliases(), ranking.getHiddenDocumentIds(),
			ranking.isInactive(), ranking.getName(),
	...
	private long _getSTRankingsEntryId(String rankingDocumentId)
		throws PortalException {
