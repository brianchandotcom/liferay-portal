...
import com.liferay.search.tuning.synonyms.storage.SynonymSetsDatabaseImporter;
...
public class SynonymSetsDatabaseImporterImpl
	...
	@Reference(
		target = "(model.class.name=com.liferay.search.tuning.synonyms.model.STSynonymsEntry)"
	)
