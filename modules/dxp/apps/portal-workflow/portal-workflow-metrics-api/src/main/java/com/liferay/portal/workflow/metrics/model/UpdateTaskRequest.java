...
public class UpdateTaskRequest {
	...
	public static class Builder {
		...
		public UpdateTaskRequest.Builder setAssetTitleMap(
		...
		public UpdateTaskRequest.Builder setAssetTypeMap(
			Map<Locale, String> assetTitleMap) {
		...
		public UpdateTaskRequest.Builder setAssignments(
		...
		public UpdateTaskRequest.Builder setCompanyId(long companyId) {
			_updateTaskRequest._companyId = companyId;

			return this;
		}

		public UpdateTaskRequest.Builder setModifiedDate(Date modifiedDate) {
			_updateTaskRequest._modifiedDate = modifiedDate;

			return this;
		}

		public UpdateTaskRequest.Builder setTaskId(long taskId) {
			_updateTaskRequest._taskId = taskId;

			return this;
		}

		public UpdateTaskRequest.Builder setUserId(long userId) {
