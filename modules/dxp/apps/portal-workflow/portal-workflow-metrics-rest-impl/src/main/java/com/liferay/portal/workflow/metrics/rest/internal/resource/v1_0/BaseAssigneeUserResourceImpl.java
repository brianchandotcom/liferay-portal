...
public abstract class BaseAssigneeUserResourceImpl
	implements AssigneeUserResource, BatchEngineTaskItemDelegate<AssigneeUser>,
			   EntityModelResource {
	...
	public com.liferay.batch.engine.pagination.Page<AssigneeUser> read(
		...
		Page<AssigneeUser> page = getProcessAssigneeUsersPage(
			...
			(String[])parameters.get("taskKeys"),
