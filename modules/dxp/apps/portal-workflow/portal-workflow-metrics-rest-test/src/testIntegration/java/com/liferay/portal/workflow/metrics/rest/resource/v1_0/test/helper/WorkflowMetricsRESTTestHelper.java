...
public class WorkflowMetricsRESTTestHelper {
	...
	public Instance addInstance(long companyId, Instance instance)
		...
		_assertCount(
			_indexNameBuilder.getIndexName(companyId) +
				WorkflowMetricsIndexEntityNameConstant.POSTFIX_INSTANCE,
	...
	public Node addNode(
		...
		_assertCount(
			_indexNameBuilder.getIndexName(companyId) +
				WorkflowMetricsIndexEntityNameConstant.POSTFIX_NODE,
	...
	public Process addProcess(long companyId, Process process)
		...
		_assertCount(
			_indexNameBuilder.getIndexName(companyId) +
				WorkflowMetricsIndexEntityNameConstant.POSTFIX_PROCESS,
	...
	public void addSLATaskResult(
		...
		_assertCount(
			_indexNameBuilder.getIndexName(companyId) +
				WorkflowMetricsIndexEntityNameConstant.POSTFIX_SLA_TASK_RESULT,
	...
	public Task addTask(
		...
		_assertCount(
			_indexNameBuilder.getIndexName(addTaskRequest.getCompanyId()) +
				WorkflowMetricsIndexEntityNameConstant.POSTFIX_TASK,
	...
	public Task addTask(long companyId, Instance instance, Task task, User user)
		...
		_assertCount(
			indexName + WorkflowMetricsIndexEntityNameConstant.POSTFIX_TASK,
		...
		_assertCount(
			...
			1,
			indexName + WorkflowMetricsIndexEntityNameConstant.POSTFIX_INSTANCE,
			"companyId", companyId, "deleted", false, "instanceId",
