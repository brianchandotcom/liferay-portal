...
public class TransitionWorkflowMetricsIndexer
	...
	public Document createDocument(KaleoTransition kaleoTransition)
		...
		KaleoNode kaleoNode = kaleoTransition.getKaleoNode();

		document.addKeyword("nodeId", getNodeId(kaleoNode));
		document.addKeyword("nodeName", kaleoNode.getName());

		KaleoNode sourceKaleoNode = kaleoTransition.getSourceKaleoNode();

		document.addKeyword("sourceNodeId", getNodeId(sourceKaleoNode));
		document.addKeyword("sourceNodeName", sourceKaleoNode.getName());

		KaleoNode targetKaleoNode = kaleoTransition.getTargetKaleoNode();

		document.addKeyword("targetNodeId", getNodeId(targetKaleoNode));
		document.addKeyword("targetNodeName", targetKaleoNode.getName());
	...
	protected long getNodeId(KaleoNode kaleoNode) throws PortalException {
