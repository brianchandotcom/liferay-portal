...
create unique index IX_3CB8E627 on WMSLADefinition (uuid_[$COLUMN_LENGTH:75$], groupId, companyId);
...
create unique index IX_6D5B7A99 on WMSLADefinitionVersion (uuid_[$COLUMN_LENGTH:75$], groupId, companyId);
