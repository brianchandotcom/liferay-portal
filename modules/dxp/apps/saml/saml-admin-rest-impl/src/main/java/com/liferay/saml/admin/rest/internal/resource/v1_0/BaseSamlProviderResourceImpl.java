...
public abstract class BaseSamlProviderResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/saml-admin/v1.0/samlProvider'  -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PATCH' 'http://localhost:8080/o/saml-admin/v1.0/samlProvider' -d $'{"enabled": ___, "entityId": ___, "idp": ___, "keyStoreCredentialPassword": ___, "role": ___, "signMetadata": ___, "sp": ___, "sslRequired": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/saml-admin/v1.0/samlProvider' -d $'{"enabled": ___, "entityId": ___, "idp": ___, "keyStoreCredentialPassword": ___, "role": ___, "signMetadata": ___, "sp": ___, "sslRequired": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/saml-admin/v1.0/samlProvider/batch'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.Path("/samlProvider/batch")
	@javax.ws.rs.POST
