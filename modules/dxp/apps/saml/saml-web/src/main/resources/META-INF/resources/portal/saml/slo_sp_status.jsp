	...
	<c:choose>
		...
		<c:when test="<%= status == 3 %>">
			<div class="portlet-msg-error">
				...
				<a href="<%= PortalUtil.getRelativeHomeURL(request) %>?p_p_id=com_liferay_saml_web_internal_portlet_SamlPortlet&p_p_lifecycle=0&p_p_state=maximized&_com_liferay_saml_web_internal_portlet_SamlPortlet_mvcRenderCommandName=/saml/slo_logout&cmd=logout&entityId=<%= samlSloRequestInfoJSONObject.getString("entityId") %>">
