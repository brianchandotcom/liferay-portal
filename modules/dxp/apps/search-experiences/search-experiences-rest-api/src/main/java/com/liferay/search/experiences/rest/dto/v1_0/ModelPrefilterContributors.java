...
@XmlRootElement(name = "ModelPrefilterContributors")
public class ModelPrefilterContributors implements Serializable {

	public static ModelPrefilterContributors toDTO(String json) {
		return ObjectMapperUtil.readValue(
			ModelPrefilterContributors.class, json);
	}

	public static ModelPrefilterContributors unsafeToDTO(String json) {
	...
	@Schema(
		...
		defaultValue = "com.liferay.search.experiences.rest.dto.v1_0.ModelPrefilterContributors",
		name = "x-class-name"
	)
