 ...
 */
@Generated("")
@GraphQLName("QueryPrefilterContributors")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "QueryPrefilterContributors")
public class QueryPrefilterContributors implements Serializable {

	public static QueryPrefilterContributors toDTO(String json) {
		return ObjectMapperUtil.readValue(
			QueryPrefilterContributors.class, json);
	}

	public static QueryPrefilterContributors unsafeToDTO(String json) {
	...
	public String toString() {
		...
		if (classNames != null) {
			...
			for (int i = 0; i < classNames.length; i++) {
				...
				sb.append(_escape(classNames[i]));
	...
	@Schema(
		...
		defaultValue = "com.liferay.search.experiences.rest.dto.v1_0.QueryPrefilterContributors",
		name = "x-class-name"
	)
