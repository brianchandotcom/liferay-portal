...
public abstract class BaseSearchableAssetNamesDisplayResourceImpl
	implements EntityModelResource, SearchableAssetNamesDisplayResource,
			   VulcanBatchEngineTaskItemDelegate<SearchableAssetNamesDisplay> {
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "SearchableAssetNamesDisplay"
			)
		}
	)
	@javax.ws.rs.GET
	...
	@Override
	public Page<SearchableAssetNamesDisplay> read(
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(
			BaseSearchableAssetNamesDisplayResourceImpl.class);
