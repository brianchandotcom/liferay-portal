...
public abstract class BaseSearchableAssetNamesDisplayResourceTestCase {
	...
	protected void assertValid(
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
					"searchableAssetDisplays", additionalAssertFieldName)) {

				if (searchableAssetNamesDisplay.getSearchableAssetDisplays() ==
						null) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("searchableAssetDisplays")) {
			throw new IllegalArgumentException(
