...
page import="com.liferay.search.experiences.web.internal.blueprint.display.context.ViewSXPElementsDisplayContext" %><%@
...
page import="com.liferay.search.experiences.web.internal.blueprint.security.permission.resource.SXPElementEntryPermission" %>
