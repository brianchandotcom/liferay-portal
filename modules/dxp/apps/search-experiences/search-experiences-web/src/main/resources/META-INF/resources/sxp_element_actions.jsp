...
>
	<c:if test="<%= SXPElementEntryPermission.contains(permissionChecker, sxpElement, ActionKeys.UPDATE) %>">
		<portlet:renderURL var="editEntryURL">
			<portlet:param name="mvcRenderCommandName" value="<%= SXPBlueprintMVCCommandNames.EDIT_SXP_ELEMENT %>" />
			<portlet:param name="redirect" value="<%= currentURL %>" />
			<portlet:param name="<%= SXPBlueprintWebKeys.SXP_ELEMENT_ID %>" value="<%= String.valueOf(sxpElementId) %>" />
		</portlet:renderURL>
	...
	<c:if test="<%= SXPElementEntryPermission.contains(permissionChecker, companyGroupId, SXPActionKeys.ADD_SXP_ELEMENT) %>">
		<portlet:actionURL name="<%= SXPBlueprintMVCCommandNames.COPY_SXP_ELEMENT %>" var="copyEntryURL">
			<portlet:param name="redirect" value="<%= currentURL %>" />
			<portlet:param name="<%= SXPBlueprintWebKeys.SXP_ELEMENT_ID %>" value="<%= String.valueOf(sxpElementId) %>" />
		</portlet:actionURL>
	...
	<portlet:resourceURL id="<%= SXPBlueprintMVCCommandNames.EXPORT_SXP_ELEMENT %>" var="exportEntryURL">
		<portlet:param name="redirect" value="<%= currentURL %>" />
		<portlet:param name="<%= SXPBlueprintWebKeys.SXP_ELEMENT_ID %>" value="<%= String.valueOf(sxpElementId) %>" />
	</portlet:resourceURL>
	...
	<c:if test="<%= SXPElementEntryPermission.contains(permissionChecker, sxpElement, ActionKeys.UPDATE) %>">
		<portlet:actionURL name="<%= SXPBlueprintMVCCommandNames.EDIT_SXP_ELEMENT %>" var="hideEntryURL">
			<portlet:param name="redirect" value="<%= currentURL %>" />
			<portlet:param name="<%= SXPBlueprintWebKeys.SXP_ELEMENT_ID %>" value="<%= String.valueOf(sxpElementId) %>" />
	...
	<c:if test="<%= SXPElementEntryPermission.contains(permissionChecker, sxpElement, ActionKeys.DELETE) && !sxpElement.getReadOnly() %>">
		<portlet:actionURL name="<%= SXPBlueprintMVCCommandNames.DELETE_SXP_ELEMENT %>" var="deleteEntryURL">
			<portlet:param name="redirect" value="<%= currentURL %>" />
			<portlet:param name="<%= SXPBlueprintWebKeys.SXP_ELEMENT_ID %>" value="<%= String.valueOf(sxpElementId) %>" />
		</portlet:actionURL>
