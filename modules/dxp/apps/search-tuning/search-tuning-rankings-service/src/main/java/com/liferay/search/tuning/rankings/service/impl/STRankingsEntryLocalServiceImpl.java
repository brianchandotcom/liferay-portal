...
public class STRankingsEntryLocalServiceImpl
	...
	@Override
	public STRankingsEntry deleteSTRankingsEntry(long rankingId)
		...
		return super.deleteSTRankingsEntry(rankingId);
	}

	@Override
	public List<STRankingsEntry> getRankingsByCompanyId(long companyId) {
	...
	public STRankingsEntry updateSTRankingsEntry(
		...
		return updateSTRankingsEntry(
			getSTRankingsEntry(rankingId), aliases, hiddenDocumentIds, inactive,
			name, documentIdsMap);
	}
