...
/**
 * Provides the local service interface for STSynonymsEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Bryan Engler
 * @see STSynonymsEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface STSynonymsEntryLocalService
	...
	public STSynonymsEntry addSTSynonymsEntry(STSynonymsEntry stSynonymsEntry);
	...
	public STSynonymsEntry createSTSynonymsEntry(long STSynonymsEntryId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public STSynonymsEntry deleteSTSynonymsEntry(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public STSynonymsEntry fetchSTSynonymsEntry(long STSynonymsEntryId);
