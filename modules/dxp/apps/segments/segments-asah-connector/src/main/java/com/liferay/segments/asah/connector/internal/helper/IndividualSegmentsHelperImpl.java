...
import com.liferay.segments.asah.connector.helper.IndividualSegmentsHelper;
...
public class IndividualSegmentsHelperImpl implements IndividualSegmentsHelper {
	...
	public void updateIndividualSegmentMemberships(
		...
		if (userId != null) {
			...
			_putSegmentsEntryIdsCache(
				segmentsEntry.getCompanyId(), individualPK,
	...
	private void _putSegmentsEntryIdsCache(
			long companyId, String userId, String individualSegmentId)
		throws PortalException {
		...
		segmentsEntryIds.add(Long.valueOf(individualSegmentId));
