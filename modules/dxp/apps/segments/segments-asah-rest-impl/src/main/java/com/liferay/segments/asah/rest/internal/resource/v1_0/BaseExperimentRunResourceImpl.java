...
public abstract class BaseExperimentRunResourceImpl
	implements ExperimentRunResource,
			   BatchEngineTaskItemDelegate<ExperimentRun>, EntityModelResource {
	...
	public void create(
		...
		for (ExperimentRun experimentRun : experimentRuns) {
			postExperimentRun(null, experimentRun);
		}
	}
	...
	@Override
	public com.liferay.batch.engine.pagination.Page<ExperimentRun> read(
			Filter filter,
