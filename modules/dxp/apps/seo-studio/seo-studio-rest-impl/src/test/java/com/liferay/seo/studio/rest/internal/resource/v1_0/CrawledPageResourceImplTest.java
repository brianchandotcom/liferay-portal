...
public class CrawledPageResourceImplTest {
	...
	public void testGetSeoStudioDomainCrawlHitsPageAppliesSearchAfter()
		...
		_crawledPageResourceImpl.getSeoStudioDomainCrawlHitsPage(
	...
	@Test(expected = NoSuchObjectEntryException.class)
	public void testGetSeoStudioDomainCrawlHitsPageFailsWithWrongAccount()
		throws Exception {
	...
	@Test
	public void testGetSeoStudioDomainCrawlHitsPageLinkFiltersInvalidEntries()
		throws Exception {
	...
	@Test
	public void testGetSeoStudioDomainCrawlHitsPageResolvesIndexNameFromDomainId()
		throws Exception {
	...
	private static final long _DOMAIN_ID = RandomTestUtil.randomLong();

	private static final long _INSTANCE_ID = RandomTestUtil.randomLong();
