...
public class CrawledPageResourceTest extends BaseCrawledPageResourceTestCase {
	...
	private void _testGetSeoStudioDomainCrawlHitsPageAppliesSearchAfter()
		...
		_indexCrawlDocument(indexName, url1, RandomTestUtil.randomString());
		_indexCrawlDocument(indexName, url2, RandomTestUtil.randomString());
		_indexCrawlDocument(indexName, url3, RandomTestUtil.randomString());
	...
	private void _testGetSeoStudioDomainCrawlHitsPageMapsTitleAndLinks()
		...
		_indexCrawlDocument(
			_indexNamesByDomainId.get(seoStudioDomainId),
			"https://liferay.com/" + RandomTestUtil.randomString(), title,
			linkAURL, linkBURL);
	...
	private void _testGetSeoStudioDomainCrawlHitsPageNormalizesLocaleRegionInCanonicalURL()
		...
		_indexCrawlDocument(
			_indexNamesByDomainId.get(seoStudioDomainId), url,
			RandomTestUtil.randomString(), aboutURL,
	...
	private void _testGetSeoStudioDomainCrawlHitsPageSkipsHitsWithoutURL()
		...
		_indexCrawlDocument(indexName, url, RandomTestUtil.randomString());
