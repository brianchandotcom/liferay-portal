...
public class CreateSEOStudioScansObjectActionExecutorTest {
	...
	public void testExecute() throws Exception {
		...
		_seoStudioInstanceObjectEntry = _addSEOStudioInstance(accountEntry);
		...
		_seoStudioDomainObjectEntry = _addSEOStudioDomain(
			accountEntry,
			JSONUtil.put(
				"engines",
				JSONUtil.put(
	...
	private ObjectEntry _addSEOStudioDomain(
			AccountEntry accountEntry, String scanConfig,
	...
	private ObjectEntry _addSEOStudioInstance(AccountEntry accountEntry)
		throws Exception {
