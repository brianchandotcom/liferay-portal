...
public class CheckSEOStudioDomainsSchedulerJobConfigurationTest
	...
	public void testCheckSEOStudioDomains() throws Exception {
		...
		for (ObjectEntry seoStudioScanObjectEntry :
			...
			_updateSEOStudioScanState(seoStudioScanObjectEntry, "running");
			_updateSEOStudioScanState(seoStudioScanObjectEntry, "completed");
		}
	...
	@Test
	public void testCheckSEOStudioDomainsDoesNotCreateScanRun()
		throws Exception {
