...
public class LiferayOutputTypeResolver implements OutputTypeResolver<String> {
	...
	public MetadataType getOutputType(
		...
		try {
			Optional<LiferayConnection> connectionOptional =
				metadataContext.getConnection();

			LiferayConnection liferayConnection = connectionOptional.get();
	...
	private void _getFieldRequired(
	...
	private MetadataType _resolveMetadataType(
		...
		while (propertiesIterator.hasNext()) {
			...
			_getFieldKey(objectFieldTypeBuilder, propertyEntry);
			_getFieldValue(objectFieldTypeBuilder, propertyEntry);
			_getFieldRequired(
