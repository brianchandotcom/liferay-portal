define(['exports', 'module', 'metal/src/core', 'metal/src/object/object', 'metal/src/component/Component', 'metal/src/component/ComponentRegistry', 'metal/src/soy/SoyComponentAop'], function (exports, module, _metalSrcCore, _metalSrcObjectObject, _metalSrcComponentComponent, _metalSrcComponentComponentRegistry, _metalSrcSoySoyComponentAop) {
	'use strict';
   ...
   */
    ...
    */
			...
			value: function buildTemplateData_() {
				...
				return _object['default'].mixin(_Component2['default'].componentsCollector.getNextComponentData(this.id), this.getAttrs(names));
			}
