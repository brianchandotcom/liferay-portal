...
public class ConfigurationPersistenceManagerTest {
	...
	public void testPortalPersistenceManager() throws Exception {
		Assert.assertEquals(
			ConfigurationPersistenceManager.class, _persistenceManager.getClass());
	}
	...
	public void testSetConfigurationProperties() throws Exception {
		...
		Dictionary<String, Object> persistedProperties =
			_persistenceManager.load(testPid);

		Assert.assertEquals("bar", persistedProperties.get("foo"));
	...
	public void testSetFactoryConfigurationProperties() throws Exception {
		...
		String testPid = configuration.getPid();
