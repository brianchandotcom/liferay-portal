...
### Added
- [LPS-69847]: Apply [Liferay Gradle Plugins Dependency Checker] to print a
warning message if the version of [Liferay Source Formatter] in use is not the
latest one and is older than 30 days.
