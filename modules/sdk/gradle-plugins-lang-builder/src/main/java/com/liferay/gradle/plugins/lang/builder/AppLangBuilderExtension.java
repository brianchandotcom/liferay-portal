 ...
 * @author Peter Shin
 */
public class AppLangBuilderExtension {

	public AppLangBuilderExtension(Project project) {
	...
	public AppLangBuilderExtension subprojects(Iterable<Project> subprojects) {
		GUtil.addToCollection(_subprojects, subprojects);

		return this;
	}

	public AppLangBuilderExtension subprojects(Project... subprojects) {
