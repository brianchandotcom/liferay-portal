...
The plugin has been successfully tested with Gradle 2.5 up to 3.4.1.
...
```gradle
dependencies {
	themeBuilder group: "com.liferay", name: "com.liferay.portal.tools.theme.builder", version: "1.1.2"
}
```
