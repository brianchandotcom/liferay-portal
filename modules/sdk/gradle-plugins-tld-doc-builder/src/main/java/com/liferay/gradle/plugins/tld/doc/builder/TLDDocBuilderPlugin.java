...
package com.liferay.gradle.plugins.tld.doc.builder;

import com.liferay.gradle.plugins.tld.doc.builder.tasks.TLDDocTask;
import com.liferay.gradle.plugins.tld.doc.builder.tasks.ValidateSchemaTask;
...
public class TLDDocBuilderPlugin implements Plugin<Project> {
	...
	protected ValidateSchemaTask addTaskValidateTLD(Project project) {
		...
		validateSchemaTask.setDescription(
			"Runs Liferay TLD Validator to format files.");
