...
import com.liferay.sdk.gradle.BasePlugin;
...
public class ApplicationPlugin extends BasePlugin {
	...
	protected void configureCleanAfterEvaluate() {
		Task cleanTask = getTask("clean");

		for (Task task : project.getTasks()) {
			String taskName = "clean" + TextFormatter.format(
				task.getName(), TextFormatter.G);
	...
	protected void configureVersion() {
		...
		if (Validator.isNotNull(moduleFullVersion)) {
			...
			if (Validator.isNotNull(bundleVersion)) {
				...
				version =
					ReleaseInfo.getVersion() + StringPool.PERIOD +
	...
	protected void doApply() throws Exception {
		...
		_extension = createExtension("liferay", ApplicationExtension.class);
	...
	private ApplicationExtension _extension;
