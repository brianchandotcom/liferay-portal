...
public class GitHubRemoteRepository extends RemoteRepository {
	...
	public boolean addLabel(String color, String description, String name) {
		...
		try {
			...
			_gitHubRemoteRepositoryLabels.remove(labelsRequestURL);
		}
	...
	public List<Label> getLabels() {
		...
		if (_gitHubRemoteRepositoryLabels.containsKey(labelRequestURL)) {
			return _gitHubRemoteRepositoryLabels.get(labelRequestURL);
		}
		...
		_gitHubRemoteRepositoryLabels.put(labelRequestURL, labels);
	...
	public void updateLabel(
		...
		try {
			...
			_gitHubRemoteRepositoryLabels.remove(_getLabelRequestURL());
		}
		catch (IOException ioe) {
			if (jsonObject == null) {
				System.out.println(
	...
	private static final Map<String, List<Label>>
		_gitHubRemoteRepositoryLabels = new ConcurrentHashMap<>();
