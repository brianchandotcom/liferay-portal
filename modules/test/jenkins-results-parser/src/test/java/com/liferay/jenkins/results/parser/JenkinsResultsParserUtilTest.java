...
public class JenkinsResultsParserUtilTest {
	...
	public void assertGetJobVariantSample(
		...
		String jsonString = _read(new File(_dependenciesDir, fileName));
	...
	public void testGetAxisVariable() throws Exception {
		JSONObject axisJson = new JSONObject(
			_read(new File(_dependenciesDir, "sample-1.json")));
	...
	public void testGetJobVariant() throws Exception {
		assertGetJobVariantSample("sample-2.json", "functional-tomcat-mysql/0");
		assertGetJobVariantSample("sample-3.json", "integration-db2");
	}
	...
	protected void assertToJSONObjectSample(String fileName) throws Exception {
		...
		JSONObject expectedJSONObject = new JSONObject(_read(jsonFile));
