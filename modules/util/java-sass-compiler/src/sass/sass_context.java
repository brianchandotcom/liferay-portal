...
public class sass_context extends Structure<sass_context, sass_context.ByValue, sass_context.ByReference > {
	...
	public List getFieldOrder() {
		return Arrays.asList(new String[]{"input_path", "output_path", "source_string", "output_string", "source_map_string", "options", "error_status", "error_message", "c_functions", "included_files", "num_included_files"});
	}
