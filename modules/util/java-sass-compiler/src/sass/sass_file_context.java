...
public class sass_file_context extends Structure<sass_file_context, sass_file_context.ByValue, sass_file_context.ByReference > {
	...
	public List getFieldOrder() {
		return Arrays.asList(new String[]{"input_path", "output_path", "output_string", "source_map_string", "options", "error_status", "error_message", "c_functions", "included_files", "num_included_files"});
	}
