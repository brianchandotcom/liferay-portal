...
public class sass_options extends Structure<sass_options, sass_options.ByValue, sass_options.ByReference > {
	...
	protected List getFieldOrder() {
		return Arrays.asList(new String[]{"output_style", "source_comments", "source_map_file", "omit_source_map_url", "source_map_embed", "source_map_contents", "is_indented_syntax_src", "include_paths", "image_path", "precision"});
	};
}
