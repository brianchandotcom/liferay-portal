 ...
 */
@Generated("")
@GraphQLName("ERCScopedTestEntity")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ERCScopedTestEntity")
public class ERCScopedTestEntity implements Serializable {

	public static ERCScopedTestEntity toDTO(String json) {
		return ObjectMapperUtil.readValue(ERCScopedTestEntity.class, json);
	}

	public static ERCScopedTestEntity unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			ERCScopedTestEntity.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.portal.tools.rest.builder.test.dto.v1_0.ERCScopedTestEntity",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:1591312307