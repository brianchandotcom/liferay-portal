...
public abstract class BaseDocumentResourceImpl
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/sample/1.0.0/document' -d $'{"dateCreated": ___, "dateModified": ___, "description": ___, "documentId": ___, "folderId": ___, "name": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/sample/1.0.0/document/batch'  -u 'test@liferay.com:test'
	 */
	...
	@Override
	public Response postDocumentBatch(
