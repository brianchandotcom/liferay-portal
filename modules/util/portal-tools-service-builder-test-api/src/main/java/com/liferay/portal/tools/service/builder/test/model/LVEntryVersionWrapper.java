...
public class LVEntryVersionWrapper implements LVEntryVersion,
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		for (Map.Entry<String, BiConsumer<LVEntryVersion, Object>> entry : attributeSetterBiConsumers.entrySet()) {
			String attributeName = entry.getKey();
	...
	public Map<String, Function<LVEntryVersion, Object>> getAttributeGetterFunctions() {
		return _lvEntryVersion.getAttributeGetterFunctions();
	}

	@Override
	public Map<String, BiConsumer<LVEntryVersion, Object>> getAttributeSetterBiConsumers() {
		return _lvEntryVersion.getAttributeSetterBiConsumers();
	}
