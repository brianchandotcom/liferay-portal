...
public class LVEntryWrapper implements LVEntry, ModelWrapper<LVEntry> {
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		for (Map.Entry<String, BiConsumer<LVEntry, Object>> entry : attributeSetterBiConsumers.entrySet()) {
			String attributeName = entry.getKey();
	...
	public Map<String, Function<LVEntry, Object>> getAttributeGetterFunctions() {
		return _lvEntry.getAttributeGetterFunctions();
	}

	@Override
	public Map<String, BiConsumer<LVEntry, Object>> getAttributeSetterBiConsumers() {
		return _lvEntry.getAttributeSetterBiConsumers();
	}
