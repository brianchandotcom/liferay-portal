...
public class LocalizedEntryLocalizationWrapper
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		for (Map.Entry<String, BiConsumer<LocalizedEntryLocalization, Object>> entry : attributeSetterBiConsumers.entrySet()) {
			String attributeName = entry.getKey();
	...
	public Map<String, Function<LocalizedEntryLocalization, Object>> getAttributeGetterFunctions() {
		return _localizedEntryLocalization.getAttributeGetterFunctions();
	}

	@Override
	public Map<String, BiConsumer<LocalizedEntryLocalization, Object>> getAttributeSetterBiConsumers() {
		return _localizedEntryLocalization.getAttributeSetterBiConsumers();
	}
