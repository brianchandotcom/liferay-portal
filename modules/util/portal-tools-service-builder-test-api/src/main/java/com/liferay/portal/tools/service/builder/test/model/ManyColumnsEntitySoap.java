...
/**
 * This class is used by SOAP remote services, specifically {@link com.liferay.portal.tools.service.builder.test.service.http.ManyColumnsEntityServiceSoap}.
 *
 ...
 */
@Deprecated
public class ManyColumnsEntitySoap implements Serializable {

	public static ManyColumnsEntitySoap toSoapModel(ManyColumnsEntity model) {
		ManyColumnsEntitySoap soapModel = new ManyColumnsEntitySoap();

		soapModel.setManyColumnsEntityId(model.getManyColumnsEntityId());
	...
	public static ManyColumnsEntitySoap[] toSoapModels(
		ManyColumnsEntity[] models) {

		ManyColumnsEntitySoap[] soapModels =
			new ManyColumnsEntitySoap[models.length];
	...
	public static ManyColumnsEntitySoap[][] toSoapModels(
		...
		ManyColumnsEntitySoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels =
				new ManyColumnsEntitySoap[models.length][models[0].length];
		}
		else {
			soapModels = new ManyColumnsEntitySoap[0][0];
		}
	...
	public static ManyColumnsEntitySoap[] toSoapModels(
		List<ManyColumnsEntity> models) {

		List<ManyColumnsEntitySoap> soapModels =
			new ArrayList<ManyColumnsEntitySoap>(models.size());

		for (ManyColumnsEntity model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new ManyColumnsEntitySoap[soapModels.size()]);
	}

	public ManyColumnsEntitySoap() {
	}
