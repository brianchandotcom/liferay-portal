...
public class VersionedEntryWrapper implements VersionedEntry,
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		for (Map.Entry<String, BiConsumer<VersionedEntry, Object>> entry : attributeSetterBiConsumers.entrySet()) {
			String attributeName = entry.getKey();
			BiConsumer<VersionedEntry, Object> attributeBiConsumer = entry.getValue();
	...
	public Map<String, Function<VersionedEntry, Object>> getAttributeGetterFunctions() {
		return _versionedEntry.getAttributeGetterFunctions();
	}

	@Override
	public Map<String, BiConsumer<VersionedEntry, Object>> getAttributeSetterBiConsumers() {
		return _versionedEntry.getAttributeSetterBiConsumers();
	}
