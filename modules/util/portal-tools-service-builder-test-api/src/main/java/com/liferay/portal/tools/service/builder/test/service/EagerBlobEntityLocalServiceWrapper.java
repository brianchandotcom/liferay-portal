...
public class EagerBlobEntityLocalServiceWrapper
	...
	/**
	 * Returns all the eager blob entities matching the UUID and company.
	 *
	 * @param uuid the UUID of the eager blob entities
	 * @param companyId the primary key of the company
	 * @return the matching eager blob entities, or an empty list if no matches were found
	 */
	@Override
	public java.util.List
		<com.liferay.portal.tools.service.builder.test.model.EagerBlobEntity>
			getEagerBlobEntitiesByUuidAndCompanyId(
				String uuid, long companyId) {

		return _eagerBlobEntityLocalService.
			getEagerBlobEntitiesByUuidAndCompanyId(uuid, companyId);
	}

	/**
	 * Returns a range of eager blob entities matching the UUID and company.
	 *
	 * @param uuid the UUID of the eager blob entities
	 * @param companyId the primary key of the company
	 * @param start the lower bound of the range of eager blob entities
	 * @param end the upper bound of the range of eager blob entities (not inclusive)
	 * @param orderByComparator the comparator to order the results by (optionally <code>null</code>)
	 * @return the range of matching eager blob entities, or an empty list if no matches were found
	 */
	@Override
	public java.util.List
		<com.liferay.portal.tools.service.builder.test.model.EagerBlobEntity>
			getEagerBlobEntitiesByUuidAndCompanyId(
				...
				com.liferay.portal.kernel.util.OrderByComparator
					<com.liferay.portal.tools.service.builder.test.model.
						EagerBlobEntity> orderByComparator) {
	...
	public com.liferay.portal.kernel.dao.orm.ExportActionableDynamicQuery
		...
		return _eagerBlobEntityLocalService.getExportActionableDynamicQuery(
			portletDataContext);
	}
