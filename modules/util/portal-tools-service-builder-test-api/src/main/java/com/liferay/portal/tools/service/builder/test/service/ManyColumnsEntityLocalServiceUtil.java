...
/**
 * Provides the local service utility for ManyColumnsEntity. This utility wraps
 * <code>com.liferay.portal.tools.service.builder.test.service.impl.ManyColumnsEntityLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ManyColumnsEntityLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.portal.tools.service.builder.test.service.impl.ManyColumnsEntityLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static
		...
		return getService().addManyColumnsEntity(manyColumnsEntity);
	}
	...
	public static
		...
		return getService().createManyColumnsEntity(manyColumnsEntityId);
	}
	...
	public static
		...
		return getService().deleteManyColumnsEntity(manyColumnsEntityId);
	}
	...
	public static
		...
		return getService().deleteManyColumnsEntity(manyColumnsEntity);
	}
	...
	public static
		...
		return getService().fetchManyColumnsEntity(manyColumnsEntityId);
	}
	...
	public static java.util.List
		...
		return getService().getManyColumnsEntities(start, end);
	}
	 ...
	 */
	public static int getManyColumnsEntitiesCount() {
		return getService().getManyColumnsEntitiesCount();
	}
	...
	public static
		...
		return getService().getManyColumnsEntity(manyColumnsEntityId);
	}
	...
	public static
		...
		return getService().updateManyColumnsEntity(manyColumnsEntity);
	}

	public static ManyColumnsEntityLocalService getService() {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			ManyColumnsEntityLocalService.class);
					...
					new ServiceTracker
						<ManyColumnsEntityLocalService,
						 ManyColumnsEntityLocalService>(
							 ...
							 ManyColumnsEntityLocalService.class, null);
