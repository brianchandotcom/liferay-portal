...
/**
 * The persistence utility for the company scoped entry service. This utility wraps <code>com.liferay.portal.tools.service.builder.test.service.persistence.impl.CompanyScopedEntryPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see CompanyScopedEntryPersistence
 * @generated
 */
public class CompanyScopedEntryUtil {
	 ...
	 */
	public static void clearCache(CompanyScopedEntry companyScopedEntry) {
		getPersistence().clearCache(companyScopedEntry);
	}
	 ...
	 */
	public static Map<Serializable, CompanyScopedEntry> fetchByPrimaryKeys(
	 ...
	 */
	public static List<CompanyScopedEntry> findWithDynamicQuery(
	 ...
	 */
	public static CompanyScopedEntry update(
		CompanyScopedEntry companyScopedEntry) {

		return getPersistence().update(companyScopedEntry);
	}
	 ...
	 */
	public static CompanyScopedEntry update(
		CompanyScopedEntry companyScopedEntry, ServiceContext serviceContext) {

		return getPersistence().update(companyScopedEntry, serviceContext);
	}
	 ...
	 */
	public static CompanyScopedEntry findByC_ERC(
			long companyId, String externalReferenceCode)
		throws com.liferay.portal.tools.service.builder.test.exception.
			NoSuchCompanyScopedEntryException {
	 ...
	 */
	public static CompanyScopedEntry fetchByC_ERC(
		long companyId, String externalReferenceCode) {
	 ...
	 */
	public static CompanyScopedEntry removeByC_ERC(
			long companyId, String externalReferenceCode)
		throws com.liferay.portal.tools.service.builder.test.exception.
			NoSuchCompanyScopedEntryException {
	 ...
	 */
	public static void cacheResult(CompanyScopedEntry companyScopedEntry) {
		getPersistence().cacheResult(companyScopedEntry);
	}
	...
	public static void cacheResult(
		List<CompanyScopedEntry> companyScopedEntries) {

		getPersistence().cacheResult(companyScopedEntries);
	}
	 ...
	 */
	public static CompanyScopedEntry create(long CompanyScopedEntryId) {
		return getPersistence().create(CompanyScopedEntryId);
	}
	 ...
	 */
	public static CompanyScopedEntry remove(long CompanyScopedEntryId)
		throws com.liferay.portal.tools.service.builder.test.exception.
			NoSuchCompanyScopedEntryException {

		return getPersistence().remove(CompanyScopedEntryId);
	}

	public static CompanyScopedEntry updateImpl(
		CompanyScopedEntry companyScopedEntry) {

		return getPersistence().updateImpl(companyScopedEntry);
	}
	 ...
	 * @throws NoSuchCompanyScopedEntryException if a company scoped entry with the primary key could not be found
	 */
	public static CompanyScopedEntry findByPrimaryKey(long CompanyScopedEntryId)
		throws com.liferay.portal.tools.service.builder.test.exception.
			NoSuchCompanyScopedEntryException {

		return getPersistence().findByPrimaryKey(CompanyScopedEntryId);
	}
	 ...
	 */
	public static CompanyScopedEntry fetchByPrimaryKey(
		long CompanyScopedEntryId) {

		return getPersistence().fetchByPrimaryKey(CompanyScopedEntryId);
	}
	 ...
	 */
	public static List<CompanyScopedEntry> findAll() {
	 ...
	 */
	public static List<CompanyScopedEntry> findAll(int start, int end) {
	...
	public static CompanyScopedEntryPersistence getPersistence() {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CompanyScopedEntryPersistence.class);

		ServiceTracker
			<CompanyScopedEntryPersistence, CompanyScopedEntryPersistence>
				serviceTracker =
					new ServiceTracker
						<CompanyScopedEntryPersistence,
						 CompanyScopedEntryPersistence>(
							 bundle.getBundleContext(),
							 CompanyScopedEntryPersistence.class, null);
