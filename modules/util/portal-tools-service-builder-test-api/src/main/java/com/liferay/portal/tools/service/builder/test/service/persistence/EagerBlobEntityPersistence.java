...
public interface EagerBlobEntityPersistence
	 ...
	 * @return the matching eager blob entities
	 */
	public java.util.List<EagerBlobEntity> findByUuid_C(
	 ...
	 * @return the matching eager blob entities
	 */
	public java.util.List<EagerBlobEntity> findByField2(boolean field2);
	 ...
	 * @return the range of matching eager blob entities
	 */
	public java.util.List<EagerBlobEntity> findByField2(
