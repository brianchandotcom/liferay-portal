...
/**
 * The persistence interface for the many columns entity service.
 *
 * <p>
 ...
 * @see ManyColumnsEntityUtil
 * @generated
 */
@ProviderType
public interface ManyColumnsEntityPersistence
	extends BasePersistence<ManyColumnsEntity> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ManyColumnsEntityUtil} to access the many columns entity persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	public void cacheResult(
		java.util.List<ManyColumnsEntity> manyColumnsEntities);
	 ...
	 */
	public java.util.List<ManyColumnsEntity> findAll();
	 ...
	 */
	public java.util.List<ManyColumnsEntity> findAll(int start, int end);
	...
	public java.util.List<ManyColumnsEntity> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ManyColumnsEntity>
			orderByComparator);
