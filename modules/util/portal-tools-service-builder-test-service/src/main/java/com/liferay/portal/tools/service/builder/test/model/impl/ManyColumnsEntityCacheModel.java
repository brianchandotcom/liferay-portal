...
/**
 * The cache model class for representing ManyColumnsEntity in entity cache.
 *
 * @author Brian Wing Shun Chan
 * @generated
 */
public class ManyColumnsEntityCacheModel
	implements CacheModel<ManyColumnsEntity>, Externalizable {
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof ManyColumnsEntityCacheModel)) {
			return false;
		}

		ManyColumnsEntityCacheModel manyColumnsEntityCacheModel =
			(ManyColumnsEntityCacheModel)object;

		if (manyColumnsEntityId ==
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, manyColumnsEntityId);
	}
	...
	@Override
	public ManyColumnsEntity toEntityModel() {
		ManyColumnsEntityImpl manyColumnsEntityImpl =
			new ManyColumnsEntityImpl();

		manyColumnsEntityImpl.setManyColumnsEntityId(manyColumnsEntityId);
		manyColumnsEntityImpl.setColumn1(column1);
		manyColumnsEntityImpl.setColumn2(column2);
		manyColumnsEntityImpl.setColumn3(column3);
		manyColumnsEntityImpl.setColumn4(column4);
		manyColumnsEntityImpl.setColumn5(column5);
		manyColumnsEntityImpl.setColumn6(column6);
		manyColumnsEntityImpl.setColumn7(column7);
		manyColumnsEntityImpl.setColumn8(column8);
		manyColumnsEntityImpl.setColumn9(column9);
		manyColumnsEntityImpl.setColumn10(column10);
		manyColumnsEntityImpl.setColumn11(column11);
		manyColumnsEntityImpl.setColumn12(column12);
		manyColumnsEntityImpl.setColumn13(column13);
		manyColumnsEntityImpl.setColumn14(column14);
		manyColumnsEntityImpl.setColumn15(column15);
		manyColumnsEntityImpl.setColumn16(column16);
		manyColumnsEntityImpl.setColumn17(column17);
		manyColumnsEntityImpl.setColumn18(column18);
		manyColumnsEntityImpl.setColumn19(column19);
		manyColumnsEntityImpl.setColumn20(column20);
		manyColumnsEntityImpl.setColumn21(column21);
		manyColumnsEntityImpl.setColumn22(column22);
		manyColumnsEntityImpl.setColumn23(column23);
		manyColumnsEntityImpl.setColumn24(column24);
		manyColumnsEntityImpl.setColumn25(column25);
		manyColumnsEntityImpl.setColumn26(column26);
		manyColumnsEntityImpl.setColumn27(column27);
		manyColumnsEntityImpl.setColumn28(column28);
		manyColumnsEntityImpl.setColumn29(column29);
		manyColumnsEntityImpl.setColumn30(column30);
		manyColumnsEntityImpl.setColumn31(column31);
		manyColumnsEntityImpl.setColumn32(column32);
		manyColumnsEntityImpl.setColumn33(column33);
		manyColumnsEntityImpl.setColumn34(column34);
		manyColumnsEntityImpl.setColumn35(column35);
		manyColumnsEntityImpl.setColumn36(column36);
		manyColumnsEntityImpl.setColumn37(column37);
		manyColumnsEntityImpl.setColumn38(column38);
		manyColumnsEntityImpl.setColumn39(column39);
		manyColumnsEntityImpl.setColumn40(column40);
		manyColumnsEntityImpl.setColumn41(column41);
		manyColumnsEntityImpl.setColumn42(column42);
		manyColumnsEntityImpl.setColumn43(column43);
		manyColumnsEntityImpl.setColumn44(column44);
		manyColumnsEntityImpl.setColumn45(column45);
		manyColumnsEntityImpl.setColumn46(column46);
		manyColumnsEntityImpl.setColumn47(column47);
		manyColumnsEntityImpl.setColumn48(column48);
		manyColumnsEntityImpl.setColumn49(column49);
		manyColumnsEntityImpl.setColumn50(column50);
		manyColumnsEntityImpl.setColumn51(column51);
		manyColumnsEntityImpl.setColumn52(column52);
		manyColumnsEntityImpl.setColumn53(column53);
		manyColumnsEntityImpl.setColumn54(column54);
		manyColumnsEntityImpl.setColumn55(column55);
		manyColumnsEntityImpl.setColumn56(column56);
		manyColumnsEntityImpl.setColumn57(column57);
		manyColumnsEntityImpl.setColumn58(column58);
		manyColumnsEntityImpl.setColumn59(column59);
		manyColumnsEntityImpl.setColumn60(column60);
		manyColumnsEntityImpl.setColumn61(column61);
		manyColumnsEntityImpl.setColumn62(column62);
		manyColumnsEntityImpl.setColumn63(column63);
		manyColumnsEntityImpl.setColumn64(column64);
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		manyColumnsEntityId = objectInput.readLong();
	...
	public void writeExternal(ObjectOutput objectOutput) throws IOException {
		objectOutput.writeLong(manyColumnsEntityId);
	...
	public long manyColumnsEntityId;
	public int column1;
	public int column2;
	public int column3;
	public int column4;
