...
public class EagerBlobEntityPersistenceImpl
	...
	/**
	 * Returns all the eager blob entities where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public List<EagerBlobEntity> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
			uuid, companyId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the eager blob entities where uuid = &#63; and companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not <code>QueryUtil#ALL_POS</code>), then the query will include the default ORDER BY logic from <code>EagerBlobEntityModelImpl</code>. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<EagerBlobEntity> findByUuid_C(
	...
	/**
	 * Returns an ordered range of all the eager blob entities where uuid = &#63; and companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not <code>QueryUtil#ALL_POS</code>), then the query will include the default ORDER BY logic from <code>EagerBlobEntityModelImpl</code>. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<EagerBlobEntity> findByUuid_C(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (EagerBlobEntity eagerBlobEntity : list) {
					if (!uuid.equals(eagerBlobEntity.getUuid()) ||
						(companyId != eagerBlobEntity.getCompanyId())) {
	...
	/**
	 * Returns the first eager blob entity in the ordered set where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public EagerBlobEntity findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<EagerBlobEntity> orderByComparator)
		throws NoSuchEagerBlobEntityException {

		EagerBlobEntity eagerBlobEntity = fetchByUuid_C_First(
	 ...
	 */
	@Override
	public EagerBlobEntity fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<EagerBlobEntity> orderByComparator) {

		List<EagerBlobEntity> list = findByUuid_C(
	...
	/**
	 * Returns the last eager blob entity in the ordered set where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public EagerBlobEntity findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<EagerBlobEntity> orderByComparator)
		throws NoSuchEagerBlobEntityException {

		EagerBlobEntity eagerBlobEntity = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	 ...
	 */
	@Override
	public EagerBlobEntity fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<EagerBlobEntity> orderByComparator) {
	...
	/**
	 * Returns the eager blob entities before and after the current eager blob entity in the ordered set where uuid = &#63; and companyId = &#63;.
	 *
	 * @param eagerBlobEntityId the primary key of the current eager blob entity
	 * @param uuid the uuid
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public EagerBlobEntity[] findByUuid_C_PrevAndNext(
			long eagerBlobEntityId, String uuid, long companyId,
			OrderByComparator<EagerBlobEntity> orderByComparator)
		throws NoSuchEagerBlobEntityException {
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, eagerBlobEntity, uuid, companyId, orderByComparator,
				true);
	...
	protected EagerBlobEntity getByUuid_C_PrevAndNext(
		Session session, EagerBlobEntity eagerBlobEntity, String uuid,
		long companyId, OrderByComparator<EagerBlobEntity> orderByComparator,
		boolean previous) {
	...
	/**
	 * Removes all the eager blob entities where uuid = &#63; and companyId = &#63; from the database.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 */
	...
	/**
	 * Returns the number of eager blob entities where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @return the number of matching eager blob entities
	...
	/**
	 * Returns all the eager blob entities where field2 = &#63;.
	 *
	 * @param field2 the field2
	 * @return the matching eager blob entities
	 */
	@Override
	public List<EagerBlobEntity> findByField2(boolean field2) {
		return findByField2(field2, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the eager blob entities where field2 = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not <code>QueryUtil#ALL_POS</code>), then the query will include the default ORDER BY logic from <code>EagerBlobEntityModelImpl</code>. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<EagerBlobEntity> findByField2(
	...
	/**
	 * Returns an ordered range of all the eager blob entities where field2 = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not <code>QueryUtil#ALL_POS</code>), then the query will include the default ORDER BY logic from <code>EagerBlobEntityModelImpl</code>. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<EagerBlobEntity> findByField2(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (EagerBlobEntity eagerBlobEntity : list) {
					if ((field2 != eagerBlobEntity.isField2())) {
						list = null;
	...
	/**
	 * Returns the first eager blob entity in the ordered set where field2 = &#63;.
	 *
	 * @param field2 the field2
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching eager blob entity
	 ...
	 */
	@Override
	public EagerBlobEntity findByField2_First(
			boolean field2,
			OrderByComparator<EagerBlobEntity> orderByComparator)
		throws NoSuchEagerBlobEntityException {

		EagerBlobEntity eagerBlobEntity = fetchByField2_First(
	 ...
	 */
	@Override
	public EagerBlobEntity fetchByField2_First(
		boolean field2, OrderByComparator<EagerBlobEntity> orderByComparator) {

		List<EagerBlobEntity> list = findByField2(
	...
	/**
	 * Returns the last eager blob entity in the ordered set where field2 = &#63;.
	 *
	 * @param field2 the field2
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching eager blob entity
	 ...
	 */
	@Override
	public EagerBlobEntity findByField2_Last(
			boolean field2,
			OrderByComparator<EagerBlobEntity> orderByComparator)
		throws NoSuchEagerBlobEntityException {

		EagerBlobEntity eagerBlobEntity = fetchByField2_Last(
			field2, orderByComparator);
	 ...
	 */
	@Override
	public EagerBlobEntity fetchByField2_Last(
		boolean field2, OrderByComparator<EagerBlobEntity> orderByComparator) {
	...
	/**
	 * Returns the eager blob entities before and after the current eager blob entity in the ordered set where field2 = &#63;.
	 *
	 * @param eagerBlobEntityId the primary key of the current eager blob entity
	 * @param field2 the field2
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public EagerBlobEntity[] findByField2_PrevAndNext(
			long eagerBlobEntityId, boolean field2,
			OrderByComparator<EagerBlobEntity> orderByComparator)
		throws NoSuchEagerBlobEntityException {
		...
		try {
			...
			array[0] = getByField2_PrevAndNext(
				session, eagerBlobEntity, field2, orderByComparator, true);

			array[1] = eagerBlobEntity;

			array[2] = getByField2_PrevAndNext(
				session, eagerBlobEntity, field2, orderByComparator, false);
	...
	protected EagerBlobEntity getByField2_PrevAndNext(
		Session session, EagerBlobEntity eagerBlobEntity, boolean field2,
		OrderByComparator<EagerBlobEntity> orderByComparator,
		boolean previous) {
	...
	/**
	 * Removes all the eager blob entities where field2 = &#63; from the database.
	 *
	 * @param field2 the field2
	 */
	@Override
	...
	/**
	 * Returns the number of eager blob entities where field2 = &#63;.
	 *
	 * @param field2 the field2
	 * @return the number of matching eager blob entities
	 */
	...
	public EagerBlobEntity create(long eagerBlobEntityId) {
		...
		eagerBlobEntity.setCompanyId(CompanyThreadLocal.getCompanyId());
	...
	public EagerBlobEntity updateImpl(EagerBlobEntity eagerBlobEntity) {
		...
		if (isNew && (eagerBlobEntity.getCreateDate() == null)) {
			if (serviceContext == null) {
				eagerBlobEntity.setCreateDate(now);
			}
			else {
				eagerBlobEntity.setCreateDate(
					serviceContext.getCreateDate(now));
			}
		}

		if (!eagerBlobEntityModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				eagerBlobEntity.setModifiedDate(now);
			}
			else {
				eagerBlobEntity.setModifiedDate(
		...
		if (isNew) {
			...
			if (!Objects.equals(
					eagerBlobEntity.getUuid(),
					eagerBlobEntityModelImpl.getOriginalUuid()) ||
				(eagerBlobEntity.getCompanyId() !=
					eagerBlobEntityModelImpl.getOriginalCompanyId())) {
				...
				args = new Object[] {
					eagerBlobEntityModelImpl.getUuid(),
					eagerBlobEntityModelImpl.getCompanyId()
				};
			...
			if ((eagerBlobEntity.isField2() !=
					eagerBlobEntityModelImpl.getOriginalField2())) {
				...
				args = new Object[] {eagerBlobEntityModelImpl.isField2()};
