...
public class UniqueFinderEntryPersistenceImpl
	...
	private UniquePersistenceFinder<UniqueFinderEntry>
	...
	public UniqueFinderEntry findByName(String name)
		...
		UniqueFinderEntry uniqueFinderEntry = fetchByName(name);
		...
		if (uniqueFinderEntry == null) {
			...
			throw new NoSuchUniqueFinderEntryException(message);
		}
...
// LIFERAY-SERVICE-BUILDER-HASH:-1102625383