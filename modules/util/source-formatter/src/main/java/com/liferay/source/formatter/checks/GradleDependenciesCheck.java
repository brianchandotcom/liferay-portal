...
public class GradleDependenciesCheck extends BaseFileCheck {
	...
	private String _formatDependencies(String content, String dependencies) {
		...
		String osgiCoreDependency = null;
		...
		if (patchedOSGiCore) {
			...
			osgiCoreDependency = _ORG_OSGI_CORE_6_0_0_DEPENDENCY;

			if (uniqueDependencies.contains(_OSGI_CORE_6_0_0_DEPENDENCY)) {
				osgiCoreDependency = _OSGI_CORE_6_0_0_DEPENDENCY;
			}

			uniqueDependencies.remove(osgiCoreDependency);
		}
