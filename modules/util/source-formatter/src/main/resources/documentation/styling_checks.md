...
JSONObjectDefinitionFileCheck | .ipynb, .json, or .npmbridgerc | Sorts `objectFields`, listing nonrelationship fields before relationship fields, in `*-object-definition.json` and `*object-definition.batch-engine-data.json` files. |
