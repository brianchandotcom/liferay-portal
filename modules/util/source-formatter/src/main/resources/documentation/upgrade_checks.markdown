...
UpgradeJavaOnAfterUpdateParameterCheck | .bnd, .ftl, .gradle, .java, .jsp, .jspf or .vm | Add new parameter in method onAfterUpdate for classes extending the BaseModelListener |
