...
public class ServiceTrackerCollectionTest {
	...
	public void byClass() {
		...
		ServiceTrackerCollection<InterfaceOne> serviceTrackerList =
			new ServiceTrackerCollection<InterfaceOne>(InterfaceOne.class);
	...
	public void byClassFilter() throws Exception {
		...
		ServiceTrackerCollection<InterfaceOne> serviceTrackerList =
			new ServiceTrackerCollection<InterfaceOne>(
	...
	public void byClassMap() throws Exception {
		...
		ServiceTrackerCollection<InterfaceOne> serviceTrackerList =
			new ServiceTrackerCollection<InterfaceOne>(InterfaceOne.class, map);
	...
	public void byClassSTCustomizerMap()
		...
		ServiceTrackerCollection<InterfaceOne> serviceTrackerList =
			new ServiceTrackerCollection<InterfaceOne>(
				InterfaceOne.class, customizer, map);
