...
public class EhcachePortalCacheManager<K extends Serializable, V>
	...
	public EhcachePortalCacheManager() {
		...
		_serviceTracker = registry.trackServices(
			...
			new RegistryAwareMBeanServerServiceTrackerCustomizer());
	...
	private class RegistryAwareMBeanServerServiceTrackerCustomizer
		implements ServiceTrackerCustomizer
			<RegistryAwareMBeanServer, RegistryAwareMBeanServer> {

		@Override
		public RegistryAwareMBeanServer addingService(
			ServiceReference<RegistryAwareMBeanServer> serviceReference) {
			...
			if (PropsValues.EHCACHE_PORTAL_CACHE_MANAGER_JMX_ENABLED) {
				_managementService = new ManagementService(
					_cacheManager, registryAwareMBeanServer,
			...
			return registryAwareMBeanServer;
		}

		@Override
		public void modifiedService(
			ServiceReference<RegistryAwareMBeanServer> serviceReference,
			RegistryAwareMBeanServer service) {
		}
