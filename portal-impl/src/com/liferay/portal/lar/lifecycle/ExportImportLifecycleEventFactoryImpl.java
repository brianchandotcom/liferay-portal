...
public class ExportImportLifecycleEventFactoryImpl
	...
	@Override
	public ExportImportLifecycleEvent createExportImportLifecycleEvent(
		int eventCode, Serializable... attributes) {

		ExportImportLifecycleEvent exportImportLifecycleEvent =
			new ExportImportLifecycleEventImpl();

		exportImportLifecycleEvent.setEventAttributes(attributes);
		exportImportLifecycleEvent.setEventCode(eventCode);
