...
public class CountryModelImpl extends BaseModelImpl<Country>
	...
	public static final String TABLE_SQL_CREATE = "create table Country (countryId LONG not null primary key,name VARCHAR(75) null,a2 VARCHAR(75) null,a3 VARCHAR(75) null,number_ VARCHAR(75) null,idd_ VARCHAR(75) null,zipRequired BOOLEAN,active_ BOOLEAN,ormVersion LONG default 0)";
	...
	public Object clone() {
		...
		countryImpl.setOrmVersion(getOrmVersion());
	...
	public CacheModel<Country> toCacheModel() {
		...
		countryCacheModel.ormVersion = getOrmVersion();
