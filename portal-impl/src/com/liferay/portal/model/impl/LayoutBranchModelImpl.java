...
public class LayoutBranchModelImpl extends BaseModelImpl<LayoutBranch>
	...
	public static final String TABLE_SQL_CREATE = "create table LayoutBranch (LayoutBranchId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,layoutSetBranchId LONG,plid LONG,name VARCHAR(75) null,description STRING null,master BOOLEAN,ormVersion LONG default 0)";
	...
	public Object clone() {
		...
		layoutBranchImpl.setOrmVersion(getOrmVersion());
	...
	public CacheModel<LayoutBranch> toCacheModel() {
		...
		layoutBranchCacheModel.ormVersion = getOrmVersion();
