...
public class ListTypeModelImpl extends BaseModelImpl<ListType>
	...
	public static final String TABLE_SQL_CREATE = "create table ListType (listTypeId INTEGER not null primary key,name VARCHAR(75) null,type_ VARCHAR(75) null,ormVersion LONG default 0)";
	...
	public Object clone() {
		...
		listTypeImpl.setOrmVersion(getOrmVersion());
	...
	public CacheModel<ListType> toCacheModel() {
		...
		listTypeCacheModel.ormVersion = getOrmVersion();
