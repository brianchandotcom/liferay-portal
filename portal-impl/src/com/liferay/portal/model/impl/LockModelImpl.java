...
public class LockModelImpl extends BaseModelImpl<Lock> implements LockModel {
	...
	public Object clone() {
		...
		lockImpl.setOrmVersion(getOrmVersion());
	...
	public CacheModel<Lock> toCacheModel() {
		...
		lockCacheModel.ormVersion = getOrmVersion();
