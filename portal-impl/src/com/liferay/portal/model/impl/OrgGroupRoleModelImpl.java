...
public class OrgGroupRoleModelImpl extends BaseModelImpl<OrgGroupRole>
	...
	public static final String TABLE_SQL_CREATE = "create table OrgGroupRole (organizationId LONG not null,groupId LONG not null,roleId LONG not null,ormVersion LONG default 0,primary key (organizationId, groupId, roleId))";
	...
	public Object clone() {
		...
		orgGroupRoleImpl.setOrmVersion(getOrmVersion());
	...
	public CacheModel<OrgGroupRole> toCacheModel() {
		...
		orgGroupRoleCacheModel.ormVersion = getOrmVersion();
