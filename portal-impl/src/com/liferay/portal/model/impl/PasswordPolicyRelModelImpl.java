...
public class PasswordPolicyRelModelImpl extends BaseModelImpl<PasswordPolicyRel>
	...
	public static final String TABLE_SQL_CREATE = "create table PasswordPolicyRel (passwordPolicyRelId LONG not null primary key,passwordPolicyId LONG,classNameId LONG,classPK LONG,ormVersion LONG default 0)";
	...
	public Object clone() {
		...
		passwordPolicyRelImpl.setOrmVersion(getOrmVersion());
	...
	public CacheModel<PasswordPolicyRel> toCacheModel() {
		...
		passwordPolicyRelCacheModel.ormVersion = getOrmVersion();
