...
public class PluginSettingModelImpl extends BaseModelImpl<PluginSetting>
	...
	public static final String TABLE_SQL_CREATE = "create table PluginSetting (pluginSettingId LONG not null primary key,companyId LONG,pluginId VARCHAR(75) null,pluginType VARCHAR(75) null,roles STRING null,active_ BOOLEAN,ormVersion LONG default 0)";
	...
	public Object clone() {
		...
		pluginSettingImpl.setOrmVersion(getOrmVersion());
	...
	public CacheModel<PluginSetting> toCacheModel() {
		...
		pluginSettingCacheModel.ormVersion = getOrmVersion();
