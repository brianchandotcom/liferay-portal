...
public class PortalPreferencesModelImpl extends BaseModelImpl<PortalPreferences>
	...
	public static final String TABLE_SQL_CREATE = "create table PortalPreferences (portalPreferencesId LONG not null primary key,ownerId LONG,ownerType INTEGER,preferences TEXT null,ormVersion LONG default 0)";
	...
	public Object clone() {
		...
		portalPreferencesImpl.setOrmVersion(getOrmVersion());
	...
	public CacheModel<PortalPreferences> toCacheModel() {
		...
		portalPreferencesCacheModel.ormVersion = getOrmVersion();
