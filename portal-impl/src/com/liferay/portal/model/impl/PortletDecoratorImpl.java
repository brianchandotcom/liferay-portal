...
public class PortletDecoratorImpl implements PortletDecorator {
	...
	@Override
	public void setDefaultPd(boolean defaultPd) {
		_defaultPd = defaultPd;
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PortletDecoratorImpl.class);

	private String _cssClass;
	private boolean _defaultPd;
	...
	private final Properties _settingsProperties = new SafeProperties();
