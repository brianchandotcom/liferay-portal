...
public class RegionModelImpl extends BaseModelImpl<Region>
	...
	public static final String TABLE_SQL_CREATE = "create table Region (regionId LONG not null primary key,countryId LONG,regionCode VARCHAR(75) null,name VARCHAR(75) null,active_ BOOLEAN,ormVersion LONG default 0)";
	...
	public Object clone() {
		...
		regionImpl.setOrmVersion(getOrmVersion());
	...
	public CacheModel<Region> toCacheModel() {
		...
		regionCacheModel.ormVersion = getOrmVersion();
