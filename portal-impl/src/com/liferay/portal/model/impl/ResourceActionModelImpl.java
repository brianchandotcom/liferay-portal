...
public class ResourceActionModelImpl extends BaseModelImpl<ResourceAction>
	...
	public static final String TABLE_SQL_CREATE = "create table ResourceAction (resourceActionId LONG not null primary key,name VARCHAR(255) null,actionId VARCHAR(75) null,bitwiseValue LONG,ormVersion LONG default 0)";
	...
	public Object clone() {
		...
		resourceActionImpl.setOrmVersion(getOrmVersion());
	...
	public CacheModel<ResourceAction> toCacheModel() {
		...
		resourceActionCacheModel.ormVersion = getOrmVersion();
