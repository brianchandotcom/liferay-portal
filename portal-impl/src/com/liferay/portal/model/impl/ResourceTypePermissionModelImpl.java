...
public class ResourceTypePermissionModelImpl extends BaseModelImpl<ResourceTypePermission>
	...
	public static final String TABLE_SQL_CREATE = "create table ResourceTypePermission (resourceTypePermissionId LONG not null primary key,companyId LONG,groupId LONG,name VARCHAR(75) null,roleId LONG,actionIds LONG,ormVersion LONG default 0)";
	...
	public Object clone() {
		...
		resourceTypePermissionImpl.setOrmVersion(getOrmVersion());
	...
	public CacheModel<ResourceTypePermission> toCacheModel() {
		...
		resourceTypePermissionCacheModel.ormVersion = getOrmVersion();
