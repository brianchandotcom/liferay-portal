...
public class ShardModelImpl extends BaseModelImpl<Shard> implements ShardModel {
	...
	public static final String TABLE_SQL_CREATE = "create table Shard (shardId LONG not null primary key,classNameId LONG,classPK LONG,name VARCHAR(75) null,ormVersion LONG default 0)";
	...
	public Object clone() {
		...
		shardImpl.setOrmVersion(getOrmVersion());
	...
	public CacheModel<Shard> toCacheModel() {
		...
		shardCacheModel.ormVersion = getOrmVersion();
