...
public class SubscriptionModelImpl extends BaseModelImpl<Subscription>
	...
	public static final String TABLE_SQL_CREATE = "create table Subscription (subscriptionId LONG not null primary key,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,classNameId LONG,classPK LONG,frequency VARCHAR(75) null,ormVersion LONG default 0)";
	...
	public Object clone() {
		...
		subscriptionImpl.setOrmVersion(getOrmVersion());
	...
	public CacheModel<Subscription> toCacheModel() {
		...
		subscriptionCacheModel.ormVersion = getOrmVersion();
