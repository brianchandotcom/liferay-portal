...
public class TeamModelImpl extends BaseModelImpl<Team> implements TeamModel {
	...
	public static final String TABLE_SQL_CREATE = "create table Team (teamId LONG not null primary key,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,groupId LONG,name VARCHAR(75) null,description STRING null,ormVersion LONG default 0)";
	...
	public Object clone() {
		...
		teamImpl.setOrmVersion(getOrmVersion());
	...
	public CacheModel<Team> toCacheModel() {
		...
		teamCacheModel.ormVersion = getOrmVersion();
