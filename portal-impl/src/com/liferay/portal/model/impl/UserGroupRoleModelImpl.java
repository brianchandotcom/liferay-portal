...
public class UserGroupRoleModelImpl extends BaseModelImpl<UserGroupRole>
	...
	public static final String TABLE_SQL_CREATE = "create table UserGroupRole (userId LONG not null,groupId LONG not null,roleId LONG not null,ormVersion LONG default 0,primary key (userId, groupId, roleId))";
	...
	public Object clone() {
		...
		userGroupRoleImpl.setOrmVersion(getOrmVersion());
	...
	public CacheModel<UserGroupRole> toCacheModel() {
		...
		userGroupRoleCacheModel.ormVersion = getOrmVersion();
