...
public class UserNotificationDeliveryModelImpl extends BaseModelImpl<UserNotificationDelivery>
	...
	public static final String TABLE_SQL_CREATE = "create table UserNotificationDelivery (uuid_ VARCHAR(75) null,deliveryId LONG not null primary key,companyId LONG,userId LONG,classNameId LONG,type_ INTEGER,email BOOLEAN,sms BOOLEAN,website BOOLEAN)";
	public static final String TABLE_SQL_DROP = "drop table UserNotificationDelivery";
	public static final String ORDER_BY_JPQL = " ORDER BY userNotificationDelivery.deliveryId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY UserNotificationDelivery.deliveryId ASC";
	...
	public static long DELIVERYID_COLUMN_BITMASK = 32L;
	...
	public Object clone() {
		...
		userNotificationDeliveryImpl.setUuid(getUuid());
		userNotificationDeliveryImpl.setDeliveryId(getDeliveryId());
	...
	public void resetOriginalValues() {
		...
		userNotificationDeliveryModelImpl._originalUuid = userNotificationDeliveryModelImpl._uuid;
	...
	public CacheModel<UserNotificationDelivery> toCacheModel() {
		...
		userNotificationDeliveryCacheModel.uuid = getUuid();

		String uuid = userNotificationDeliveryCacheModel.uuid;

		if ((uuid != null) && (uuid.length() == 0)) {
			userNotificationDeliveryCacheModel.uuid = null;
		}

		userNotificationDeliveryCacheModel.deliveryId = getDeliveryId();
