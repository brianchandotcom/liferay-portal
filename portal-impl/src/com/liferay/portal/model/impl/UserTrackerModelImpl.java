...
public class UserTrackerModelImpl extends BaseModelImpl<UserTracker>
	...
	public static final String TABLE_SQL_CREATE = "create table UserTracker (userTrackerId LONG not null primary key,companyId LONG,userId LONG,modifiedDate DATE null,sessionId VARCHAR(200) null,remoteAddr VARCHAR(75) null,remoteHost VARCHAR(75) null,userAgent VARCHAR(200) null,ormVersion LONG default 0)";
	...
	public Object clone() {
		...
		userTrackerImpl.setOrmVersion(getOrmVersion());
	...
	public CacheModel<UserTracker> toCacheModel() {
		...
		userTrackerCacheModel.ormVersion = getOrmVersion();
