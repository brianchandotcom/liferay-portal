...
public class SPIRuntimeMappingImpl implements SPIRuntimeMapping {
	...
	public void register(SPI spi) throws RemoteException {
		...
		try {
			...
			_spiToServletContextNamesMap.put(
				spi,
				Arrays.copyOf(servletContextNames, servletContextNames.length));
	...
	private final Log _log = LogFactoryUtil.getLog(SPIRuntimeMappingImpl.class);
