...
public abstract class ImageLocalServiceBaseImpl extends BaseLocalServiceImpl
	...
	public long count(DynamicQuery dynamicQuery) throws SystemException {
		return imagePersistence.count(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery) throws SystemException {
		return imagePersistence.find(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return imagePersistence.find(dynamicQuery, start, end);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end,
		OrderByComparator orderByComparator) throws SystemException {
		return imagePersistence.find(dynamicQuery, start, end, orderByComparator);
	}
