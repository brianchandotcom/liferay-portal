...
public abstract class LayoutFriendlyURLLocalServiceBaseImpl
	...
	public long count(DynamicQuery dynamicQuery) throws SystemException {
		return layoutFriendlyURLPersistence.count(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery) throws SystemException {
		return layoutFriendlyURLPersistence.find(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return layoutFriendlyURLPersistence.find(dynamicQuery, start, end);
	}
