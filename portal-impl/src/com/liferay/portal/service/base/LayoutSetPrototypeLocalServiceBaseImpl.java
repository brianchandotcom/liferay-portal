...
public abstract class LayoutSetPrototypeLocalServiceBaseImpl
	...
	public long count(DynamicQuery dynamicQuery) throws SystemException {
		return layoutSetPrototypePersistence.count(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery) throws SystemException {
		return layoutSetPrototypePersistence.find(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return layoutSetPrototypePersistence.find(dynamicQuery, start, end);
	}
