...
public abstract class PasswordPolicyRelLocalServiceBaseImpl
	...
	public long count(DynamicQuery dynamicQuery) throws SystemException {
		return passwordPolicyRelPersistence.count(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery) throws SystemException {
		return passwordPolicyRelPersistence.find(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return passwordPolicyRelPersistence.find(dynamicQuery, start, end);
	}
