...
public abstract class PhoneLocalServiceBaseImpl extends BaseLocalServiceImpl
	...
	public long count(DynamicQuery dynamicQuery) throws SystemException {
		return phonePersistence.count(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery) throws SystemException {
		return phonePersistence.find(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return phonePersistence.find(dynamicQuery, start, end);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end,
		OrderByComparator orderByComparator) throws SystemException {
		return phonePersistence.find(dynamicQuery, start, end, orderByComparator);
	}
