...
public abstract class ResourceBlockPermissionLocalServiceBaseImpl
	...
	public long count(DynamicQuery dynamicQuery) throws SystemException {
		return resourceBlockPermissionPersistence.count(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery) throws SystemException {
		return resourceBlockPermissionPersistence.find(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return resourceBlockPermissionPersistence.find(dynamicQuery, start, end);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end,
		OrderByComparator orderByComparator) throws SystemException {
		return resourceBlockPermissionPersistence.find(dynamicQuery, start,
