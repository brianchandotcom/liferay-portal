...
public abstract class ResourceBlockPermissionLocalServiceBaseImpl
	implements ResourceBlockPermissionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	private static Log _log = LogFactoryUtil.getLog(ResourceBlockPermissionLocalServiceBaseImpl.class);
