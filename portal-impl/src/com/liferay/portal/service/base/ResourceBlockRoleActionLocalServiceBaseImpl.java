...
/**
 * The base implementation of the resource block role action local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portal.service.impl.ResourceBlockRoleActionLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ResourceBlockRoleActionLocalServiceBaseImpl
	implements ResourceBlockRoleActionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.portal.service.ResourceBlockRoleActionLocalServiceUtil} to access the resource block role action local service.
	 */
	...
	public ResourceBlockRoleAction addResourceBlockRoleAction(
		...
		resourceBlockRoleAction = resourceBlockRoleActionPersistence.update(resourceBlockRoleAction,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(resourceBlockRoleAction);
			}
	 ...
	 */
	public ResourceBlockRoleAction createResourceBlockRoleAction(
		ResourceBlockRoleActionPK resourceBlockRoleActionPK) {
		return resourceBlockRoleActionPersistence.create(resourceBlockRoleActionPK);
	}
	...
	public void deleteResourceBlockRoleAction(
		...
		ResourceBlockRoleAction resourceBlockRoleAction = resourceBlockRoleActionPersistence.remove(resourceBlockRoleActionPK);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(resourceBlockRoleAction);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return resourceBlockRoleActionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return resourceBlockRoleActionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ResourceBlockRoleAction getResourceBlockRoleAction(
		ResourceBlockRoleActionPK resourceBlockRoleActionPK)
		throws PortalException, SystemException {
		return resourceBlockRoleActionPersistence.findByPrimaryKey(resourceBlockRoleActionPK);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ResourceBlockRoleAction> getResourceBlockRoleActions(
		int start, int end) throws SystemException {
		return resourceBlockRoleActionPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getResourceBlockRoleActionsCount() throws SystemException {
		return resourceBlockRoleActionPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ResourceBlockRoleAction updateResourceBlockRoleAction(
		ResourceBlockRoleAction resourceBlockRoleAction)
		throws SystemException {
		return updateResourceBlockRoleAction(resourceBlockRoleAction, true);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = resourceBlockRoleActionPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(ResourceBlockRoleActionLocalServiceBaseImpl.class);
