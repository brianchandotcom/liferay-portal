...
public abstract class SystemEventLocalServiceBaseImpl
	...
	public long count(DynamicQuery dynamicQuery) throws SystemException {
		return systemEventPersistence.count(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery) throws SystemException {
		return systemEventPersistence.find(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return systemEventPersistence.find(dynamicQuery, start, end);
	}
