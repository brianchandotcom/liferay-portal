...
public abstract class TeamLocalServiceBaseImpl extends BaseLocalServiceImpl
	...
	public long count(DynamicQuery dynamicQuery) throws SystemException {
		return teamPersistence.count(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery) throws SystemException {
		return teamPersistence.find(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return teamPersistence.find(dynamicQuery, start, end);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end,
		OrderByComparator orderByComparator) throws SystemException {
		return teamPersistence.find(dynamicQuery, start, end, orderByComparator);
	}
