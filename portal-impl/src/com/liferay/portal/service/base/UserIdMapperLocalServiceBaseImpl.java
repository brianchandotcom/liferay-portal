...
public abstract class UserIdMapperLocalServiceBaseImpl
	...
	public long count(DynamicQuery dynamicQuery) throws SystemException {
		return userIdMapperPersistence.count(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery) throws SystemException {
		return userIdMapperPersistence.find(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return userIdMapperPersistence.find(dynamicQuery, start, end);
	}
