...
public abstract class UserLocalServiceBaseImpl extends BaseLocalServiceImpl
	...
	public long count(DynamicQuery dynamicQuery) throws SystemException {
		return userPersistence.count(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery) throws SystemException {
		return userPersistence.find(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return userPersistence.find(dynamicQuery, start, end);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end,
		OrderByComparator orderByComparator) throws SystemException {
		return userPersistence.find(dynamicQuery, start, end, orderByComparator);
	}
