...
public abstract class UserNotificationDeliveryLocalServiceBaseImpl
	...
	public UserNotificationDelivery createUserNotificationDelivery(
		long deliveryId) {
		return userNotificationDeliveryPersistence.create(deliveryId);
	}
	...
	public UserNotificationDelivery deleteUserNotificationDelivery(
		long deliveryId) throws PortalException, SystemException {
		return userNotificationDeliveryPersistence.remove(deliveryId);
	}
	...
	public UserNotificationDelivery fetchUserNotificationDelivery(
		long deliveryId) throws SystemException {
		return userNotificationDeliveryPersistence.fetchByPrimaryKey(deliveryId);
	}
	 ...
	 */
	@Override
	public UserNotificationDelivery fetchUserNotificationDeliveryByUuidAndCompanyId(
		String uuid, long companyId) throws SystemException {
		return userNotificationDeliveryPersistence.fetchByUuid_C_First(uuid,
			companyId, null);
	}
	 ...
	 */
	@Override
	public UserNotificationDelivery getUserNotificationDelivery(long deliveryId)
		throws PortalException, SystemException {
		return userNotificationDeliveryPersistence.findByPrimaryKey(deliveryId);
	}
	 ...
	 */
	@Override
	public UserNotificationDelivery getUserNotificationDeliveryByUuidAndCompanyId(
		String uuid, long companyId) throws PortalException, SystemException {
		return userNotificationDeliveryPersistence.findByUuid_C_First(uuid,
			companyId, null);
	}
