...
public abstract class WorkflowDefinitionLinkLocalServiceBaseImpl
	...
	public long count(DynamicQuery dynamicQuery) throws SystemException {
		return workflowDefinitionLinkPersistence.count(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery) throws SystemException {
		return workflowDefinitionLinkPersistence.find(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return workflowDefinitionLinkPersistence.find(dynamicQuery, start, end);
	}
