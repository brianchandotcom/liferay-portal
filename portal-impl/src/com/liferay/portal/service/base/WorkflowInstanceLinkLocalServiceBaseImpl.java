...
public abstract class WorkflowInstanceLinkLocalServiceBaseImpl
	...
	public long count(DynamicQuery dynamicQuery) throws SystemException {
		return workflowInstanceLinkPersistence.count(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery) throws SystemException {
		return workflowInstanceLinkPersistence.find(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return workflowInstanceLinkPersistence.find(dynamicQuery, start, end);
	}
