		...
		if (release == null) {
			if ("0.0.0".equals(previousVersion)) {
				...
				throw new IllegalStateException(
					"Cowardly refusing to upgrade from a non existent release");
			}
		}

		if (!(release.getVersion().equals(previousVersion))) {
			throw new IllegalStateException("Cowardly refusing to upgrade " +
				"because previousVersion does not match!");
		}
