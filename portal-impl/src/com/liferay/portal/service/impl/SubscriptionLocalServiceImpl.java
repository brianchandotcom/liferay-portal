		...
		if (groupId > 0) {
			...
			if (className.equals(MBThread.class.getName())) {
				...
				socialActivityLocalService.addActivity(
					...
					SocialActivityConstants.SUBSCRIBE, extraData.toString(), 0);
			}
			else {
				socialActivityLocalService.addActivity(
					userId, groupId, className, classPK,
					SocialActivityConstants.SUBSCRIBE, StringPool.BLANK, 0);
			}
	...
	public void deleteSubscription(Subscription subscription)
		...
		if (assetEntry != null) {
			...
			socialActivityLocalService.addActivity(
				...
				subscription.getClassPK(), SocialActivityConstants.UNSUBSCRIBE,
				StringPool.BLANK, 0);
