...
public class UserLocalServiceImpl extends UserLocalServiceBaseImpl {
	 ...
	 *             with the user
	 * @deprecated As of 2.10.0, replaced by {@link #getSocialUsers(long, int,
	 ...
	 * @deprecated As of 2.10.0, replaced by {@link #getSocialUsersCount(long,
	 *             int, String)}
	 */
	@Deprecated
	@Override
	 ...
	 * @return     the user
	 * @deprecated As of 2.10.0, replaced by {@link #updateStatus(long, int,
	 *             ServiceContext)}
	 */
	@Deprecated
	@Override
	 ...
	 * @return     the user
	 * @deprecated As of 2.10.0, replaced by {@link #updateUser(long, String,
