...
public class UserPermissionImpl
	implements EntityPermissionChecker, UserPermission {
	...
	public void checkPermission(
		...
		List<Organization> userOrganizations =
			OrganizationLocalServiceUtil.getUserOrganizations(entryId);
		...
		check(permissionChecker, entryId, userOrganizationsIds, actionId);
	}
