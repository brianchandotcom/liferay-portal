...
public class AddressPersistenceImpl extends BasePersistenceImpl<Address>
	...
	public static final FinderPath FINDER_PATH_FIND_BY_COMPANYID = new FinderPath(AddressModelImpl.ENTITY_CACHE_ENABLED,
			...
			AddressModelImpl.COMPANYID_BIT_MASK,
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_COMPANYID_PAGE_ORDER = new FinderPath(AddressModelImpl.ENTITY_CACHE_ENABLED,
			AddressModelImpl.FINDER_CACHE_ENABLED, AddressImpl.class,
	...
	public static final FinderPath FINDER_PATH_FIND_BY_USERID = new FinderPath(AddressModelImpl.ENTITY_CACHE_ENABLED,
			...
			AddressModelImpl.USERID_BIT_MASK,
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_USERID_PAGE_ORDER = new FinderPath(AddressModelImpl.ENTITY_CACHE_ENABLED,
			AddressModelImpl.FINDER_CACHE_ENABLED, AddressImpl.class,
	...
	public static final FinderPath FINDER_PATH_FIND_BY_C_C = new FinderPath(AddressModelImpl.ENTITY_CACHE_ENABLED,
			...
			AddressModelImpl.COMPANYID_BIT_MASK |
			AddressModelImpl.CLASSNAMEID_BIT_MASK,
			new String[] { Long.class.getName(), Long.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_C_C_PAGE_ORDER = new FinderPath(AddressModelImpl.ENTITY_CACHE_ENABLED,
			AddressModelImpl.FINDER_CACHE_ENABLED, AddressImpl.class,
	...
	public static final FinderPath FINDER_PATH_FIND_BY_C_C_C = new FinderPath(AddressModelImpl.ENTITY_CACHE_ENABLED,
			...
			AddressModelImpl.COMPANYID_BIT_MASK |
			AddressModelImpl.CLASSNAMEID_BIT_MASK |
			AddressModelImpl.CLASSPK_BIT_MASK,
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			});
	public static final FinderPath FINDER_PATH_FIND_BY_C_C_C_PAGE_ORDER = new FinderPath(AddressModelImpl.ENTITY_CACHE_ENABLED,
			AddressModelImpl.FINDER_CACHE_ENABLED, AddressImpl.class,
			FINDER_CLASS_NAME_LIST_PAGE_ORDER, "findByC_C_C",
			AddressModelImpl.COMPANYID_BIT_MASK |
			AddressModelImpl.CLASSNAMEID_BIT_MASK |
			AddressModelImpl.CLASSPK_BIT_MASK,
			new String[] {
	...
	public static final FinderPath FINDER_PATH_FIND_BY_C_C_C_M = new FinderPath(AddressModelImpl.ENTITY_CACHE_ENABLED,
			...
			AddressModelImpl.CLASSNAMEID_BIT_MASK |
			AddressModelImpl.CLASSPK_BIT_MASK |
			AddressModelImpl.MAILING_BIT_MASK,
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName(),
				Boolean.class.getName()
			});
	public static final FinderPath FINDER_PATH_FIND_BY_C_C_C_M_PAGE_ORDER = new FinderPath(AddressModelImpl.ENTITY_CACHE_ENABLED,
			AddressModelImpl.FINDER_CACHE_ENABLED, AddressImpl.class,
			FINDER_CLASS_NAME_LIST_PAGE_ORDER, "findByC_C_C_M",
			AddressModelImpl.COMPANYID_BIT_MASK |
			AddressModelImpl.CLASSNAMEID_BIT_MASK |
			AddressModelImpl.CLASSPK_BIT_MASK |
			AddressModelImpl.MAILING_BIT_MASK,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_C_C_C_M = new FinderPath(AddressModelImpl.ENTITY_CACHE_ENABLED,
			AddressModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST, "countByC_C_C_M",
			AddressModelImpl.COMPANYID_BIT_MASK |
			AddressModelImpl.CLASSNAMEID_BIT_MASK |
			AddressModelImpl.CLASSPK_BIT_MASK |
			AddressModelImpl.MAILING_BIT_MASK,
	...
	public static final FinderPath FINDER_PATH_FIND_BY_C_C_C_P = new FinderPath(AddressModelImpl.ENTITY_CACHE_ENABLED,
			...
			AddressModelImpl.CLASSNAMEID_BIT_MASK |
			AddressModelImpl.CLASSPK_BIT_MASK |
			AddressModelImpl.PRIMARY_BIT_MASK,
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName(),
				Boolean.class.getName()
			});
	public static final FinderPath FINDER_PATH_FIND_BY_C_C_C_P_PAGE_ORDER = new FinderPath(AddressModelImpl.ENTITY_CACHE_ENABLED,
			AddressModelImpl.FINDER_CACHE_ENABLED, AddressImpl.class,
			FINDER_CLASS_NAME_LIST_PAGE_ORDER, "findByC_C_C_P",
			AddressModelImpl.COMPANYID_BIT_MASK |
			AddressModelImpl.CLASSNAMEID_BIT_MASK |
			AddressModelImpl.CLASSPK_BIT_MASK |
			AddressModelImpl.PRIMARY_BIT_MASK,
	...
	public static final FinderPath FINDER_PATH_FIND_ALL_PAGE_ORDER = new FinderPath(AddressModelImpl.ENTITY_CACHE_ENABLED,
			AddressModelImpl.FINDER_CACHE_ENABLED, AddressImpl.class,
	...
	public Address updateImpl(com.liferay.portal.model.Address address,
		...
		if (isNew || !AddressModelImpl.COLUMN_BIT_MASK_ENABLED) {
			FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST);
		}
		else {
			if ((addressModelImpl.getBitMask() &
			...
			if ((addressModelImpl.getBitMask() &
					FINDER_PATH_FIND_BY_C_C_C.getColumnBitMask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(addressModelImpl.getOriginalCompanyId()),
						Long.valueOf(addressModelImpl.getOriginalClassNameId()),
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_C_C_C, args);

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_C_C_C, args);
			}

			if ((addressModelImpl.getBitMask() &
					FINDER_PATH_FIND_BY_C_C_C_M.getColumnBitMask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(addressModelImpl.getOriginalCompanyId()),
						Long.valueOf(addressModelImpl.getOriginalClassNameId()),
						Long.valueOf(addressModelImpl.getOriginalClassPK()),
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_C_C_C_M, args);

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_C_C_C_M, args);
			}

			if ((addressModelImpl.getBitMask() &
					FINDER_PATH_FIND_BY_C_C_C_P.getColumnBitMask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(addressModelImpl.getOriginalCompanyId()),
						Long.valueOf(addressModelImpl.getOriginalClassNameId()),
						Long.valueOf(addressModelImpl.getOriginalClassPK()),
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_C_C_C_P, args);
	...
	public List<Address> findByC_C_C(long companyId, long classNameId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderPath = FINDER_PATH_FIND_BY_C_C_C;
		}
		else {
			finderArgs = new Object[] {
			...
			finderPath = FINDER_PATH_FIND_BY_C_C_C_PAGE_ORDER;
		}
	...
	public List<Address> findByC_C_C_M(long companyId, long classNameId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderPath = FINDER_PATH_FIND_BY_C_C_C_M;
		}
		else {
			finderArgs = new Object[] {
			...
			finderPath = FINDER_PATH_FIND_BY_C_C_C_M_PAGE_ORDER;
		}
	...
	public List<Address> findByC_C_C_P(long companyId, long classNameId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderPath = FINDER_PATH_FIND_BY_C_C_C_P;
		}
		else {
			finderArgs = new Object[] {
			...
			finderPath = FINDER_PATH_FIND_BY_C_C_C_P_PAGE_ORDER;
		}
