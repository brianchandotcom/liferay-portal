...
public class ContactPersistenceImpl extends BasePersistenceImpl<Contact>
	...
	public static final FinderPath FINDER_PATH_FIND_BY_COMPANYID = new FinderPath(ContactModelImpl.ENTITY_CACHE_ENABLED,
			...
			ContactModelImpl.COMPANYID_BIT_MASK,
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_COMPANYID_PAGE_ORDER = new FinderPath(ContactModelImpl.ENTITY_CACHE_ENABLED,
			ContactModelImpl.FINDER_CACHE_ENABLED, ContactImpl.class,
	...
	public static final FinderPath FINDER_PATH_FIND_ALL_PAGE_ORDER = new FinderPath(ContactModelImpl.ENTITY_CACHE_ENABLED,
			ContactModelImpl.FINDER_CACHE_ENABLED, ContactImpl.class,
	...
	public Contact updateImpl(com.liferay.portal.model.Contact contact,
		...
		if (isNew || !ContactModelImpl.COLUMN_BIT_MASK_ENABLED) {
			FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST);
		}
		else {
			if ((contactModelImpl.getBitMask() &
