...
public class LayoutSetBranchPersistenceImpl extends BasePersistenceImpl<LayoutSetBranch>
	...
	public static final FinderPath FINDER_PATH_FIND_BY_GROUPID = new FinderPath(LayoutSetBranchModelImpl.ENTITY_CACHE_ENABLED,
			...
			LayoutSetBranchModelImpl.GROUPID_BIT_MASK,
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_GROUPID_PAGE_ORDER = new FinderPath(LayoutSetBranchModelImpl.ENTITY_CACHE_ENABLED,
			LayoutSetBranchModelImpl.FINDER_CACHE_ENABLED,
			LayoutSetBranchImpl.class, FINDER_CLASS_NAME_LIST_PAGE_ORDER,
			"findByGroupId", LayoutSetBranchModelImpl.GROUPID_BIT_MASK,
			new String[] {
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_FIND_BY_G_P = new FinderPath(LayoutSetBranchModelImpl.ENTITY_CACHE_ENABLED,
			...
			LayoutSetBranchModelImpl.GROUPID_BIT_MASK |
			LayoutSetBranchModelImpl.PRIVATELAYOUT_BIT_MASK,
			new String[] { Long.class.getName(), Boolean.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_G_P_PAGE_ORDER = new FinderPath(LayoutSetBranchModelImpl.ENTITY_CACHE_ENABLED,
			LayoutSetBranchModelImpl.FINDER_CACHE_ENABLED,
			LayoutSetBranchImpl.class, FINDER_CLASS_NAME_LIST_PAGE_ORDER,
			"findByG_P",
			LayoutSetBranchModelImpl.GROUPID_BIT_MASK |
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_G_P_N = new FinderPath(LayoutSetBranchModelImpl.ENTITY_CACHE_ENABLED,
			...
			LayoutSetBranchModelImpl.GROUPID_BIT_MASK |
			LayoutSetBranchModelImpl.PRIVATELAYOUT_BIT_MASK |
			LayoutSetBranchModelImpl.NAME_BIT_MASK,
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
	...
	public static final FinderPath FINDER_PATH_FIND_ALL = new FinderPath(LayoutSetBranchModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[0]);
	public static final FinderPath FINDER_PATH_FIND_ALL_PAGE_ORDER = new FinderPath(LayoutSetBranchModelImpl.ENTITY_CACHE_ENABLED,
			LayoutSetBranchModelImpl.FINDER_CACHE_ENABLED,
			LayoutSetBranchImpl.class, FINDER_CLASS_NAME_LIST_PAGE_ORDER,
	...
	public LayoutSetBranch updateImpl(
		...
		if (isNew || !LayoutSetBranchModelImpl.COLUMN_BIT_MASK_ENABLED) {
			FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST);
		}
		else {
			if ((layoutSetBranchModelImpl.getBitMask() &
