...
public class LayoutSetPrototypePersistenceImpl extends BasePersistenceImpl<LayoutSetPrototype>
	...
	public static final String FINDER_CLASS_NAME_LIST_PAGE_ORDER = FINDER_CLASS_NAME_ENTITY +
		".List_Page_Order";
	public static final FinderPath FINDER_PATH_FIND_BY_UUID = new FinderPath(LayoutSetPrototypeModelImpl.ENTITY_CACHE_ENABLED,
			LayoutSetPrototypeModelImpl.FINDER_CACHE_ENABLED,
			LayoutSetPrototypeImpl.class, FINDER_CLASS_NAME_LIST, "findByUuid",
			LayoutSetPrototypeModelImpl.UUID_BIT_MASK,
			new String[] { String.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_UUID_PAGE_ORDER = new FinderPath(LayoutSetPrototypeModelImpl.ENTITY_CACHE_ENABLED,
			LayoutSetPrototypeModelImpl.FINDER_CACHE_ENABLED,
			LayoutSetPrototypeImpl.class, FINDER_CLASS_NAME_LIST_PAGE_ORDER,
			"findByUuid", LayoutSetPrototypeModelImpl.UUID_BIT_MASK,
			new String[] {
	...
	public static final FinderPath FINDER_PATH_FIND_BY_COMPANYID = new FinderPath(LayoutSetPrototypeModelImpl.ENTITY_CACHE_ENABLED,
			LayoutSetPrototypeModelImpl.FINDER_CACHE_ENABLED,
			LayoutSetPrototypeImpl.class, FINDER_CLASS_NAME_LIST,
			"findByCompanyId", LayoutSetPrototypeModelImpl.COMPANYID_BIT_MASK,
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_COMPANYID_PAGE_ORDER = new FinderPath(LayoutSetPrototypeModelImpl.ENTITY_CACHE_ENABLED,
			LayoutSetPrototypeModelImpl.FINDER_CACHE_ENABLED,
			LayoutSetPrototypeImpl.class, FINDER_CLASS_NAME_LIST_PAGE_ORDER,
			"findByCompanyId", LayoutSetPrototypeModelImpl.COMPANYID_BIT_MASK,
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(LayoutSetPrototypeModelImpl.ENTITY_CACHE_ENABLED,
			...
			LayoutSetPrototypeModelImpl.COMPANYID_BIT_MASK,
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_C_A = new FinderPath(LayoutSetPrototypeModelImpl.ENTITY_CACHE_ENABLED,
			LayoutSetPrototypeModelImpl.FINDER_CACHE_ENABLED,
			LayoutSetPrototypeImpl.class, FINDER_CLASS_NAME_LIST, "findByC_A",
			LayoutSetPrototypeModelImpl.COMPANYID_BIT_MASK |
			LayoutSetPrototypeModelImpl.ACTIVE_BIT_MASK,
			new String[] { Long.class.getName(), Boolean.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_C_A_PAGE_ORDER = new FinderPath(LayoutSetPrototypeModelImpl.ENTITY_CACHE_ENABLED,
			LayoutSetPrototypeModelImpl.FINDER_CACHE_ENABLED,
			LayoutSetPrototypeImpl.class, FINDER_CLASS_NAME_LIST_PAGE_ORDER,
			"findByC_A",
			LayoutSetPrototypeModelImpl.COMPANYID_BIT_MASK |
	...
	public static final FinderPath FINDER_PATH_FIND_ALL = new FinderPath(LayoutSetPrototypeModelImpl.ENTITY_CACHE_ENABLED,
			LayoutSetPrototypeModelImpl.FINDER_CACHE_ENABLED,
			LayoutSetPrototypeImpl.class, FINDER_CLASS_NAME_LIST, "findAll",
			new String[0]);
	public static final FinderPath FINDER_PATH_FIND_ALL_PAGE_ORDER = new FinderPath(LayoutSetPrototypeModelImpl.ENTITY_CACHE_ENABLED,
			LayoutSetPrototypeModelImpl.FINDER_CACHE_ENABLED,
			LayoutSetPrototypeImpl.class, FINDER_CLASS_NAME_LIST_PAGE_ORDER,
	...
	public LayoutSetPrototype updateImpl(
		...
		if (isNew || !LayoutSetPrototypeModelImpl.COLUMN_BIT_MASK_ENABLED) {
			FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST);
		}
		else {
			if ((layoutSetPrototypeModelImpl.getBitMask() &
