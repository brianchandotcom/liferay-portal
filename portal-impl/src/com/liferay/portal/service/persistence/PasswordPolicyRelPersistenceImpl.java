...
public class PasswordPolicyRelPersistenceImpl extends BasePersistenceImpl<PasswordPolicyRel>
	...
	public static final FinderPath FINDER_PATH_FIND_BY_PASSWORDPOLICYID = new FinderPath(PasswordPolicyRelModelImpl.ENTITY_CACHE_ENABLED,
			...
			PasswordPolicyRelModelImpl.PASSWORDPOLICYID_BIT_MASK,
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_PASSWORDPOLICYID_PAGE_ORDER =
		new FinderPath(PasswordPolicyRelModelImpl.ENTITY_CACHE_ENABLED,
			PasswordPolicyRelModelImpl.FINDER_CACHE_ENABLED,
			PasswordPolicyRelImpl.class, FINDER_CLASS_NAME_LIST_PAGE_ORDER,
			"findByPasswordPolicyId",
			PasswordPolicyRelModelImpl.PASSWORDPOLICYID_BIT_MASK,
			new String[] {
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_C_C = new FinderPath(PasswordPolicyRelModelImpl.ENTITY_CACHE_ENABLED,
			...
			"fetchByC_C",
			PasswordPolicyRelModelImpl.CLASSNAMEID_BIT_MASK |
			PasswordPolicyRelModelImpl.CLASSPK_BIT_MASK,
	...
	public static final FinderPath FINDER_PATH_FIND_ALL = new FinderPath(PasswordPolicyRelModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[0]);
	public static final FinderPath FINDER_PATH_FIND_ALL_PAGE_ORDER = new FinderPath(PasswordPolicyRelModelImpl.ENTITY_CACHE_ENABLED,
			PasswordPolicyRelModelImpl.FINDER_CACHE_ENABLED,
			PasswordPolicyRelImpl.class, FINDER_CLASS_NAME_LIST_PAGE_ORDER,
	...
	public PasswordPolicyRel updateImpl(
		...
		if (isNew || !PasswordPolicyRelModelImpl.COLUMN_BIT_MASK_ENABLED) {
			FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST);
		}
		else {
			if ((passwordPolicyRelModelImpl.getBitMask() &
					FINDER_PATH_FIND_BY_PASSWORDPOLICYID.getColumnBitMask()) != 0) {
		...
		if (isNew) {
			...
			if ((passwordPolicyRelModelImpl.getBitMask() &
					FINDER_PATH_COUNT_BY_P_C_C.getColumnBitMask()) != 0) {
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_P_C_C,
					new Object[] {
						Long.valueOf(
	...
	public List<PasswordPolicyRel> findByPasswordPolicyId(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderPath = FINDER_PATH_FIND_BY_PASSWORDPOLICYID;
		}
		else {
			...
			finderPath = FINDER_PATH_FIND_BY_PASSWORDPOLICYID_PAGE_ORDER;
		}
