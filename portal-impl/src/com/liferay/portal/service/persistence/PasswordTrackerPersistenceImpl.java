...
public class PasswordTrackerPersistenceImpl extends BasePersistenceImpl<PasswordTracker>
	...
	public static final FinderPath FINDER_PATH_FIND_BY_USERID = new FinderPath(PasswordTrackerModelImpl.ENTITY_CACHE_ENABLED,
			...
			PasswordTrackerModelImpl.USERID_BIT_MASK,
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_USERID_PAGE_ORDER = new FinderPath(PasswordTrackerModelImpl.ENTITY_CACHE_ENABLED,
			PasswordTrackerModelImpl.FINDER_CACHE_ENABLED,
			PasswordTrackerImpl.class, FINDER_CLASS_NAME_LIST_PAGE_ORDER,
			"findByUserId", PasswordTrackerModelImpl.USERID_BIT_MASK,
			new String[] {
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_FIND_ALL = new FinderPath(PasswordTrackerModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[0]);
	public static final FinderPath FINDER_PATH_FIND_ALL_PAGE_ORDER = new FinderPath(PasswordTrackerModelImpl.ENTITY_CACHE_ENABLED,
			PasswordTrackerModelImpl.FINDER_CACHE_ENABLED,
			PasswordTrackerImpl.class, FINDER_CLASS_NAME_LIST_PAGE_ORDER,
	...
	public PasswordTracker updateImpl(
		...
		if (isNew || !PasswordTrackerModelImpl.COLUMN_BIT_MASK_ENABLED) {
			FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST);
		}
		else {
			if ((passwordTrackerModelImpl.getBitMask() &
