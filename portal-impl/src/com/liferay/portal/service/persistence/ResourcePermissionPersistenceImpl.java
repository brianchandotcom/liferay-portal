...
public class ResourcePermissionPersistenceImpl extends BasePersistenceImpl<ResourcePermission>
	...
	public static final FinderPath FINDER_PATH_FIND_BY_C_N_S_P_RS = new FinderPath(ResourcePermissionModelImpl.ENTITY_CACHE_ENABLED,
			ResourcePermissionModelImpl.FINDER_CACHE_ENABLED,
			ResourcePermissionImpl.class, FINDER_CLASS_NAME_LIST,
			"findByC_N_S_P_RS",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_C_N_S_P_RS = new FinderPath(ResourcePermissionModelImpl.ENTITY_CACHE_ENABLED,
			ResourcePermissionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST, "countByC_N_S_P_RS",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Integer.class.getName(), String.class.getName(),
				Long.class.getName()
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ResourcePermission> findByC_N_S_P_RS(long companyId,
		String name, int scope, String primKey, long roleId)
		throws SystemException {
		return findByC_N_S_P_RS(companyId, name, scope, primKey, roleId,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<ResourcePermission> findByC_N_S_P_RS(long companyId,
		...
		throws SystemException {
		return findByC_N_S_P_RS(companyId, name, scope, primKey, roleId, start,
			end, null);
	}
	...
	public List<ResourcePermission> findByC_N_S_P_RS(long companyId,
		...
		List<ResourcePermission> list = (List<ResourcePermission>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_C_N_S_P_RS,
				finderArgs, this);
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_N_S_P_RS_COMPANYID_2);

			if (name == null) {
				query.append(_FINDER_COLUMN_C_N_S_P_RS_NAME_1);
			}
			else {
				if (name.equals(StringPool.BLANK)) {
					query.append(_FINDER_COLUMN_C_N_S_P_RS_NAME_3);
				}
				else {
					query.append(_FINDER_COLUMN_C_N_S_P_RS_NAME_2);
				}
			}

			query.append(_FINDER_COLUMN_C_N_S_P_RS_SCOPE_2);

			if (primKey == null) {
				query.append(_FINDER_COLUMN_C_N_S_P_RS_PRIMKEY_1);
			}
			else {
				if (primKey.equals(StringPool.BLANK)) {
					query.append(_FINDER_COLUMN_C_N_S_P_RS_PRIMKEY_3);
				}
				else {
					query.append(_FINDER_COLUMN_C_N_S_P_RS_PRIMKEY_2);
				}
			}

			query.append(_FINDER_COLUMN_C_N_S_P_RS_ROLEID_2);
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_C_N_S_P_RS,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_C_N_S_P_RS,
						finderArgs, list);
				}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ResourcePermission findByC_N_S_P_RS_First(long companyId,
		String name, int scope, String primKey, long roleId,
		OrderByComparator orderByComparator)
		throws NoSuchResourcePermissionException, SystemException {
		List<ResourcePermission> list = findByC_N_S_P_RS(companyId, name,
				scope, primKey, roleId, 0, 1, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ResourcePermission findByC_N_S_P_RS_Last(long companyId,
		String name, int scope, String primKey, long roleId,
		OrderByComparator orderByComparator)
		throws NoSuchResourcePermissionException, SystemException {
		int count = countByC_N_S_P_RS(companyId, name, scope, primKey, roleId);

		List<ResourcePermission> list = findByC_N_S_P_RS(companyId, name,
				scope, primKey, roleId, count - 1, count, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ResourcePermission[] findByC_N_S_P_RS_PrevAndNext(
		long resourcePermissionId, long companyId, String name, int scope,
		...
		try {
			...
			array[0] = getByC_N_S_P_RS_PrevAndNext(session, resourcePermission,
					companyId, name, scope, primKey, roleId, orderByComparator,
					true);

			array[1] = resourcePermission;

			array[2] = getByC_N_S_P_RS_PrevAndNext(session, resourcePermission,
					companyId, name, scope, primKey, roleId, orderByComparator,
					false);
	...
	protected ResourcePermission getByC_N_S_P_RS_PrevAndNext(Session session,
		ResourcePermission resourcePermission, long companyId, String name,
		int scope, String primKey, long roleId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public List<ResourcePermission> findByC_N_S_P_RS(long companyId,
		...
		throws SystemException {
		return findByC_N_S_P_RS(companyId, name, scope, primKey, roleIds,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<ResourcePermission> findByC_N_S_P_RS(long companyId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_N_S_P_RS_COMPANYID_5);
			...
			if (name == null) {
				query.append(_FINDER_COLUMN_C_N_S_P_RS_NAME_4);
			}
			else {
				if (name.equals(StringPool.BLANK)) {
					query.append(_FINDER_COLUMN_C_N_S_P_RS_NAME_6);
				}
				else {
					query.append(_FINDER_COLUMN_C_N_S_P_RS_NAME_5);
				}
			}
			...
			query.append(_FINDER_COLUMN_C_N_S_P_RS_SCOPE_5);
			...
			if (primKey == null) {
				query.append(_FINDER_COLUMN_C_N_S_P_RS_PRIMKEY_4);
			}
			else {
				if (primKey.equals(StringPool.BLANK)) {
					query.append(_FINDER_COLUMN_C_N_S_P_RS_PRIMKEY_6);
				}
				else {
					query.append(_FINDER_COLUMN_C_N_S_P_RS_PRIMKEY_5);
				}
			}
			...
			if ((roleIds == null) || (roleIds.length > 0)) {
				...
				for (int i = 0; i < roleIds.length; i++) {
					query.append(_FINDER_COLUMN_C_N_S_P_RS_ROLEID_5);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByC_N_S_P_RS(long companyId, String name, int scope,
		String primKey, long roleId) throws SystemException {
		for (ResourcePermission resourcePermission : findByC_N_S_P_RS(
				companyId, name, scope, primKey, roleId)) {
			resourcePermissionPersistence.remove(resourcePermission);
		}
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int countByC_N_S_P_RS(long companyId, String name, int scope,
		String primKey, long roleId) throws SystemException {
		Object[] finderArgs = new Object[] {
				companyId, name, scope, primKey, roleId
			};

		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_C_N_S_P_RS,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_C_N_S_P_RS,
					finderArgs, count);
	...
	private static final String _FINDER_COLUMN_C_N_S_P_RS_COMPANYID_2 = "resourcePermission.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_N_S_P_RS_COMPANYID_5 = "(" +
		_removeConjunction(_FINDER_COLUMN_C_N_S_P_RS_COMPANYID_2) + ")";
	private static final String _FINDER_COLUMN_C_N_S_P_RS_NAME_1 = "resourcePermission.name IS NULL AND ";
	private static final String _FINDER_COLUMN_C_N_S_P_RS_NAME_2 = "resourcePermission.name = ? AND ";
	private static final String _FINDER_COLUMN_C_N_S_P_RS_NAME_3 = "(resourcePermission.name IS NULL OR resourcePermission.name = ?) AND ";
	private static final String _FINDER_COLUMN_C_N_S_P_RS_NAME_4 = "(" +
		_removeConjunction(_FINDER_COLUMN_C_N_S_P_RS_NAME_1) + ")";
	private static final String _FINDER_COLUMN_C_N_S_P_RS_NAME_5 = "(" +
		_removeConjunction(_FINDER_COLUMN_C_N_S_P_RS_NAME_2) + ")";
	private static final String _FINDER_COLUMN_C_N_S_P_RS_NAME_6 = "(" +
		_removeConjunction(_FINDER_COLUMN_C_N_S_P_RS_NAME_3) + ")";
	private static final String _FINDER_COLUMN_C_N_S_P_RS_SCOPE_2 = "resourcePermission.scope = ? AND ";
	private static final String _FINDER_COLUMN_C_N_S_P_RS_SCOPE_5 = "(" +
		_removeConjunction(_FINDER_COLUMN_C_N_S_P_RS_SCOPE_2) + ")";
	private static final String _FINDER_COLUMN_C_N_S_P_RS_PRIMKEY_1 = "resourcePermission.primKey IS NULL AND ";
	private static final String _FINDER_COLUMN_C_N_S_P_RS_PRIMKEY_2 = "resourcePermission.primKey = ? AND ";
	private static final String _FINDER_COLUMN_C_N_S_P_RS_PRIMKEY_3 = "(resourcePermission.primKey IS NULL OR resourcePermission.primKey = ?) AND ";
	private static final String _FINDER_COLUMN_C_N_S_P_RS_PRIMKEY_4 = "(" +
		_removeConjunction(_FINDER_COLUMN_C_N_S_P_RS_PRIMKEY_1) + ")";
	private static final String _FINDER_COLUMN_C_N_S_P_RS_PRIMKEY_5 = "(" +
		_removeConjunction(_FINDER_COLUMN_C_N_S_P_RS_PRIMKEY_2) + ")";
	private static final String _FINDER_COLUMN_C_N_S_P_RS_PRIMKEY_6 = "(" +
		_removeConjunction(_FINDER_COLUMN_C_N_S_P_RS_PRIMKEY_3) + ")";
	private static final String _FINDER_COLUMN_C_N_S_P_RS_ROLEID_2 = "resourcePermission.roleId = ?";
	private static final String _FINDER_COLUMN_C_N_S_P_RS_ROLEID_5 = "(" +
		_removeConjunction(_FINDER_COLUMN_C_N_S_P_RS_ROLEID_2) + ")";
