...
public class UserIdMapperPersistenceImpl extends BasePersistenceImpl<UserIdMapper>
	...
	public static final FinderPath FINDER_PATH_FIND_BY_USERID = new FinderPath(UserIdMapperModelImpl.ENTITY_CACHE_ENABLED,
			...
			UserIdMapperModelImpl.USERID_BIT_MASK,
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_USERID_PAGE_ORDER = new FinderPath(UserIdMapperModelImpl.ENTITY_CACHE_ENABLED,
			UserIdMapperModelImpl.FINDER_CACHE_ENABLED, UserIdMapperImpl.class,
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_U_T = new FinderPath(UserIdMapperModelImpl.ENTITY_CACHE_ENABLED,
			...
			UserIdMapperModelImpl.USERID_BIT_MASK |
			UserIdMapperModelImpl.TYPE_BIT_MASK,
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_T_E = new FinderPath(UserIdMapperModelImpl.ENTITY_CACHE_ENABLED,
			...
			UserIdMapperModelImpl.TYPE_BIT_MASK |
			UserIdMapperModelImpl.EXTERNALUSERID_BIT_MASK,
	...
	public static final FinderPath FINDER_PATH_FIND_ALL_PAGE_ORDER = new FinderPath(UserIdMapperModelImpl.ENTITY_CACHE_ENABLED,
			UserIdMapperModelImpl.FINDER_CACHE_ENABLED, UserIdMapperImpl.class,
	...
	public UserIdMapper updateImpl(
		...
		if (isNew || !UserIdMapperModelImpl.COLUMN_BIT_MASK_ENABLED) {
			FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST);
		}
		else {
			if ((userIdMapperModelImpl.getBitMask() &
		...
		if (isNew) {
			...
			if ((userIdMapperModelImpl.getBitMask() &
					FINDER_PATH_COUNT_BY_T_E.getColumnBitMask()) != 0) {
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_T_E,
					new Object[] {
						userIdMapperModelImpl.getOriginalType(),
