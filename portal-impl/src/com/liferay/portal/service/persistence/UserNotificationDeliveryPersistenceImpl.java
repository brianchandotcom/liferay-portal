...
public class UserNotificationDeliveryPersistenceImpl extends BasePersistenceImpl<UserNotificationDelivery>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(UserNotificationDeliveryModelImpl.ENTITY_CACHE_ENABLED,
			UserNotificationDeliveryModelImpl.FINDER_CACHE_ENABLED,
			UserNotificationDeliveryImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(UserNotificationDeliveryModelImpl.ENTITY_CACHE_ENABLED,
			UserNotificationDeliveryModelImpl.FINDER_CACHE_ENABLED,
			UserNotificationDeliveryImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			UserNotificationDeliveryModelImpl.UUID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(UserNotificationDeliveryModelImpl.ENTITY_CACHE_ENABLED,
			UserNotificationDeliveryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUuid",
			new String[] { String.class.getName() });

	/**
	 * Returns all the user notification deliveries where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public List<UserNotificationDelivery> findByUuid(String uuid)
		throws SystemException {
		return findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the user notification deliveries where uuid = &#63;.
	 *
	 * <p>
	 ...
	 */
	@Override
	public List<UserNotificationDelivery> findByUuid(String uuid, int start,
		int end) throws SystemException {
		return findByUuid(uuid, start, end, null);
	}

	/**
	 * Returns an ordered range of all the user notification deliveries where uuid = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portal.model.impl.UserNotificationDeliveryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<UserNotificationDelivery> findByUuid(String uuid, int start,
		...
		if ((list != null) && !list.isEmpty()) {
			for (UserNotificationDelivery userNotificationDelivery : list) {
				if (!Validator.equals(uuid, userNotificationDelivery.getUuid())) {
					list = null;
	...
	/**
	 * Returns the first user notification delivery in the ordered set where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public UserNotificationDelivery findByUuid_First(String uuid,
		OrderByComparator orderByComparator)
		throws NoSuchUserNotificationDeliveryException, SystemException {
		UserNotificationDelivery userNotificationDelivery = fetchByUuid_First(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public UserNotificationDelivery fetchByUuid_First(String uuid,
		OrderByComparator orderByComparator) throws SystemException {
		List<UserNotificationDelivery> list = findByUuid(uuid, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last user notification delivery in the ordered set where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public UserNotificationDelivery findByUuid_Last(String uuid,
		OrderByComparator orderByComparator)
		throws NoSuchUserNotificationDeliveryException, SystemException {
		UserNotificationDelivery userNotificationDelivery = fetchByUuid_Last(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public UserNotificationDelivery fetchByUuid_Last(String uuid,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByUuid(uuid);

		List<UserNotificationDelivery> list = findByUuid(uuid, count - 1,
	...
	/**
	 * Returns the user notification deliveries before and after the current user notification delivery in the ordered set where uuid = &#63;.
	 *
	 * @param deliveryId the primary key of the current user notification delivery
	 * @param uuid the uuid
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public UserNotificationDelivery[] findByUuid_PrevAndNext(long deliveryId,
		String uuid, OrderByComparator orderByComparator)
		throws NoSuchUserNotificationDeliveryException, SystemException {
		UserNotificationDelivery userNotificationDelivery = findByPrimaryKey(deliveryId);
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session, userNotificationDelivery,
					uuid, orderByComparator, true);

			array[1] = userNotificationDelivery;

			array[2] = getByUuid_PrevAndNext(session, userNotificationDelivery,
	...
	protected UserNotificationDelivery getByUuid_PrevAndNext(Session session,
		UserNotificationDelivery userNotificationDelivery, String uuid,
	...
	/**
	 * Removes all the user notification deliveries where uuid = &#63; from the database.
	 *
	 * @param uuid the uuid
	 * @throws SystemException if a system exception occurred
	 */
	...
	public void removeByUuid(String uuid) throws SystemException {
		for (UserNotificationDelivery userNotificationDelivery : findByUuid(
	...
	/**
	 * Returns the number of user notification deliveries where uuid = &#63;.
	 *
	 * @param uuid the uuid
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "userNotificationDelivery.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "userNotificationDelivery.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(userNotificationDelivery.uuid IS NULL OR userNotificationDelivery.uuid = '')";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(UserNotificationDeliveryModelImpl.ENTITY_CACHE_ENABLED,
			UserNotificationDeliveryModelImpl.FINDER_CACHE_ENABLED,
			UserNotificationDeliveryImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
		new FinderPath(UserNotificationDeliveryModelImpl.ENTITY_CACHE_ENABLED,
			...
			UserNotificationDeliveryModelImpl.UUID_COLUMN_BITMASK |
			UserNotificationDeliveryModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(UserNotificationDeliveryModelImpl.ENTITY_CACHE_ENABLED,
			UserNotificationDeliveryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUuid_C",
			new String[] { String.class.getName(), Long.class.getName() });

	/**
	 * Returns all the user notification deliveries where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public List<UserNotificationDelivery> findByUuid_C(String uuid,
	...
	/**
	 * Returns a range of all the user notification deliveries where uuid = &#63; and companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portal.model.impl.UserNotificationDeliveryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the user notification deliveries where uuid = &#63; and companyId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portal.model.impl.UserNotificationDeliveryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns the first user notification delivery in the ordered set where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public UserNotificationDelivery findByUuid_C_First(String uuid,
		long companyId, OrderByComparator orderByComparator)
		throws NoSuchUserNotificationDeliveryException, SystemException {
		UserNotificationDelivery userNotificationDelivery = fetchByUuid_C_First(uuid,
	 ...
	 */
	@Override
	public UserNotificationDelivery fetchByUuid_C_First(String uuid,
		long companyId, OrderByComparator orderByComparator)
		throws SystemException {
		List<UserNotificationDelivery> list = findByUuid_C(uuid, companyId, 0,
				1, orderByComparator);
	...
	/**
	 * Returns the last user notification delivery in the ordered set where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public UserNotificationDelivery findByUuid_C_Last(String uuid,
		long companyId, OrderByComparator orderByComparator)
		throws NoSuchUserNotificationDeliveryException, SystemException {
		UserNotificationDelivery userNotificationDelivery = fetchByUuid_C_Last(uuid,
				companyId, orderByComparator);
	 ...
	 */
	@Override
	public UserNotificationDelivery fetchByUuid_C_Last(String uuid,
		long companyId, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByUuid_C(uuid, companyId);

		List<UserNotificationDelivery> list = findByUuid_C(uuid, companyId,
	...
	/**
	 * Returns the user notification deliveries before and after the current user notification delivery in the ordered set where uuid = &#63; and companyId = &#63;.
	 *
	 * @param deliveryId the primary key of the current user notification delivery
	 * @param uuid the uuid
	 * @param companyId the company ID
	 ...
	 */
	@Override
	public UserNotificationDelivery[] findByUuid_C_PrevAndNext(
		long deliveryId, String uuid, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchUserNotificationDeliveryException, SystemException {
		UserNotificationDelivery userNotificationDelivery = findByPrimaryKey(deliveryId);
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session,
					userNotificationDelivery, uuid, companyId,
	...
	protected UserNotificationDelivery getByUuid_C_PrevAndNext(
	...
	/**
	 * Removes all the user notification deliveries where uuid = &#63; and companyId = &#63; from the database.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @throws SystemException if a system exception occurred
	...
	public void removeByUuid_C(String uuid, long companyId)
		throws SystemException {
		for (UserNotificationDelivery userNotificationDelivery : findByUuid_C(
	...
	/**
	 * Returns the number of user notification deliveries where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @return the number of matching user notification deliveries
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "userNotificationDelivery.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "userNotificationDelivery.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(userNotificationDelivery.uuid IS NULL OR userNotificationDelivery.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "userNotificationDelivery.companyId = ?";
	...
	public UserNotificationDelivery[] findByUserId_PrevAndNext(
		long deliveryId, long userId, OrderByComparator orderByComparator)
		throws NoSuchUserNotificationDeliveryException, SystemException {
		UserNotificationDelivery userNotificationDelivery = findByPrimaryKey(deliveryId);
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_U_C_T = new FinderPath(UserNotificationDeliveryModelImpl.ENTITY_CACHE_ENABLED,
			UserNotificationDeliveryModelImpl.FINDER_CACHE_ENABLED,
			...
			UserNotificationDeliveryModelImpl.TYPE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_U_C_T = new FinderPath(UserNotificationDeliveryModelImpl.ENTITY_CACHE_ENABLED,
			UserNotificationDeliveryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByU_C_T",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName()
			});
	 ...
	 */
	@Override
	public UserNotificationDelivery findByU_C_T(long userId, long classNameId,
		int type)
		throws NoSuchUserNotificationDeliveryException, SystemException {
		UserNotificationDelivery userNotificationDelivery = fetchByU_C_T(userId,
				classNameId, type);
	 ...
	 */
	@Override
	public UserNotificationDelivery fetchByU_C_T(long userId, long classNameId,
		int type) throws SystemException {
		return fetchByU_C_T(userId, classNameId, type, true);
	}
	...
	public UserNotificationDelivery fetchByU_C_T(long userId, long classNameId,
		...
		Object[] finderArgs = new Object[] { userId, classNameId, type };

		Object result = null;

		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_U_C_T,
					finderArgs, this);
		}
		...
		if (result instanceof UserNotificationDelivery) {
			...
			if ((userId != userNotificationDelivery.getUserId()) ||
					...
					(type != userNotificationDelivery.getType())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_U_C_T_USERID_2);

			query.append(_FINDER_COLUMN_U_C_T_CLASSNAMEID_2);

			query.append(_FINDER_COLUMN_U_C_T_TYPE_2);
			...
			try {
				...
				if (list.isEmpty()) {
					FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_U_C_T,
						finderArgs, list);
				}
				else {
					...
					if ((userNotificationDelivery.getUserId() != userId) ||
							...
							(userNotificationDelivery.getType() != type)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_U_C_T,
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_U_C_T,
					finderArgs);
	 ...
	 */
	@Override
	public UserNotificationDelivery removeByU_C_T(long userId,
		long classNameId, int type)
		throws NoSuchUserNotificationDeliveryException, SystemException {
		UserNotificationDelivery userNotificationDelivery = findByU_C_T(userId,
				classNameId, type);
	...
	public int countByU_C_T(long userId, long classNameId, int type)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_U_C_T;
	...
	private static final String _FINDER_COLUMN_U_C_T_USERID_2 = "userNotificationDelivery.userId = ? AND ";
	private static final String _FINDER_COLUMN_U_C_T_CLASSNAMEID_2 = "userNotificationDelivery.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_U_C_T_TYPE_2 = "userNotificationDelivery.type = ?";
	...
	public void cacheResult(UserNotificationDelivery userNotificationDelivery) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_U_C_T,
			new Object[] {
				...
				userNotificationDelivery.getType()
	...
	protected void cacheUniqueFindersCache(
		...
		if (userNotificationDelivery.isNew()) {
			...
			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_U_C_T, args,
				Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_U_C_T, args,
				userNotificationDelivery);
		}
		else {
			...
			if ((userNotificationDeliveryModelImpl.getColumnBitmask() &
					FINDER_PATH_FETCH_BY_U_C_T.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						userNotificationDelivery.getUserId(),
						userNotificationDelivery.getClassNameId(),
						userNotificationDelivery.getType()
	...
	protected void clearUniqueFindersCache(
		...
		FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_U_C_T, args);
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_U_C_T, args);
		...
		if ((userNotificationDeliveryModelImpl.getColumnBitmask() &
			...
			args = new Object[] {
					...
					userNotificationDeliveryModelImpl.getOriginalType()
				};
	 ...
	 *
	 * @param deliveryId the primary key for the new user notification delivery
	 * @return the new user notification delivery
	 */
	@Override
	public UserNotificationDelivery create(long deliveryId) {
		UserNotificationDelivery userNotificationDelivery = new UserNotificationDeliveryImpl();

		userNotificationDelivery.setNew(true);
		userNotificationDelivery.setPrimaryKey(deliveryId);

		String uuid = PortalUUIDUtil.generate();

		userNotificationDelivery.setUuid(uuid);
	 ...
	 *
	 * @param deliveryId the primary key of the user notification delivery
	 * @return the user notification delivery that was removed
	 * @throws com.liferay.portal.NoSuchUserNotificationDeliveryException if a user notification delivery with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public UserNotificationDelivery remove(long deliveryId)
		throws NoSuchUserNotificationDeliveryException, SystemException {
	...
	public UserNotificationDelivery updateImpl(
		...
		if (Validator.isNull(userNotificationDelivery.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew || !UserNotificationDeliveryModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((userNotificationDeliveryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						userNotificationDeliveryModelImpl.getOriginalUuid()
					};
				...
				args = new Object[] { userNotificationDeliveryModelImpl.getUuid() };
			...
			if ((userNotificationDeliveryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						userNotificationDeliveryModelImpl.getOriginalUuid(),
						userNotificationDeliveryModelImpl.getOriginalCompanyId()
					};
				...
				args = new Object[] {
						userNotificationDeliveryModelImpl.getUuid(),
						userNotificationDeliveryModelImpl.getCompanyId()
					};
	...
	protected UserNotificationDelivery toUnwrappedModel(
		...
		userNotificationDeliveryImpl.setUuid(userNotificationDelivery.getUuid());
		userNotificationDeliveryImpl.setDeliveryId(userNotificationDelivery.getDeliveryId());
		...
		userNotificationDeliveryImpl.setType(userNotificationDelivery.getType());
		userNotificationDeliveryImpl.setEmail(userNotificationDelivery.isEmail());
		userNotificationDeliveryImpl.setSms(userNotificationDelivery.isSms());
		userNotificationDeliveryImpl.setWebsite(userNotificationDelivery.isWebsite());
	 ...
	 */
	@Override
	public UserNotificationDelivery findByPrimaryKey(long deliveryId)
		throws NoSuchUserNotificationDeliveryException, SystemException {
	 ...
	 */
	@Override
	public UserNotificationDelivery fetchByPrimaryKey(long deliveryId)
		throws SystemException {
