...
public class GroupPersistenceImpl extends BasePersistenceImpl<Group>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_P_N_S = new FinderPath(GroupModelImpl.ENTITY_CACHE_ENABLED,
			GroupModelImpl.FINDER_CACHE_ENABLED, GroupImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByC_P_N_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_P_N_S = new FinderPath(GroupModelImpl.ENTITY_CACHE_ENABLED,
			GroupModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByC_P_N_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName(), Boolean.class.getName()
			});
	 ...
	 */
	@Override
	public List<Group> findByC_P_N_S(long companyId, long parentGroupId,
		String name, boolean site) {
		return findByC_P_N_S(companyId, parentGroupId, name, site,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<Group> findByC_P_N_S(long companyId, long parentGroupId,
		...
		return findByC_P_N_S(companyId, parentGroupId, name, site, start, end,
			null);
	}
	...
	public List<Group> findByC_P_N_S(long companyId, long parentGroupId,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_C_P_N_S;
		finderArgs = new Object[] {
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_P_N_S_COMPANYID_2);

			query.append(_FINDER_COLUMN_C_P_N_S_PARENTGROUPID_2);

			boolean bindName = false;

			if (name == null) {
				query.append(_FINDER_COLUMN_C_P_N_S_NAME_1);
			}
			else if (name.equals("")) {
				query.append(_FINDER_COLUMN_C_P_N_S_NAME_3);
			}
			else {
				bindName = true;

				query.append(_FINDER_COLUMN_C_P_N_S_NAME_2);
			}

			query.append(_FINDER_COLUMN_C_P_N_S_SITE_2);
	 ...
	 */
	@Override
	public Group findByC_P_N_S_First(long companyId, long parentGroupId,
		String name, boolean site, OrderByComparator<Group> orderByComparator)
		throws NoSuchGroupException {
		Group group = fetchByC_P_N_S_First(companyId, parentGroupId, name,
				site, orderByComparator);
	 ...
	 */
	@Override
	public Group fetchByC_P_N_S_First(long companyId, long parentGroupId,
		String name, boolean site, OrderByComparator<Group> orderByComparator) {
		List<Group> list = findByC_P_N_S(companyId, parentGroupId, name, site,
				0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Group findByC_P_N_S_Last(long companyId, long parentGroupId,
		String name, boolean site, OrderByComparator<Group> orderByComparator)
		throws NoSuchGroupException {
		Group group = fetchByC_P_N_S_Last(companyId, parentGroupId, name, site,
				orderByComparator);
	 ...
	 */
	@Override
	public Group fetchByC_P_N_S_Last(long companyId, long parentGroupId,
		String name, boolean site, OrderByComparator<Group> orderByComparator) {
		int count = countByC_P_N_S(companyId, parentGroupId, name, site);
	 ...
	 */
	@Override
	public Group[] findByC_P_N_S_PrevAndNext(long groupId, long companyId,
		...
		try {
			...
			array[0] = getByC_P_N_S_PrevAndNext(session, group, companyId,
					parentGroupId, name, site, orderByComparator, true);

			array[1] = group;

			array[2] = getByC_P_N_S_PrevAndNext(session, group, companyId,
	...
	protected Group getByC_P_N_S_PrevAndNext(Session session, Group group,
	 ...
	 */
	@Override
	public void removeByC_P_N_S(long companyId, long parentGroupId,
		String name, boolean site) {
		for (Group group : findByC_P_N_S(companyId, parentGroupId, name, site,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(group);
		}
	}
	 ...
	 */
	@Override
	public int countByC_P_N_S(long companyId, long parentGroupId, String name,
		boolean site) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_P_N_S;
	...
	private static final String _FINDER_COLUMN_C_P_N_S_COMPANYID_2 = "group_.companyId = ? AND ";
	private static final String _FINDER_COLUMN_C_P_N_S_PARENTGROUPID_2 = "group_.parentGroupId = ? AND ";
	private static final String _FINDER_COLUMN_C_P_N_S_NAME_1 = "group_.name IS NULL AND ";
	private static final String _FINDER_COLUMN_C_P_N_S_NAME_2 = "group_.name LIKE ? AND ";
	private static final String _FINDER_COLUMN_C_P_N_S_NAME_3 = "(group_.name IS NULL OR group_.name LIKE '') AND ";
	private static final String _FINDER_COLUMN_C_P_N_S_SITE_2 = "group_.site = ?";
