...
public class ServiceComponentFinderImpl
	...
	public static final String FIND_LAST_VERSION_BY_BUILDNAMESPACE =
		ServiceComponentFinder.class.getName() +
			".findLastVersionByBuildNamespace";

	@Override
	public List<ServiceComponent> findLastVersionByBuildNamespace() {
		Session session = null;

		try {
			session = openSession();

			String sql = CustomSQLUtil.get(FIND_LAST_VERSION_BY_BUILDNAMESPACE);
