...
public class ${entity.name}Util {
	 ...
	 */
	public static long count(DynamicQuery dynamicQuery) throws SystemException {
	 ...
	 */
	public static List<${entity.name}> find(DynamicQuery dynamicQuery) throws SystemException {
	 ...
	 */
	public static List<${entity.name}> find(DynamicQuery dynamicQuery, int start, int end) throws SystemException {
	 ...
	 */
	public static List<${entity.name}> find(DynamicQuery dynamicQuery, int start, int end, OrderByComparator orderByComparator) throws SystemException {
