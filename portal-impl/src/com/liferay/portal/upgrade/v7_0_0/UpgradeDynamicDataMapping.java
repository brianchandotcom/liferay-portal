...
public class UpgradeDynamicDataMapping extends UpgradeProcess {
	...
	protected void addStructureVersion(
		...
		try {
			...
			sb.append("structureId, name, description, definition, ");
			sb.append("storageType, type_, version) values (?, ?, ?, ?, ?, ");
			sb.append("?, ?, ?, ?, ?, ?, ?, ?)");
			...
			ps.setString(11, storageType);
			ps.setInt(12, type);
			ps.setString(13, DDMStructureConstants.VERSION_DEFAULT);
