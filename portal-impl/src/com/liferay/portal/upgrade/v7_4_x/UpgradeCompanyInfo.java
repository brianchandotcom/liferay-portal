...
public class UpgradeCompanyInfo extends UpgradeProcess {
	...
	protected void doUpgrade() throws Exception {
		...
		String selectCompanySQL = StringBundler.concat(
			...
			(companyId == null) ? StringPool.BLANK : " where companyId = ?");
		...
		try (PreparedStatement preparedStatement1 = connection.prepareStatement(
			...
			try (ResultSet resultSet = preparedStatement1.executeQuery()) {
				while (resultSet.next()) {
					...
					preparedStatement2.setLong(2, resultSet.getLong("logoId"));
					preparedStatement2.setString(
						3, resultSet.getString("name"));
					preparedStatement2.setString(
						4, resultSet.getString("legalName"));
					preparedStatement2.setString(
						5, resultSet.getString("legalId"));
					preparedStatement2.setString(
						6, resultSet.getString("legalType"));
					preparedStatement2.setString(
						7, resultSet.getString("sicCode"));
					preparedStatement2.setString(
						8, resultSet.getString("tickerSymbol"));
					preparedStatement2.setString(
						9, resultSet.getString("industry"));
					preparedStatement2.setString(
						10, resultSet.getString("type_"));
					preparedStatement2.setString(
						11, resultSet.getString("size_"));
					preparedStatement2.setString(
						12, resultSet.getString("indexNameCurrent"));
					preparedStatement2.setString(
						13, resultSet.getString("indexNameNext"));
