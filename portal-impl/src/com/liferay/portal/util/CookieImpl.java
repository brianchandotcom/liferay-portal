 ...
 * @author Yuxing Wu
 */
public class CookieImpl implements com.liferay.portal.kernel.util.Cookie {

	@Override
	public Cookie deserialize(byte[] bytes) {
	...
	@Override
	public boolean equals(Cookie cookie1, Cookie cookie2) {
	...
	@Override
	public byte[] serialize(Cookie cookie) {
