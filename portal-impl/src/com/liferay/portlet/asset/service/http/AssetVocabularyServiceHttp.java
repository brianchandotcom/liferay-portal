...
public class AssetVocabularyServiceHttp {
	...
	public static com.liferay.portlet.asset.model.AssetVocabulary getVocabulary(
		...
		try {
			MethodKey methodKey = new MethodKey(AssetVocabularyServiceUtil.class.getName(),
					"getVocabulary", _getVocabularyParameterTypes9);
	...
	public static com.liferay.portlet.asset.model.AssetVocabulary updateVocabulary(
		...
		try {
			MethodKey methodKey = new MethodKey(AssetVocabularyServiceUtil.class.getName(),
					"updateVocabulary", _updateVocabularyParameterTypes11);
	...
	private static final Class<?>[] _getVocabularyParameterTypes9 = new Class[] {
			long.class
		};
	...
	private static final Class<?>[] _updateVocabularyParameterTypes11 = new Class[] {
