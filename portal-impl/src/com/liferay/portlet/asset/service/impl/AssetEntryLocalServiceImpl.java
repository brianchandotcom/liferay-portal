...
import com.liferay.portal.kernel.view.count.ViewCountHelper;
...
public class AssetEntryLocalServiceImpl extends AssetEntryLocalServiceBaseImpl {
	...
	public void deleteEntry(AssetEntry entry) throws PortalException {
		...
		_viewCountHelper.removeViewCount(
			entry.getCompanyId(),
	...
	private static volatile ViewCountHelper _viewCountHelper =
		ServiceProxyFactory.newServiceTrackedInstance(
			ViewCountHelper.class, AssetEntryLocalServiceImpl.class,
			"_viewCountHelper", false, true);
