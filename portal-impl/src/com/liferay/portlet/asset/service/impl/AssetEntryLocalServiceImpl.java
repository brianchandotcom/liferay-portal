...
public class AssetEntryLocalServiceImpl extends AssetEntryLocalServiceBaseImpl {
	...
	public List<AssetEntry> getEntries(
		...
		String title, String description, boolean includeNoListable,
		...
		AssetEntryQuery assetEntryQuery = getAssetEntryQuery(
			...
			includeNoListable, advancedSearch, andOperator, start, end,
	...
	public int getEntriesCount(
		...
		AssetEntryQuery assetEntryQuery = getAssetEntryQuery(
			groupIds, classNameIds, keywords, userName, title, description,
			includeNoListable, advancedSearch, andOperator, QueryUtil.ALL_POS,
