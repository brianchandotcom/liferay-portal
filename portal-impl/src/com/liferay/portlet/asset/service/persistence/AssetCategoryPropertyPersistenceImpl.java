...
public class AssetCategoryPropertyPersistenceImpl extends BasePersistenceImpl<AssetCategoryProperty>
	...
	public List<AssetCategoryProperty> findByC_K(long companyId, String key,
		...
		if (list == null) {
			...
			if (key == null) {
				query.append(_FINDER_COLUMN_C_K_KEY__1);
			}
			else {
				if (key.equals(StringPool.BLANK)) {
					query.append(_FINDER_COLUMN_C_K_KEY__3);
				}
				else {
					query.append(_FINDER_COLUMN_C_K_KEY__2);
				}
			}
	...
	private static final String _FINDER_COLUMN_C_K_KEY__1 = "assetCategoryProperty.key_ IS NULL";
	private static final String _FINDER_COLUMN_C_K_KEY__2 = "assetCategoryProperty.key_ = ?";
	private static final String _FINDER_COLUMN_C_K_KEY__3 = "(assetCategoryProperty.key_ IS NULL OR assetCategoryProperty.key_ = ?)";
	...
	public AssetCategoryProperty fetchByCA_K(long categoryId, String key,
		...
		if (result == null) {
			...
			if (key == null) {
				query.append(_FINDER_COLUMN_CA_K_KEY__1);
			}
			else {
				if (key.equals(StringPool.BLANK)) {
					query.append(_FINDER_COLUMN_CA_K_KEY__3);
				}
				else {
					query.append(_FINDER_COLUMN_CA_K_KEY__2);
				}
			}
	...
	private static final String _FINDER_COLUMN_CA_K_KEY__1 = "assetCategoryProperty.key_ IS NULL";
	private static final String _FINDER_COLUMN_CA_K_KEY__2 = "assetCategoryProperty.key_ = ?";
	private static final String _FINDER_COLUMN_CA_K_KEY__3 = "(assetCategoryProperty.key_ IS NULL OR assetCategoryProperty.key_ = ?)";
