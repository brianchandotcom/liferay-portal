...
public class AssetCategoryPersistenceImpl
	...
	public AssetCategory findByCompanyId_First(
		...
		AssetCategory assetCategory = fetchByCompanyId_First(
	...
	public AssetCategory fetchByCompanyId_First(
		...
		List<AssetCategory> list = findByCompanyId(
	...
	public AssetCategory findByCompanyId_Last(
		...
		AssetCategory assetCategory = fetchByCompanyId_Last(
			companyId, orderByComparator);
	...
	public AssetCategory[] findByCompanyId_PrevAndNext(
		...
		try {
			...
			array[0] = getByCompanyId_PrevAndNext(
				session, assetCategory, companyId, orderByComparator, true);

			array[1] = assetCategory;

			array[2] = getByCompanyId_PrevAndNext(
				session, assetCategory, companyId, orderByComparator, false);
	...
	protected AssetCategory getByCompanyId_PrevAndNext(
		Session session, AssetCategory assetCategory, long companyId,
		OrderByComparator<AssetCategory> orderByComparator, boolean previous) {
