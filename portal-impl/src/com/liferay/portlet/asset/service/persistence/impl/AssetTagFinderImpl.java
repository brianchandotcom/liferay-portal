...
public class AssetTagFinderImpl
	...
	public List<AssetTag> findByG_C_N(
		...
		try {
			...
			Table<AssetTagTable> tempAssetTagTable =
				_getAssetTagEntriesGroupByStep(
					groupId, classNameId, name
				).unionAll(
					_getAssetTagEmptyEntriesGroupByStep(name)
				).as(
	...
	private GroupByStep _getAssetTagEmptyEntriesGroupByStep(String name) {
	...
	private HavingStep _getAssetTagEntriesGroupByStep(
