...
public class DLFileEntryTypeServiceImpl extends DLFileEntryTypeServiceBaseImpl {
	...
	public int searchCount(
		...
		Long count = dlFileEntryTypeLocalService.dslQuery(dslQuery);
	...
	private Predicate _getSearchWherePredicate(
		long companyId, long[] groupIds, String keywords,
		boolean includeBasicFileEntryType, int scope) {

		Predicate predicate = DLFileEntryTypeTable.INSTANCE.companyId.eq(
			companyId);
