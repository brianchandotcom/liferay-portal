...
public class DLContentPersistenceImpl extends BasePersistenceImpl<DLContent>
	...
	public List<DLContent> findByC_R_P(long companyId, long repositoryId,
		...
		if (list == null) {
			...
			if (path == null) {
				query.append(_FINDER_COLUMN_C_R_P_PATH__1);
			}
			else {
				if (path.equals(StringPool.BLANK)) {
					query.append(_FINDER_COLUMN_C_R_P_PATH__3);
				}
				else {
					query.append(_FINDER_COLUMN_C_R_P_PATH__2);
				}
			}
	...
	private static final String _FINDER_COLUMN_C_R_P_PATH__1 = "dlContent.path_ IS NULL";
	private static final String _FINDER_COLUMN_C_R_P_PATH__2 = "dlContent.path_ = ?";
	private static final String _FINDER_COLUMN_C_R_P_PATH__3 = "(dlContent.path_ IS NULL OR dlContent.path_ = ?)";
	...
	public List<DLContent> findByC_R_LikeP(long companyId, long repositoryId,
		...
		if (list == null) {
			...
			if (path == null) {
				query.append(_FINDER_COLUMN_C_R_LIKEP_PATH__1);
			}
			else {
				if (path.equals(StringPool.BLANK)) {
					query.append(_FINDER_COLUMN_C_R_LIKEP_PATH__3);
				}
				else {
					query.append(_FINDER_COLUMN_C_R_LIKEP_PATH__2);
				}
			}
	...
	private static final String _FINDER_COLUMN_C_R_LIKEP_PATH__1 = "dlContent.path_ LIKE NULL";
	private static final String _FINDER_COLUMN_C_R_LIKEP_PATH__2 = "dlContent.path_ LIKE ?";
	private static final String _FINDER_COLUMN_C_R_LIKEP_PATH__3 = "(dlContent.path_ IS NULL OR dlContent.path_ LIKE ?)";
	...
	public DLContent fetchByC_R_P_V(long companyId, long repositoryId,
		...
		if (result == null) {
			...
			if (path == null) {
				query.append(_FINDER_COLUMN_C_R_P_V_PATH__1);
			}
			else {
				if (path.equals(StringPool.BLANK)) {
					query.append(_FINDER_COLUMN_C_R_P_V_PATH__3);
				}
				else {
					query.append(_FINDER_COLUMN_C_R_P_V_PATH__2);
				}
			}
	...
	private static final String _FINDER_COLUMN_C_R_P_V_PATH__1 = "dlContent.path_ IS NULL AND ";
	private static final String _FINDER_COLUMN_C_R_P_V_PATH__2 = "dlContent.path_ = ? AND ";
	private static final String _FINDER_COLUMN_C_R_P_V_PATH__3 = "(dlContent.path_ IS NULL OR dlContent.path_ = ?) AND ";
