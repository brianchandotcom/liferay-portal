...
public class DLFileEntryTypePersistenceImpl extends BasePersistenceImpl<DLFileEntryType>
	...
	protected DLFileEntryType removeImpl(DLFileEntryType dlFileEntryType)
		...
		dlFileEntryTypeToDLFolderMappingTable.deleteByLeftPk(dlFileEntryType.getPrimaryKey());

		dlFileEntryTypeToDDMStructureMappingTable.deleteByLeftPk(dlFileEntryType.getPrimaryKey());
	...
	public List<com.liferay.portlet.documentlibrary.model.DLFolder> getDLFolders(
		...
		throws SystemException {
		return dlFileEntryTypeToDLFolderMappingTable.findByLeftPkAsEntities(pk,
			start, end, orderByComparator);
	}
	...
	public int getDLFoldersSize(long pk) throws SystemException {
		long[] pks = dlFileEntryTypeToDLFolderMappingTable.findByLeftPk(pk);
	...
	public boolean containsDLFolder(long pk, long dlFolderPK)
		throws SystemException {
		return dlFileEntryTypeToDLFolderMappingTable.containsMapping(pk,
			dlFolderPK);
	}
	...
	public void addDLFolder(long pk, long dlFolderPK) throws SystemException {
		dlFileEntryTypeToDLFolderMappingTable.addMapping(pk, dlFolderPK);
	}
	...
	public void addDLFolder(long pk,
		...
		throws SystemException {
		dlFileEntryTypeToDLFolderMappingTable.addMapping(pk,
	...
	public void clearDLFolders(long pk) throws SystemException {
		dlFileEntryTypeToDLFolderMappingTable.deleteByLeftPk(pk);
	}
	...
	public void removeDLFolder(long pk, long dlFolderPK)
		throws SystemException {
		dlFileEntryTypeToDLFolderMappingTable.deleteMapping(pk, dlFolderPK);
	}
	...
	public void removeDLFolder(long pk,
		com.liferay.portlet.documentlibrary.model.DLFolder dlFolder)
		throws SystemException {
		dlFileEntryTypeToDLFolderMappingTable.deleteMapping(pk,
			dlFolder.getPrimaryKey());
	}
	...
	public List<com.liferay.portlet.dynamicdatamapping.model.DDMStructure> getDDMStructures(
		long pk, int start, int end, OrderByComparator orderByComparator)
		throws SystemException {
		return dlFileEntryTypeToDDMStructureMappingTable.findByLeftPkAsEntities(pk,
			start, end, orderByComparator);
	}
	...
	public int getDDMStructuresSize(long pk) throws SystemException {
		long[] pks = dlFileEntryTypeToDDMStructureMappingTable.findByLeftPk(pk);
	...
	public boolean containsDDMStructure(long pk, long ddmStructurePK)
		throws SystemException {
		return dlFileEntryTypeToDDMStructureMappingTable.containsMapping(pk,
			ddmStructurePK);
	}
	...
	public void addDDMStructure(long pk, long ddmStructurePK)
		throws SystemException {
		dlFileEntryTypeToDDMStructureMappingTable.addMapping(pk, ddmStructurePK);
	}
	...
	public void addDDMStructure(long pk,
		...
		throws SystemException {
		dlFileEntryTypeToDDMStructureMappingTable.addMapping(pk,
	...
	public void clearDDMStructures(long pk) throws SystemException {
		dlFileEntryTypeToDDMStructureMappingTable.deleteByLeftPk(pk);
	}
	...
	public void removeDDMStructure(long pk, long ddmStructurePK)
		throws SystemException {
		dlFileEntryTypeToDDMStructureMappingTable.deleteMapping(pk,
			ddmStructurePK);
	}
	...
	public void afterPropertiesSet() {
		...
		dlFileEntryTypeToDLFolderMappingTable = MappingTableUtil.getMappingTable("DLFileEntryTypes_DLFolders",
				"fileEntryTypeId", "folderId", this, dlFolderPersistence);

		dlFileEntryTypeToDDMStructureMappingTable = MappingTableUtil.getMappingTable("DLFileEntryTypes_DDMStructures",
	...
	protected MappingTable<DLFileEntryType, com.liferay.portlet.documentlibrary.model.DLFolder> dlFileEntryTypeToDLFolderMappingTable;
	@BeanReference(type = DDMStructurePersistence.class)
	protected DDMStructurePersistence ddmStructurePersistence;
	protected MappingTable<DLFileEntryType, com.liferay.portlet.dynamicdatamapping.model.DDMStructure> dlFileEntryTypeToDDMStructureMappingTable;
