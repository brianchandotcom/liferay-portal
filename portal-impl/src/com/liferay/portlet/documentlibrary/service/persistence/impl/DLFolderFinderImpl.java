...
public class DLFolderFinderImpl
	...
	public static final String COUNT_FE_BY_G_F_FET =
		DLFolderFinder.class.getName() + ".countFE_ByG_F_FET";
	...
	public static final String FIND_FE_BY_G_F_FET =
		DLFolderFinder.class.getName() + ".findFE_ByG_F_FET";
	...
	@Override
	public int filterCountF_FE_FS_ByG_F_M_FET_M(
		long groupId, long folderId, String[] mimeTypes, long fileEntryTypeId,
		boolean includeMountFolders, QueryDefinition<?> queryDefinition) {

		return doCountF_FE_FS_ByG_F_M_FET_M(
	...
	@Override
	public List<Object> filterFindF_FE_FS_ByG_F_M_FET_M(
		long groupId, long folderId, String[] mimeTypes, long fileEntryTypeId,
		boolean includeMountFolders, QueryDefinition<?> queryDefinition) {

		return doFindF_FE_FS_ByG_F_M_FET_M(
			groupId, folderId, mimeTypes, fileEntryTypeId, includeMountFolders,
			queryDefinition, true);
	}
	...
	@Override
	public List<Object> findF_FE_FS_ByG_F_M_FET_M(
		long groupId, long folderId, String[] mimeTypes, long fileEntryTypeId,
		boolean includeMountFolders, QueryDefinition<?> queryDefinition) {
	...
	protected int doCountF_FE_FS_ByG_F_M_FET_M(
		long groupId, long folderId, String[] mimeTypes, long fileEntryTypeId,
		boolean includeMountFolders, QueryDefinition<?> queryDefinition,
		boolean inlineSQLHelper) {
		...
		try {
			...
			sb.append(
				getFileVersionsSQL(
					COUNT_FE_BY_G_F_FET, groupId, mimeTypes, queryDefinition,
					inlineSQLHelper));
			sb.append(") UNION ALL (");
			sb.append(
				getFileShortcutsSQL(
	...
	protected List<Object> doFindF_FE_FS_ByG_F_M_FET_M(
		long groupId, long folderId, String[] mimeTypes, long fileEntryTypeId,
		boolean includeMountFolders, QueryDefinition<?> queryDefinition,
		boolean inlineSQLHelper) {
		...
		try {
			...
			sql = getFileEntriesSQL(
				FIND_FE_BY_G_F_FET, groupId, mimeTypes, queryDefinition,
				inlineSQLHelper);
