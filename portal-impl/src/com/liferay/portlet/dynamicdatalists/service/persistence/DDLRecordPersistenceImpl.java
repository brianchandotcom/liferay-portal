...
public class DDLRecordPersistenceImpl extends BasePersistenceImpl<DDLRecord>
	...
	private static final String _FINDER_COLUMN_UUID_UUID__1 = "ddlRecord.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID__2 = "ddlRecord.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID__3 = "(ddlRecord.uuid_ IS NULL OR ddlRecord.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID__1 = "ddlRecord.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID__2 = "ddlRecord.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID__3 = "(ddlRecord.uuid_ IS NULL OR ddlRecord.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID__1 = "ddlRecord.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID__2 = "ddlRecord.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID__3 = "(ddlRecord.uuid_ IS NULL OR ddlRecord.uuid_ = ?) AND ";
	...
	public DDLRecord updateImpl(
		...
		if (isNew || !DDLRecordModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((ddlRecordModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						ddlRecordModelImpl.getOriginalUuid(),
						Long.valueOf(ddlRecordModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						...
						Long.valueOf(ddlRecordModelImpl.getCompanyId())
					};
