...
public class DDLRecordSetFinderImpl extends BasePersistenceImpl<DDLRecordSet>
	...
	public static String COUNT_BY_C_G_S_N_D =
		DDLRecordSetFinder.class.getName() + ".countByC_G_S_N_D";

	public static String FIND_BY_C_G_S_N_D =
		DDLRecordSetFinder.class.getName() + ".findByC_G_S_N_D";
	...
	public int countByKeywords(
		...
		return doCountByC_G_S_N_D(
			companyId, groupId, scope, names, descriptions, andOperator);
	}
	...
	public List<DDLRecordSet> findByKeywords(
			long companyId, long groupId, int scope, String keywords, int start,
	...
	public List<DDLRecordSet> findByC_G_S_N_D(
			long companyId, long groupId, int scope, String name,
		...
		return findByC_G_S_N_D(
			companyId, groupId, scope, names, descriptions, andOperator, start,
			end, orderByComparator);
	}

	public List<DDLRecordSet> findByC_G_S_N_D(
			long companyId, long groupId, int scope, String[] names,
	...
	protected List<DDLRecordSet> doFindByC_G_S_N_D(
			long companyId, long groupId, int scope, String[] names,
			String[] descriptions, boolean andOperator, int start, int end,
			OrderByComparator orderByComparator)
		throws SystemException {
