...
public class DDMStructureLinkPersistenceImpl extends BasePersistenceImpl<DDMStructureLink>
	...
	public static final FinderPath FINDER_PATH_FIND_BY_CLASSNAMEID = new FinderPath(DDMStructureLinkModelImpl.ENTITY_CACHE_ENABLED,
			...
			"findByClassNameId",
			DDMStructureLinkModelImpl.CLASSNAMEID_BIT_MASK,
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_CLASSNAMEID_PAGE_ORDER = new FinderPath(DDMStructureLinkModelImpl.ENTITY_CACHE_ENABLED,
			DDMStructureLinkModelImpl.FINDER_CACHE_ENABLED,
			DDMStructureLinkImpl.class, FINDER_CLASS_NAME_LIST_PAGE_ORDER,
			"findByClassNameId",
			DDMStructureLinkModelImpl.CLASSNAMEID_BIT_MASK,
			new String[] {
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_CLASSPK = new FinderPath(DDMStructureLinkModelImpl.ENTITY_CACHE_ENABLED,
			...
			"fetchByClassPK", DDMStructureLinkModelImpl.CLASSPK_BIT_MASK,
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_COUNT_BY_CLASSPK = new FinderPath(DDMStructureLinkModelImpl.ENTITY_CACHE_ENABLED,
			...
			DDMStructureLinkModelImpl.CLASSPK_BIT_MASK,
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_STRUCTUREID = new FinderPath(DDMStructureLinkModelImpl.ENTITY_CACHE_ENABLED,
			...
			DDMStructureLinkImpl.class, FINDER_CLASS_NAME_LIST,
			"findByStructureId",
			DDMStructureLinkModelImpl.STRUCTUREID_BIT_MASK,
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_STRUCTUREID_PAGE_ORDER = new FinderPath(DDMStructureLinkModelImpl.ENTITY_CACHE_ENABLED,
			DDMStructureLinkModelImpl.FINDER_CACHE_ENABLED,
			DDMStructureLinkImpl.class, FINDER_CLASS_NAME_LIST_PAGE_ORDER,
			"findByStructureId",
			DDMStructureLinkModelImpl.STRUCTUREID_BIT_MASK,
	...
	public static final FinderPath FINDER_PATH_FIND_ALL = new FinderPath(DDMStructureLinkModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[0]);
	public static final FinderPath FINDER_PATH_FIND_ALL_PAGE_ORDER = new FinderPath(DDMStructureLinkModelImpl.ENTITY_CACHE_ENABLED,
			DDMStructureLinkModelImpl.FINDER_CACHE_ENABLED,
			DDMStructureLinkImpl.class, FINDER_CLASS_NAME_LIST_PAGE_ORDER,
	...
	public DDMStructureLink updateImpl(
		...
		if (isNew || !DDMStructureLinkModelImpl.COLUMN_BIT_MASK_ENABLED) {
			FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST);
		}
		else {
			if ((ddmStructureLinkModelImpl.getBitMask() &
					FINDER_PATH_FIND_BY_CLASSNAMEID.getColumnBitMask()) != 0) {
		...
		if (isNew) {
			...
			if ((ddmStructureLinkModelImpl.getBitMask() &
					FINDER_PATH_COUNT_BY_CLASSPK.getColumnBitMask()) != 0) {
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_CLASSPK,
					new Object[] {
						Long.valueOf(
	...
	public List<DDMStructureLink> findByClassNameId(long classNameId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderPath = FINDER_PATH_FIND_BY_CLASSNAMEID;
		}
		else {
			...
			finderPath = FINDER_PATH_FIND_BY_CLASSNAMEID_PAGE_ORDER;
		}
