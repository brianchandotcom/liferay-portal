...
public class JournalArticleLocalServiceImpl
	...
	public JournalArticle updateArticle(
		...
		if (isContextUrlTitleRegexpMatch(urlTitleFromContext)) {
			...
			if (articleWithUrlTitle != null) {
				if (articleWithUrlTitle.getArticleId().equals(
						oldArticle.getArticleId())) {

					// Use the URL title as it matches that of the old article

				}
				else if (!articleWithUrlTitle.getArticleId().equals(
						articleId)) {
					urlTitle = getUniqueUrlTitle(
						article.getId(), groupId, articleId, urlTitle);
				}
			...
			if (isContextUrlTitleRegexpMatch(urlTitleFromContext)) {
				...
				if (articleWithUrlTitle != null) {
					if (articleWithUrlTitle.getArticleId().equals(
						...
						// Use the URL title as it matches that of the old
						// article
