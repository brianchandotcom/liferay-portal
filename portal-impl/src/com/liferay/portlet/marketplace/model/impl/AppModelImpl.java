...
import com.liferay.portlet.marketplace.model.AppModel;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.portlet.marketplace.model.AppModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link AppImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see AppImpl
 * @see com.liferay.portlet.marketplace.model.App
 * @see com.liferay.portlet.marketplace.model.AppModel
 * @generated
 */
public class AppModelImpl extends BaseModelImpl<App> implements AppModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a app model instance should use the {@link com.liferay.portlet.marketplace.model.App} interface instead.
	 */
	...
	public static final String TABLE_SQL_CREATE = "create table App (uuid_ VARCHAR(75) null,appId LONG not null primary key,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,marketplaceAppId LONG,version VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table App";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.portal.util.PropsUtil.get(
				"value.object.entity.cache.enabled.com.liferay.portlet.marketplace.model.App"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.portal.util.PropsUtil.get(
				"value.object.finder.cache.enabled.com.liferay.portlet.marketplace.model.App"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.portal.util.PropsUtil.get(
				"lock.expiration.time.com.liferay.portlet.marketplace.model.App"));
	...
	public App toEscapedModel() {
		if (isEscapedModel()) {
			...
			if (_escapedModelProxy == null) {
				_escapedModelProxy = (App)Proxy.newProxyInstance(_classLoader,
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.portlet.marketplace.model.App");
