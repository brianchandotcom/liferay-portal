...
public class MBSettings {
	...
	public String getEmailMessageAddedSignature() {
		String emailMessageAddedSignature = _serviceGroupSettings.getValue(
	...
	public String getEmailMessageUpdatedSignature() {
		String emailMessageUpdatedSignature = _serviceGroupSettings.getValue(
