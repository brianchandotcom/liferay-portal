...
public abstract class MBStatsUserLocalServiceBaseImpl
	...
	public long count(DynamicQuery dynamicQuery) throws SystemException {
		return mbStatsUserPersistence.count(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery) throws SystemException {
		return mbStatsUserPersistence.find(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return mbStatsUserPersistence.find(dynamicQuery, start, end);
	}
