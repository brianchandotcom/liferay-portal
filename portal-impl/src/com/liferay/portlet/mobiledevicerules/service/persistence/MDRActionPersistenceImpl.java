...
public class MDRActionPersistenceImpl extends BasePersistenceImpl<MDRAction>
	...
	public static final FinderPath FINDER_PATH_FIND_BY_UUID = new FinderPath(MDRActionModelImpl.ENTITY_CACHE_ENABLED,
			...
			MDRActionModelImpl.UUID_BIT_MASK,
			new String[] { String.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_UUID_PAGE_ORDER = new FinderPath(MDRActionModelImpl.ENTITY_CACHE_ENABLED,
			MDRActionModelImpl.FINDER_CACHE_ENABLED, MDRActionImpl.class,
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_UUID_G = new FinderPath(MDRActionModelImpl.ENTITY_CACHE_ENABLED,
			...
			MDRActionModelImpl.UUID_BIT_MASK |
			MDRActionModelImpl.GROUPID_BIT_MASK,
	...
	public static final FinderPath FINDER_PATH_FIND_BY_RULEID = new FinderPath(MDRActionModelImpl.ENTITY_CACHE_ENABLED,
			...
			MDRActionModelImpl.RULEID_BIT_MASK,
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_RULEID_PAGE_ORDER = new FinderPath(MDRActionModelImpl.ENTITY_CACHE_ENABLED,
			MDRActionModelImpl.FINDER_CACHE_ENABLED, MDRActionImpl.class,
			FINDER_CLASS_NAME_LIST_PAGE_ORDER, "findByRuleId",
			MDRActionModelImpl.RULEID_BIT_MASK,
			new String[] {
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_FIND_ALL_PAGE_ORDER = new FinderPath(MDRActionModelImpl.ENTITY_CACHE_ENABLED,
			MDRActionModelImpl.FINDER_CACHE_ENABLED, MDRActionImpl.class,
	...
	public MDRAction updateImpl(
		...
		if (isNew || !MDRActionModelImpl.COLUMN_BIT_MASK_ENABLED) {
			FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST);
		}
		else {
			if ((mdrActionModelImpl.getBitMask() &
			...
			if ((mdrActionModelImpl.getBitMask() &
					FINDER_PATH_FIND_BY_RULEID.getColumnBitMask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(mdrActionModelImpl.getOriginalRuleId())
					};

				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_RULEID, args);
	...
	public List<MDRAction> findByRuleId(long ruleId, int start, int end,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderPath = FINDER_PATH_FIND_BY_RULEID;
		}
		else {
			finderArgs = new Object[] {
					ruleId,
			...
			finderPath = FINDER_PATH_FIND_BY_RULEID_PAGE_ORDER;
		}
