...
public abstract class PollsChoiceLocalServiceBaseImpl
	...
	public long count(DynamicQuery dynamicQuery) throws SystemException {
		return pollsChoicePersistence.count(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery) throws SystemException {
		return pollsChoicePersistence.find(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return pollsChoicePersistence.find(dynamicQuery, start, end);
	}
