...
public abstract class ShoppingItemFieldLocalServiceBaseImpl
	...
	public long count(DynamicQuery dynamicQuery) throws SystemException {
		return shoppingItemFieldPersistence.count(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery) throws SystemException {
		return shoppingItemFieldPersistence.find(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return shoppingItemFieldPersistence.find(dynamicQuery, start, end);
	}
