...
public abstract class ShoppingItemLocalServiceBaseImpl
	...
	public long count(DynamicQuery dynamicQuery) throws SystemException {
		return shoppingItemPersistence.count(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery) throws SystemException {
		return shoppingItemPersistence.find(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return shoppingItemPersistence.find(dynamicQuery, start, end);
	}
