...
public class ShoppingItemPricePersistenceImpl extends BasePersistenceImpl<ShoppingItemPrice>
	...
	public static final FinderPath FINDER_PATH_FIND_BY_ITEMID = new FinderPath(ShoppingItemPriceModelImpl.ENTITY_CACHE_ENABLED,
			...
			"findByItemId", ShoppingItemPriceModelImpl.ITEMID_BIT_MASK,
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_ITEMID_PAGE_ORDER = new FinderPath(ShoppingItemPriceModelImpl.ENTITY_CACHE_ENABLED,
			ShoppingItemPriceModelImpl.FINDER_CACHE_ENABLED,
			ShoppingItemPriceImpl.class, FINDER_CLASS_NAME_LIST_PAGE_ORDER,
			"findByItemId", ShoppingItemPriceModelImpl.ITEMID_BIT_MASK,
			new String[] {
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_ITEMID = new FinderPath(ShoppingItemPriceModelImpl.ENTITY_CACHE_ENABLED,
			...
			ShoppingItemPriceModelImpl.ITEMID_BIT_MASK,
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_ALL = new FinderPath(ShoppingItemPriceModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[0]);
	public static final FinderPath FINDER_PATH_FIND_ALL_PAGE_ORDER = new FinderPath(ShoppingItemPriceModelImpl.ENTITY_CACHE_ENABLED,
			ShoppingItemPriceModelImpl.FINDER_CACHE_ENABLED,
			ShoppingItemPriceImpl.class, FINDER_CLASS_NAME_LIST_PAGE_ORDER,
	...
	public ShoppingItemPrice updateImpl(
		...
		if (isNew || !ShoppingItemPriceModelImpl.COLUMN_BIT_MASK_ENABLED) {
			FinderCacheUtil.clearCache(FINDER_CLASS_NAME_LIST);
		}
		else {
			if ((shoppingItemPriceModelImpl.getBitMask() &
