...
public class SocialActivityAchievementModelImpl extends BaseModelImpl<SocialActivityAchievement>
	...
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "name", Types.VARCHAR },
			{ "unlockDate", Types.TIMESTAMP },
			{ "unlockedBy", Types.BIGINT },
			{ "firstUnlock", Types.BOOLEAN }
		};
	public static final String TABLE_SQL_CREATE = "create table SocialActivityAchievement (activityAchievementId LONG not null primary key,groupId LONG,companyId LONG,name VARCHAR(75) null,unlockDate DATE null,unlockedBy LONG,firstUnlock BOOLEAN)";
	...
	public void setUnlockedBy(long unlockedBy) {
		if (!_setOriginalUnlockedBy) {
			_setOriginalUnlockedBy = true;

			_originalUnlockedBy = _unlockedBy;
		}

		_unlockedBy = unlockedBy;
	}

	public long getOriginalUnlockedBy() {
		return _originalUnlockedBy;
	}
	...
	public Object clone() {
		...
		socialActivityAchievementImpl.setUnlockDate(getUnlockDate());
		socialActivityAchievementImpl.setUnlockedBy(getUnlockedBy());
		socialActivityAchievementImpl.setFirstUnlock(getFirstUnlock());
	...
	public void resetOriginalValues() {
		...
		socialActivityAchievementModelImpl._originalUnlockedBy = socialActivityAchievementModelImpl._unlockedBy;

		socialActivityAchievementModelImpl._setOriginalUnlockedBy = false;
	}
	...
	public CacheModel<SocialActivityAchievement> toCacheModel() {
		...
		if (unlockDate != null) {
			socialActivityAchievementCacheModel.unlockDate = unlockDate.getTime();
		}
		else {
			socialActivityAchievementCacheModel.unlockDate = Long.MIN_VALUE;
		}

		socialActivityAchievementCacheModel.unlockedBy = getUnlockedBy();

		socialActivityAchievementCacheModel.firstUnlock = getFirstUnlock();
	...
	public String toString() {
		...
		sb.append(getUnlockDate());
		sb.append(", unlockedBy=");
		sb.append(getUnlockedBy());
		sb.append(", firstUnlock=");
		sb.append(getFirstUnlock());
		sb.append("}");
	...
	public String toXmlString() {
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>unlockDate</column-name><column-value><![CDATA[");
		sb.append(getUnlockDate());
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>unlockedBy</column-name><column-value><![CDATA[");
		sb.append(getUnlockedBy());
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>firstUnlock</column-name><column-value><![CDATA[");
		sb.append(getFirstUnlock());
		sb.append("]]></column-value></column>");
	...
	private long _originalUnlockedBy;
	private boolean _setOriginalUnlockedBy;
