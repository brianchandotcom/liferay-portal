...
public class SocialActivityLimitModelImpl extends BaseModelImpl<SocialActivityLimit>
	...
	public static final String TABLE_SQL_CREATE = "create table SocialActivityLimit (activityLimitId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,classNameId LONG,classPK LONG,activityKey INTEGER,statName VARCHAR(75) null,value VARCHAR(75) null)";
	...
	public Object clone() {
		...
		socialActivityLimitImpl.setActivityKey(getActivityKey());
		socialActivityLimitImpl.setStatName(getStatName());
	...
	public void resetOriginalValues() {
		...
		socialActivityLimitModelImpl._originalActivityKey = socialActivityLimitModelImpl._activityKey;

		socialActivityLimitModelImpl._setOriginalActivityKey = false;

		socialActivityLimitModelImpl._originalStatName = socialActivityLimitModelImpl._statName;
	}
	...
	public CacheModel<SocialActivityLimit> toCacheModel() {
		...
		socialActivityLimitCacheModel.activityKey = getActivityKey();

		socialActivityLimitCacheModel.statName = getStatName();

		String statName = socialActivityLimitCacheModel.statName;

		if ((statName != null) && (statName.length() == 0)) {
			socialActivityLimitCacheModel.statName = null;
		}
