...
public abstract class SocialActivityAchievementLocalServiceBaseImpl
	...
	public long count(DynamicQuery dynamicQuery) throws SystemException {
		return socialActivityAchievementPersistence.count(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery) throws SystemException {
		return socialActivityAchievementPersistence.find(dynamicQuery);
	}
	...
	public List find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return socialActivityAchievementPersistence.find(dynamicQuery, start,
			end);
	}
