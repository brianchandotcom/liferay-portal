...
/**
 * The base implementation of the social activity group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portlet.social.service.impl.SocialActivityGroupLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class SocialActivityGroupLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SocialActivityGroupLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.portlet.social.service.SocialActivityGroupLocalServiceUtil} to access the social activity group local service.
	 */
	...
	public SocialActivityGroup addSocialActivityGroup(
		SocialActivityGroup socialActivityGroup) throws SystemException {
		socialActivityGroup.setNew(true);

		return socialActivityGroupPersistence.update(socialActivityGroup);
	}
	 ...
	 */
	public SocialActivityGroup createSocialActivityGroup(long activityGroupId) {
		return socialActivityGroupPersistence.create(activityGroupId);
	}
	...
	public SocialActivityGroup deleteSocialActivityGroup(long activityGroupId)
		throws PortalException, SystemException {
		return socialActivityGroupPersistence.remove(activityGroupId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SocialActivityGroup deleteSocialActivityGroup(
		SocialActivityGroup socialActivityGroup) throws SystemException {
		return socialActivityGroupPersistence.remove(socialActivityGroup);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(SocialActivityGroup.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return socialActivityGroupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return socialActivityGroupPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public SocialActivityGroup fetchSocialActivityGroup(long activityGroupId)
		throws SystemException {
		return socialActivityGroupPersistence.fetchByPrimaryKey(activityGroupId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityGroup getSocialActivityGroup(long activityGroupId)
		throws PortalException, SystemException {
		return socialActivityGroupPersistence.findByPrimaryKey(activityGroupId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return socialActivityGroupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SocialActivityGroup> getSocialActivityGroups(int start, int end)
		throws SystemException {
		return socialActivityGroupPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSocialActivityGroupsCount() throws SystemException {
		return socialActivityGroupPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SocialActivityGroup updateSocialActivityGroup(
		SocialActivityGroup socialActivityGroup) throws SystemException {
		return socialActivityGroupPersistence.update(socialActivityGroup);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.portlet.social.model.SocialActivityGroup",
			socialActivityGroupLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.portlet.social.model.SocialActivityGroup");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = socialActivityGroupPersistence.getDataSource();
