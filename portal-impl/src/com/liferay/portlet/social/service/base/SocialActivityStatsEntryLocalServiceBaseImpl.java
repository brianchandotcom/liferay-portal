...
import com.liferay.portlet.social.service.SocialActivityStatsEntryLocalService;
...
import com.liferay.portlet.social.service.persistence.SocialActivityStatsEntryFinder;
import com.liferay.portlet.social.service.persistence.SocialActivityStatsEntryPersistence;
...
/**
 * The base implementation of the social activity stats entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.portlet.social.service.impl.SocialActivityStatsEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.portlet.social.service.impl.SocialActivityStatsEntryLocalServiceImpl
 * @see com.liferay.portlet.social.service.SocialActivityStatsEntryLocalServiceUtil
 * @generated
 */
public abstract class SocialActivityStatsEntryLocalServiceBaseImpl
	implements SocialActivityStatsEntryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.portlet.social.service.SocialActivityStatsEntryLocalServiceUtil} to access the social activity stats entry local service.
	 */

	/**
	 * Adds the social activity stats entry to the database. Also notifies the appropriate model listeners.
	 *
	 * @param socialActivityStatsEntry the social activity stats entry
	 * @return the social activity stats entry that was added
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityStatsEntry addSocialActivityStatsEntry(
		SocialActivityStatsEntry socialActivityStatsEntry)
		throws SystemException {
		socialActivityStatsEntry.setNew(true);

		socialActivityStatsEntry = socialActivityStatsEntryPersistence.update(socialActivityStatsEntry,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(socialActivityStatsEntry);
			}
	 ...
	 */
	public SocialActivityStatsEntry createSocialActivityStatsEntry(
		long activityStatsEntryId) {
		return socialActivityStatsEntryPersistence.create(activityStatsEntryId);
	}

	/**
	 * Deletes the social activity stats entry with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param activityStatsEntryId the primary key of the social activity stats entry
	 * @throws PortalException if a social activity stats entry with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteSocialActivityStatsEntry(long activityStatsEntryId)
		throws PortalException, SystemException {
		SocialActivityStatsEntry socialActivityStatsEntry = socialActivityStatsEntryPersistence.remove(activityStatsEntryId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(socialActivityStatsEntry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	/**
	 * Deletes the social activity stats entry from the database. Also notifies the appropriate model listeners.
	 *
	 * @param socialActivityStatsEntry the social activity stats entry
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteSocialActivityStatsEntry(
		SocialActivityStatsEntry socialActivityStatsEntry)
		throws SystemException {
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return socialActivityStatsEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return socialActivityStatsEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Returns the social activity stats entry with the primary key.
	 *
	 * @param activityStatsEntryId the primary key of the social activity stats entry
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityStatsEntry getSocialActivityStatsEntry(
		long activityStatsEntryId) throws PortalException, SystemException {
		return socialActivityStatsEntryPersistence.findByPrimaryKey(activityStatsEntryId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return socialActivityStatsEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SocialActivityStatsEntry> getSocialActivityStatsEntries(
		int start, int end) throws SystemException {
		return socialActivityStatsEntryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSocialActivityStatsEntriesCount() throws SystemException {
		return socialActivityStatsEntryPersistence.countAll();
	}

	/**
	 * Updates the social activity stats entry in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param socialActivityStatsEntry the social activity stats entry
	 * @return the social activity stats entry that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityStatsEntry updateSocialActivityStatsEntry(
		SocialActivityStatsEntry socialActivityStatsEntry)
		throws SystemException {
		return updateSocialActivityStatsEntry(socialActivityStatsEntry, true);
	}
	 ...
	 *
	 * @param socialActivityStatsEntry the social activity stats entry
	 * @param merge whether to merge the social activity stats entry with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the social activity stats entry that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityStatsEntry updateSocialActivityStatsEntry(
	...
	/**
	 * Returns the social activity stats entry local service.
	 *
	 * @return the social activity stats entry local service
	 */
	public SocialActivityStatsEntryLocalService getSocialActivityStatsEntryLocalService() {
		return socialActivityStatsEntryLocalService;
	}

	/**
	 * Sets the social activity stats entry local service.
	 *
	 * @param socialActivityStatsEntryLocalService the social activity stats entry local service
	 */
	public void setSocialActivityStatsEntryLocalService(
		SocialActivityStatsEntryLocalService socialActivityStatsEntryLocalService) {
		this.socialActivityStatsEntryLocalService = socialActivityStatsEntryLocalService;
	}

	/**
	 * Returns the social activity stats entry persistence.
	 *
	 * @return the social activity stats entry persistence
	 */
	public SocialActivityStatsEntryPersistence getSocialActivityStatsEntryPersistence() {
		return socialActivityStatsEntryPersistence;
	}

	/**
	 * Sets the social activity stats entry persistence.
	 *
	 * @param socialActivityStatsEntryPersistence the social activity stats entry persistence
	 */
	public void setSocialActivityStatsEntryPersistence(
		SocialActivityStatsEntryPersistence socialActivityStatsEntryPersistence) {
		this.socialActivityStatsEntryPersistence = socialActivityStatsEntryPersistence;
	}

	/**
	 * Returns the social activity stats entry finder.
	 *
	 * @return the social activity stats entry finder
	 */
	public SocialActivityStatsEntryFinder getSocialActivityStatsEntryFinder() {
		return socialActivityStatsEntryFinder;
	}

	/**
	 * Sets the social activity stats entry finder.
	 *
	 * @param socialActivityStatsEntryFinder the social activity stats entry finder
	 */
	public void setSocialActivityStatsEntryFinder(
		SocialActivityStatsEntryFinder socialActivityStatsEntryFinder) {
		this.socialActivityStatsEntryFinder = socialActivityStatsEntryFinder;
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.portlet.social.model.SocialActivityStatsEntry",
			socialActivityStatsEntryLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.portlet.social.model.SocialActivityStatsEntry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = socialActivityStatsEntryPersistence.getDataSource();
	...
	@BeanReference(type = SocialActivityStatsEntryLocalService.class)
	protected SocialActivityStatsEntryLocalService socialActivityStatsEntryLocalService;
	...
	@BeanReference(type = SocialActivityStatsEntryFinder.class)
	protected SocialActivityStatsEntryFinder socialActivityStatsEntryFinder;
	...
	private static Log _log = LogFactoryUtil.getLog(SocialActivityStatsEntryLocalServiceBaseImpl.class);
