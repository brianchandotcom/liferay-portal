...
public class SocialActivityAchievementPersistenceImpl
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_G_F = new FinderPath(SocialActivityAchievementModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivityAchievementModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST, "countByG_F",
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_G_N = new FinderPath(SocialActivityAchievementModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivityAchievementModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST, "countByG_N",
			new String[] { Long.class.getName(), String.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_BY_G_UB = new FinderPath(SocialActivityAchievementModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivityAchievementModelImpl.FINDER_CACHE_ENABLED,
			SocialActivityAchievementImpl.class, FINDER_CLASS_NAME_LIST,
			"findByG_UB",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_G_UB = new FinderPath(SocialActivityAchievementModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivityAchievementModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST, "countByG_UB",
			new String[] { Long.class.getName(), Long.class.getName() });
	public static final FinderPath FINDER_PATH_FETCH_BY_G_N_UB = new FinderPath(SocialActivityAchievementModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivityAchievementModelImpl.FINDER_CACHE_ENABLED,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_G_N_UB = new FinderPath(SocialActivityAchievementModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivityAchievementModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST, "countByG_N_UB",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Long.class.getName()
			});
	public static final FinderPath FINDER_PATH_FIND_BY_G_UB_F = new FinderPath(SocialActivityAchievementModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivityAchievementModelImpl.FINDER_CACHE_ENABLED,
			SocialActivityAchievementImpl.class, FINDER_CLASS_NAME_LIST,
			"findByG_UB_F",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_G_UB_F = new FinderPath(SocialActivityAchievementModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivityAchievementModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST, "countByG_UB_F",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Boolean.class.getName()
			});
	...
	public void cacheResult(SocialActivityAchievement socialActivityAchievement) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_G_N_UB,
			new Object[] {
				Long.valueOf(socialActivityAchievement.getGroupId()),
				
			socialActivityAchievement.getName(),
				Long.valueOf(socialActivityAchievement.getUnlockedBy())
	...
	public void clearCache(SocialActivityAchievement socialActivityAchievement) {
		...
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_G_N_UB,
			new Object[] {
				Long.valueOf(socialActivityAchievement.getGroupId()),
	...
	protected SocialActivityAchievement removeImpl(
		...
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_G_N_UB,
			...
			socialActivityAchievementModelImpl.getName(),
				Long.valueOf(socialActivityAchievementModelImpl.getUnlockedBy())
			});
	...
	public SocialActivityAchievement updateImpl(
		...
		if (!isNew &&
				((socialActivityAchievement.getGroupId() != socialActivityAchievementModelImpl.getOriginalGroupId()) ||
				!Validator.equals(socialActivityAchievement.getName(),
					socialActivityAchievementModelImpl.getOriginalName()) ||
				(socialActivityAchievement.getUnlockedBy() != socialActivityAchievementModelImpl.getOriginalUnlockedBy()))) {
			FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_G_N_UB,
				new Object[] {
					Long.valueOf(
				...
				socialActivityAchievementModelImpl.getOriginalName(),
					Long.valueOf(
						socialActivityAchievementModelImpl.getOriginalUnlockedBy())
				});
		}
	...
	protected SocialActivityAchievement toUnwrappedModel(
		...
		socialActivityAchievementImpl.setUnlockDate(socialActivityAchievement.getUnlockDate());
		socialActivityAchievementImpl.setUnlockedBy(socialActivityAchievement.getUnlockedBy());
		socialActivityAchievementImpl.setFirstUnlock(socialActivityAchievement.isFirstUnlock());
	...
	public List<SocialActivityAchievement> findByG_F(long groupId,
		boolean firstUnlock) throws SystemException {
		return findByG_F(groupId, firstUnlock, QueryUtil.ALL_POS,
	 ...
	 */
	public List<SocialActivityAchievement> findByG_F(long groupId,
		boolean firstUnlock, int start, int end) throws SystemException {
		return findByG_F(groupId, firstUnlock, start, end, null);
	}
	 ...
	 */
	public List<SocialActivityAchievement> findByG_F(long groupId,
		boolean firstUnlock, int start, int end,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_F_FIRSTUNLOCK_2);
	...
	public SocialActivityAchievement findByG_F_First(long groupId,
		boolean firstUnlock, OrderByComparator orderByComparator)
		throws NoSuchActivityAchievementException, SystemException {
		List<SocialActivityAchievement> list = findByG_F(groupId, firstUnlock,
	...
	public SocialActivityAchievement findByG_F_Last(long groupId,
		boolean firstUnlock, OrderByComparator orderByComparator)
		throws NoSuchActivityAchievementException, SystemException {
		int count = countByG_F(groupId, firstUnlock);
	...
	protected SocialActivityAchievement getByG_F_PrevAndNext(Session session,
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByValues(socialActivityAchievement);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SocialActivityAchievement> findByG_UB(long groupId,
		long unlockedBy) throws SystemException {
		return findByG_UB(groupId, unlockedBy, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	public List<SocialActivityAchievement> findByG_UB(long groupId,
		long unlockedBy, int start, int end) throws SystemException {
		return findByG_UB(groupId, unlockedBy, start, end, null);
	}
	 ...
	 */
	public List<SocialActivityAchievement> findByG_UB(long groupId,
		long unlockedBy, int start, int end, OrderByComparator orderByComparator)
		throws SystemException {
		Object[] finderArgs = new Object[] {
				groupId, unlockedBy,
		...
		List<SocialActivityAchievement> list = (List<SocialActivityAchievement>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_G_UB,
				finderArgs, this);
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_UB_GROUPID_2);

			query.append(_FINDER_COLUMN_G_UB_UNLOCKEDBY_2);
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_G_UB,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_G_UB,
						finderArgs, list);
				}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityAchievement findByG_UB_First(long groupId,
		long unlockedBy, OrderByComparator orderByComparator)
		throws NoSuchActivityAchievementException, SystemException {
		List<SocialActivityAchievement> list = findByG_UB(groupId, unlockedBy,
				0, 1, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityAchievement findByG_UB_Last(long groupId,
		long unlockedBy, OrderByComparator orderByComparator)
		throws NoSuchActivityAchievementException, SystemException {
		int count = countByG_UB(groupId, unlockedBy);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityAchievement[] findByG_UB_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_UB_PrevAndNext(session,
					socialActivityAchievement, groupId, unlockedBy,
					orderByComparator, true);

			array[1] = socialActivityAchievement;

			array[2] = getByG_UB_PrevAndNext(session,
					socialActivityAchievement, groupId, unlockedBy,
	...
	protected SocialActivityAchievement getByG_UB_PrevAndNext(Session session,
		SocialActivityAchievement socialActivityAchievement, long groupId,
		long unlockedBy, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityAchievement findByG_N_UB(long groupId, String name,
		long unlockedBy)
		throws NoSuchActivityAchievementException, SystemException {
		SocialActivityAchievement socialActivityAchievement = fetchByG_N_UB(groupId,
				name, unlockedBy);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityAchievement fetchByG_N_UB(long groupId, String name,
		long unlockedBy) throws SystemException {
		return fetchByG_N_UB(groupId, name, unlockedBy, true);
	}
	 ...
	 */
	public SocialActivityAchievement fetchByG_N_UB(long groupId, String name,
		long unlockedBy, boolean retrieveFromCache) throws SystemException {
		Object[] finderArgs = new Object[] { groupId, name, unlockedBy };

		Object result = null;

		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_G_N_UB,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_G_N_UB_GROUPID_2);

			if (name == null) {
				query.append(_FINDER_COLUMN_G_N_UB_NAME_1);
			}
			else {
				if (name.equals(StringPool.BLANK)) {
					query.append(_FINDER_COLUMN_G_N_UB_NAME_3);
				}
				else {
					query.append(_FINDER_COLUMN_G_N_UB_NAME_2);
				}
			}

			query.append(_FINDER_COLUMN_G_N_UB_UNLOCKEDBY_2);
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((socialActivityAchievement.getGroupId() != groupId) ||
							...
							(socialActivityAchievement.getUnlockedBy() != unlockedBy)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_G_N_UB,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SocialActivityAchievement> findByG_UB_F(long groupId,
		long unlockedBy, boolean firstUnlock) throws SystemException {
		return findByG_UB_F(groupId, unlockedBy, firstUnlock,
	 ...
	 */
	public List<SocialActivityAchievement> findByG_UB_F(long groupId,
		long unlockedBy, boolean firstUnlock, int start, int end)
		throws SystemException {
		return findByG_UB_F(groupId, unlockedBy, firstUnlock, start, end, null);
	}
	...
	public List<SocialActivityAchievement> findByG_UB_F(long groupId,
		...
		OrderByComparator orderByComparator) throws SystemException {
		Object[] finderArgs = new Object[] {
				groupId, unlockedBy, firstUnlock,
				
				start, end, orderByComparator
			};

		List<SocialActivityAchievement> list = (List<SocialActivityAchievement>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_G_UB_F,
				finderArgs, this);
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_UB_F_GROUPID_2);

			query.append(_FINDER_COLUMN_G_UB_F_UNLOCKEDBY_2);

			query.append(_FINDER_COLUMN_G_UB_F_FIRSTUNLOCK_2);
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_G_UB_F,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_G_UB_F,
						finderArgs, list);
				}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityAchievement findByG_UB_F_First(long groupId,
		long unlockedBy, boolean firstUnlock,
		OrderByComparator orderByComparator)
		throws NoSuchActivityAchievementException, SystemException {
		List<SocialActivityAchievement> list = findByG_UB_F(groupId,
				unlockedBy, firstUnlock, 0, 1, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityAchievement findByG_UB_F_Last(long groupId,
		long unlockedBy, boolean firstUnlock,
		OrderByComparator orderByComparator)
		throws NoSuchActivityAchievementException, SystemException {
		int count = countByG_UB_F(groupId, unlockedBy, firstUnlock);

		List<SocialActivityAchievement> list = findByG_UB_F(groupId,
				unlockedBy, firstUnlock, count - 1, count, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivityAchievement[] findByG_UB_F_PrevAndNext(
		long activityAchievementId, long groupId, long unlockedBy,
		boolean firstUnlock, OrderByComparator orderByComparator)
		throws NoSuchActivityAchievementException, SystemException {
		SocialActivityAchievement socialActivityAchievement = findByPrimaryKey(activityAchievementId);
		...
		try {
			...
			array[0] = getByG_UB_F_PrevAndNext(session,
					socialActivityAchievement, groupId, unlockedBy,
					firstUnlock, orderByComparator, true);

			array[1] = socialActivityAchievement;

			array[2] = getByG_UB_F_PrevAndNext(session,
					socialActivityAchievement, groupId, unlockedBy,
					firstUnlock, orderByComparator, false);
	...
	protected SocialActivityAchievement getByG_UB_F_PrevAndNext(
	...
	public void removeByG_UB(long groupId, long unlockedBy)
		throws SystemException {
		for (SocialActivityAchievement socialActivityAchievement : findByG_UB(
				groupId, unlockedBy)) {
			socialActivityAchievementPersistence.remove(socialActivityAchievement);
		}
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByG_N_UB(long groupId, String name, long unlockedBy)
		throws NoSuchActivityAchievementException, SystemException {
		SocialActivityAchievement socialActivityAchievement = findByG_N_UB(groupId,
				name, unlockedBy);
	...
	public void removeByG_UB_F(long groupId, long unlockedBy,
		boolean firstUnlock) throws SystemException {
		for (SocialActivityAchievement socialActivityAchievement : findByG_UB_F(
				groupId, unlockedBy, firstUnlock)) {
			socialActivityAchievementPersistence.remove(socialActivityAchievement);
		}
	}
	...
	public int countByG_F(long groupId, boolean firstUnlock)
		throws SystemException {
		Object[] finderArgs = new Object[] { groupId, firstUnlock };
	...
	public int countByG_UB(long groupId, long unlockedBy)
		throws SystemException {
		Object[] finderArgs = new Object[] { groupId, unlockedBy };

		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_G_UB,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_G_UB,
					finderArgs, count);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int countByG_N_UB(long groupId, String name, long unlockedBy)
		throws SystemException {
		Object[] finderArgs = new Object[] { groupId, name, unlockedBy };

		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_G_N_UB,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_G_N_UB,
					finderArgs, count);
	...
	public int countByG_UB_F(long groupId, long unlockedBy, boolean firstUnlock)
		throws SystemException {
		Object[] finderArgs = new Object[] { groupId, unlockedBy, firstUnlock };

		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_COUNT_BY_G_UB_F,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_G_UB_F,
					finderArgs, count);
	...
	private static final String _FINDER_COLUMN_G_F_FIRSTUNLOCK_2 = "socialActivityAchievement.firstUnlock = ?";
	...
	private static final String _FINDER_COLUMN_G_UB_GROUPID_2 = "socialActivityAchievement.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_UB_UNLOCKEDBY_2 = "socialActivityAchievement.unlockedBy = ?";
	private static final String _FINDER_COLUMN_G_N_UB_GROUPID_2 = "socialActivityAchievement.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_N_UB_NAME_1 = "socialActivityAchievement.name IS NULL AND ";
	private static final String _FINDER_COLUMN_G_N_UB_NAME_2 = "socialActivityAchievement.name = ? AND ";
	private static final String _FINDER_COLUMN_G_N_UB_NAME_3 = "(socialActivityAchievement.name IS NULL OR socialActivityAchievement.name = ?) AND ";
	private static final String _FINDER_COLUMN_G_N_UB_UNLOCKEDBY_2 = "socialActivityAchievement.unlockedBy = ?";
	private static final String _FINDER_COLUMN_G_UB_F_GROUPID_2 = "socialActivityAchievement.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_UB_F_UNLOCKEDBY_2 = "socialActivityAchievement.unlockedBy = ? AND ";
	private static final String _FINDER_COLUMN_G_UB_F_FIRSTUNLOCK_2 = "socialActivityAchievement.firstUnlock = ?";
