...
public class SocialActivityCounterFinderImpl
	...
	SocialActivityCounterFinder.class.getName() + ".findACD_ByG_N_S_E_2";

	public static String FIND_AC_BY_G_N_S_E_3 =
		SocialActivityCounterFinder.class.getName() + ".findACT_ByG_N_S_E_3";

	public static String FIND_U_BY_G_C_N_S_E =
		SocialActivityCounterFinder.class.getName() + ".findU_ByG_C_N_S_E";

	public int countU_ByG_C_N_S_E(long groupId, String[] orderBy)
	...
	public List<SocialActivityCounter> findAC_ByG_N_S_E_3(
			long groupId, String counterName, int startPeriod, int endPeriod)
		throws SystemException {
		...
		try {
			...
			String sql = CustomSQLUtil.get(FIND_AC_BY_G_N_S_E_3);
			SQLQuery q = session.createSQLQuery(sql);
	...
	public List<Long> findU_ByG_C_N_S_E(
