...
public class SocialActivityGroupPersistenceImpl extends BasePersistenceImpl<SocialActivityGroup>
	...
	protected SocialActivityGroup removeImpl(
		...
		try {
			clearSocialActivities.clear(socialActivityGroup.getPrimaryKey());
		}
		catch (Exception e) {
			throw processException(e);
		}
		finally {
			FinderCacheUtil.clearCache(SocialActivityGroupModelImpl.MAPPING_TABLE_SOCIALACTIVITYGROUPS_SOCIALACTIVITIES_NAME);
		}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<com.liferay.portlet.social.model.SocialActivity> getSocialActivities(
		long pk) throws SystemException {
		return getSocialActivities(pk, QueryUtil.ALL_POS, QueryUtil.ALL_POS);
	}
	...
	public List<com.liferay.portlet.social.model.SocialActivity> getSocialActivities(
		...
		return getSocialActivities(pk, start, end, null);
	}

	public static final FinderPath FINDER_PATH_GET_SOCIALACTIVITIES = new FinderPath(com.liferay.portlet.social.model.impl.SocialActivityModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivityGroupModelImpl.FINDER_CACHE_ENABLED_SOCIALACTIVITYGROUPS_SOCIALACTIVITIES,
			com.liferay.portlet.social.model.impl.SocialActivityImpl.class,
			SocialActivityGroupModelImpl.MAPPING_TABLE_SOCIALACTIVITYGROUPS_SOCIALACTIVITIES_NAME,
			"getSocialActivities",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
	...
	static {
		FINDER_PATH_GET_SOCIALACTIVITIES.setCacheKeyGeneratorCacheName(null);
	}
	...
	public List<com.liferay.portlet.social.model.SocialActivity> getSocialActivities(
		...
		List<com.liferay.portlet.social.model.SocialActivity> list = (List<com.liferay.portlet.social.model.SocialActivity>)FinderCacheUtil.getResult(FINDER_PATH_GET_SOCIALACTIVITIES,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (orderByComparator != null) {
					sql = _SQL_GETSOCIALACTIVITIES.concat(ORDER_BY_CLAUSE)
												  .concat(orderByComparator.getOrderBy());
				}
				else {
					sql = _SQL_GETSOCIALACTIVITIES;

					if (pagination) {
						sql = sql.concat(com.liferay.portlet.social.model.impl.SocialActivityModelImpl.ORDER_BY_SQL);
					}
				}

				SQLQuery q = session.createSQLQuery(sql);

				q.addEntity("SocialActivity",
					com.liferay.portlet.social.model.impl.SocialActivityImpl.class);
				...
				if (!pagination) {
					list = (List<com.liferay.portlet.social.model.SocialActivity>)QueryUtil.list(q,
							getDialect(), start, end, false);

					Collections.sort(list);

					list = new UnmodifiableList<com.liferay.portlet.social.model.SocialActivity>(list);
				}
				else {
					list = (List<com.liferay.portlet.social.model.SocialActivity>)QueryUtil.list(q,
							getDialect(), start, end);
				...
				socialActivityPersistence.cacheResult(list);

				FinderCacheUtil.putResult(FINDER_PATH_GET_SOCIALACTIVITIES,
					finderArgs, list);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_GET_SOCIALACTIVITIES,
					finderArgs);
	...
	public static final FinderPath FINDER_PATH_GET_SOCIALACTIVITIES_SIZE = new FinderPath(com.liferay.portlet.social.model.impl.SocialActivityModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivityGroupModelImpl.FINDER_CACHE_ENABLED_SOCIALACTIVITYGROUPS_SOCIALACTIVITIES,
			Long.class,
			SocialActivityGroupModelImpl.MAPPING_TABLE_SOCIALACTIVITYGROUPS_SOCIALACTIVITIES_NAME,
			"getSocialActivitiesSize", new String[] { Long.class.getName() });

	static {
		FINDER_PATH_GET_SOCIALACTIVITIES_SIZE.setCacheKeyGeneratorCacheName(null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSocialActivitiesSize(long pk) throws SystemException {
		Object[] finderArgs = new Object[] { pk };

		Long count = (Long)FinderCacheUtil.getResult(FINDER_PATH_GET_SOCIALACTIVITIES_SIZE,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				SQLQuery q = session.createSQLQuery(_SQL_GETSOCIALACTIVITIESSIZE);
				...
				FinderCacheUtil.putResult(FINDER_PATH_GET_SOCIALACTIVITIES_SIZE,
					finderArgs, count);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_GET_SOCIALACTIVITIES_SIZE,
					finderArgs);
	...
	public static final FinderPath FINDER_PATH_CONTAINS_SOCIALACTIVITY = new FinderPath(com.liferay.portlet.social.model.impl.SocialActivityModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivityGroupModelImpl.FINDER_CACHE_ENABLED_SOCIALACTIVITYGROUPS_SOCIALACTIVITIES,
			Boolean.class,
			SocialActivityGroupModelImpl.MAPPING_TABLE_SOCIALACTIVITYGROUPS_SOCIALACTIVITIES_NAME,
			"containsSocialActivity",
			new String[] { Long.class.getName(), Long.class.getName() });
	...
	public boolean containsSocialActivity(long pk, long socialActivityPK)
		throws SystemException {
		Object[] finderArgs = new Object[] { pk, socialActivityPK };

		Boolean value = (Boolean)FinderCacheUtil.getResult(FINDER_PATH_CONTAINS_SOCIALACTIVITY,
				finderArgs, this);

		if (value == null) {
			try {
				value = Boolean.valueOf(containsSocialActivity.contains(pk,
							socialActivityPK));

				FinderCacheUtil.putResult(FINDER_PATH_CONTAINS_SOCIALACTIVITY,
					finderArgs, value);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_CONTAINS_SOCIALACTIVITY,
					finderArgs);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public boolean containsSocialActivities(long pk) throws SystemException {
		if (getSocialActivitiesSize(pk) > 0) {
			return true;
		}
		else {
			return false;
	...
	public void addSocialActivity(long pk, long socialActivityPK)
		throws SystemException {
		try {
			addSocialActivity.add(pk, socialActivityPK);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	public void addSocialActivity(long pk,
		...
		throws SystemException {
		try {
			addSocialActivity.add(pk, socialActivity.getPrimaryKey());
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	public void addSocialActivities(long pk, long[] socialActivityPKs)
		throws SystemException {
		try {
			for (long socialActivityPK : socialActivityPKs) {
				addSocialActivity.add(pk, socialActivityPK);
			}
		}
		catch (Exception e) {
	...
	public void addSocialActivities(long pk,
		List<com.liferay.portlet.social.model.SocialActivity> socialActivities)
		throws SystemException {
		try {
			for (com.liferay.portlet.social.model.SocialActivity socialActivity : socialActivities) {
				addSocialActivity.add(pk, socialActivity.getPrimaryKey());
			}
		}
		catch (Exception e) {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void clearSocialActivities(long pk) throws SystemException {
		try {
			clearSocialActivities.clear(pk);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	public void removeSocialActivity(long pk, long socialActivityPK)
		throws SystemException {
		try {
			removeSocialActivity.remove(pk, socialActivityPK);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	public void removeSocialActivity(long pk,
		...
		throws SystemException {
		try {
			removeSocialActivity.remove(pk, socialActivity.getPrimaryKey());
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	public void setSocialActivities(long pk, long[] socialActivityPKs)
		throws SystemException {
		try {
			Set<Long> socialActivityPKSet = SetUtil.fromArray(socialActivityPKs);

			List<com.liferay.portlet.social.model.SocialActivity> socialActivities =
				getSocialActivities(pk);

			for (com.liferay.portlet.social.model.SocialActivity socialActivity : socialActivities) {
				if (!socialActivityPKSet.remove(socialActivity.getPrimaryKey())) {
					removeSocialActivity.remove(pk,
						socialActivity.getPrimaryKey());
				}
			}

			for (Long socialActivityPK : socialActivityPKSet) {
				addSocialActivity.add(pk, socialActivityPK);
			}
		}
		catch (Exception e) {
	...
	public void setSocialActivities(long pk,
		...
		throws SystemException {
		try {
			long[] socialActivityPKs = new long[socialActivities.size()];

			for (int i = 0; i < socialActivities.size(); i++) {
				com.liferay.portlet.social.model.SocialActivity socialActivity = socialActivities.get(i);

				socialActivityPKs[i] = socialActivity.getPrimaryKey();
			}

			setSocialActivities(pk, socialActivityPKs);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	public void afterPropertiesSet() {
		...
		containsSocialActivity = new ContainsSocialActivity();

		addSocialActivity = new AddSocialActivity();
		clearSocialActivities = new ClearSocialActivities();
		removeSocialActivity = new RemoveSocialActivity();
	}
	...
	protected ContainsSocialActivity containsSocialActivity;
	protected AddSocialActivity addSocialActivity;
	protected ClearSocialActivities clearSocialActivities;
	protected RemoveSocialActivity removeSocialActivity;

	protected class ContainsSocialActivity {
		protected ContainsSocialActivity() {
			_mappingSqlQuery = MappingSqlQueryFactoryUtil.getMappingSqlQuery(getDataSource(),
					_SQL_CONTAINSSOCIALACTIVITY,
					new int[] { java.sql.Types.BIGINT, java.sql.Types.BIGINT },
					RowMapper.COUNT);
		}

		protected boolean contains(long activityGroupId, long activityId) {
			List<Integer> results = _mappingSqlQuery.execute(new Object[] {
						new Long(activityGroupId), new Long(activityId)
					});
	...
	protected class AddSocialActivity {
		protected AddSocialActivity() {
			_sqlUpdate = SqlUpdateFactoryUtil.getSqlUpdate(getDataSource(),
					"INSERT INTO SocialActivityGroups_SocialActivities (activityGroupId, activityId) VALUES (?, ?)",
					new int[] { java.sql.Types.BIGINT, java.sql.Types.BIGINT });
		}

		protected void add(long activityGroupId, long activityId)
			throws SystemException {
			if (!containsSocialActivity.contains(activityGroupId, activityId)) {
				ModelListener<com.liferay.portlet.social.model.SocialActivity>[] socialActivityListeners =
					socialActivityPersistence.getListeners();

				for (ModelListener<SocialActivityGroup> listener : listeners) {
					listener.onBeforeAddAssociation(activityGroupId,
						com.liferay.portlet.social.model.SocialActivity.class.getName(),
						activityId);
				}

				for (ModelListener<com.liferay.portlet.social.model.SocialActivity> listener : socialActivityListeners) {
					listener.onBeforeAddAssociation(activityId,
						SocialActivityGroup.class.getName(), activityGroupId);
				}
	...
	protected class ClearSocialActivities {
		protected ClearSocialActivities() {
			_sqlUpdate = SqlUpdateFactoryUtil.getSqlUpdate(getDataSource(),
					"DELETE FROM SocialActivityGroups_SocialActivities WHERE activityGroupId = ?",
					new int[] { java.sql.Types.BIGINT });
		}

		protected void clear(long activityGroupId) throws SystemException {
			ModelListener<com.liferay.portlet.social.model.SocialActivity>[] socialActivityListeners =
				socialActivityPersistence.getListeners();
			...
			if ((listeners.length > 0) || (socialActivityListeners.length > 0)) {
				socialActivities = getSocialActivities(activityGroupId);
				...
				for (com.liferay.portlet.social.model.SocialActivity socialActivity : socialActivities) {
					...
					for (ModelListener<com.liferay.portlet.social.model.SocialActivity> listener : socialActivityListeners) {
						listener.onBeforeRemoveAssociation(socialActivity.getPrimaryKey(),
							SocialActivityGroup.class.getName(), activityGroupId);
					}
				}
			}

			_sqlUpdate.update(new Object[] { new Long(activityGroupId) });
			...
			if ((listeners.length > 0) || (socialActivityListeners.length > 0)) {
				for (com.liferay.portlet.social.model.SocialActivity socialActivity : socialActivities) {
					...
					for (ModelListener<com.liferay.portlet.social.model.SocialActivity> listener : socialActivityListeners) {
						listener.onAfterRemoveAssociation(socialActivity.getPrimaryKey(),
							SocialActivityGroup.class.getName(), activityGroupId);
					}
				}
			}
	...
	protected class RemoveSocialActivity {
		protected RemoveSocialActivity() {
			_sqlUpdate = SqlUpdateFactoryUtil.getSqlUpdate(getDataSource(),
					"DELETE FROM SocialActivityGroups_SocialActivities WHERE activityGroupId = ? AND activityId = ?",
					new int[] { java.sql.Types.BIGINT, java.sql.Types.BIGINT });
		}

		protected void remove(long activityGroupId, long activityId)
			throws SystemException {
			if (containsSocialActivity.contains(activityGroupId, activityId)) {
				ModelListener<com.liferay.portlet.social.model.SocialActivity>[] socialActivityListeners =
					socialActivityPersistence.getListeners();
	...
	private static final String _SQL_GETSOCIALACTIVITIES = "SELECT {SocialActivity.*} FROM SocialActivity INNER JOIN SocialActivityGroups_SocialActivities ON (SocialActivityGroups_SocialActivities.activityId = SocialActivity.activityId) WHERE (SocialActivityGroups_SocialActivities.activityGroupId = ?)";
	private static final String _SQL_GETSOCIALACTIVITIESSIZE = "SELECT COUNT(*) AS COUNT_VALUE FROM SocialActivityGroups_SocialActivities WHERE activityGroupId = ?";
	private static final String _SQL_CONTAINSSOCIALACTIVITY = "SELECT COUNT(*) AS COUNT_VALUE FROM SocialActivityGroups_SocialActivities WHERE activityGroupId = ? AND activityId = ?";
