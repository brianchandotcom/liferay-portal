...
public class SocialActivityPersistenceImpl extends BasePersistenceImpl<SocialActivity>
	...
	public List<SocialActivity> findByG_U_C_C_T_R(long groupId, long userId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_U_C_C_T_R_TYPE__2);
	...
	private static final String _FINDER_COLUMN_G_U_C_C_T_R_TYPE__2 = "socialActivity.type_ = ? AND ";
	...
	public SocialActivity fetchByG_U_CD_C_C_T_R(long groupId, long userId,
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_G_U_CD_C_C_T_R_TYPE__2);
	...
	private static final String _FINDER_COLUMN_G_U_CD_C_C_T_R_TYPE__2 = "socialActivity.type_ = ? AND ";
