...
public class SocialActivitySettingPersistenceImpl extends BasePersistenceImpl<SocialActivitySetting>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_G_C_A_N = new FinderPath(SocialActivitySettingModelImpl.ENTITY_CACHE_ENABLED,
			SocialActivitySettingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST, "countByG_C_A_N",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName(), String.class.getName()
			});
	...
	public void cacheResult(SocialActivitySetting socialActivitySetting) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_G_C_A_N,
			new Object[] {
				...
				Integer.valueOf(socialActivitySetting.getActivityKey()),
	...
	protected SocialActivitySetting removeImpl(
		...
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_G_C_A_N,
			new Object[] {
				...
				Integer.valueOf(socialActivitySettingModelImpl.getActivityKey()),
	...
	public SocialActivitySetting updateImpl(
		...
		if (!isNew &&
				((socialActivitySetting.getGroupId() != socialActivitySettingModelImpl.getOriginalGroupId()) ||
				(socialActivitySetting.getClassNameId() != socialActivitySettingModelImpl.getOriginalClassNameId()) ||
				(socialActivitySetting.getActivityKey() != socialActivitySettingModelImpl.getOriginalActivityKey()) ||
				!Validator.equals(socialActivitySetting.getName(),
			...
			FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_G_C_A_N,
				new Object[] {
					...
					Integer.valueOf(
						socialActivitySettingModelImpl.getOriginalActivityKey()),
	...
	protected SocialActivitySetting toUnwrappedModel(
		...
		socialActivitySettingImpl.setActivityKey(socialActivitySetting.getActivityKey());
	...
	/**
	 * Returns all the social activity settings where groupId = &#63; and activityKey = &#63;.
	 *
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SocialActivitySetting> findByG_A(long groupId, int activityKey)
		throws SystemException {
		return findByG_A(groupId, activityKey, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the social activity settings where groupId = &#63; and activityKey = &#63;.
	 *
	 * <p>
	...
	public List<SocialActivitySetting> findByG_A(long groupId, int activityKey,
		...
		return findByG_A(groupId, activityKey, start, end, null);
	}

	/**
	 * Returns an ordered range of all the social activity settings where groupId = &#63; and activityKey = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public List<SocialActivitySetting> findByG_A(long groupId, int activityKey,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_A_ACTIVITYKEY_2);
	...
	/**
	 * Returns the first social activity setting in the ordered set where groupId = &#63; and activityKey = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySetting findByG_A_First(long groupId, int activityKey,
		OrderByComparator orderByComparator)
		throws NoSuchActivitySettingException, SystemException {
		List<SocialActivitySetting> list = findByG_A(groupId, activityKey, 0,
				1, orderByComparator);
	...
	/**
	 * Returns the last social activity setting in the ordered set where groupId = &#63; and activityKey = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SocialActivitySetting findByG_A_Last(long groupId, int activityKey,
		OrderByComparator orderByComparator)
		throws NoSuchActivitySettingException, SystemException {
		int count = countByG_A(groupId, activityKey);

		List<SocialActivitySetting> list = findByG_A(groupId, activityKey,
	...
	/**
	 * Returns the social activity settings before and after the current social activity setting in the ordered set where groupId = &#63; and activityKey = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public SocialActivitySetting[] findByG_A_PrevAndNext(
		long activitySettingId, long groupId, int activityKey,
		OrderByComparator orderByComparator)
		throws NoSuchActivitySettingException, SystemException {
	...
	protected SocialActivitySetting getByG_A_PrevAndNext(Session session,
		...
		int activityKey, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByValues(socialActivitySetting);
	...
	/**
	 * Returns all the social activity settings where groupId = &#63; and classNameId = &#63; and activityKey = &#63;.
	 *
	 * @param groupId the group ID
	...
	public List<SocialActivitySetting> findByG_C_A(long groupId,
		long classNameId, int activityKey) throws SystemException {
		return findByG_C_A(groupId, classNameId, activityKey,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the social activity settings where groupId = &#63; and classNameId = &#63; and activityKey = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 */
	public List<SocialActivitySetting> findByG_C_A(long groupId,
		long classNameId, int activityKey, int start, int end)
		throws SystemException {
		return findByG_C_A(groupId, classNameId, activityKey, start, end, null);
	}

	/**
	 * Returns an ordered range of all the social activity settings where groupId = &#63; and classNameId = &#63; and activityKey = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public List<SocialActivitySetting> findByG_C_A(long groupId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_C_A_ACTIVITYKEY_2);
	...
	/**
	 * Returns the first social activity setting in the ordered set where groupId = &#63; and classNameId = &#63; and activityKey = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public SocialActivitySetting findByG_C_A_First(long groupId,
		long classNameId, int activityKey, OrderByComparator orderByComparator)
		throws NoSuchActivitySettingException, SystemException {
		List<SocialActivitySetting> list = findByG_C_A(groupId, classNameId,
				activityKey, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last social activity setting in the ordered set where groupId = &#63; and classNameId = &#63; and activityKey = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public SocialActivitySetting findByG_C_A_Last(long groupId,
		long classNameId, int activityKey, OrderByComparator orderByComparator)
		throws NoSuchActivitySettingException, SystemException {
		int count = countByG_C_A(groupId, classNameId, activityKey);

		List<SocialActivitySetting> list = findByG_C_A(groupId, classNameId,
				activityKey, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the social activity settings before and after the current social activity setting in the ordered set where groupId = &#63; and classNameId = &#63; and activityKey = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	public SocialActivitySetting[] findByG_C_A_PrevAndNext(
		...
		int activityKey, OrderByComparator orderByComparator)
		throws NoSuchActivitySettingException, SystemException {
		SocialActivitySetting socialActivitySetting = findByPrimaryKey(activitySettingId);
		...
		try {
			...
			array[0] = getByG_C_A_PrevAndNext(session, socialActivitySetting,
					groupId, classNameId, activityKey, orderByComparator, true);

			array[1] = socialActivitySetting;

			array[2] = getByG_C_A_PrevAndNext(session, socialActivitySetting,
					groupId, classNameId, activityKey, orderByComparator, false);
	...
	/**
	 * Returns the social activity setting where groupId = &#63; and classNameId = &#63; and activityKey = &#63; and name = &#63; or throws a {@link com.liferay.portlet.social.NoSuchActivitySettingException} if it could not be found.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param activityKey the activity key
	...
	/**
	 * Returns the social activity setting where groupId = &#63; and classNameId = &#63; and activityKey = &#63; and name = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param activityKey the activity key
	...
	public SocialActivitySetting fetchByG_C_A_N(long groupId, long classNameId,
		int activityKey, String name) throws SystemException {
		return fetchByG_C_A_N(groupId, classNameId, activityKey, name, true);
	}

	/**
	 * Returns the social activity setting where groupId = &#63; and classNameId = &#63; and activityKey = &#63; and name = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param activityKey the activity key
	 ...
	 */
	public SocialActivitySetting fetchByG_C_A_N(long groupId, long classNameId,
		int activityKey, String name, boolean retrieveFromCache)
		throws SystemException {
		Object[] finderArgs = new Object[] {
				groupId, classNameId, activityKey, name
			};
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_G_C_A_N_ACTIVITYKEY_2);
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((socialActivitySetting.getGroupId() != groupId) ||
							...
							(socialActivitySetting.getActivityKey() != activityKey) ||
	...
	/**
	 * Removes all the social activity settings where groupId = &#63; and activityKey = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param activityKey the activity key
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByG_A(long groupId, int activityKey)
		throws SystemException {
	...
	/**
	 * Removes all the social activity settings where groupId = &#63; and classNameId = &#63; and activityKey = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param activityKey the activity key
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByG_C_A(long groupId, long classNameId, int activityKey)
		throws SystemException {
	...
	/**
	 * Removes the social activity setting where groupId = &#63; and classNameId = &#63; and activityKey = &#63; and name = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param activityKey the activity key
	...
	/**
	 * Returns the number of social activity settings where groupId = &#63; and activityKey = &#63;.
	 *
	 * @param groupId the group ID
	 * @param activityKey the activity key
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int countByG_A(long groupId, int activityKey)
		throws SystemException {
		Object[] finderArgs = new Object[] { groupId, activityKey };
	...
	/**
	 * Returns the number of social activity settings where groupId = &#63; and classNameId = &#63; and activityKey = &#63;.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param activityKey the activity key
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int countByG_C_A(long groupId, long classNameId, int activityKey)
		throws SystemException {
		Object[] finderArgs = new Object[] { groupId, classNameId, activityKey };
	...
	/**
	 * Returns the number of social activity settings where groupId = &#63; and classNameId = &#63; and activityKey = &#63; and name = &#63;.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param activityKey the activity key
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int countByG_C_A_N(long groupId, long classNameId, int activityKey,
	...
	private static final String _FINDER_COLUMN_G_A_ACTIVITYKEY_2 = "socialActivitySetting.activityKey = ?";
	...
	private static final String _FINDER_COLUMN_G_C_A_ACTIVITYKEY_2 = "socialActivitySetting.activityKey = ?";
	...
	private static final String _FINDER_COLUMN_G_C_A_N_ACTIVITYKEY_2 = "socialActivitySetting.activityKey = ? AND ";
