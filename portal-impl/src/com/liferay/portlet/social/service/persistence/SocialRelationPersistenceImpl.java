...
public class SocialRelationPersistenceImpl extends BasePersistenceImpl<SocialRelation>
	...
	private static final String _FINDER_COLUMN_UUID_UUID__1 = "socialRelation.uuid_ IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID__2 = "socialRelation.uuid_ = ?";
	private static final String _FINDER_COLUMN_UUID_UUID__3 = "(socialRelation.uuid_ IS NULL OR socialRelation.uuid_ = ?)";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID__1 = "socialRelation.uuid_ IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID__2 = "socialRelation.uuid_ = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID__3 = "(socialRelation.uuid_ IS NULL OR socialRelation.uuid_ = ?) AND ";
	...
	private static final String _FINDER_COLUMN_TYPE_TYPE__2 = "socialRelation.type_ = ?";
	...
	public List<SocialRelation> findByC_T(long companyId, int type, int start,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_C_T_TYPE__2);
	...
	private static final String _FINDER_COLUMN_C_T_TYPE__2 = "socialRelation.type_ = ?";
	...
	public List<SocialRelation> findByU1_T(long userId1, int type, int start,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_U1_T_TYPE__2);
	...
	private static final String _FINDER_COLUMN_U1_T_TYPE__2 = "socialRelation.type_ = ?";
	...
	public List<SocialRelation> findByU2_T(long userId2, int type, int start,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_U2_T_TYPE__2);
	...
	private static final String _FINDER_COLUMN_U2_T_TYPE__2 = "socialRelation.type_ = ?";
	...
	public SocialRelation fetchByU1_U2_T(long userId1, long userId2, int type,
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_U1_U2_T_TYPE__2);
	...
	private static final String _FINDER_COLUMN_U1_U2_T_TYPE__2 = "socialRelation.type_ = ?";
