...
public class SCLicensePersistenceImpl extends BasePersistenceImpl<SCLicense>
	...
	protected SCLicense removeImpl(SCLicense scLicense)
		...
		scLicenseToSCProductEntryTableMapping.deleteMappingsByLeftPrimaryKey(scLicense.getPrimaryKey());
	...
	public List<com.liferay.portlet.softwarecatalog.model.SCProductEntry> getSCProductEntries(
		...
		throws SystemException {
		return scLicenseToSCProductEntryTableMapping.getRightBaseModelsByLeftPrimaryKey(pk,
			start, end, orderByComparator);
	}
	...
	public int getSCProductEntriesSize(long pk) throws SystemException {
		long[] pks = scLicenseToSCProductEntryTableMapping.getRightPrimaryKeysByLeftPrimaryKey(pk);
	...
	public boolean containsSCProductEntry(long pk, long scProductEntryPK)
		throws SystemException {
		return scLicenseToSCProductEntryTableMapping.containsMapping(pk,
			scProductEntryPK);
	}
	...
	public void addSCProductEntry(long pk, long scProductEntryPK)
		throws SystemException {
		scLicenseToSCProductEntryTableMapping.addMapping(pk, scProductEntryPK);
	}
	...
	public void addSCProductEntry(long pk,
		...
		throws SystemException {
		scLicenseToSCProductEntryTableMapping.addMapping(pk,
	...
	public void clearSCProductEntries(long pk) throws SystemException {
		scLicenseToSCProductEntryTableMapping.deleteMappingsByLeftPrimaryKey(pk);
	}
	...
	public void removeSCProductEntry(long pk, long scProductEntryPK)
		throws SystemException {
		scLicenseToSCProductEntryTableMapping.deleteMapping(pk, scProductEntryPK);
	}
	...
	public void removeSCProductEntry(long pk,
		com.liferay.portlet.softwarecatalog.model.SCProductEntry scProductEntry)
		throws SystemException {
		scLicenseToSCProductEntryTableMapping.deleteMapping(pk,
			scProductEntry.getPrimaryKey());
	}
