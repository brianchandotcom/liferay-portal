...
public class SocialActivityAchievementPersistenceTest
	...
	public void testUpdateExisting() throws Exception {
		...
		newSocialActivityAchievement.setUnlockDate(nextDate());

		newSocialActivityAchievement.setUnlockedBy(nextLong());

		newSocialActivityAchievement.setFirstUnlock(randomBoolean());
		...
		assertEquals(Time.getShortTimestamp(
				existingSocialActivityAchievement.getUnlockDate()),
			Time.getShortTimestamp(newSocialActivityAchievement.getUnlockDate()));
		assertEquals(existingSocialActivityAchievement.getUnlockedBy(),
			newSocialActivityAchievement.getUnlockedBy());
		assertEquals(existingSocialActivityAchievement.getFirstUnlock(),
			newSocialActivityAchievement.getFirstUnlock());
	}
	...
	public void testResetOriginalValues() throws Exception {
		...
		assertEquals(existingSocialActivityAchievementModelImpl.getUnlockedBy(),
			existingSocialActivityAchievementModelImpl.getOriginalUnlockedBy());
	}
	...
	protected SocialActivityAchievement addSocialActivityAchievement()
		...
		socialActivityAchievement.setUnlockDate(nextDate());

		socialActivityAchievement.setUnlockedBy(nextLong());

		socialActivityAchievement.setFirstUnlock(randomBoolean());
