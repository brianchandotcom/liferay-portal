...
public class SocialActivityLimitPersistenceTest extends BasePersistenceTestCase {
	...
	public void testUpdateExisting() throws Exception {
		...
		newSocialActivityLimit.setActivityKey(nextInt());

		newSocialActivityLimit.setStatName(randomString());
		...
		assertEquals(existingSocialActivityLimit.getActivityKey(),
			newSocialActivityLimit.getActivityKey());
		assertEquals(existingSocialActivityLimit.getStatName(),
			newSocialActivityLimit.getStatName());
	...
	public void testResetOriginalValues() throws Exception {
		...
		assertEquals(existingSocialActivityLimitModelImpl.getActivityKey(),
			existingSocialActivityLimitModelImpl.getOriginalActivityKey());
		assertTrue(Validator.equals(
				existingSocialActivityLimitModelImpl.getStatName(),
				existingSocialActivityLimitModelImpl.getOriginalStatName()));
	}
	...
	protected SocialActivityLimit addSocialActivityLimit()
		...
		socialActivityLimit.setActivityKey(nextInt());

		socialActivityLimit.setStatName(randomString());
