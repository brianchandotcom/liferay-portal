...
public class SocialActivitySettingPersistenceTest
	...
	public void testUpdateExisting() throws Exception {
		...
		newSocialActivitySetting.setActivityKey(nextInt());
		...
		assertEquals(existingSocialActivitySetting.getActivityKey(),
			newSocialActivitySetting.getActivityKey());
	...
	public void testResetOriginalValues() throws Exception {
		...
		assertEquals(existingSocialActivitySettingModelImpl.getActivityKey(),
			existingSocialActivitySettingModelImpl.getOriginalActivityKey());
	...
	protected SocialActivitySetting addSocialActivitySetting()
		...
		socialActivitySetting.setActivityKey(nextInt());
