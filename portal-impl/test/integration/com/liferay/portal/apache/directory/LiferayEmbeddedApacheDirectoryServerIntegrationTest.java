...
import com.liferay.portal.test.ApacheDirectoryServerExecutionTestListener;
...
@LdapPartitions(
	partitions = {
		"root:dc=example,dc=com:objectClass,ou,uid"
	})
@RunWith(LiferayIntegrationJUnitTestRunner.class)
@Transactional
public class LiferayEmbeddedApacheDirectoryServerIntegrationTest {
	...
	protected void configureLDAPServer() throws Exception {
		...
		sb.append(
			PrefsPropsUtil.getInteger(PropsKeys.LDAP_APACHE_DIRECTORY_PORT));

		properties.put(
			PropsKeys.LDAP_BASE_PROVIDER_URL + postfix, sb.toString());
		properties.put(
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LiferayEmbeddedApacheDirectoryServerIntegrationTest.class);
