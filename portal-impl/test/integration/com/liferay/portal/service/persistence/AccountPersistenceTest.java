...
public class AccountPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newAccount.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingAccount.getOrmVersion(),
			newAccount.getOrmVersion());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("Account_", "accountId",
			...
			"type", true, "size", true, "ormVersion", true);
	}
	...
	protected Account addAccount() throws Exception {
		...
		account.setOrmVersion(ServiceTestUtil.nextLong());
