...
public class BackgroundTaskPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newBackgroundTask.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingBackgroundTask.getOrmVersion(),
			newBackgroundTask.getOrmVersion());
	}
	...
	protected BackgroundTask addBackgroundTask() throws Exception {
		...
		backgroundTask.setOrmVersion(ServiceTestUtil.nextLong());
