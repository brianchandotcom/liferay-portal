...
public class ClusterGroupPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newClusterGroup.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingClusterGroup.getOrmVersion(),
			newClusterGroup.getOrmVersion());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("ClusterGroup",
			...
			"wholeCluster", true, "ormVersion", true);
	}
	...
	protected ClusterGroup addClusterGroup() throws Exception {
		...
		clusterGroup.setOrmVersion(ServiceTestUtil.nextLong());
