...
public class CompanyPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newCompany.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingCompany.getOrmVersion(),
			newCompany.getOrmVersion());
	}
	...
	protected Company addCompany() throws Exception {
		...
		company.setOrmVersion(ServiceTestUtil.nextLong());
