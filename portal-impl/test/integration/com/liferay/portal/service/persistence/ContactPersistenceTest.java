...
public class ContactPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newContact.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingContact.getOrmVersion(),
			newContact.getOrmVersion());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("Contact_", "contactId",
			...
			"jobClass", true, "hoursOfOperation", true, "ormVersion", true);
	}
	...
	protected Contact addContact() throws Exception {
		...
		contact.setOrmVersion(ServiceTestUtil.nextLong());
