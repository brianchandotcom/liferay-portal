...
public class CountryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newCountry.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingCountry.getOrmVersion(),
			newCountry.getOrmVersion());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("Country", "countryId",
			...
			true, "zipRequired", true, "active", true, "ormVersion", true);
	}
	...
	protected Country addCountry() throws Exception {
		...
		country.setOrmVersion(ServiceTestUtil.nextLong());
