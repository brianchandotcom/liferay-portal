...
public class EmailAddressPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newEmailAddress.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingEmailAddress.getOrmVersion(),
			newEmailAddress.getOrmVersion());
	}
	...
	protected EmailAddress addEmailAddress() throws Exception {
		...
		emailAddress.setOrmVersion(ServiceTestUtil.nextLong());
