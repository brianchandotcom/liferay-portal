...
public class GroupPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newGroup.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingGroup.getOrmVersion(),
			newGroup.getOrmVersion());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("Group_", "uuid", true,
			...
			"remoteStagingGroupCount", true, "active", true, "ormVersion", true);
	}
	...
	protected Group addGroup() throws Exception {
		...
		group.setOrmVersion(ServiceTestUtil.nextLong());
