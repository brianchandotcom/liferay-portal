...
public class ImagePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newImage.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingImage.getOrmVersion(),
			newImage.getOrmVersion());
	}
	...
	protected Image addImage() throws Exception {
		...
		image.setOrmVersion(ServiceTestUtil.nextLong());
