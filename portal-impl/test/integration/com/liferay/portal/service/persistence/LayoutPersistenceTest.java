...
public class LayoutPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newLayout.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingLayout.getOrmVersion(),
			newLayout.getOrmVersion());
	}
	...
	protected Layout addLayout() throws Exception {
		...
		layout.setOrmVersion(ServiceTestUtil.nextLong());
