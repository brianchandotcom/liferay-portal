...
public class LayoutSetBranchPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newLayoutSetBranch.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingLayoutSetBranch.getOrmVersion(),
			newLayoutSetBranch.getOrmVersion());
	}
	...
	protected LayoutSetBranch addLayoutSetBranch() throws Exception {
		...
		layoutSetBranch.setOrmVersion(ServiceTestUtil.nextLong());
