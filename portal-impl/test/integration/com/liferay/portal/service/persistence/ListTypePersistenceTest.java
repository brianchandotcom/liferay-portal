...
public class ListTypePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newListType.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingListType.getOrmVersion(),
			newListType.getOrmVersion());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("ListType", "listTypeId",
			true, "name", true, "type", true, "ormVersion", true);
	}
	...
	protected ListType addListType() throws Exception {
		...
		listType.setOrmVersion(ServiceTestUtil.nextLong());
