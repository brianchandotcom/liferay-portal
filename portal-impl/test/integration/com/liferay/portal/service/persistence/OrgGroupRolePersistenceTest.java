...
public class OrgGroupRolePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newOrgGroupRole.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingOrgGroupRole.getOrmVersion(),
			newOrgGroupRole.getOrmVersion());
	}
	...
	protected OrgGroupRole addOrgGroupRole() throws Exception {
		...
		orgGroupRole.setOrmVersion(ServiceTestUtil.nextLong());
