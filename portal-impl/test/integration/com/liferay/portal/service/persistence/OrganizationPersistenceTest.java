...
public class OrganizationPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newOrganization.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingOrganization.getOrmVersion(),
			newOrganization.getOrmVersion());
	}
	...
	protected Organization addOrganization() throws Exception {
		...
		organization.setOrmVersion(ServiceTestUtil.nextLong());
