...
public class PasswordPolicyPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newPasswordPolicy.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingPasswordPolicy.getOrmVersion(),
			newPasswordPolicy.getOrmVersion());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("PasswordPolicy", "uuid",
			...
			"resetTicketMaxAge", true, "ormVersion", true);
	}
	...
	protected PasswordPolicy addPasswordPolicy() throws Exception {
		...
		passwordPolicy.setOrmVersion(ServiceTestUtil.nextLong());
