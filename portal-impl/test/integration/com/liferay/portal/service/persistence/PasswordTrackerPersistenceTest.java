...
public class PasswordTrackerPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newPasswordTracker.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingPasswordTracker.getOrmVersion(),
			newPasswordTracker.getOrmVersion());
	}
	...
	protected PasswordTracker addPasswordTracker() throws Exception {
		...
		passwordTracker.setOrmVersion(ServiceTestUtil.nextLong());
