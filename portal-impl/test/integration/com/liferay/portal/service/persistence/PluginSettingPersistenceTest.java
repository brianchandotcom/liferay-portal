...
public class PluginSettingPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newPluginSetting.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingPluginSetting.getOrmVersion(),
			newPluginSetting.getOrmVersion());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("PluginSetting",
			...
			"pluginType", true, "roles", true, "active", true, "ormVersion",
			true);
	}
	...
	protected PluginSetting addPluginSetting() throws Exception {
		...
		pluginSetting.setOrmVersion(ServiceTestUtil.nextLong());
