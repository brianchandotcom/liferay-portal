...
public class PortletItemPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newPortletItem.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingPortletItem.getOrmVersion(),
			newPortletItem.getOrmVersion());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("PortletItem",
			...
			"classNameId", true, "ormVersion", true);
	}
	...
	protected PortletItem addPortletItem() throws Exception {
		...
		portletItem.setOrmVersion(ServiceTestUtil.nextLong());
