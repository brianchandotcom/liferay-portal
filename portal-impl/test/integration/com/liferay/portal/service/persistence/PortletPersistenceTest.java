...
public class PortletPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newPortlet.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingPortlet.getOrmVersion(),
			newPortlet.getOrmVersion());
	}
	...
	protected Portlet addPortlet() throws Exception {
		...
		portlet.setOrmVersion(ServiceTestUtil.nextLong());
