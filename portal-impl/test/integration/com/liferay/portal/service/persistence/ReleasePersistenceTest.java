...
public class ReleasePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newRelease.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingRelease.getOrmVersion(),
			newRelease.getOrmVersion());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("Release_", "releaseId",
			...
			"verified", true, "state", true, "testString", true, "ormVersion",
			true);
	}
	...
	protected Release addRelease() throws Exception {
		...
		release.setOrmVersion(ServiceTestUtil.nextLong());
