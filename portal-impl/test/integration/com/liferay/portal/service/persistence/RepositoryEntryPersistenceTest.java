...
public class RepositoryEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newRepositoryEntry.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingRepositoryEntry.getOrmVersion(),
			newRepositoryEntry.getOrmVersion());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("RepositoryEntry", "uuid",
			...
			"manualCheckInRequired", true, "ormVersion", true);
	}
	...
	protected RepositoryEntry addRepositoryEntry() throws Exception {
		...
		repositoryEntry.setOrmVersion(ServiceTestUtil.nextLong());
