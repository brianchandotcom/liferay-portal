...
public class RepositoryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newRepository.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingRepository.getOrmVersion(),
			newRepository.getOrmVersion());
	}
	...
	protected Repository addRepository() throws Exception {
		...
		repository.setOrmVersion(ServiceTestUtil.nextLong());
