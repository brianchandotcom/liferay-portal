...
public class ResourceBlockPermissionPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newResourceBlockPermission.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingResourceBlockPermission.getOrmVersion(),
			newResourceBlockPermission.getOrmVersion());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("ResourceBlockPermission",
			...
			"roleId", true, "actionIds", true, "ormVersion", true);
	}
	...
	protected ResourceBlockPermission addResourceBlockPermission()
		...
		resourceBlockPermission.setOrmVersion(ServiceTestUtil.nextLong());
