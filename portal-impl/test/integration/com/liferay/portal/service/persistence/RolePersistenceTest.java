...
public class RolePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newRole.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingRole.getOrmVersion(),
			newRole.getOrmVersion());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("Role_", "uuid", true,
			...
			true, "type", true, "subtype", true, "ormVersion", true);
	}
	...
	protected Role addRole() throws Exception {
		...
		role.setOrmVersion(ServiceTestUtil.nextLong());
