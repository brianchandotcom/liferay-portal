...
public class ShardPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newShard.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingShard.getOrmVersion(),
			newShard.getOrmVersion());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("Shard", "shardId", true,
			"classNameId", true, "classPK", true, "name", true, "ormVersion",
			true);
	}
	...
	protected Shard addShard() throws Exception {
		...
		shard.setOrmVersion(ServiceTestUtil.nextLong());
