...
public class SystemEventPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newSystemEvent.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingSystemEvent.getOrmVersion(),
			newSystemEvent.getOrmVersion());
	}
	...
	protected SystemEvent addSystemEvent() throws Exception {
		...
		systemEvent.setOrmVersion(ServiceTestUtil.nextLong());
