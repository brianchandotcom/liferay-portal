...
public class UserGroupRolePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newUserGroupRole.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingUserGroupRole.getOrmVersion(),
			newUserGroupRole.getOrmVersion());
	}
	...
	protected UserGroupRole addUserGroupRole() throws Exception {
		...
		userGroupRole.setOrmVersion(ServiceTestUtil.nextLong());
