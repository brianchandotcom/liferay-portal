...
public class UserNotificationDeliveryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newUserNotificationDelivery.setUuid(ServiceTestUtil.randomString());
		...
		Assert.assertEquals(existingUserNotificationDelivery.getUuid(),
			newUserNotificationDelivery.getUuid());
		Assert.assertEquals(existingUserNotificationDelivery.getDeliveryId(),
			newUserNotificationDelivery.getDeliveryId());
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("UserNotificationDelivery",
			"uuid", true, "deliveryId", true, "companyId", true, "userId",
	...
	public void testDynamicQueryByProjectionExisting()
		...
		Object newDeliveryId = newUserNotificationDelivery.getDeliveryId();
	...
	protected UserNotificationDelivery addUserNotificationDelivery()
		...
		userNotificationDelivery.setUuid(ServiceTestUtil.randomString());
