...
public class UserNotificationDeliveryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newUserNotificationDelivery.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingUserNotificationDelivery.getOrmVersion(),
			newUserNotificationDelivery.getOrmVersion());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("UserNotificationDelivery",
			...
			true, "deliveryType", true, "deliver", true, "ormVersion", true);
	}
	...
	protected UserNotificationDelivery addUserNotificationDelivery()
		...
		userNotificationDelivery.setOrmVersion(ServiceTestUtil.nextLong());
