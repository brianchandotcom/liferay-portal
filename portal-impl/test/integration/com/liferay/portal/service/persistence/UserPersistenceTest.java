...
public class UserPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newUser.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingUser.getOrmVersion(),
			newUser.getOrmVersion());
	}
	...
	protected User addUser() throws Exception {
		...
		user.setOrmVersion(ServiceTestUtil.nextLong());
