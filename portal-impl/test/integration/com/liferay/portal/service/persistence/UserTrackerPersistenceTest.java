...
public class UserTrackerPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newUserTracker.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingUserTracker.getOrmVersion(),
			newUserTracker.getOrmVersion());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("UserTracker",
			...
			"remoteHost", true, "userAgent", true, "ormVersion", true);
	}
	...
	protected UserTracker addUserTracker() throws Exception {
		...
		userTracker.setOrmVersion(ServiceTestUtil.nextLong());
