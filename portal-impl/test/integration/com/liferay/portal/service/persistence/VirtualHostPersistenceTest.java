...
public class VirtualHostPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newVirtualHost.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingVirtualHost.getOrmVersion(),
			newVirtualHost.getOrmVersion());
	}
	...
	protected VirtualHost addVirtualHost() throws Exception {
		...
		virtualHost.setOrmVersion(ServiceTestUtil.nextLong());
