...
public class WorkflowDefinitionLinkPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newWorkflowDefinitionLink.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingWorkflowDefinitionLink.getOrmVersion(),
			newWorkflowDefinitionLink.getOrmVersion());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("WorkflowDefinitionLink",
			...
			"workflowDefinitionVersion", true, "ormVersion", true);
	}
	...
	protected WorkflowDefinitionLink addWorkflowDefinitionLink()
		...
		workflowDefinitionLink.setOrmVersion(ServiceTestUtil.nextLong());
