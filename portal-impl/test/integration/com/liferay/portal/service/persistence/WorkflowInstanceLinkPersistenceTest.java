...
public class WorkflowInstanceLinkPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newWorkflowInstanceLink.setOrmVersion(ServiceTestUtil.nextLong());
		...
		Assert.assertEquals(existingWorkflowInstanceLink.getOrmVersion(),
			newWorkflowInstanceLink.getOrmVersion());
	}
	...
	protected OrderByComparator getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("WorkflowInstanceLink",
			...
			"workflowInstanceId", true, "ormVersion", true);
	}
	...
	protected WorkflowInstanceLink addWorkflowInstanceLink()
		...
		workflowInstanceLink.setOrmVersion(ServiceTestUtil.nextLong());
