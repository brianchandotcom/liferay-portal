...
public class JournalArticleStagedModelDataHandlerTest
	...
	protected void validateDeletion(
		...
		Assert.assertNull(
			DDMStructure.class.getName() + " was not deleted", ddmStructure);
		...
		Assert.assertNull(
			DDMTemplate.class.getName() + " was not deleted", ddmTemplate);
		...
		Assert.assertNull(
			JournalFolder.class.getName() + " was not deleted", folder);
	}
