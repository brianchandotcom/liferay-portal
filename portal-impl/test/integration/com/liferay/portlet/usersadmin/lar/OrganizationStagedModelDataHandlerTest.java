...
public class OrganizationStagedModelDataHandlerTest
	...
	protected void validateDeletion(
		...
		Assert.assertNull(
			Organization.class + " was not deleted", suborganization);
		...
		Assert.assertNull(Address.class + " was not deleted", address);
		...
		Assert.assertNull(
			EmailAddress.class + " was not deleted", emailAddress);
		...
		Assert.assertNull(Phone.class + " was not deleted", phone);
		...
		Assert.assertNull(Website.class + " was not deleted", website);
	}
