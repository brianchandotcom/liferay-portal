...
public class BaseAsyncDatagramReceiveHandlerTest {
	...
	@Test
	public void testErroeDispatch() throws Exception {
		...
		Assert.assertEquals("Dispatch Error", logRecord.getMessage());
		Assert.assertEquals(Exception.class, logRecord.getThrown().getClass());
	...
	@AdviseWith(adviceClasses = {PortalExecutorManagerUtilAdvice.class})
	@Test
	public void testNormalDispatch() throws Exception {
	...
	public static class DummyAsyncDatagramReceiveHandler
	...
	public static class ErrorAsyncDatagramReceiveHandler
		extends BaseAsyncDatagramReceiveHandler {
