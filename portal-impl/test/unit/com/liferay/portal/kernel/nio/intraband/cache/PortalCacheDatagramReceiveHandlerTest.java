...
public class PortalCacheDatagramReceiveHandlerTest {
	...
	@Before
	public void setUp() {
		_mockPortalCacheManager = new MockPortalCacheManager();
	...
	public void testDestroy() throws Exception {
		...
		Datagram datagram = Datagram.createRequestDatagram(
			SystemDataType.PORTAL_CACHE.getValue(), serializer.toByteBuffer());
		...
		MockPortalCache mockPortalCache =
			(MockPortalCache)IntraBandPortalCacheManager.
				<String, String>getPortalCacheManager().getCache(_testName);
