...
import com.liferay.portal.resiliency.spi.agent.AgentRequest.AgentHttpServletRequestWrapper;
...
public class AgentRequestTest {
	...
	public static void setUpClass() throws Exception {
		...
		threadLocalDistributor.setThreadLocalSources(
			Arrays.asList(
				new KeyValuePair(
					AgentRequestTest.class.getName(), "_threadLocal")));
	...
	public void testContentTypeIsMultipart() {
		...
		HttpServletRequest populateHttpServletRequest =
			agentRequest.populateRequest(new MockHttpServletRequest());
		...
		populateHttpServletRequest = agentRequest.populateRequest(
	...
	public void testContentTypeIsNotMultipart() throws Exception {
		...
		new AgentRequest(uploadServletRequestImpl);
	}
	...
	public void testContentTypeIsNull() throws Exception {
		...
		AgentRequest agentRequest = new AgentRequest(_mockHttpServletRequest);
		...
		agentRequest.populateSessionAttributes(mockHttpSession);
		...
		sb.append(agentRequest.distributedRequestAttributes);
		sb.append(", _headerMap=");
		sb.append(agentRequest.headerMap);
		sb.append(", _multipartParameterMap=null");
		sb.append(", originalSessionAttributes=");
		sb.append(agentRequest.getOriginalSessionAttributes());
		...
		Assert.assertEquals(sb.toString(), agentRequest.toString());

		_mockHttpServletRequest.setCookies(null);

		agentRequest = new AgentRequest(_mockHttpServletRequest);
