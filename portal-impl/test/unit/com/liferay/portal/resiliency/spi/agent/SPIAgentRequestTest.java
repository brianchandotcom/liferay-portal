...
public class SPIAgentRequestTest {
	...
	public void testFooterControl() {
		...
		_mockHttpServletRequest.setParameter("prpsf", StringPool.TRUE);
		...
		Assert.assertArrayEquals(
			new String[] {StringPool.TRUE}, parameterMap.get("prpsf"));
		...
		Assert.assertArrayEquals(
			new String[] {StringPool.FALSE}, parameterMap.get("prpsf"));
	}
