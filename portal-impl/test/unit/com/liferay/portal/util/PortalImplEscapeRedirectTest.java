	...
	public void testEscapeRedirectWithIPs() throws Exception {
		...
		try {
			...
			Assert.assertEquals(
				...
				_portalImpl.escapeRedirect("http://0177.0000.0000.0001"));

			Assert.assertEquals(
				"http://0x7F000001",
				_portalImpl.escapeRedirect("http://0x7F000001"));

			Assert.assertEquals(
				"http://2130706433",
				_portalImpl.escapeRedirect("http://2130706433"));
			...
			Assert.assertNull(_portalImpl.escapeRedirect("127.127.127.127"));
		}
		finally {
