 ...
 * @deprecated As of com.liferay.portal.kernel#2.19.0, with a replacement. Theme
 *             developers must eventually switch from using Velocity  templates
 *             that leverage this taglib wrapper mechanism, to using FreeMarker
