 ...
 * @author Sam Ziemer
 */
public class InterceptorLogWrapper extends SanitizerLogWrapper {

	public static boolean isEnabled() {
		return _LOG_INTERCEPTOR_ENABLED;
	}

	public InterceptorLogWrapper(Log log, String name) {
		super(log);

		_className = name;

		setLogWrapperClassName(InterceptorLogWrapper.class.getName());
	}
