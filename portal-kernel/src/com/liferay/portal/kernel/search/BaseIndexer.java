...
public abstract class BaseIndexer<T> implements Indexer<T> {
	...
	/**
	 * @deprecated As of 2.18.0, replaced by {@link #getSearchClassNames}
	 */
	@Deprecated
	@Override
	...
	/**
	 * @deprecated As of 2.18.0, replaced by {@link #getClassName}
	 */
	@Deprecated
	@Override
	...
	/**
	 * @deprecated As of 2.18.0, replaced by {@link #getSummary(Document, String,
	...
	/**
	 * @deprecated As of 2.18.0, added strictly to support backwards
