...
public class BooleanClauseFactoryUtil {
	...
	/**
	 * @deprecated As of 2.19.0, replaced by {@link create(Query, String)}
	 */
	@Deprecated
	...
	/**
	 * @deprecated As of 2.19.0, replaced by {@link create(String, String,
	 *             String)}
	 */
	@Deprecated
	public static BooleanClause<Query> create(
	...
	/**
	 * @deprecated As of 2.19.0, replaced by {@link getBooleanClauseFactory()}
	 */
	@Deprecated
	public static BooleanClauseFactory getBooleanClauseFactory(
