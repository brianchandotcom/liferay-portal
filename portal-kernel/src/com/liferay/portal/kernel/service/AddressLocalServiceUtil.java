...
public class AddressLocalServiceUtil {
	...
	public static void deleteAddressesByCountry(long countryId)
		throws com.liferay.portal.kernel.exception.PortalException {

		getService().deleteAddressesByCountry(countryId);
	}

	public static void deleteAddressesByRegion(long regionId)
		throws com.liferay.portal.kernel.exception.PortalException {

		getService().deleteAddressesByRegion(regionId);
	}
