...
public class GroupUtil {
	...
	* @return the matching groups
	*/
	public static List<Group> findByC_P_N_S(long companyId, long parentGroupId,
		String name, boolean site) {
		return getPersistence()
				   .findByC_P_N_S(companyId, parentGroupId, name, site);
	}
	...
	*/
	public static List<Group> findByC_P_N_S(long companyId, long parentGroupId,
		...
		return getPersistence()
				   .findByC_P_N_S(companyId, parentGroupId, name, site, start,
			end);
	}
	...
	* @throws NoSuchGroupException if a matching group could not be found
	*/
	public static Group findByC_P_N_S_First(long companyId, long parentGroupId,
		String name, boolean site, OrderByComparator<Group> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchGroupException {
		return getPersistence()
				   .findByC_P_N_S_First(companyId, parentGroupId, name, site,
			orderByComparator);
	}
	...
	* @return the first matching group, or <code>null</code> if a matching group could not be found
	*/
	public static Group fetchByC_P_N_S_First(long companyId,
		long parentGroupId, String name, boolean site,
		OrderByComparator<Group> orderByComparator) {
		return getPersistence()
				   .fetchByC_P_N_S_First(companyId, parentGroupId, name, site,
			orderByComparator);
	}
	...
	* @throws NoSuchGroupException if a matching group could not be found
	*/
	public static Group findByC_P_N_S_Last(long companyId, long parentGroupId,
		String name, boolean site, OrderByComparator<Group> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchGroupException {
		return getPersistence()
				   .findByC_P_N_S_Last(companyId, parentGroupId, name, site,
			orderByComparator);
	}
	...
	* @return the last matching group, or <code>null</code> if a matching group could not be found
	*/
	public static Group fetchByC_P_N_S_Last(long companyId, long parentGroupId,
		String name, boolean site, OrderByComparator<Group> orderByComparator) {
		return getPersistence()
				   .fetchByC_P_N_S_Last(companyId, parentGroupId, name, site,
			orderByComparator);
	}
	...
	* @throws NoSuchGroupException if a group with the primary key could not be found
	*/
	public static Group[] findByC_P_N_S_PrevAndNext(long groupId,
		long companyId, long parentGroupId, String name, boolean site,
		OrderByComparator<Group> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchGroupException {
		return getPersistence()
				   .findByC_P_N_S_PrevAndNext(groupId, companyId,
	...
	* @param site the site
	*/
	public static void removeByC_P_N_S(long companyId, long parentGroupId,
		String name, boolean site) {
		getPersistence().removeByC_P_N_S(companyId, parentGroupId, name, site);
	}
	...
	* @return the number of matching groups
	*/
	public static int countByC_P_N_S(long companyId, long parentGroupId,
		String name, boolean site) {
		return getPersistence()
				   .countByC_P_N_S(companyId, parentGroupId, name, site);
	}
