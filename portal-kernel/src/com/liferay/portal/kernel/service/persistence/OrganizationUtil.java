...
public class OrganizationUtil {
	...
	* @return the matching organizations
	*/
	public static List<Organization> findByC_P_N(long companyId,
		long parentOrganizationId, String name) {
		return getPersistence()
				   .findByC_P_N(companyId, parentOrganizationId, name);
	}
	...
	*/
	public static List<Organization> findByC_P_N(long companyId,
		...
		return getPersistence()
				   .findByC_P_N(companyId, parentOrganizationId, name, start,
			end);
	}
	...
	* @throws NoSuchOrganizationException if a matching organization could not be found
	*/
	public static Organization findByC_P_N_First(long companyId,
		long parentOrganizationId, String name,
		OrderByComparator<Organization> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchOrganizationException {
		return getPersistence()
				   .findByC_P_N_First(companyId, parentOrganizationId, name,
			orderByComparator);
	}
	...
	* @return the first matching organization, or <code>null</code> if a matching organization could not be found
	*/
	public static Organization fetchByC_P_N_First(long companyId,
		long parentOrganizationId, String name,
		OrderByComparator<Organization> orderByComparator) {
		return getPersistence()
				   .fetchByC_P_N_First(companyId, parentOrganizationId, name,
			orderByComparator);
	}
	...
	* @throws NoSuchOrganizationException if a matching organization could not be found
	*/
	public static Organization findByC_P_N_Last(long companyId,
		long parentOrganizationId, String name,
		OrderByComparator<Organization> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchOrganizationException {
		return getPersistence()
				   .findByC_P_N_Last(companyId, parentOrganizationId, name,
			orderByComparator);
	}
	...
	* @return the last matching organization, or <code>null</code> if a matching organization could not be found
	*/
	public static Organization fetchByC_P_N_Last(long companyId,
		long parentOrganizationId, String name,
		OrderByComparator<Organization> orderByComparator) {
		return getPersistence()
				   .fetchByC_P_N_Last(companyId, parentOrganizationId, name,
			orderByComparator);
	}
	...
	* @throws NoSuchOrganizationException if a organization with the primary key could not be found
	*/
	public static Organization[] findByC_P_N_PrevAndNext(long organizationId,
		long companyId, long parentOrganizationId, String name,
		OrderByComparator<Organization> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchOrganizationException {
		return getPersistence()
				   .findByC_P_N_PrevAndNext(organizationId, companyId,
	...
	* @return the matching organizations that the user has permission to view
	*/
	public static List<Organization> filterFindByC_P_N(long companyId,
		long parentOrganizationId, String name) {
		return getPersistence()
				   .filterFindByC_P_N(companyId, parentOrganizationId, name);
	}
	...
	* @throws NoSuchOrganizationException if a organization with the primary key could not be found
	*/
	public static Organization[] filterFindByC_P_N_PrevAndNext(
		long organizationId, long companyId, long parentOrganizationId,
		String name, OrderByComparator<Organization> orderByComparator)
		throws com.liferay.portal.kernel.exception.NoSuchOrganizationException {
		return getPersistence()
				   .filterFindByC_P_N_PrevAndNext(organizationId, companyId,
			parentOrganizationId, name, orderByComparator);
	}
	...
	* @param name the name
	*/
	public static void removeByC_P_N(long companyId, long parentOrganizationId,
		String name) {
		getPersistence().removeByC_P_N(companyId, parentOrganizationId, name);
	}
	...
	* @return the number of matching organizations
	*/
	public static int countByC_P_N(long companyId, long parentOrganizationId,
		String name) {
		return getPersistence()
				   .countByC_P_N(companyId, parentOrganizationId, name);
	}
	...
	* @return the number of matching organizations that the user has permission to view
	*/
	public static int filterCountByC_P_N(long companyId,
		long parentOrganizationId, String name) {
		return getPersistence()
				   .filterCountByC_P_N(companyId, parentOrganizationId, name);
	}
