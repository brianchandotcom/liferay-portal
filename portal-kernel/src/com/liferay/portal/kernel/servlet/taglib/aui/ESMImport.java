...
public final class ESMImport {
	 ...
	 * @review
	 */
	public ESMImport(String symbol, String module) {
	 ...
	 * @review
	 */
	public ESMImport(String symbol, String alias, String module) {
		_symbol = symbol;
		_alias = alias;
		_module = module;
	}
	...
	/**
	 * The semantics for the equality of two {@link ESMImport} objects are that
	...
	public boolean equals(Object object) {
		...
		ESMImport esmImport = (ESMImport)object;

		if (_module.equals(esmImport._module) &&
			_symbol.equals(esmImport._symbol)) {
