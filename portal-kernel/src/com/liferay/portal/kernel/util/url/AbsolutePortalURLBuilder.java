...
package com.liferay.portal.kernel.util.url;
...
public interface AbsolutePortalURLBuilder {
	 ...
	 * live in {@link Portal#getPathImage()}.
	 ...
	 * resources live in {@link Portal#getPathMain()}.
	 ...
	 * resources live in {@link Portal#getPathModule()}.
	 * @param relativeURL the relative URL of the resource
	 ...
	 * @see Portal#getCDNHost(HttpServletRequest)
	 * @review
	 */
