...
public class PortalCacheProvider {
	...
	public static PortalCacheManager<? extends Serializable, ?>
		getPortalCacheManager(String cacheManagerName) {

		return _portalCacheManagers.get(cacheManagerName);
	}
	...
	public static void unregisterPortalCacheManager(String cacheManagerName) {
		_portalCacheManagers.remove(cacheManagerName);
	}
