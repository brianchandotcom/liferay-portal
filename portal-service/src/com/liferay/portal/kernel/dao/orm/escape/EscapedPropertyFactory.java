 ...
 * @author Shuyang Zhou
 */
public class EscapedPropertyFactory implements PropertyFactory {

	public EscapedPropertyFactory(PropertyFactory propertyFactory) {
	...
	public Property forName(String propertyName) {
		...
		return _propertyFactory.forName(propertyName);
	}
