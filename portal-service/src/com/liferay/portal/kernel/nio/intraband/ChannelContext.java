...
public class ChannelContext {
	...
	// All non-final fields are non-threadsafe fields. They depend on external
	// logic to do thread safe publication, after that these fields must be
	// accessed sololy by polling threads to remain thread safety.
