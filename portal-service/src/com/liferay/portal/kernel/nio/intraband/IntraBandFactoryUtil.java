...
public class IntraBandFactoryUtil {
	...
	public static IntraBand createIntraBand() throws IOException {
		if (Validator.isNotNull(_INTRABAND_IMPL_CLASS)) {
			try {
				Class<? extends IntraBand> intraBandClass =
					(Class<? extends IntraBand>)Class.forName(
						_INTRABAND_IMPL_CLASS);
	...
	private static final String _INTRABAND_IMPL_CLASS = GetterUtil.getString(
