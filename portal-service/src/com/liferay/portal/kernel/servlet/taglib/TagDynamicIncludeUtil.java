...
public class TagDynamicIncludeUtil {
	...
	public static List<TagDynamicInclude> getDynamicIncludes(
		String tagClassName, String tagId, String tagPoint) {

		String key = _getKey(tagClassName, tagId, tagPoint);
		...
		while (iterator.hasNext()) {
			...
			try {
				dynamicInclude.include(
					request, response, tagClassName, tagId, tagPoint);
			}
			catch (Exception e) {
				_log.error(e, e);
			}
						...
						tagDynamicInclude.register(
							new TagDynamicInclude.TagItemRegistry() {
								...
								public void register(
									String tagClassName, String tagId,
									String tagPoint) {
