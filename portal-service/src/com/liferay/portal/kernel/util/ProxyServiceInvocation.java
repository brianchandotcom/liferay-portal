...
public class ProxyServiceInvocation {
	...
	public static <T> T newInstance(Class<T> managerService) {
		return (T)ProxyUtil.newProxyInstance(
			managerService.getClassLoader(), managerService.getInterfaces(),
			new ManagerInvocationHandler<T>(managerService));
	}
