...
public interface UserNotificationDeliveryModel extends BaseModel<UserNotificationDelivery> {
	...
	/**
	 * Returns the uuid of this user notification delivery.
	 *
	 * @return the uuid of this user notification delivery
	 */
	@AutoEscape
	public String getUuid();

	/**
	 * Sets the uuid of this user notification delivery.
	 *
	 * @param uuid the uuid of this user notification delivery
	 */
	public void setUuid(String uuid);

	/**
	 * Returns the delivery ID of this user notification delivery.
	 *
	 * @return the delivery ID of this user notification delivery
	 */
	public long getDeliveryId();

	/**
	 * Sets the delivery ID of this user notification delivery.
	 *
	 * @param deliveryId the delivery ID of this user notification delivery
	 */
