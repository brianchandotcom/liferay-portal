...
public class ExportImportConfigurationLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.portal.model.ExportImportConfiguration addConfiguration(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .addConfiguration(userId, groupId, name, description, type,
			settingsMap, serviceContext);
	}

	public static void deleteGroupConfigurations(long groupId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteGroupConfigurations(groupId);
	}

	public static com.liferay.portal.model.ExportImportConfiguration getConfiguration(
	...
	public static java.util.List<com.liferay.portal.model.ExportImportConfiguration> getConfigurations(
		long groupId, int type)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getConfigurations(groupId, type);
	}
	...
	public static java.util.List<com.liferay.portal.model.ExportImportConfiguration> getConfigurations(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .getConfigurations(groupId, type, start, end,
			orderByComparator);
	}

	public static int getConfigurationsCount(long groupId, int type)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getConfigurationsCount(groupId, type);
	}

	public static com.liferay.portal.model.ExportImportConfiguration updateConfiguration(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateConfiguration(configurationId, name, description,
			settingsMap, serviceContext);
	}
