...
public interface ResourceLocalService extends BaseLocalService {
	...
	* permissions are to be added, then only the model's default permissions
	* are added. See {@link
	* com.liferay.portal.service.ServiceContext#setAddGroupPermissions(
	* boolean)} and {@link
	...
	*/
	...
	/**
	* Deletes the resource associated with the model at the scope. Note,
	* deleting an individually scoped resource also deletes corresponding
	* resources at the group, group template, and company scope, if they exist.
	*
	...
	*/
	...
	/**
	* Deletes the resource matching the primary key. Note, deleting an
	* individually scoped resource also deletes corresponding resources at the
	* group, group template, and company scope, if they exist.
	*
	* @param companyId the primary key of the portal instance
	...
	* @param userId the primary key of the user performing the permission
	check
	* @param resourceId the primary key of the group
	...
	*/
	...
	/**
	* Updates the resources for the model, setting new group and guest
	* permissions from the service context.
	*
