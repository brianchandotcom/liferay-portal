...
public class ServiceComponentLocalServiceUtil {
	...
	*/
	...
	public static java.util.List<com.liferay.portal.model.ServiceComponent> getLastServiceComponentsByBuildNamespace() {
		return getService().getLastServiceComponentsByBuildNamespace();
	}
