...
public class ImageUtil {
	 ...
	 */
	public static List<Image> find(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static List<Image> find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
	 ...
	 */
	public static List<Image> find(DynamicQuery dynamicQuery, int start,
