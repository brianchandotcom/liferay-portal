...
public class LockUtil {
	 ...
	 */
	public static List<Lock> find(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static List<Lock> find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
	 ...
	 */
	public static List<Lock> find(DynamicQuery dynamicQuery, int start,
