...
public class RoleUtil {
	 ...
	 */
	public static List<Role> find(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static List<Role> find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
	 ...
	 */
	public static List<Role> find(DynamicQuery dynamicQuery, int start,
