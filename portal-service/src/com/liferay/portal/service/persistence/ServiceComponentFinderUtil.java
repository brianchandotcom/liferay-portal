...
public class ServiceComponentFinderUtil {
	public static java.util.List<com.liferay.portal.model.ServiceComponent> findLatestVersionByBuildNamespace() {
		return getFinder().findLatestVersionByBuildNamespace();
	}
