...
public class ServiceComponentFinderUtil {
	public static java.util.List<com.liferay.portal.model.ServiceComponent> findLastVersionByBuildNamespace() {
		return getFinder().findLastVersionByBuildNamespace();
	}
