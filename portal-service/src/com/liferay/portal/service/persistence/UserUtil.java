...
public class UserUtil {
	 ...
	 */
	public static List<User> find(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static List<User> find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
	 ...
	 */
	public static List<User> find(DynamicQuery dynamicQuery, int start,
