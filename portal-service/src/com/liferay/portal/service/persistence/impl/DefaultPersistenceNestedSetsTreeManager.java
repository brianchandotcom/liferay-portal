...
public class DefaultPersistenceNestedSetsTreeManager
	...
	public DefaultPersistenceNestedSetsTreeManager(
		...
		String scopeIdName, String nsLeftName, String nsRightName) {
		...
		_nsLeftName = nsLeftName;
		_nsRightName = nsRightName;
	}

	@Override
	protected long doCountAncestors(long scopeId, long nsLeft, long nsRight)
		...
		sb.append(" = ? AND ");
		sb.append(_nsLeftName);
		sb.append(" <= ? AND ");
		sb.append(_nsRightName);
		sb.append(" >= ?");
	...
	@Override
	protected long doCountDescendants(long scopeId, long nsLeft, long nsRight)
		throws SystemException {
	...
	@Override
	protected List<T> doGetAncestors(long scopeId, long nsLeft, long nsRight)
		throws SystemException {
	...
	@Override
	protected List<T> doGetDescendants(long scopeId, long nsLeft, long nsRight)
		throws SystemException {
	...
	@Override
	protected long getMaxNSRight(long scopeId) throws SystemException {
		StringBundler sb = new StringBundler(9);
	...
	private final String _nsLeftName;
	private final String _nsRightName;
