...
public class DDMContentLocalServiceWrapper implements DDMContentLocalService,
	...
	*/
	...
	public long count(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _ddmContentLocalService.count(dynamicQuery);
	}
	...
	*/
	...
	public java.util.List find(
		com.liferay.portal.kernel.dao.orm.DynamicQuery dynamicQuery)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _ddmContentLocalService.find(dynamicQuery);
	}
	...
	*/
	...
	public java.util.List find(
		com.liferay.portal.kernel.dao.orm.DynamicQuery dynamicQuery, int start,
		int end) throws com.liferay.portal.kernel.exception.SystemException {
		return _ddmContentLocalService.find(dynamicQuery, start, end);
	}
