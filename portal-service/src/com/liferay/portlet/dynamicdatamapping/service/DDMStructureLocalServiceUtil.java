...
public class DDMStructureLocalServiceUtil {
	...
	public static com.liferay.portlet.dynamicdatamapping.model.DDMStructure addStructure(
		...
		return getService()
			.addStructure(
				userId, groupId, classNameId, nameMap,
	...
	public static com.liferay.portlet.dynamicdatamapping.model.DDMStructure copyStructure(
		...
		return getService()
			.copyStructure(
				userId, structureId, nameMap, descriptionMap,
				serviceContext);
	}
	...
	public static java.util.List<com.liferay.portlet.dynamicdatamapping.model.DDMStructure> search(
		...
		return getService()
			.search(
				companyId, groupIds, classNameIds, keywords, start,
	...
	public static java.util.List<com.liferay.portlet.dynamicdatamapping.model.DDMStructure> search(
		...
		return getService()
			.search(
				companyId, groupIds, classNameIds, name,
	...
	public static com.liferay.portlet.dynamicdatamapping.model.DDMStructure updateStructure(
		...
		return getService()
			.updateStructure(
				structureId, parentStructureId, nameMap,
				descriptionMap, xsd, serviceContext);
	}
	...
	public static com.liferay.portlet.dynamicdatamapping.model.DDMStructure updateStructure(
		...
		return getService()
			.updateStructure(
				groupId, parentStructureId, structureKey,
	...
	public static com.liferay.portlet.dynamicdatamapping.model.DDMStructure updateStructureXsd(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
		com.liferay.portal.kernel.exception.SystemException {
		return getService().updateStructureXsd(structureId, xsd, serviceContext);
	}

	public static void updateXSDFieldMetadataEntryValue(
		long structureId,
		...
		com.liferay.portal.kernel.exception.SystemException {
		getService()
			.updateXSDFieldMetadataEntryValue(
				structureId, fieldName,
				metadataEntryName, metadataEntryValue, locale, serviceContext);
	}
