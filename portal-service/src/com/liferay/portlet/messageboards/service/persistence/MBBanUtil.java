...
public class MBBanUtil {
	 ...
	 */
	public static List<MBBan> find(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static List<MBBan> find(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
	 ...
	 */
	public static List<MBBan> find(DynamicQuery dynamicQuery, int start,
