 ...
 */
public class SocialActivityCounter implements Serializable {

	public SocialActivityCounter() {
	}

	public SocialActivityCounter(String name, int ownerType) {
		_name = name;
		_ownerType = ownerType;
	}

	public SocialActivityCounter clone() {
	...
	public boolean equals(SocialActivityCounter counter) {
	...
	public void setOwnerType(String ownerType) {
		if ("actor".equals(ownerType)) {
			setOwnerType(SocialActivityConstants.OWNER_TYPE_ACTOR);
		} else if ("asset".equals(ownerType)) {
			setOwnerType(SocialActivityConstants.OWNER_TYPE_ASSET);
		} else if ("creator".equals(ownerType)) {
			setOwnerType(SocialActivityConstants.OWNER_TYPE_CREATOR);
		}
	}
