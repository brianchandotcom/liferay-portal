...
public class SocialActivityDefinition implements Serializable {
	...
	public void addCounter(SocialActivityCounter counter) {
	...
	public SocialActivityDefinition clone() {
		...
		for (SocialActivityCounter counter : _counters.values()) {
	...
	public SocialActivityCounter getCounter(String name) {
		return _counters.get(name);
	}

	public Collection<SocialActivityCounter> getCounters() {
	...
	public void setCounters(List<SocialActivityCounter> counters) {
		_counters.clear();
	...
	private Map<String, SocialActivityCounter> _counters =
