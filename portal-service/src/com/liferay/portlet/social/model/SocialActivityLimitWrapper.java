...
public class SocialActivityLimitWrapper implements SocialActivityLimit {
	...
	*/
	...
	/**
	* Returns the activity key of this social activity limit.
	*
	* @return the activity key of this social activity limit
	*/
	public int getActivityKey() {
		return _socialActivityLimit.getActivityKey();
	}

	/**
	* Sets the activity key of this social activity limit.
	*
	* @param activityKey the activity key of this social activity limit
	*/
	public void setActivityKey(int activityKey) {
		_socialActivityLimit.setActivityKey(activityKey);
	}

	/**
	* Returns the stat name of this social activity limit.
	*
	* @return the stat name of this social activity limit
	*/
	public java.lang.String getStatName() {
		return _socialActivityLimit.getStatName();
	}

	/**
	* Sets the stat name of this social activity limit.
	*
	* @param statName the stat name of this social activity limit
	*/
	public void setStatName(java.lang.String statName) {
		_socialActivityLimit.setStatName(statName);
	}
	...
	*/
	...
	public void setEscapedModel(boolean escapedModel) {
		_socialActivityLimit.setEscapedModel(escapedModel);
	}
