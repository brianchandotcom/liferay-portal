...
public class SocialActivitySettingWrapper implements SocialActivitySetting {
	...
	*/
	...
	/**
	* Returns the activity key of this social activity setting.
	*
	* @return the activity key of this social activity setting
	*/
	public int getActivityKey() {
		return _socialActivitySetting.getActivityKey();
	}

	/**
	* Sets the activity key of this social activity setting.
	*
	* @param activityKey the activity key of this social activity setting
	*/
	public void setActivityKey(int activityKey) {
		_socialActivitySetting.setActivityKey(activityKey);
	}
	...
	*/
	...
	public void setEscapedModel(boolean escapedModel) {
		_socialActivitySetting.setEscapedModel(escapedModel);
	}
