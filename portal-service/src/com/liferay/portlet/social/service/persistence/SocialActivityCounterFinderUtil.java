...
public class SocialActivityCounterFinderUtil {
	public static int countU_ByG_C_N_S_E(long groupId,
		java.lang.String[] orderBy)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getFinder().countU_ByG_C_N_S_E(groupId, orderBy);
	}
	...
	public static java.util.List<com.liferay.portlet.social.model.SocialActivityCounter> findAC_ByG_N_S_E_3(
		long groupId, java.lang.String counterName, int startPeriod,
		int endPeriod)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getFinder()
				   .findAC_ByG_N_S_E_3(groupId, counterName, startPeriod,
			endPeriod);
	}

	public static java.util.List<java.lang.Long> findU_ByG_C_N_S_E(
		long groupId, java.lang.String[] orderBy, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getFinder().findU_ByG_C_N_S_E(groupId, orderBy, start, end);
	}
