...
public class BaseIntraBandTest {
	...
	public void testDatagramReceiveHandlerRegister() throws Exception {
		...
		DatagramReceiveHandler[] datagramReceiveHandlers =
			_mockIntraBand.getRegisteredDatagramReceiveHandlers();
		...
		Assert.assertSame(
			...
			_mockIntraBand.getRegisteredDatagramReceiveHandlers()[_type]);
	...
	public void testResponseWaiting() throws Exception {
		...
		recordCompletionHandler1.waitUntilTimeouted(null);
		recordCompletionHandler2.waitUntilTimeouted(null);
	...
	public void testSendSyncDatagram() throws Exception {
		...
		final IOException expectedIOException =
			new IOException("Force to fail");
