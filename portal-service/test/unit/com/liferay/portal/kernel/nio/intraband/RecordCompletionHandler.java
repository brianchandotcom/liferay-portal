...
public class RecordCompletionHandler<A> implements CompletionHandler<A> {
	...
	private final CountDownLatch _deliveredCountDownLatch =
	...
	private final CountDownLatch _submittedCountDownLatch =
		new CountDownLatch(1);
	private final CountDownLatch _timeoutedCountDownLatch =
		new CountDownLatch(1);
