...
public class DistributedRegistryTest {
	...
	public void testClassRegister() {
		...
		Assert.assertEquals(
			Direction.REQUEST, _exactDirections.get(ChildClass.name11));
		...
		Assert.assertEquals(
			Direction.RESPONSE, _postfixDirections.get(ChildClass.name12));
		...
		Assert.assertEquals(
			Direction.DUPLEX, _prefixDirections.get(ChildClass.name13));
