...
<link href="<%= HtmlUtil.escape(PortalUtil.getStaticResourceURL(request, (themeDisplay.isCDNDynamicResourcesEnabled() ? themeDisplay.getCDNHost() : "") + themeDisplay.getPathContext() + "/html/css/main.css")) %>" rel="stylesheet" type="text/css" />
