...
<c:choose>
	<c:when test="<%= portletDisplayTemplateId > 0 %>">
		<%= PortletDisplayTemplateUtil.renderDDMTemplate(pageContext, portletDisplayTemplateId, BreadcrumbUtil.getBreadcrumbEntries(request, BreadcrumbUtil.ENTRY_TYPE_ANY)) %>
	</c:when>
	<c:otherwise>
