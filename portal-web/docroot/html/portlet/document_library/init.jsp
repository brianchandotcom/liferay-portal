...
page import="com.liferay.portlet.documentlibrary.context.JavascriptMenuItem" %><%@
page import="com.liferay.portlet.documentlibrary.context.MenuItem" %><%@
page import="com.liferay.portlet.documentlibrary.context.URLMenuItem" %><%@
