...
List<DDMStructure> ddmStructures = JournalFolderServiceUtil.getFolderDDMStructures(PortalUtil.getCurrentAndAncestorSiteGroupIds(scopeGroupId), folderId, inherited);
%>
