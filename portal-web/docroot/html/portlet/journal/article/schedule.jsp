...
<aui:fieldset>
	...
	<aui:input disabled="<%= neverExpire %>" disabledToggler="neverExpire" formName="fm1" name="expirationDate" />

	<aui:input disabled="<%= neverReview %>" disabledToggler="neverReview" formName="fm1" name="reviewDate" />
</aui:fieldset>