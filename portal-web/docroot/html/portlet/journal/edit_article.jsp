		...
		<div class="journal-article-wrapper" id="<portlet:namespace />journalArticleWrapper">
			<div class="journal-article-wrapper-content">
				...
				<liferay-util:buffer var="htmlBottom">
					...
					long inheritedDDMStructuresFolderId = JournalFolderLocalServiceUtil.getInheritedDDMStructuresFolderId(folderId, JournalFolderConstants.RESTRICTION_TYPE_WORKFLOW);

					boolean workflowEnabled = WorkflowDefinitionLinkLocalServiceUtil.hasWorkflowDefinitionLink(themeDisplay.getCompanyId(), groupId, JournalFolder.class.getName(), folderId, ddmStructure.getStructureId()) || WorkflowDefinitionLinkLocalServiceUtil.hasWorkflowDefinitionLink(themeDisplay.getCompanyId(), groupId, JournalFolder.class.getName(), inheritedDDMStructuresFolderId, JournalArticleConstants.DDM_STRUCTURE_ID_ALL);
