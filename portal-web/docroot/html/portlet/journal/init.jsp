...
<%@ page import="com.liferay.portlet.journal.StructureRequiredByJournalException" %>
<%@ page import="com.liferay.portlet.journal.StructureRequiredByStructureException" %>
<%@ page import="com.liferay.portlet.journal.StructureRequiredByTemplateException" %>
