...
<head>
	<link href="<%= PortalUtil.getStaticResourceURL(request, (themeDisplay.isCDNDynamicResourcesEnabled() ? themeDisplay.getCDNHost() : "") + themeDisplay.getPathContext() + "/html/css/main.css") %>" type="text/css" rel="stylesheet" />
