										...
										<li class="options">
											...
											<aui:fieldset cssClass="export-deletions">
												...
												<c:if test="<%= modelDeletionCount != 0 %>">
													...
													<aui:input checked="<%= true %>" helpMessage="deletions-help" id="deletions" label='<%= LanguageUtil.get(pageContext, "deletions") + badgeHTML %>' name="<%= PortletDataHandlerKeys.EXPORT_DELETIONS %>" type="checkbox" value="<%= true %>" />
												</c:if>
											</aui:fieldset>
										</li>
									</ul>
