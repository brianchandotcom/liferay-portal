															...
															<ul class="lfr-tree unstyled">
																<li class="tree-item">
																	...
																	<c:if test="<%= modelDeletionCount != 0 %>">
																		...
																		<aui:input data-name="<%= deletionsLabel %>" helpMessage="deletions-help" label="<%= deletionsLabel %>" name="<%= PortletDataHandlerKeys.EXPORT_DELETIONS %>" type="checkbox" value="<%= true %>" />
																	</c:if>
																</li>
															</ul>
														</div>
