...
<aui:form action="<%= configurationActionURL %>" method="post" name="fm">
	...
	<liferay-ui:panel collapsible="<%= true %>" extended="<%= true %>" id="topUsersRankingCounters" persistState="<%= true %>" title="ranking">
		<aui:input label='<%= LanguageUtil.format(pageContext, "rank-on-x", LanguageUtil.format(pageContext, "participation", false), false) %>' name="preferences--rankOnParticipation--" type="checkbox" value="<%= rankOnParticipation %>" />

		<br />

		<aui:input label='<%= LanguageUtil.format(pageContext, "rank-on-x", LanguageUtil.format(pageContext, "contribution", false), false) %>' name="preferences--rankOnContribution--" type="checkbox" value="<%= rankOnContribution %>" />
	</liferay-ui:panel>
