...
public class CPDocumentsAndMediaDocumentEditPaths {
	...
	static {
		...
		_paths.put("BUTTON_CANCEL_CHECKIN", "//input[@value='Cancel Checkin']");
		_paths.put("BUTTON_CHECKOUT", "//input[@value='Checkout']");
		_paths.put("BUTTON_PUBLISH", "//input[@value='Publish']");
		_paths.put("BUTTON_SAVE", "//input[@value='Save']");
		_paths.put("BUTTON_SAVE_AND_CHECKIN",
			"//input[@value='Save and Checkin']");
	}
}