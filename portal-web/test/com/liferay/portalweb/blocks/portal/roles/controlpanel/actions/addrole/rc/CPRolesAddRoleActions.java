 ...
 */
public class CPRolesAddRoleActions extends BaseLiferayActions {
	public CPRolesAddRoleActions(LiferaySelenium liferaySelenium) {
		super(liferaySelenium);
		paths = CPRolesAddRolePaths.getPaths();
	}
