...
public class CPUsersAndOrganizationsHomePaths {
	...
	static {
		...
		_paths.put("SEARCH_FIELD", "//input[@id='_125_keywords']");
		_paths.put("SEARCH_BUTTON", "//input[@value='Search']");
		_paths.put("ORGANIZATIONS_SEARCH_ALL", "link=Search All Organizations");
		_paths.put("ORGANIZATIONS_ACTIONS_EDIT",
		...
		_paths.put("ORGANIZATIONS_ACTIONS_DELETE",
			"//div[@class='lfr-component lfr-menu-list']/ul/li/a[contains(.,'Delete')]");
		_paths.put("USERS_SEARCH_ALL", "link=Search All Users");
		_paths.put("USERS_DEACTIVATE", "//input[@value='Deactivate']");
		_paths.put("USERS_CHECK_ALL",
		...
		_paths.put("USERS_ACTIONS_DEACTIVATE",
