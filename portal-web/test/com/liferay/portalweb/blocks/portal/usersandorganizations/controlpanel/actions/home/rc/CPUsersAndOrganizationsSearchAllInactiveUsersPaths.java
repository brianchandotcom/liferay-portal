...
public class CPUsersAndOrganizationsSearchAllInactiveUsersPaths {
	...
	static {
		...
		_paths.put("USERS_DELETE", "//input[@value='Delete']");
		_paths.put("USERS_RESTORE", "//input[@value='Restore']");
		...
		_paths.put("USERS_MESSAGE", "//div[@class='portlet-msg-info']");
		...
		_paths.put("USERS_ACTIONS_ACTIVATE",
			"//div[@class='lfr-component lfr-menu-list']/ul/li/a[contains(.,'Activate')]");
		_paths.put("USERS_ACTIONS_DELETE",
