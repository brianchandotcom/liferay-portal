...
public class AddRegRoleTest extends BaseTestCase {
	...
	public void test() throws Exception {
		...
		cPRolesHomeActions.type("SEARCH_FILED", "Regrole Title");
		cPRolesHomeActions.click("SEARCH_BUTTON", "Search");
		cPRolesHomeActions.assertTextEquals("ROLES_NAME", "Regrole Title");
		cPRolesHomeActions.click("ROLES_NAME", "Regrole Title");
		cPRolesEditRoleActions.assertTextEquals("ROLE_TYPE", "Regular");
		cPRolesEditRoleActions.assertTextEquals("ROLE_NAME", "Regrole Name");
		cPRolesEditRoleActions.assertTextEquals("ROLE_TITLE", "Regrole Title");
