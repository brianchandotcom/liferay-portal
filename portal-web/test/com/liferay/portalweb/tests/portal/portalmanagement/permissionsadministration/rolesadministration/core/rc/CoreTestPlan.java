...
public class CoreTestPlan extends BaseTestSuite {
	public static Test suite() {
		...
		testSuite.addTestSuite(AssignRegRoleUserTest.class);
		testSuite.addTestSuite(DeleteOrgRoleTest.class);
		testSuite.addTestSuite(DeleteRegRoleTest.class);
		testSuite.addTestSuite(DeleteSiteRoleTest.class);
