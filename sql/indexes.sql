...
create unique index IX_CF74CD41 on DDMStructureLayout (structureId, structureVersion);
create unique index IX_CD8A8F60 on DDMStructureLayout (structureId, version);
