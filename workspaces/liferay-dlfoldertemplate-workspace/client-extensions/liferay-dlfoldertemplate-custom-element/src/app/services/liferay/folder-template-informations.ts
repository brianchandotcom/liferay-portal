...
export class foldertemplateinformationsService {
	...
	public deleteFolderTemplateInformation(FolderTemplateInformation: any) {
		...
		const prom = new Promise((resolve, reject) => {
			this.http
				.delete(
					`/o/c/foldertemplateinformations/${FolderTemplateInformation}`,
					httpOptions
				)
				.subscribe(
					(result) => {
	...
	public postFolderTemplateInformation(FolderTemplateInformation: any) {
		...
		const prom = new Promise((resolve, reject) => {
			this.http
				.post(
					`/o/c/foldertemplateinformations/`,
					FolderTemplateInformation,
					httpOptions
				)
				.subscribe(
					(result) => {
	...
	public getFolderTemplateInformationsPage(
		...
		const prom = new Promise((resolve, reject) => {
			this.http
				.get(`/o/c/foldertemplateinformations/`, httpOptions)
				.subscribe(
					(result) => {
						resolve(result);
					},
