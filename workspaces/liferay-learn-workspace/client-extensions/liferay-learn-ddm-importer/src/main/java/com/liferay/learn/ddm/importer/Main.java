...
public class Main {
	...
	public static void main(String[] arguments) throws Exception {
		...
		Main main = new Main(
			System.getenv("LIFERAY_LEARN_DDM_IMPORTER_LIFERAY_OAUTH_CLIENT_ID"),
			System.getenv(
				"LIFERAY_LEARN_DDM_IMPORTER_LIFERAY_OAUTH_CLIENT_SECRET"),
			new URL(System.getenv("LIFERAY_LEARN_DDM_IMPORTER_LIFERAY_URL")));

		main.uploadToLiferay(
			System.getenv(
				"LIFERAY_LEARN_DDM_IMPORTER_LIFERAY_SITE_FRIENDLY_URL_PATH"));
