...
public class FaroDataSourceUsageLocalServiceWrapper
	...
	public com.liferay.osb.faro.model.FaroDataSourceUsage
		addFaroDataSourceUsage(
			long companyId, long userId, long billableEventsCount,
		...
		return _faroDataSourceUsageLocalService.addFaroDataSourceUsage(
			companyId, userId, billableEventsCount, dataSourceId,
			dataSourceName, dataSourceStatus, faroProjectId,
			knownIndividualsCount, usageDate);
	}
	...
	public com.liferay.osb.faro.model.FaroDataSourceUsage
			addOrUpdateFaroDataSourceUsage(
				...
				String dataSourceStatus, long faroProjectId,
...
// LIFERAY-SERVICE-BUILDER-HASH:1781226326