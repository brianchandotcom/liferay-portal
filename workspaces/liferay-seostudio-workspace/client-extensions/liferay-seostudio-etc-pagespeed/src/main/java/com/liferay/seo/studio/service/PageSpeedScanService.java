...
public class PageSpeedScanService {
	...
	public void processQueuedScans() {
		JSONArray scansJSONArray = _liferayService.getQueuedScansJSONArray();
	...
	private void _runScan(JSONObject scanJSONObject, long seoStudioScanId) {
		...
		PageSpeedScanResult desktopPageSpeedScanResult = _scanURLs(
			googlePageSpeedAPIKey, PageSpeedConstants.STRATEGY_DESKTOP, urls);

		_liferayService.postPageSpeedResult(
			desktopPageSpeedScanResult, seoStudioScanId);

		PageSpeedScanResult mobilePageSpeedScanResult = _scanURLs(
